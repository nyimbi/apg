...
ENTITIES = [{'name': 'Vendor', 'type': 'entity', 'properties': ['vendor_number', 'legal_name', 'tax_id', 'payment_terms', 'currency', 'bank_account', 'status', 'country'], 'fields': [{'name': 'vendor_number', 'type': 'str', 'required': True}, {'name': 'legal_name', 'type': 'str', 'required': True}, {'name': 'tax_id', 'type': 'str', 'required': True}, {'name': 'payment_terms', 'type': 'str', 'required': False, 'default': '"NET30"'}, {'name': 'currency', 'type': 'str', 'required': False, 'default': '"KES"'}, {'name': 'bank_account', 'type': 'str?', 'required': True}, {'name': 'status', 'type': 'str', 'required': False, 'default': '"active"'}, {'name': 'country', 'type': 'str', 'required': False, 'default': '"KE"'}], 'methods': []}, {'name': 'Customer', 'type': 'entity', 'properties': ['customer_number', 'legal_name', 'credit_limit', 'payment_terms', 'currency', 'status', 'region'], 'fields': [{'name': 'customer_number', 'type': 'str', 'required': True}, {'name': 'legal_name', 'type': 'str', 'required': True}, {'name': 'credit_limit', 'type': 'float', 'required': False, 'default': '100000.0'}, {'name': 'payment_terms', 'type': 'str', 'required': False, 'default': '"NET30"'}, {'name': 'currency', 'type': 'str', 'required': False, 'default': '"KES"'}, {'name': 'status', 'type': 'str', 'required': False, 'default': '"active"'}, {'name': 'region', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Employee', 'type': 'entity', 'properties': ['employee_number', 'full_name', 'department', 'position', 'salary', 'hire_date', 'is_active'], 'fields': [{'name': 'employee_number', 'type': 'str', 'required': True}, {'name': 'full_name', 'type': 'str', 'required': True}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'position', 'type': 'str', 'required': True}, {'name': 'salary', 'type': 'float', 'required': True}, {'name': 'hire_date', 'type': 'str', 'required': True}, {'name': 'is_active', 'type': 'bool', 'required': False, 'default': 'true'}], 'methods': []}, {'name': 'ERPDB', 'type': 'database', 'properties': ['engine', 'schema', 'url'], 'fields': [{'name': 'engine', 'type': 'str', 'required': False, 'default': 'postgresql'}, {'name': 'schema', 'type': 'str', 'required': False, 'default': 'erp_platform'}, {'name': 'url', 'type': 'str', 'required': False, 'default': 'env("ERP_DATABASE_URL")'}], 'methods': [], 'connection_config': {'engine': 'postgresql', 'schema': 'erp_platform', 'url': 'env("ERP_DATABASE_URL")'}, 'schemas': []}, {'name': 'ERPCore', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ExecutiveERP', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ERPAnalyst', 'type': 'agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'PrivacyAgent', 'type': 'agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ERPAdvisors', 'type': 'agent_team', 'properties': ['agents', 'flow', 'capabilities'], 'fields': [{'name': 'agents', 'type': '[ERPAnalyst, PrivacyAgent]', 'required': True}, {'name': 'flow', 'type': 'ERPAnalyst -> PrivacyAgent', 'required': True}, {'name': 'capabilities', 'type': '[erp_entities, executive_dashboard]', 'required': True}], 'methods': []}, {'name': 'HireToRetire', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'MonthEndClose', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'EnterpriseERP', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
