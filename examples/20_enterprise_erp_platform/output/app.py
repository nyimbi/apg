"""
enterprise_erp_platform - APG Python Application
================================================
...
NEXT_EVENT_ID = 1
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['enterprise_erp_platform.apg'], 'app': {'name': 'enterprise_erp_platform', 'version': '1.0.0', 'description': None, 'entity_count': 7}, 'symbols': {'module.enterprise_erp_platform': {'id': 'module.enterprise_erp_platform', 'kind': 'module', 'name': 'enterprise_erp_platform', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.EnterpriseERPPlatform': {'id': 'app.EnterpriseERPPlatform', 'kind': 'app', 'name': 'EnterpriseERPPlatform', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Customer': {'id': 'table.Customer', 'kind': 'table', 'name': 'Customer', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.customer_number': {'id': 'field.Customer.customer_number', 'kind': 'field', 'name': 'Customer.customer_number', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.legal_name': {'id': 'field.Customer.legal_name', 'kind': 'field', 'name': 'Customer.legal_name', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.email': {'id': 'field.Customer.email', 'kind': 'field', 'name': 'Customer.email', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.active': {'id': 'field.Customer.active', 'kind': 'field', 'name': 'Customer.active', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Item': {'id': 'table.Item', 'kind': 'table', 'name': 'Item', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Item.sku': {'id': 'field.Item.sku', 'kind': 'field', 'name': 'Item.sku', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Item.description': {'id': 'field.Item.description', 'kind': 'field', 'name': 'Item.description', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Item.unit_price': {'id': 'field.Item.unit_price', 'kind': 'field', 'name': 'Item.unit_price', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Item.active': {'id': 'field.Item.active', 'kind': 'field', 'name': 'Item.active', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.SalesOrder': {'id': 'table.SalesOrder', 'kind': 'table', 'name': 'SalesOrder', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SalesOrder.customer_id': {'id': 'field.SalesOrder.customer_id', 'kind': 'field', 'name': 'SalesOrder.customer_id', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SalesOrder.order_number': {'id': 'field.SalesOrder.order_number', 'kind': 'field', 'name': 'SalesOrder.order_number', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SalesOrder.total': {'id': 'field.SalesOrder.total', 'kind': 'field', 'name': 'SalesOrder.total', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SalesOrder.status': {'id': 'field.SalesOrder.status', 'kind': 'field', 'name': 'SalesOrder.status', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.PlatformAudit': {'id': 'capability.PlatformAudit', 'kind': 'capability', 'name': 'PlatformAudit', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.EnterpriseFinance': {'id': 'capability.EnterpriseFinance', 'kind': 'capability', 'name': 'EnterpriseFinance', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.EnterpriseOperations': {'id': 'capability.EnterpriseOperations', 'kind': 'capability', 'name': 'EnterpriseOperations', 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'Customer': {'name': 'Customer', 'fields': {'customer_number': {'type': 'str', 'required': True, 'relationship': None}, 'legal_name': {'type': 'str', 'required': True, 'relationship': None}, 'email': {'type': 'str', 'required': True, 'relationship': None}, 'active': {'type': 'bool', 'required': True, 'relationship': None}}, 'lookup_paths': {}}, 'Item': {'name': 'Item', 'fields': {'sku': {'type': 'str', 'required': True, 'relationship': None}, 'description': {'type': 'str', 'required': True, 'relationship': None}, 'unit_price': {'type': 'float', 'required': True, 'relationship': None}, 'active': {'type': 'bool', 'required': True, 'relationship': None}}, 'lookup_paths': {}}, 'SalesOrder': {'name': 'SalesOrder', 'fields': {'customer_id': {'type': 'int', 'required': True, 'relationship': {'target_table': 'Customer', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'customer'}}, 'order_number': {'type': 'str', 'required': True, 'relationship': None}, 'total': {'type': 'float', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {'EnterpriseFinance.balanced_journal': {'name': 'balanced_journal', 'when': 'debits != credits', 'action': 'deny'}, 'EnterpriseFinance.invoice_requires_order': {'name': 'invoice_requires_order', 'when': 'order_id missing', 'action': 'deny'}, 'EnterpriseOperations.no_negative_stock': {'name': 'no_negative_stock', 'when': 'on_hand - reserved < 0', 'action': 'deny'}, 'EnterpriseOperations.critical_exception_review': {'name': 'critical_exception_review', 'when': 'severity == critical', 'action': 'require_review'}}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {'PlatformAudit': {'name': 'PlatformAudit', 'provides': ['audit_events'], 'requires': [], 'configuration': {'retention_days': 730}, 'rules': [], 'rule_engine': {}, 'ui': {}, 'theme': {}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {'processor': 'bytewax', 'state': 'platform_audit_state'}, 'screens': {}}, 'EnterpriseFinance': {'name': 'EnterpriseFinance', 'provides': ['journal_entries', 'invoice_generation', 'payment_allocation'], 'requires': ['audit_events'], 'configuration': {'currency': 'KES', 'fiscal_calendar': 'monthly'}, 'rules': [{'name': 'balanced_journal', 'when': 'debits != credits', 'action': 'deny'}, {'name': 'invoice_requires_order', 'when': 'order_id missing', 'action': 'deny'}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Finance', 'path': '/erp/finance', 'component': 'FinanceWorkbench'}]}, 'theme': {'name': 'finance_theme', 'tokens': {'accent': '#126E82'}}, 'runtime': {}, 'erp_modules': ['finance', 'general_ledger', 'accounts_payable'], 'components': {}, 'business_rules': [], 'approvals': {'levels': 2, 'approvers': ['controller', 'cfo']}, 'master_data': {'entities': ['account', 'cost_center', 'financial_period']}, 'i18n': {'supported_languages': ['en', 'sw', 'ha', 'yo', 'zu', 'am', 'rw'], 'default_language': 'en', 'fallback_language': 'en'}, 'streaming': {'processor': 'bytewax', 'state': 'finance_event_state'}, 'screens': {}}, 'EnterpriseOperations': {'name': 'EnterpriseOperations', 'provides': ['stock_balances', 'order_fulfillment', 'executive_kpis'], 'requires': ['journal_entries', 'audit_events'], 'configuration': {'default_warehouse': 'NBO-01', 'refresh_seconds': 30}, 'rules': [{'name': 'no_negative_stock', 'when': 'on_hand - reserved < 0', 'action': 'deny'}, {'name': 'critical_exception_review', 'when': 'severity == critical', 'action': 'require_review'}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Operations', 'path': '/erp/operations', 'component': 'OperationsWorkbench'}]}, 'theme': {'name': 'operations_theme', 'tokens': {'accent': '#2F855A', 'surface': '#F7FAFC'}}, 'runtime': {}, 'erp_modules': ['inventory', 'warehouse', 'manufacturing', 'sales'], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {'processor': 'bytewax', 'state': 'operations_event_state'}, 'screens': {'OperationsDashboard': {'route': '/erp/operations/dashboard', 'title': 'Enterprise Operations', 'layout': 'dashboard', 'contains': ['InventoryKpis', 'OrderQueue', 'ExceptionQueue'], 'composes': ['FulfillmentTable', 'FinanceKpis'], 'binds': ['executive_kpis.current'], 'actions': ['approve', 'reject', 'escalate'], 'events': [{'on': 'select', 'do': 'filter', 'target': 'FulfillmentTable'}], 'relationships': ['InventoryKpis -> ExceptionQueue', 'OrderQueue -> FulfillmentTable', 'FinanceKpis -> ExceptionQueue']}}}}, 'composition': {'applications': {'EnterpriseERPPlatform': {'name': 'EnterpriseERPPlatform', 'description': 'Composable ERP application shell that assembles finance, operations, and audit capabilities', 'capabilities': ['PlatformAudit', 'EnterpriseFinance', 'EnterpriseOperations'], 'agents': [], 'agent_teams': [], 'components': {'finance_workbench': {'capability': 'journal_entries', 'route': '/erp/finance'}, 'operations_workbench': {'capability': 'executive_kpis', 'route': '/erp/operations'}, 'audit_console': {'capability': 'audit_events', 'route': '/erp/audit'}}, 'screens': {'ExecutiveHome': {'route': '/erp', 'capability': 'EnterpriseOperations', 'component': 'ExecutiveHome'}}, 'routes': ['/erp/finance', '/erp/operations', '/erp/operations/dashboard'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {'name': 'enterprise_theme', 'tokens': {'accent': '#174EA6', 'surface': '#F8FAFC'}}, 'runtime': {'target': 'python', 'deployment': 'container', 'streaming': {'processor': 'bytewax'}}, 'integrations': {}, 'deployments': {'default': 'local', 'container': 'docker'}}}, 'agent_teams': {}, 'capability_dependencies': {'PlatformAudit': [], 'EnterpriseFinance': ['audit_events'], 'EnterpriseOperations': ['journal_entries', 'audit_events']}}, 'contracts': {'PlatformAudit': {'id': 'platform_audit', 'provides': ['audit_events'], 'configuration': {'retention_days': 730}}, 'EnterpriseFinance': {'id': 'enterprise_finance', 'provides': ['journal_entries', 'invoice_generation', 'payment_allocation'], 'requires': ['audit_events'], 'configuration': {'currency': 'KES', 'fiscal_calendar': 'monthly'}, 'rules': [{'name': 'balanced_journal', 'when': 'debits != credits', 'action': 'deny'}, {'name': 'invoice_requires_order', 'when': 'order_id missing', 'action': 'deny'}], 'ui': {'shell': 'python', 'routes': [{'name': 'Finance', 'path': '/erp/finance', 'component': 'FinanceWorkbench'}]}, 'theme': {'name': 'finance_theme', 'tokens': {'accent': '#126E82'}}}, 'EnterpriseOperations': {'id': 'enterprise_operations', 'provides': ['stock_balances', 'order_fulfillment', 'executive_kpis'], 'requires': ['journal_entries', 'audit_events'], 'configuration': {'default_warehouse': 'NBO-01', 'refresh_seconds': 30}, 'rules': [{'name': 'no_negative_stock', 'when': 'on_hand - reserved < 0', 'action': 'deny'}, {'name': 'critical_exception_review', 'when': 'severity == critical', 'action': 'require_review'}], 'ui': {'shell': 'python', 'routes': [{'name': 'Operations', 'path': '/erp/operations', 'component': 'OperationsWorkbench'}]}, 'theme': {'name': 'operations_theme', 'tokens': {'accent': '#2F855A', 'surface': '#F7FAFC'}}}}, 'deployment': {'target': 'python', 'source': 'enterprise_erp_platform.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 15, 'edges': 13}, 'lookup': {'kind': 'lookup', 'nodes': 8, 'edges': 7}, 'workflow': {'kind': 'workflow', 'nodes': 8, 'edges': 7}, 'handler': {'kind': 'handler', 'nodes': 8, 'edges': 7}, 'capability': {'kind': 'capability', 'nodes': 6, 'edges': 6}, 'security': {'kind': 'security', 'nodes': 8, 'edges': 7}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 8, 'edges': 7}, 'package': {'kind': 'package', 'nodes': 8, 'edges': 7}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'customer_number' appears to be unused", 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'legal_name' appears to be unused", 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'email' appears to be unused", 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'active' appears to be unused", 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'sku' appears to be unused", 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'description' appears to be unused", 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'unit_price' appears to be unused", 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'active' appears to be unused", 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'customer_id' appears to be unused", 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'order_number' appears to be unused", 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'total' appears to be unused", 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'status' appears to be unused", 'file': 'enterprise_erp_platform.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
