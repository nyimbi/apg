...
AI_AGENT_DATA: Dict[str, Dict[str, Any]] = {'ERPAnalyst': {'role': 'ERP business analyst', 'model': 'openai:gpt-4.1', 'runtime': None, 'system': 'Analyse ERP data across Finance, Procurement, HR, and CRM. Produce concise insights with KPI context. Cite data sources.', 'capabilities': ['erp_entities', 'executive_dashboard', 'board_reporting'], 'tools': ['gl.query', 'procurement.analysis', 'inventory.forecast', 'hr.analytics'], 'memory': {'kind': 'vector', 'name': 'erp_analyst_memory'}, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {'temperature': 0.1, 'max_turns': 10}, 'rules': [], 'ui': {}, 'theme': {}}, 'PrivacyAgent': {'role': 'privacy-safe HR advisor', 'model': 'ollama:llama3.3', 'runtime': None, 'system': 'Handle HR queries locally. No data transmitted externally. GDPR-compliant responses.', 'capabilities': ['erp_entities'], 'tools': ['hr.query_local', 'payroll.summarise_local'], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {'temperature': 0.0, 'max_turns': 5}, 'rules': [], 'ui': {}, 'theme': {}}}
