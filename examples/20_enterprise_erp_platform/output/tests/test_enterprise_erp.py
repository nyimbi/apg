...
def test_crud_vendor(generated_app_client):
	payload = {'vendor_number': 'Vendor Wave K Needle', 'legal_name': 'sample legal_name', 'tax_id': 'sample tax_id', 'payment_terms': 'sample payment_terms', 'currency': 'sample currency', 'bank_account': 'sample bank_account', 'status': 'sample status', 'country': 'sample country'}
