...
- `TaxRegistrationPipeline`
- `GovernmentPortal`

## AI agents

- `CitizenAssistant` - runtime `local`, invoke with `POST /agents/CitizenAssistant/invoke`
...
- `CitizenServicesHub` - provides citizen_registration, service_application_lifecycle, payment_processing, status_tracking, digital_notification, multi_channel_access
