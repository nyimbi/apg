...
ENTITIES = [{'name': 'InventoryItem', 'type': 'entity', 'properties': ['sku', 'description', 'barcode', 'notes', 'quantity_on_hand', 'quantity_reserved', 'quantity_on_order', 'unit_price', 'cost_price', 'weight_kg', 'reorder_point', 'reorder_quantity', 'is_active', 'is_serialised', 'is_hazardous', 'requires_refrigeration', 'created_at', 'last_counted_at', 'best_before', 'reorder_time', 'image_thumbnail', 'categories', 'attributes', 'dimensions', 'metadata', 'status', 'warehouse_location'], 'fields': [{'name': 'sku', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str', 'required': True}, {'name': 'barcode', 'type': 'str?', 'required': True}, {'name': 'notes', 'type': 'str | None', 'required': True}, {'name': 'quantity_on_hand', 'type': 'int', 'required': True, 'default': '0'}, {'name': 'quantity_reserved', 'type': 'int', 'required': True, 'default': '0'}, {'name': 'quantity_on_order', 'type': 'int', 'required': True, 'default': '0'}, {'name': 'unit_price', 'type': 'decimal', 'required': True}, {'name': 'cost_price', 'type': 'decimal', 'required': True}, {'name': 'weight_kg', 'type': 'float', 'required': True, 'default': '0.0'}, {'name': 'reorder_point', 'type': 'int', 'required': True, 'default': '10'}, {'name': 'reorder_quantity', 'type': 'int', 'required': True, 'default': '50'}, {'name': 'is_active', 'type': 'bool', 'required': True, 'default': 'true'}, {'name': 'is_serialised', 'type': 'bool', 'required': True, 'default': 'false'}, {'name': 'is_hazardous', 'type': 'bool', 'required': True, 'default': 'false'}, {'name': 'requires_refrigeration', 'type': 'bool', 'required': True, 'default': 'false'}, {'name': 'created_at', 'type': 'datetime', 'required': True}, {'name': 'last_counted_at', 'type': 'datetime?', 'required': True}, {'name': 'best_before', 'type': 'date?', 'required': True}, {'name': 'reorder_time', 'type': 'time?', 'required': True}, {'name': 'image_thumbnail', 'type': 'bytes?', 'required': True}, {'name': 'categories', 'type': 'List', 'required': True}, {'name': 'attributes', 'type': 'Dict', 'required': True}, {'name': 'dimensions', 'type': 'Dict', 'required': True}, {'name': 'metadata', 'type': 'Dict', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"active"'}, {'name': 'warehouse_location', 'type': 'str?', 'required': True}], 'methods': []}, {'name': 'StockMovement', 'type': 'entity', 'properties': ['movement_id', 'item_id', 'movement_type', 'quantity', 'reference', 'notes', 'movement_date', 'performed_by'], 'fields': [{'name': 'movement_id', 'type': 'str', 'required': True}, {'name': 'item_id', 'type': 'str', 'required': True}, {'name': 'movement_type', 'type': 'str', 'required': True}, {'name': 'quantity', 'type': 'int', 'required': True}, {'name': 'reference', 'type': 'str?', 'required': True}, {'name': 'notes', 'type': 'str | None', 'required': True}, {'name': 'movement_date', 'type': 'datetime', 'required': True}, {'name': 'performed_by', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'InventoryRecords', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
