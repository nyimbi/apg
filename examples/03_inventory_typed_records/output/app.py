...
ENTITIES = [{'name': 'InventoryItem', 'type': 'entity', 'properties': ['sku', 'name', 'quantity', 'reorder_level', 'active'], 'fields': [{'name': 'sku', 'type': 'str', 'required': True}, {'name': 'name', 'type': 'str', 'required': True}, {'name': 'quantity', 'type': 'int', 'required': True}, {'name': 'reorder_level', 'type': 'int', 'required': True}, {'name': 'active', 'type': 'bool', 'required': True}], 'methods': []}]
