...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'InventoryRecords': {'description': 'Inventory management', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/inventory', '/stock-movements'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
