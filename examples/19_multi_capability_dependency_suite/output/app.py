"""
platform_suite - APG Python Application
=======================================
...
MODULE_NAME = 'platform_suite'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
LANDING_STYLE = 'default'
ENTITIES = [{'name': 'Authentication', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'AuditTrail', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'CustomerMaster', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'SalesPortal', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'SalesAdvisor', 'type': 'agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ComplianceAdvisor', 'type': 'agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'SalesComplianceCrew', 'type': 'agent_team', 'properties': ['agents', 'flow', 'capabilities'], 'fields': [{'name': 'agents', 'type': '[SalesAdvisor, ComplianceAdvisor]', 'required': True}, {'name': 'flow', 'type': 'SalesAdvisor -> ComplianceAdvisor', 'required': True}, {'name': 'capabilities', 'type': '[customer_records, audit_events]', 'required': True}], 'methods': []}, {'name': 'PlatformSuite', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['platform_suite.apg'], 'app': {'name': 'platform_suite', 'version': '1.0.0', 'description': None, 'entity_count': 8}, 'symbols': {'module.platform_suite': {'id': 'module.platform_suite', 'kind': 'module', 'name': 'platform_suite', 'file': 'platform_suite.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.Authentication': {'id': 'capability.Authentication', 'kind': 'capability', 'name': 'Authentication', 'file': 'platform_suite.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.AuditTrail': {'id': 'capability.AuditTrail', 'kind': 'capability', 'name': 'AuditTrail', 'file': 'platform_suite.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.CustomerMaster': {'id': 'capability.CustomerMaster', 'kind': 'capability', 'name': 'CustomerMaster', 'file': 'platform_suite.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.SalesPortal': {'id': 'capability.SalesPortal', 'kind': 'capability', 'name': 'SalesPortal', 'file': 'platform_suite.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'agent.SalesAdvisor': {'id': 'agent.SalesAdvisor', 'kind': 'agent', 'name': 'SalesAdvisor', 'file': 'platform_suite.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'llm.openai:gpt-4.1-mini': {'id': 'llm.openai:gpt-4.1-mini', 'kind': 'llm', 'name': 'openai:gpt-4.1-mini', 'file': 'platform_suite.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'agent.ComplianceAdvisor': {'id': 'agent.ComplianceAdvisor', 'kind': 'agent', 'name': 'ComplianceAdvisor', 'file': 'platform_suite.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'llm.ollama:llama3.3': {'id': 'llm.ollama:llama3.3', 'kind': 'llm', 'name': 'ollama:llama3.3', 'file': 'platform_suite.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'agent_team.SalesComplianceCrew': {'id': 'agent_team.SalesComplianceCrew', 'kind': 'agent_team', 'name': 'SalesComplianceCrew', 'file': 'platform_suite.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.PlatformSuite': {'id': 'app.PlatformSuite', 'kind': 'app', 'name': 'PlatformSuite', 'file': 'platform_suite.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {'Authentication.valid_session': {'name': 'valid_session', 'when': 'session_token not missing', 'action': 'allow', 'priority': 100}, 'Authentication.mfa_required': {'name': 'mfa_required', 'when': 'mfa_token missing', 'action': 'deny', 'priority': 90}, 'Authentication.locked_account': {'name': 'locked_account', 'when': 'account_locked == true', 'action': 'deny', 'priority': 80}, 'Authentication.rate_limited': {'name': 'rate_limited', 'when': 'login_attempts > 5', 'action': 'deny', 'priority': 70}, 'AuditTrail.actor_required': {'name': 'actor_required', 'when': 'actor_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'actor_id', 'negated': False}}, 'AuditTrail.event_type_valid': {'name': 'event_type_valid', 'when': 'event_type missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'event_type', 'negated': False}}, 'CustomerMaster.kyc_required': {'name': 'kyc_required', 'when': 'kyc_status == pending', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'kyc_status', 'op': '==', 'value': 'pending'}}, 'CustomerMaster.duplicate_email': {'name': 'duplicate_email', 'when': 'email_exists == true', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'email_exists', 'op': '==', 'value': True}}, 'CustomerMaster.credit_limit': {'name': 'credit_limit', 'when': 'credit_score < 300', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'credit_score', 'op': '<', 'value': 300}}, 'SalesPortal.auth_required': {'name': 'auth_required', 'when': 'session_token missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'session_token', 'negated': False}}, 'SalesPortal.kyc_gate': {'name': 'kyc_gate', 'when': 'kyc_status != verified', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'kyc_status', 'op': '!=', 'value': 'verified'}}, 'SalesPortal.credit_gate': {'name': 'credit_gate', 'when': 'available_credit < 0', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'available_credit', 'op': '<', 'value': 0}}, 'SalesPortal.large_order': {'name': 'large_order', 'when': 'order_total > 1000000', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'order_total', 'op': '>', 'value': 1000000}}, 'SalesPortal.approved_region': {'name': 'approved_region', 'when': 'customer_region == KE', 'action': 'allow', 'when_ast': {'type': 'compare', 'field': 'customer_region', 'op': '==', 'value': 'KE'}}, 'SalesPortal.unsupported_region': {'name': 'unsupported_region', 'when': 'customer_region missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'customer_region', 'negated': False}}}, 'roles': {}, 'security': {}, 'agents': {'SalesAdvisor': {'name': 'SalesAdvisor', 'role': 'sales advisor', 'model': 'openai:gpt-4.1-mini', 'runtime': None, 'system': 'Advise sales team on customer engagement, upsell opportunities, and deal risk.', 'capabilities': ['customer_records', 'sales_dashboard', 'order_management'], 'tools': ['customer.lookup', 'order.history', 'credit.check'], 'memory': {'kind': 'vector', 'name': 'sales_memory'}, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {'temperature': 0.2, 'max_turns': 8}, 'rules': [], 'ui': {}, 'theme': {}}, 'ComplianceAdvisor': {'name': 'ComplianceAdvisor', 'role': 'compliance advisor', 'model': 'ollama:llama3.3', 'runtime': None, 'system': 'Review transactions for AML and KYC compliance. Flag any concerns.', 'capabilities': ['audit_events', 'kyc_status'], 'tools': ['kyc.verify', 'aml.screen', 'compliance.report'], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {'temperature': 0.0, 'max_turns': 4}, 'rules': [], 'ui': {}, 'theme': {}}}, 'llms': {'SalesAdvisor': {'model': 'openai:gpt-4.1-mini', 'runtime': None}, 'ComplianceAdvisor': {'model': 'ollama:llama3.3', 'runtime': None}}, 'capabilities': {'Authentication': {'name': 'Authentication', 'provides': ['identity_verification', 'session_management', 'role_assignment', 'jwt_tokens'], 'requires': [], 'configuration': {'tenant_id': 'default', 'token_ttl_seconds': 3600, 'mfa_required': False}, 'rules': [], 'rule_engine': {'type': 'deterministic', 'default_decision': 'deny', 'rules': [{'name': 'valid_session', 'when': 'session_token not missing', 'action': 'allow', 'priority': 100}, {'name': 'mfa_required', 'when': 'mfa_token missing', 'action': 'deny', 'priority': 90}, {'name': 'locked_account', 'when': 'account_locked == true', 'action': 'deny', 'priority': 80}, {'name': 'rate_limited', 'when': 'login_attempts > 5', 'action': 'deny', 'priority': 70}]}, 'ui': {}, 'theme': {}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {}, 'screens': {}}, 'AuditTrail': {'name': 'AuditTrail', 'provides': ['audit_events', 'compliance_trail', 'change_history'], 'requires': ['identity_verification'], 'configuration': {'tenant_id': 'default', 'retention_days': 2555, 'immutable': True}, 'rules': [{'name': 'actor_required', 'when': 'actor_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'actor_id', 'negated': False}}, {'name': 'event_type_valid', 'when': 'event_type missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'event_type', 'negated': False}}], 'rule_engine': {}, 'ui': {}, 'theme': {}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {}, 'screens': {}}, 'CustomerMaster': {'name': 'CustomerMaster', 'provides': ['customer_records', 'credit_profiles', 'kyc_status'], 'requires': ['identity_verification', 'audit_events'], 'configuration': {'tenant_id': 'default', 'kyc_required': True, 'credit_check_provider': 'internal'}, 'rules': [{'name': 'kyc_required', 'when': 'kyc_status == pending', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'kyc_status', 'op': '==', 'value': 'pending'}}, {'name': 'duplicate_email', 'when': 'email_exists == true', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'email_exists', 'op': '==', 'value': True}}, {'name': 'credit_limit', 'when': 'credit_score < 300', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'credit_score', 'op': '<', 'value': 300}}], 'rule_engine': {'type': 'policy', 'default_decision': 'allow'}, 'ui': {'shell': 'python', 'routes': [{'name': 'Customers', 'path': '/customers', 'component': 'CustomerList', 'permission': 'customers:view'}]}, 'theme': {'name': 'customer_theme', 'tokens': {'accent': '#00695C'}}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {'entities': ['customer', 'credit_profile', 'kyc_document']}, 'i18n': {}, 'streaming': {}, 'screens': {}}, 'SalesPortal': {'name': 'SalesPortal', 'provides': ['sales_dashboard', 'order_management', 'customer_engagement'], 'requires': ['identity_verification', 'audit_events', 'customer_records', 'credit_profiles'], 'configuration': {'tenant_id': 'default', 'max_order_value': 5000000}, 'rules': [{'name': 'auth_required', 'when': 'session_token missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'session_token', 'negated': False}}, {'name': 'kyc_gate', 'when': 'kyc_status != verified', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'kyc_status', 'op': '!=', 'value': 'verified'}}, {'name': 'credit_gate', 'when': 'available_credit < 0', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'available_credit', 'op': '<', 'value': 0}}, {'name': 'large_order', 'when': 'order_total > 1000000', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'order_total', 'op': '>', 'value': 1000000}}, {'name': 'approved_region', 'when': 'customer_region == KE', 'action': 'allow', 'when_ast': {'type': 'compare', 'field': 'customer_region', 'op': '==', 'value': 'KE'}}, {'name': 'unsupported_region', 'when': 'customer_region missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'customer_region', 'negated': False}}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Dashboard', 'path': '/sales', 'component': 'SalesDashboard', 'permission': 'sales:view'}, {'name': 'Orders', 'path': '/sales/orders', 'component': 'OrderList', 'permission': 'sales:orders'}]}, 'theme': {'name': 'sales_theme', 'tokens': {'accent': '#1565C0'}}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {'processor': 'bytewax', 'state': 'sales_event_state'}, 'screens': {'SalesDashboard': {'route': '/sales', 'layout': 'dashboard', 'contains': ['RevenueChart', 'TopCustomers', 'RecentOrders'], 'binds': ['sales.summary', 'customers.top', 'orders.recent'], 'actions': ['create_order', 'refresh', 'export']}}}}, 'composition': {'applications': {'PlatformSuite': {'name': 'PlatformSuite', 'description': 'Multi-capability platform with full dependency chain', 'capabilities': ['Authentication', 'AuditTrail', 'CustomerMaster', 'SalesPortal'], 'agents': [], 'agent_teams': ['SalesComplianceCrew'], 'components': {'auth_service': {'capability': 'identity_verification', 'route': '/auth'}, 'customer_portal': {'capability': 'customer_records', 'route': '/customers'}, 'sales_portal': {'capability': 'sales_dashboard', 'route': '/sales'}}, 'screens': {}, 'routes': ['/', '/customers', '/sales'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {'target': 'python', 'deployment': 'container', 'streaming': {'processor': 'bytewax'}}, 'integrations': {}, 'deployments': {'default': 'local', 'container': 'docker', 'cloud': 'kubernetes'}}}, 'agent_teams': {}, 'capability_dependencies': {'Authentication': [], 'AuditTrail': ['identity_verification'], 'CustomerMaster': ['identity_verification', 'audit_events'], 'SalesPortal': ['identity_verification', 'audit_events', 'customer_records', 'credit_profiles']}}, 'contracts': {'Authentication': {'id': 'auth', 'provides': ['identity_verification', 'session_management', 'role_assignment', 'jwt_tokens'], 'configuration': {'tenant_id': 'default', 'token_ttl_seconds': 3600, 'mfa_required': False}, 'rule_engine': {'type': 'deterministic', 'default_decision': 'deny', 'rules': [{'name': 'valid_session', 'when': 'session_token not missing', 'action': 'allow', 'priority': 100}, {'name': 'mfa_required', 'when': 'mfa_token missing', 'action': 'deny', 'priority': 90}, {'name': 'locked_account', 'when': 'account_locked == true', 'action': 'deny', 'priority': 80}, {'name': 'rate_limited', 'when': 'login_attempts > 5', 'action': 'deny', 'priority': 70}]}}, 'AuditTrail': {'id': 'audl', 'provides': ['audit_events', 'compliance_trail', 'change_history'], 'requires': ['identity_verification'], 'configuration': {'tenant_id': 'default', 'retention_days': 2555, 'immutable': True}, 'rules': [{'name': 'actor_required', 'when': 'actor_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'actor_id', 'negated': False}}, {'name': 'event_type_valid', 'when': 'event_type missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'event_type', 'negated': False}}]}, 'CustomerMaster': {'id': 'customer_master', 'provides': ['customer_records', 'credit_profiles', 'kyc_status'], 'requires': ['identity_verification', 'audit_events'], 'configuration': {'tenant_id': 'default', 'kyc_required': True, 'credit_check_provider': 'internal'}, 'rules': [{'name': 'kyc_required', 'when': 'kyc_status == pending', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'kyc_status', 'op': '==', 'value': 'pending'}}, {'name': 'duplicate_email', 'when': 'email_exists == true', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'email_exists', 'op': '==', 'value': True}}, {'name': 'credit_limit', 'when': 'credit_score < 300', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'credit_score', 'op': '<', 'value': 300}}], 'rule_engine': {'type': 'policy', 'default_decision': 'allow'}, 'ui': {'shell': 'python', 'routes': [{'name': 'Customers', 'path': '/customers', 'component': 'CustomerList', 'permission': 'customers:view'}]}, 'theme': {'name': 'customer_theme', 'tokens': {'accent': '#00695C'}}}, 'SalesPortal': {'id': 'sales_portal', 'provides': ['sales_dashboard', 'order_management', 'customer_engagement'], 'requires': ['identity_verification', 'audit_events', 'customer_records', 'credit_profiles'], 'configuration': {'tenant_id': 'default', 'max_order_value': 5000000}, 'rules': [{'name': 'auth_required', 'when': 'session_token missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'session_token', 'negated': False}}, {'name': 'kyc_gate', 'when': 'kyc_status != verified', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'kyc_status', 'op': '!=', 'value': 'verified'}}, {'name': 'credit_gate', 'when': 'available_credit < 0', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'available_credit', 'op': '<', 'value': 0}}, {'name': 'large_order', 'when': 'order_total > 1000000', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'order_total', 'op': '>', 'value': 1000000}}, {'name': 'approved_region', 'when': 'customer_region == KE', 'action': 'allow', 'when_ast': {'type': 'compare', 'field': 'customer_region', 'op': '==', 'value': 'KE'}}, {'name': 'unsupported_region', 'when': 'customer_region missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'customer_region', 'negated': False}}], 'ui': {'shell': 'python', 'routes': [{'name': 'Dashboard', 'path': '/sales', 'component': 'SalesDashboard', 'permission': 'sales:view'}, {'name': 'Orders', 'path': '/sales/orders', 'component': 'OrderList', 'permission': 'sales:orders'}]}, 'theme': {'name': 'sales_theme', 'tokens': {'accent': '#1565C0'}}}}, 'deployment': {'target': 'python', 'source': 'platform_suite.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 9, 'edges': 8}, 'workflow': {'kind': 'workflow', 'nodes': 9, 'edges': 8}, 'handler': {'kind': 'handler', 'nodes': 9, 'edges': 8}, 'capability': {'kind': 'capability', 'nodes': 9, 'edges': 11}, 'security': {'kind': 'security', 'nodes': 9, 'edges': 8}, 'agent': {'kind': 'agent', 'nodes': 3, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 9, 'edges': 8}, 'package': {'kind': 'package', 'nodes': 9, 'edges': 8}}, 'diagnostics': []}
