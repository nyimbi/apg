"""
multi_capability_dependency_suite - APG Python Application
==========================================================
...
MODULE_NAME = 'multi_capability_dependency_suite'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'AuditEvents', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'CustomerMaster', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'OrderManagement', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'Billing', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}]
