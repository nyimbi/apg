...
CAPABILITY_DATA: Dict[str, Dict[str, Any]] = {'AuditEvents': {'contract': {'id': 'audit_events', 'provides': ['audit_events'], 'configuration': {'retention_days': 365}}, 'provides': ['audit_events'], 'requires': [], 'configuration': {'retention_days': 365}, 'rules': [], 'rule_engine': {}, 'ui': {}, 'theme': {}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {'processor': 'bytewax', 'state': 'audit_event_state'}, 'screens': {}}, 'CustomerMaster': {'contract': {'id': 'customer_master', 'provides': ['customer_master'], 'requires': ['audit_events'], 'configuration': {'deduplicate': True}}, 'provides': ['customer_master'], 'requires': ['audit_events'], 'configuration': {'deduplicate': True}, 'rules': [], 'rule_engine': {}, 'ui': {}, 'theme': {}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {'entities': ['customer', 'address', 'contact']}, 'i18n': {}, 'streaming': {}, 'screens': {}}, 'OrderManagement': {'contract': {'id': 'order_management', 'provides': ['sales_orders', 'order_fulfillment'], 'requires': ['customer_master', 'audit_events'], 'configuration': {'default_status': 'pending'}, 'rules': [{'name': 'customer_required', 'when': 'customer_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'customer_id', 'negated': False}}], 'ui': {'shell': 'python', 'routes': [{'name': 'Orders', 'path': '/orders', 'component': 'OrderScreen'}]}}, 'provides': ['sales_orders', 'order_fulfillment'], 'requires': ['customer_master', 'audit_events'], 'configuration': {'default_status': 'pending'}, 'rules': [{'name': 'customer_required', 'when': 'customer_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'customer_id', 'negated': False}}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Orders', 'path': '/orders', 'component': 'OrderScreen'}]}, 'theme': {}, 'runtime': {}, 'erp_modules': ['sales', 'inventory', 'finance'], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {}, 'screens': {}}, 'Billing': {'contract': {'id': 'billing', 'provides': ['invoice_generation', 'payment_allocation'], 'requires': ['sales_orders', 'customer_master', 'audit_events'], 'configuration': {'currency': 'KES'}, 'rules': [{'name': 'invoice_requires_order', 'when': 'order_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'order_id', 'negated': False}}]}, 'provides': ['invoice_generation', 'payment_allocation'], 'requires': ['sales_orders', 'customer_master', 'audit_events'], 'configuration': {'currency': 'KES'}, 'rules': [{'name': 'invoice_requires_order', 'when': 'order_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'order_id', 'negated': False}}], 'rule_engine': {}, 'ui': {}, 'theme': {}, 'runtime': {}, 'erp_modules': ['finance', 'sales'], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {}, 'screens': {}}}
