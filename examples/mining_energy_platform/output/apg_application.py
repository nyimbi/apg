...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'MiningEnergyPlatform': {'description': 'Integrated mining and energy operations platform for mine-to-market and energy dispatch', 'capabilities': ['MiningExploration', 'MiningProduction', 'MiningSafety', 'MiningEquipmentManagement', 'EnergyGeneration', 'EnergyDistribution', 'SmartMetering', 'RenewableEnergyManagement'], 'agents': ['MineOptimisationAgent', 'EnergyDispatchAgent', 'SafetyComplianceAgent', 'SmartMeterAnalyticsAgent'], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/mining', '/mining/exploration', '/mining/production', '/mining/safety', '/mining/equipment', '/mining/stockpile', '/mining/environment', '/energy', '/energy/generation', '/energy/dispatch', '/energy/grid', '/energy/metering', '/energy/renewables', '/energy/billing'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {'name': 'mining_energy_theme', 'tokens': {'color.primary': '#BF360C', 'color.accent': '#FF6F00', 'color.secondary': '#1B5E20', 'surface.canvas': '#FFF8F5', 'surface.panel': '#FFFFFF', 'text.primary': '#1C0900', 'text.secondary': '#5D4037', 'border.radius': '4px', 'density': 'compact'}}, 'runtime': {'target': 'python', 'deployment': 'container', 'streaming': {'processor': 'bytewax'}}, 'integrations': {}, 'deployments': {'default': 'local', 'container': 'docker', 'production': 'kubernetes', 'edge': 'docker'}}}
