"""
fulfillment_ops - APG Python Application
========================================
...
MODULE_NAME = 'fulfillment_ops'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'Customer', 'type': 'entity', 'properties': ['name', 'email'], 'fields': [{'name': 'name', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'SalesOrder', 'type': 'entity', 'properties': ['customer_id', 'order_number', 'total', 'status'], 'fields': [{'name': 'customer_id', 'type': 'int', 'required': True}, {'name': 'order_number', 'type': 'str', 'required': True}, {'name': 'total', 'type': 'float', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Shipment', 'type': 'entity', 'properties': ['sales_order_id', 'carrier', 'tracking_number', 'delivered'], 'fields': [{'name': 'sales_order_id', 'type': 'int', 'required': True}, {'name': 'carrier', 'type': 'str', 'required': True}, {'name': 'tracking_number', 'type': 'str', 'required': True}, {'name': 'delivered', 'type': 'bool', 'required': True}], 'methods': []}, {'name': 'FulfillmentEvent', 'type': 'entity', 'properties': ['shipment_id', 'event_type', 'event_time'], 'fields': [{'name': 'shipment_id', 'type': 'int', 'required': True}, {'name': 'event_type', 'type': 'str', 'required': True}, {'name': 'event_time', 'type': 'str', 'required': True}], 'methods': []}]
...
NEXT_EVENT_ID = 1
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['fulfillment_ops.apg'], 'app': {'name': 'fulfillment_ops', 'version': '1.0.0', 'description': None, 'entity_count': 4}, 'symbols': {'module.fulfillment_ops': {'id': 'module.fulfillment_ops', 'kind': 'module', 'name': 'fulfillment_ops', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Customer': {'id': 'table.Customer', 'kind': 'table', 'name': 'Customer', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.name': {'id': 'field.Customer.name', 'kind': 'field', 'name': 'Customer.name', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.email': {'id': 'field.Customer.email', 'kind': 'field', 'name': 'Customer.email', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.SalesOrder': {'id': 'table.SalesOrder', 'kind': 'table', 'name': 'SalesOrder', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SalesOrder.customer_id': {'id': 'field.SalesOrder.customer_id', 'kind': 'field', 'name': 'SalesOrder.customer_id', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SalesOrder.order_number': {'id': 'field.SalesOrder.order_number', 'kind': 'field', 'name': 'SalesOrder.order_number', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SalesOrder.total': {'id': 'field.SalesOrder.total', 'kind': 'field', 'name': 'SalesOrder.total', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SalesOrder.status': {'id': 'field.SalesOrder.status', 'kind': 'field', 'name': 'SalesOrder.status', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Shipment': {'id': 'table.Shipment', 'kind': 'table', 'name': 'Shipment', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Shipment.sales_order_id': {'id': 'field.Shipment.sales_order_id', 'kind': 'field', 'name': 'Shipment.sales_order_id', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Shipment.carrier': {'id': 'field.Shipment.carrier', 'kind': 'field', 'name': 'Shipment.carrier', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Shipment.tracking_number': {'id': 'field.Shipment.tracking_number', 'kind': 'field', 'name': 'Shipment.tracking_number', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Shipment.delivered': {'id': 'field.Shipment.delivered', 'kind': 'field', 'name': 'Shipment.delivered', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.FulfillmentEvent': {'id': 'table.FulfillmentEvent', 'kind': 'table', 'name': 'FulfillmentEvent', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FulfillmentEvent.shipment_id': {'id': 'field.FulfillmentEvent.shipment_id', 'kind': 'field', 'name': 'FulfillmentEvent.shipment_id', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FulfillmentEvent.event_type': {'id': 'field.FulfillmentEvent.event_type', 'kind': 'field', 'name': 'FulfillmentEvent.event_type', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FulfillmentEvent.event_time': {'id': 'field.FulfillmentEvent.event_time', 'kind': 'field', 'name': 'FulfillmentEvent.event_time', 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'Customer': {'name': 'Customer', 'fields': {'name': {'type': 'str', 'required': True, 'relationship': None}, 'email': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {}}, 'SalesOrder': {'name': 'SalesOrder', 'fields': {'customer_id': {'type': 'int', 'required': True, 'relationship': {'target_table': 'Customer', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'customer'}}, 'order_number': {'type': 'str', 'required': True, 'relationship': None}, 'total': {'type': 'float', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {}}, 'Shipment': {'name': 'Shipment', 'fields': {'sales_order_id': {'type': 'int', 'required': True, 'relationship': {'target_table': 'SalesOrder', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'sales_order'}}, 'carrier': {'type': 'str', 'required': True, 'relationship': None}, 'tracking_number': {'type': 'str', 'required': True, 'relationship': None}, 'delivered': {'type': 'bool', 'required': True, 'relationship': None}}, 'lookup_paths': {}}, 'FulfillmentEvent': {'name': 'FulfillmentEvent', 'fields': {'shipment_id': {'type': 'int', 'required': True, 'relationship': {'target_table': 'Shipment', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'shipment'}}, 'event_type': {'type': 'str', 'required': True, 'relationship': None}, 'event_time': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'fulfillment_ops.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 17, 'edges': 16}, 'lookup': {'kind': 'lookup', 'nodes': 5, 'edges': 4}, 'workflow': {'kind': 'workflow', 'nodes': 5, 'edges': 4}, 'handler': {'kind': 'handler', 'nodes': 5, 'edges': 4}, 'capability': {'kind': 'capability', 'nodes': 0, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 5, 'edges': 4}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 5, 'edges': 4}, 'package': {'kind': 'package', 'nodes': 5, 'edges': 4}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'name' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'email' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'customer_id' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'order_number' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'total' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'status' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'sales_order_id' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'carrier' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'tracking_number' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'delivered' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'shipment_id' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'event_type' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'event_time' appears to be unused", 'file': 'fulfillment_ops.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
