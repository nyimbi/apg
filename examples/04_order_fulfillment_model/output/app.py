"""
order_fulfillment - APG Python Application
==========================================
...
MODULE_NAME = 'order_fulfillment'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
LANDING_STYLE = 'default'
ENTITIES = [{'name': 'Order', 'type': 'entity', 'properties': ['order_number', 'customer_id', 'status', 'total', 'priority'], 'fields': [{'name': 'order_number', 'type': 'str', 'required': True}, {'name': 'customer_id', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': False, 'default': '"pending"'}, {'name': 'total', 'type': 'decimal', 'required': True}, {'name': 'priority', 'type': 'str', 'required': False, 'default': '"standard"'}], 'methods': []}, {'name': 'Shipment', 'type': 'entity', 'properties': ['shipment_id', 'order_id', 'carrier', 'tracking_number', 'status', 'dispatched_at', 'delivered_at'], 'fields': [{'name': 'shipment_id', 'type': 'str', 'required': True}, {'name': 'order_id', 'type': 'str', 'required': True}, {'name': 'carrier', 'type': 'str', 'required': True}, {'name': 'tracking_number', 'type': 'str?', 'required': True}, {'name': 'status', 'type': 'str', 'required': False, 'default': '"pending"'}, {'name': 'dispatched_at', 'type': 'datetime?', 'required': True}, {'name': 'delivered_at', 'type': 'datetime?', 'required': True}], 'methods': []}, {'name': 'Return', 'type': 'entity', 'properties': ['return_id', 'order_id', 'reason', 'status', 'refund_amount'], 'fields': [{'name': 'return_id', 'type': 'str', 'required': True}, {'name': 'order_id', 'type': 'str', 'required': True}, {'name': 'reason', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': False, 'default': '"requested"'}, {'name': 'refund_amount', 'type': 'decimal', 'required': False, 'default': '0.0'}], 'methods': []}, {'name': 'PaymentRetry', 'type': 'entity', 'properties': ['retry_id', 'order_id', 'attempt', 'status'], 'fields': [{'name': 'retry_id', 'type': 'str', 'required': True}, {'name': 'order_id', 'type': 'str', 'required': True}, {'name': 'attempt', 'type': 'int', 'required': False, 'default': '1'}, {'name': 'status', 'type': 'str', 'required': False, 'default': '"pending"'}], 'methods': []}, {'name': 'OrderFulfilment', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ReturnProcess', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'FulfilmentApp', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['order_fulfillment.apg'], 'app': {'name': 'order_fulfillment', 'version': '1.0.0', 'description': None, 'entity_count': 7}, 'symbols': {'module.order_fulfillment': {'id': 'module.order_fulfillment', 'kind': 'module', 'name': 'order_fulfillment', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Order': {'id': 'table.Order', 'kind': 'table', 'name': 'Order', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.order_number': {'id': 'field.Order.order_number', 'kind': 'field', 'name': 'Order.order_number', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.customer_id': {'id': 'field.Order.customer_id', 'kind': 'field', 'name': 'Order.customer_id', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.status': {'id': 'field.Order.status', 'kind': 'field', 'name': 'Order.status', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.total': {'id': 'field.Order.total', 'kind': 'field', 'name': 'Order.total', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.priority': {'id': 'field.Order.priority', 'kind': 'field', 'name': 'Order.priority', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Shipment': {'id': 'table.Shipment', 'kind': 'table', 'name': 'Shipment', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Shipment.shipment_id': {'id': 'field.Shipment.shipment_id', 'kind': 'field', 'name': 'Shipment.shipment_id', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Shipment.order_id': {'id': 'field.Shipment.order_id', 'kind': 'field', 'name': 'Shipment.order_id', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Shipment.carrier': {'id': 'field.Shipment.carrier', 'kind': 'field', 'name': 'Shipment.carrier', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Shipment.tracking_number': {'id': 'field.Shipment.tracking_number', 'kind': 'field', 'name': 'Shipment.tracking_number', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Shipment.status': {'id': 'field.Shipment.status', 'kind': 'field', 'name': 'Shipment.status', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Shipment.dispatched_at': {'id': 'field.Shipment.dispatched_at', 'kind': 'field', 'name': 'Shipment.dispatched_at', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Shipment.delivered_at': {'id': 'field.Shipment.delivered_at', 'kind': 'field', 'name': 'Shipment.delivered_at', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Return': {'id': 'table.Return', 'kind': 'table', 'name': 'Return', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Return.return_id': {'id': 'field.Return.return_id', 'kind': 'field', 'name': 'Return.return_id', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Return.order_id': {'id': 'field.Return.order_id', 'kind': 'field', 'name': 'Return.order_id', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Return.reason': {'id': 'field.Return.reason', 'kind': 'field', 'name': 'Return.reason', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Return.status': {'id': 'field.Return.status', 'kind': 'field', 'name': 'Return.status', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Return.refund_amount': {'id': 'field.Return.refund_amount', 'kind': 'field', 'name': 'Return.refund_amount', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.PaymentRetry': {'id': 'table.PaymentRetry', 'kind': 'table', 'name': 'PaymentRetry', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.PaymentRetry.retry_id': {'id': 'field.PaymentRetry.retry_id', 'kind': 'field', 'name': 'PaymentRetry.retry_id', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.PaymentRetry.order_id': {'id': 'field.PaymentRetry.order_id', 'kind': 'field', 'name': 'PaymentRetry.order_id', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.PaymentRetry.attempt': {'id': 'field.PaymentRetry.attempt', 'kind': 'field', 'name': 'PaymentRetry.attempt', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.PaymentRetry.status': {'id': 'field.PaymentRetry.status', 'kind': 'field', 'name': 'PaymentRetry.status', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'workflow.OrderFulfilment': {'id': 'workflow.OrderFulfilment', 'kind': 'workflow', 'name': 'OrderFulfilment', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'workflow.ReturnProcess': {'id': 'workflow.ReturnProcess', 'kind': 'workflow', 'name': 'ReturnProcess', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.FulfilmentApp': {'id': 'app.FulfilmentApp', 'kind': 'app', 'name': 'FulfilmentApp', 'file': 'order_fulfillment.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'Order': {'name': 'Order', 'fields': {'order_number': {'type': 'str', 'required': True, 'relationship': None}, 'customer_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Customer', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'customer'}}, 'status': {'type': 'str', 'required': False, 'relationship': None}, 'total': {'type': 'decimal', 'required': True, 'relationship': {'target_table': 'decimal', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'priority': {'type': 'str', 'required': False, 'relationship': None}}, 'lookup_paths': {'total.id': {'chain': ['Order.total', 'decimal.id'], 'valid': True}}}, 'Shipment': {'name': 'Shipment', 'fields': {'shipment_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Shipment', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'shipment'}}, 'order_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Order', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'order'}}, 'carrier': {'type': 'str', 'required': True, 'relationship': None}, 'tracking_number': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'status': {'type': 'str', 'required': False, 'relationship': None}, 'dispatched_at': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'delivered_at': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'tracking_number.id': {'chain': ['Shipment.tracking_number', 'str?.id'], 'valid': True}, 'dispatched_at.id': {'chain': ['Shipment.dispatched_at', 'datetime?.id'], 'valid': True}, 'delivered_at.id': {'chain': ['Shipment.delivered_at', 'datetime?.id'], 'valid': True}}}, 'Return': {'name': 'Return', 'fields': {'return_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Return', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'return'}}, 'order_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Order', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'order'}}, 'reason': {'type': 'str', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': False, 'relationship': None}, 'refund_amount': {'type': 'decimal', 'required': False, 'relationship': {'target_table': 'decimal', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'refund_amount.id': {'chain': ['Return.refund_amount', 'decimal.id'], 'valid': True}}}, 'PaymentRetry': {'name': 'PaymentRetry', 'fields': {'retry_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Retry', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'retry'}}, 'order_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Order', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'order'}}, 'attempt': {'type': 'int', 'required': False, 'relationship': None}, 'status': {'type': 'str', 'required': False, 'relationship': None}}, 'lookup_paths': {}}}, 'views': {}, 'flows': {'OrderFulfilment': {'name': 'OrderFulfilment', 'type': 'workflow', 'properties': {}, 'methods': [], 'states': ['received', 'payment_authorised', 'picking', 'packing', 'dispatched', 'delivered'], 'transitions': [{'source': 'received', 'target': 'payment_authorised', 'guard': 'payment_status == approved and fraud_score < 0.7'}, {'source': 'payment_authorised', 'target': 'picking', 'guard': None}, {'source': 'picking', 'target': 'packing', 'guard': None}, {'source': 'packing', 'target': 'dispatched', 'guard': 'all_items_packed and carrier_confirmed'}, {'source': 'dispatched', 'target': 'delivered', 'guard': None}], 'steps': ['received', 'payment_authorised', 'picking', 'packing', 'dispatched', 'delivered'], 'human_tasks': ['picking', 'packing'], 'guards': {'payment_authorised': 'payment_status == approved and fraud_score < 0.7', 'dispatched': 'all_items_packed and carrier_confirmed'}, 'assignments': {'picking': 'warehouse_operator', 'packing': 'packing_station'}, 'timers': {'picking': 'PT4H', 'packing': 'PT2H', 'dispatched': 'PT24H'}, 'waits': {'payment_authorised': 'payment_confirmed', 'delivered': 'delivery_confirmation_received'}, 'retry_policy': {'payment_authorised': '3', 'dispatched': '2'}, 'compensation': {'payment_authorised': 'void_payment_authorisation', 'picking': 'return_items_to_stock', 'dispatched': 'initiate_carrier_recall'}, 'steps_raw': 'received -> payment_authorised -> picking -> packing -> dispatched -> delivered'}, 'ReturnProcess': {'name': 'ReturnProcess', 'type': 'workflow', 'properties': {}, 'methods': [], 'states': ['requested', 'approved', 'received', 'inspected', 'refunded'], 'transitions': [{'source': 'requested', 'target': 'approved', 'guard': 'return_reason in [defective, wrong_item, not_as_described]'}, {'source': 'approved', 'target': 'received', 'guard': None}, {'source': 'received', 'target': 'inspected', 'guard': None}, {'source': 'inspected', 'target': 'refunded', 'guard': 'inspection_passed == true'}], 'steps': ['requested', 'approved', 'received', 'inspected', 'refunded'], 'human_tasks': ['approved', 'inspected'], 'guards': {'approved': 'return_reason in [defective, wrong_item, not_as_described]', 'refunded': 'inspection_passed == true'}, 'assignments': {'approved': 'returns_manager', 'inspected': 'quality_inspector'}, 'timers': {'approved': 'PT48H', 'inspected': 'PT24H'}, 'waits': {}, 'retry_policy': {}, 'compensation': {'refunded': 'reverse_refund'}, 'steps_raw': 'requested -> approved -> received -> inspected -> refunded'}}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {'FulfilmentApp': {'name': 'FulfilmentApp', 'description': 'Order fulfilment and returns management', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/orders', '/shipments', '/returns'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'order_fulfillment.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 25, 'edges': 26}, 'lookup': {'kind': 'lookup', 'nodes': 8, 'edges': 7}, 'workflow': {'kind': 'workflow', 'nodes': 8, 'edges': 7}, 'handler': {'kind': 'handler', 'nodes': 8, 'edges': 7}, 'capability': {'kind': 'capability', 'nodes': 1, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 8, 'edges': 7}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 8, 'edges': 7}, 'package': {'kind': 'package', 'nodes': 8, 'edges': 7}}, 'diagnostics': []}
