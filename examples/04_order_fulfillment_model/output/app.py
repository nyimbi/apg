...
ENTITIES = [{'name': 'Order', 'type': 'entity', 'properties': ['order_number', 'customer_id', 'status', 'total', 'priority'], 'fields': [{'name': 'order_number', 'type': 'str', 'required': True}, {'name': 'customer_id', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"pending"'}, {'name': 'total', 'type': 'decimal', 'required': True}, {'name': 'priority', 'type': 'str', 'required': True, 'default': '"standard"'}], 'methods': []}, {'name': 'Shipment', 'type': 'entity', 'properties': ['shipment_id', 'order_id', 'carrier', 'tracking_number', 'status', 'dispatched_at', 'delivered_at'], 'fields': [{'name': 'shipment_id', 'type': 'str', 'required': True}, {'name': 'order_id', 'type': 'str', 'required': True}, {'name': 'carrier', 'type': 'str', 'required': True}, {'name': 'tracking_number', 'type': 'str?', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"pending"'}, {'name': 'dispatched_at', 'type': 'datetime?', 'required': True}, {'name': 'delivered_at', 'type': 'datetime?', 'required': True}], 'methods': []}, {'name': 'Return', 'type': 'entity', 'properties': ['return_id', 'order_id', 'reason', 'status', 'refund_amount'], 'fields': [{'name': 'return_id', 'type': 'str', 'required': True}, {'name': 'order_id', 'type': 'str', 'required': True}, {'name': 'reason', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"requested"'}, {'name': 'refund_amount', 'type': 'decimal', 'required': True, 'default': '0.0'}], 'methods': []}, {'name': 'PaymentRetry', 'type': 'entity', 'properties': ['retry_id', 'order_id', 'attempt', 'status'], 'fields': [{'name': 'retry_id', 'type': 'str', 'required': True}, {'name': 'order_id', 'type': 'str', 'required': True}, {'name': 'attempt', 'type': 'int', 'required': True, 'default': '1'}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"pending"'}], 'methods': []}, {'name': 'OrderFulfilment', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ReturnProcess', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'FulfilmentApp', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
