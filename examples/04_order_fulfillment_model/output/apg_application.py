...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'FulfilmentApp': {'description': 'Order fulfilment and returns management', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/orders', '/shipments', '/returns'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
