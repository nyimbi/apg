"""
manufacturing_qc - APG Python Application
=========================================
...
MODULE_NAME = 'manufacturing_qc'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
LANDING_STYLE = 'default'
ENTITIES = [{'name': 'WorkOrder', 'type': 'entity', 'properties': ['work_order_id', 'product_code', 'quantity_planned', 'quantity_produced', 'quantity_rejected', 'status', 'started_at', 'completed_at', 'production_line'], 'fields': [{'name': 'work_order_id', 'type': 'str', 'required': True}, {'name': 'product_code', 'type': 'str', 'required': True}, {'name': 'quantity_planned', 'type': 'int', 'required': True}, {'name': 'quantity_produced', 'type': 'int', 'required': False, 'default': '0'}, {'name': 'quantity_rejected', 'type': 'int', 'required': False, 'default': '0'}, {'name': 'status', 'type': 'str', 'required': False, 'default': '"planned"'}, {'name': 'started_at', 'type': 'datetime?', 'required': True}, {'name': 'completed_at', 'type': 'datetime?', 'required': True}, {'name': 'production_line', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'QualityInspection', 'type': 'entity', 'properties': ['inspection_id', 'work_order_id', 'inspector_id', 'inspection_type', 'result', 'defect_count', 'defect_rate', 'inspected_at', 'notes'], 'fields': [{'name': 'inspection_id', 'type': 'str', 'required': True}, {'name': 'work_order_id', 'type': 'str', 'required': True}, {'name': 'inspector_id', 'type': 'str', 'required': True}, {'name': 'inspection_type', 'type': 'str', 'required': True}, {'name': 'result', 'type': 'str?', 'required': True}, {'name': 'defect_count', 'type': 'int', 'required': False, 'default': '0'}, {'name': 'defect_rate', 'type': 'float', 'required': False, 'default': '0.0'}, {'name': 'inspected_at', 'type': 'datetime', 'required': True}, {'name': 'notes', 'type': 'str?', 'required': True}], 'methods': []}, {'name': 'ManufacturingQC', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'QualityInspectionFlow', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ManufacturingQCApp', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['manufacturing_qc.apg'], 'app': {'name': 'manufacturing_qc', 'version': '1.0.0', 'description': None, 'entity_count': 5}, 'symbols': {'module.manufacturing_qc': {'id': 'module.manufacturing_qc', 'kind': 'module', 'name': 'manufacturing_qc', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.WorkOrder': {'id': 'table.WorkOrder', 'kind': 'table', 'name': 'WorkOrder', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WorkOrder.work_order_id': {'id': 'field.WorkOrder.work_order_id', 'kind': 'field', 'name': 'WorkOrder.work_order_id', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WorkOrder.product_code': {'id': 'field.WorkOrder.product_code', 'kind': 'field', 'name': 'WorkOrder.product_code', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WorkOrder.quantity_planned': {'id': 'field.WorkOrder.quantity_planned', 'kind': 'field', 'name': 'WorkOrder.quantity_planned', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WorkOrder.quantity_produced': {'id': 'field.WorkOrder.quantity_produced', 'kind': 'field', 'name': 'WorkOrder.quantity_produced', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WorkOrder.quantity_rejected': {'id': 'field.WorkOrder.quantity_rejected', 'kind': 'field', 'name': 'WorkOrder.quantity_rejected', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WorkOrder.status': {'id': 'field.WorkOrder.status', 'kind': 'field', 'name': 'WorkOrder.status', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WorkOrder.started_at': {'id': 'field.WorkOrder.started_at', 'kind': 'field', 'name': 'WorkOrder.started_at', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WorkOrder.completed_at': {'id': 'field.WorkOrder.completed_at', 'kind': 'field', 'name': 'WorkOrder.completed_at', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WorkOrder.production_line': {'id': 'field.WorkOrder.production_line', 'kind': 'field', 'name': 'WorkOrder.production_line', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.QualityInspection': {'id': 'table.QualityInspection', 'kind': 'table', 'name': 'QualityInspection', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspection.inspection_id': {'id': 'field.QualityInspection.inspection_id', 'kind': 'field', 'name': 'QualityInspection.inspection_id', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspection.work_order_id': {'id': 'field.QualityInspection.work_order_id', 'kind': 'field', 'name': 'QualityInspection.work_order_id', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspection.inspector_id': {'id': 'field.QualityInspection.inspector_id', 'kind': 'field', 'name': 'QualityInspection.inspector_id', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspection.inspection_type': {'id': 'field.QualityInspection.inspection_type', 'kind': 'field', 'name': 'QualityInspection.inspection_type', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspection.result': {'id': 'field.QualityInspection.result', 'kind': 'field', 'name': 'QualityInspection.result', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspection.defect_count': {'id': 'field.QualityInspection.defect_count', 'kind': 'field', 'name': 'QualityInspection.defect_count', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspection.defect_rate': {'id': 'field.QualityInspection.defect_rate', 'kind': 'field', 'name': 'QualityInspection.defect_rate', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspection.inspected_at': {'id': 'field.QualityInspection.inspected_at', 'kind': 'field', 'name': 'QualityInspection.inspected_at', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspection.notes': {'id': 'field.QualityInspection.notes', 'kind': 'field', 'name': 'QualityInspection.notes', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.ManufacturingQC': {'id': 'capability.ManufacturingQC', 'kind': 'capability', 'name': 'ManufacturingQC', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'workflow.QualityInspectionFlow': {'id': 'workflow.QualityInspectionFlow', 'kind': 'workflow', 'name': 'QualityInspectionFlow', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.ManufacturingQCApp': {'id': 'app.ManufacturingQCApp', 'kind': 'app', 'name': 'ManufacturingQCApp', 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'WorkOrder': {'name': 'WorkOrder', 'fields': {'work_order_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'WorkOrder', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'work_order'}}, 'product_code': {'type': 'str', 'required': True, 'relationship': None}, 'quantity_planned': {'type': 'int', 'required': True, 'relationship': None}, 'quantity_produced': {'type': 'int', 'required': False, 'relationship': None}, 'quantity_rejected': {'type': 'int', 'required': False, 'relationship': None}, 'status': {'type': 'str', 'required': False, 'relationship': None}, 'started_at': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'completed_at': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'production_line': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'started_at.id': {'chain': ['WorkOrder.started_at', 'datetime?.id'], 'valid': True}, 'completed_at.id': {'chain': ['WorkOrder.completed_at', 'datetime?.id'], 'valid': True}}}, 'QualityInspection': {'name': 'QualityInspection', 'fields': {'inspection_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Inspection', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'inspection'}}, 'work_order_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'WorkOrder', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'work_order'}}, 'inspector_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Inspector', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'inspector'}}, 'inspection_type': {'type': 'str', 'required': True, 'relationship': None}, 'result': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'defect_count': {'type': 'int', 'required': False, 'relationship': None}, 'defect_rate': {'type': 'float', 'required': False, 'relationship': None}, 'inspected_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'notes': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'result.id': {'chain': ['QualityInspection.result', 'str?.id'], 'valid': True}, 'inspected_at.id': {'chain': ['QualityInspection.inspected_at', 'datetime.id'], 'valid': True}, 'notes.id': {'chain': ['QualityInspection.notes', 'str?.id'], 'valid': True}}}}, 'views': {}, 'flows': {'QualityInspectionFlow': {'name': 'QualityInspectionFlow', 'type': 'workflow', 'properties': {}, 'methods': [], 'states': ['initiated', 'in_process_check', 'final_inspection', 'disposition', 'closed'], 'transitions': [{'source': 'initiated', 'target': 'in_process_check', 'guard': None}, {'source': 'in_process_check', 'target': 'final_inspection', 'guard': 'in_process_check_passed == true'}, {'source': 'final_inspection', 'target': 'disposition', 'guard': 'final_inspection_complete == true'}, {'source': 'disposition', 'target': 'closed', 'guard': 'disposition_recorded == true'}], 'steps': ['initiated', 'in_process_check', 'final_inspection', 'disposition', 'closed'], 'human_tasks': ['in_process_check', 'final_inspection', 'disposition'], 'guards': {'final_inspection': 'in_process_check_passed == true', 'disposition': 'final_inspection_complete == true', 'closed': 'disposition_recorded == true'}, 'assignments': {'in_process_check': 'line_inspector', 'final_inspection': 'quality_manager', 'disposition': 'production_manager'}, 'timers': {'in_process_check': 'PT2H', 'final_inspection': 'PT4H'}, 'waits': {}, 'retry_policy': {}, 'compensation': {}, 'steps_raw': 'initiated -> in_process_check -> final_inspection -> disposition -> closed'}}, 'operations': {}, 'rules': {'ManufacturingQC.defect_rate_fail': {'name': 'defect_rate_fail', 'when': 'defect_rate >= auto_fail_threshold', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'defect_rate', 'op': '>=', 'value': 'auto_fail_threshold'}}, 'ManufacturingQC.defect_review': {'name': 'defect_review', 'when': 'defect_rate > max_defect_rate', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'defect_rate', 'op': '>', 'value': 'max_defect_rate'}}, 'ManufacturingQC.inspector_required': {'name': 'inspector_required', 'when': 'inspector_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'inspector_id', 'negated': False}}, 'ManufacturingQC.valid_result': {'name': 'valid_result', 'when': 'result in [pass, fail, conditional]', 'action': 'allow', 'when_ast': {'type': 'in', 'field': 'result', 'values': ['pass', 'fail', 'conditional'], 'negated': False}}}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {'ManufacturingQC': {'name': 'ManufacturingQC', 'provides': ['quality_inspections', 'defect_tracking', 'production_yield'], 'requires': ['audit_events', 'work_orders'], 'configuration': {'tenant_id': 'env("APG_TENANT_ID")', 'db_url': 'env("MANUFACTURING_DB_URL")', 'erp_api_key': '$ERP_API_KEY', 'erp_endpoint': 'env("ERP_API_ENDPOINT")', 'max_defect_rate': 0.02, 'inspection_interval': 50, 'auto_fail_threshold': 0.05, 'alert_email': 'env("QC_ALERT_EMAIL")'}, 'rules': [{'name': 'defect_rate_fail', 'when': 'defect_rate >= auto_fail_threshold', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'defect_rate', 'op': '>=', 'value': 'auto_fail_threshold'}}, {'name': 'defect_review', 'when': 'defect_rate > max_defect_rate', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'defect_rate', 'op': '>', 'value': 'max_defect_rate'}}, {'name': 'inspector_required', 'when': 'inspector_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'inspector_id', 'negated': False}}, {'name': 'valid_result', 'when': 'result in [pass, fail, conditional]', 'action': 'allow', 'when_ast': {'type': 'in', 'field': 'result', 'values': ['pass', 'fail', 'conditional'], 'negated': False}}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Inspections', 'path': '/qc', 'component': 'InspectionQueue', 'permission': 'qc:view'}, {'name': 'Defects', 'path': '/qc/defects', 'component': 'DefectTracker', 'permission': 'qc:defects'}, {'name': 'Yield', 'path': '/qc/yield', 'component': 'YieldReport', 'permission': 'qc:reports'}]}, 'theme': {'name': 'manufacturing_theme', 'tokens': {'accent': '#F57F17'}}, 'runtime': {}, 'erp_modules': ['manufacturing', 'quality', 'production_planning'], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {'entities': ['product_spec', 'quality_standard', 'defect_category', 'production_line']}, 'i18n': {}, 'streaming': {}, 'screens': {}}}, 'composition': {'applications': {'ManufacturingQCApp': {'name': 'ManufacturingQCApp', 'description': 'Manufacturing quality control', 'capabilities': ['ManufacturingQC'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/qc', '/production'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {'ManufacturingQC': ['audit_events', 'work_orders']}}, 'contracts': {'ManufacturingQC': {'id': 'manufacturing_qc', 'provides': ['quality_inspections', 'defect_tracking', 'production_yield'], 'requires': ['audit_events', 'work_orders'], 'configuration': {'tenant_id': 'env("APG_TENANT_ID")', 'db_url': 'env("MANUFACTURING_DB_URL")', 'erp_api_key': '$ERP_API_KEY', 'erp_endpoint': 'env("ERP_API_ENDPOINT")', 'max_defect_rate': 0.02, 'inspection_interval': 50, 'auto_fail_threshold': 0.05, 'alert_email': 'env("QC_ALERT_EMAIL")'}, 'configuration_schema': {'required': ['tenant_id', 'db_url', 'erp_api_key']}, 'rules': [{'name': 'defect_rate_fail', 'when': 'defect_rate >= auto_fail_threshold', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'defect_rate', 'op': '>=', 'value': 'auto_fail_threshold'}}, {'name': 'defect_review', 'when': 'defect_rate > max_defect_rate', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'defect_rate', 'op': '>', 'value': 'max_defect_rate'}}, {'name': 'inspector_required', 'when': 'inspector_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'inspector_id', 'negated': False}}, {'name': 'valid_result', 'when': 'result in [pass, fail, conditional]', 'action': 'allow', 'when_ast': {'type': 'in', 'field': 'result', 'values': ['pass', 'fail', 'conditional'], 'negated': False}}], 'ui': {'shell': 'python', 'routes': [{'name': 'Inspections', 'path': '/qc', 'component': 'InspectionQueue', 'permission': 'qc:view'}, {'name': 'Defects', 'path': '/qc/defects', 'component': 'DefectTracker', 'permission': 'qc:defects'}, {'name': 'Yield', 'path': '/qc/yield', 'component': 'YieldReport', 'permission': 'qc:reports'}]}, 'theme': {'name': 'manufacturing_theme', 'tokens': {'accent': '#F57F17'}}}}, 'deployment': {'target': 'python', 'source': 'manufacturing_qc.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 20, 'edges': 20}, 'lookup': {'kind': 'lookup', 'nodes': 6, 'edges': 5}, 'workflow': {'kind': 'workflow', 'nodes': 6, 'edges': 5}, 'handler': {'kind': 'handler', 'nodes': 6, 'edges': 5}, 'capability': {'kind': 'capability', 'nodes': 4, 'edges': 3}, 'security': {'kind': 'security', 'nodes': 6, 'edges': 5}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 6, 'edges': 5}, 'package': {'kind': 'package', 'nodes': 6, 'edges': 5}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Capability 'ManufacturingQC' requires 'audit_events' which is not declared in this module", 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Capability 'ManufacturingQC' requires 'work_orders' which is not declared in this module", 'file': 'manufacturing_qc.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
