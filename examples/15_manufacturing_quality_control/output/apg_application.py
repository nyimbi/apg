...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'ManufacturingQCApp': {'description': 'Manufacturing quality control', 'capabilities': ['ManufacturingQC'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/qc', '/production'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
