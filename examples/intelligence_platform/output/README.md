...
- `ThreatAnalyst` - runtime `local`, invoke with `POST /agents/ThreatAnalyst/invoke`
...
- `IntelPlatformCore` - provides intelligence_collection, threat_analysis, indicator_management, alert_lifecycle, intelligence_fusion, analytical_products
...
- `GET /intel`
- `GET /intel/alerts`
- `GET /intel/authorities`
- `GET /intel/correlation`
- `GET /intel/fusion`
