...
class ThreatAnalyst(AgentBase):
    name = 'ThreatAnalyst'
    role = 'threat intelligence analyst'
    model = 'openai:gpt-4.1-mini'
    runtime = 'codex'
    system = 'You are an intelligence analyst. Assess threats, identify patterns, and produce structured analytica'
