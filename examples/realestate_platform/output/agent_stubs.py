...
class PropertyAdvisor(AgentBase):
    name = 'PropertyAdvisor'
    role = 'property management advisor'
    model = 'openai:gpt-4.1-mini'
    runtime = 'codex'
    system = 'You assist property managers with lease analysis, IFRS 16 calculations, and market insights for Keny'
