...
- `PropertyAdvisor` - runtime `local`, invoke with `POST /agents/PropertyAdvisor/invoke`
...
- `RealEstatePlatformCore` - provides property_portfolio_management, lease_lifecycle_management, tenant_relationship_management, maintenance_management, service_charge_management, ifrs16_accounting, property_analytics
