...
ENTITIES = [{'name': 'TriageAgent', 'type': 'agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'SupportAgent', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['support_agent.apg'], 'app': {'name': 'support_agent', 'version': '1.0.0', 'description': None, 'entity_count': 2}, 'symbols': {'module.support_agent': {'id': 'module.support_agent', 'kind': 'module', 'name': 'support_agent', 'file': 'support_agent.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'agent.TriageAgent': {'id': 'agent.TriageAgent', 'kind': 'agent', 'name': 'TriageAgent', 'file': 'support_agent.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'llm.openai:gpt-4.1-mini': {'id': 'llm.openai:gpt-4.1-mini', 'kind': 'llm', 'name': 'openai:gpt-4.1-mini', 'file': 'support_agent.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.SupportAgent': {'id': 'app.SupportAgent', 'kind': 'app', 'name': 'SupportAgent', 'file': 'support_agent.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {'TriageAgent': {'name': 'TriageAgent', 'role': 'support triage specialist', 'model': 'openai:gpt-4.1-mini', 'runtime': None, 'system': 'Classify incoming support tickets by severity and category. Produce a structured triage plan with suggested resolution steps and escalation path. Never reveal internal system details.', 'capabilities': ['ticket_management', 'knowledge_base', 'customer_history'], 'tools': ['tickets.read', 'tickets.update', 'knowledge.search', 'customer.lookup', 'escalation.trigger'], 'memory': {'kind': 'vector', 'name': 'support_memory'}, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {'temperature': 0.1, 'max_turns': 8, 'top_p': 0.9, 'presence_penalty': 0.0}, 'rules': [{'name': 'ticket_required', 'when': 'ticket_id missing', 'action': 'reject'}, {'name': 'valid_channel', 'when': 'channel not in [email, chat, phone, portal]', 'action': 'deny'}, {'name': 'customer_identified', 'when': 'customer_id not missing', 'action': 'allow'}, {'name': 'critical_escalation', 'when': 'severity == critical and sla_breach_imminent == true', 'action': 'require_review'}, {'name': 'rate_limit', 'when': 'requests_per_minute > 100', 'action': 'deny'}], 'ui': {}, 'theme': {}}}, 'llms': {'TriageAgent': {'model': 'openai:gpt-4.1-mini', 'runtime': None}}, 'capabilities': {}, 'composition': {'applications': {'SupportAgent': {'name': 'SupportAgent', 'description': 'AI-powered support triage', 'capabilities': [], 'agents': ['TriageAgent'], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/support', '/agents/triage'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'support_agent.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 3, 'edges': 2}, 'workflow': {'kind': 'workflow', 'nodes': 3, 'edges': 2}, 'handler': {'kind': 'handler', 'nodes': 3, 'edges': 2}, 'capability': {'kind': 'capability', 'nodes': 1, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 3, 'edges': 2}, 'agent': {'kind': 'agent', 'nodes': 1, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 3, 'edges': 2}, 'package': {'kind': 'package', 'nodes': 3, 'edges': 2}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Agent 'TriageAgent' references capability 'ticket_management' not declared or provided in this module", 'file': 'support_agent.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Agent 'TriageAgent' references capability 'knowledge_base' not declared or provided in this module", 'file': 'support_agent.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Agent 'TriageAgent' references capability 'customer_history' not declared or provided in this module", 'file': 'support_agent.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
