...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['support_agent.apg'], 'app': {'name': 'support_agent', 'version': '1.0.0', 'description': 'Single support triage agent', 'entity_count': 1}, 'symbols': {'module.support_agent': {'id': 'module.support_agent', 'kind': 'module', 'name': 'support_agent', 'file': 'support_agent.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'agent.TriageAgent': {'id': 'agent.TriageAgent', 'kind': 'agent', 'name': 'TriageAgent', 'file': 'support_agent.apg', 'range': {'start': {'line': 8, 'character': 0}, 'end': {'line': 8, 'character': 1}}, 'references': []}, 'llm.openai:gpt-4.1-mini': {'id': 'llm.openai:gpt-4.1-mini', 'kind': 'llm', 'name': 'openai:gpt-4.1-mini', 'file': 'support_agent.apg', 'range': {'start': {'line': 8, 'character': 0}, 'end': {'line': 8, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {'TriageAgent': {'name': 'TriageAgent', 'role': 'support_triage', 'model': 'openai:gpt-4.1-mini', 'runtime': 'codex', 'system': 'Classify incoming tickets and produce a concise next action.', 'capabilities': [], 'tools': ['tickets.read', 'knowledge.search'], 'memory': {'kind': 'vector', 'name': 'support_memory'}, 'inputs': ['ticket'], 'outputs': ['triage_plan'], 'handoffs': [], 'configuration': {}, 'rules': [{'name': 'ticket_required', 'when': 'ticket missing', 'action': 'reject'}], 'ui': {}, 'theme': {}}}, 'llms': {'TriageAgent': {'model': 'openai:gpt-4.1-mini', 'runtime': 'codex'}}, 'capabilities': {}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'support_agent.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 2, 'edges': 1}, 'workflow': {'kind': 'workflow', 'nodes': 2, 'edges': 1}, 'handler': {'kind': 'handler', 'nodes': 2, 'edges': 1}, 'capability': {'kind': 'capability', 'nodes': 0, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 2, 'edges': 1}, 'agent': {'kind': 'agent', 'nodes': 1, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 2, 'edges': 1}, 'package': {'kind': 'package', 'nodes': 2, 'edges': 1}}, 'diagnostics': []}
