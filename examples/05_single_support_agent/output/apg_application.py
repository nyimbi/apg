...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'SupportAgent': {'description': 'AI-powered support triage', 'capabilities': [], 'agents': ['TriageAgent'], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/support', '/agents/triage'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
