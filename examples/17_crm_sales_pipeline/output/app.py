...
ENTITIES = [{'name': 'Lead', 'type': 'entity', 'properties': ['lead_id', 'first_name', 'last_name', 'email', 'phone', 'company', 'source', 'status', 'score', 'owner_id', 'created_at', 'notes'], 'fields': [{'name': 'lead_id', 'type': 'str', 'required': True}, {'name': 'first_name', 'type': 'str', 'required': True}, {'name': 'last_name', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str?', 'required': True}, {'name': 'company', 'type': 'str?', 'required': True}, {'name': 'source', 'type': 'str', 'required': True, 'default': '"website"'}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"new"'}, {'name': 'score', 'type': 'float', 'required': True, 'default': '0.0'}, {'name': 'owner_id', 'type': 'str', 'required': True}, {'name': 'created_at', 'type': 'str', 'required': True}, {'name': 'notes', 'type': 'str?', 'required': True}], 'methods': []}, {'name': 'Opportunity', 'type': 'entity', 'properties': ['opportunity_id', 'lead_id', 'account_id', 'name', 'stage', 'amount', 'probability', 'expected_close', 'owner_id', 'competitor', 'loss_reason'], 'fields': [{'name': 'opportunity_id', 'type': 'str', 'required': True}, {'name': 'lead_id', 'type': 'str?', 'required': True}, {'name': 'account_id', 'type': 'str', 'required': True}, {'name': 'name', 'type': 'str', 'required': True}, {'name': 'stage', 'type': 'str', 'required': True, 'default': '"prospecting"'}, {'name': 'amount', 'type': 'float', 'required': True}, {'name': 'probability', 'type': 'float', 'required': True, 'default': '0.0'}, {'name': 'expected_close', 'type': 'str', 'required': True}, {'name': 'owner_id', 'type': 'str', 'required': True}, {'name': 'competitor', 'type': 'str?', 'required': True}, {'name': 'loss_reason', 'type': 'str?', 'required': True}], 'methods': []}, {'name': 'LeadManagement', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'OpportunityPipeline', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'CRMSalesPipeline', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
