"""
crm_sales_pipeline - APG Python Application
===========================================
...
MODULE_NAME = 'crm_sales_pipeline'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'Lead', 'type': 'entity', 'properties': ['company', 'contact_name', 'email', 'score', 'qualified'], 'fields': [{'name': 'company', 'type': 'str', 'required': True}, {'name': 'contact_name', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'score', 'type': 'int', 'required': True}, {'name': 'qualified', 'type': 'bool', 'required': True}], 'methods': []}, {'name': 'Opportunity', 'type': 'entity', 'properties': ['lead_id', 'stage', 'amount', 'probability', 'expected_close_date'], 'fields': [{'name': 'lead_id', 'type': 'int', 'required': True}, {'name': 'stage', 'type': 'str', 'required': True}, {'name': 'amount', 'type': 'float', 'required': True}, {'name': 'probability', 'type': 'int', 'required': True}, {'name': 'expected_close_date', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'SalesPipeline', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}]
