...
Models leads, opportunities, pipeline rules, and forecast screen composition.

## What This Example Demonstrates

- Lead and opportunity records
- Sales pipeline rules
- Forecast dashboard screen
...
```bash
apg compile examples/17_crm_sales_pipeline/main.apg --output examples/17_crm_sales_pipeline/output
```

Equivalent direct Python invocation from this repository:

```bash
.venv/bin/python -m cli.main compile examples/17_crm_sales_pipeline/main.apg --output examples/17_crm_sales_pipeline/output
```

## Run Generated App

```bash
cd examples/17_crm_sales_pipeline/output
