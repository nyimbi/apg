"""
localized_streaming_capability - APG Python Application
=======================================================
...
MODULE_NAME = 'localized_streaming_capability'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'OperationsFeed', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['localized_streaming_capability.apg'], 'app': {'name': 'localized_streaming_capability', 'version': '1.0.0', 'description': None, 'entity_count': 1}, 'symbols': {'module.localized_streaming_capability': {'id': 'module.localized_streaming_capability', 'kind': 'module', 'name': 'localized_streaming_capability', 'file': 'localized_streaming_capability.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.OperationsFeed': {'id': 'capability.OperationsFeed', 'kind': 'capability', 'name': 'OperationsFeed', 'file': 'localized_streaming_capability.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {'OperationsFeed': {'name': 'OperationsFeed', 'provides': ['operations_events', 'operations_dashboard'], 'requires': [], 'configuration': {'tenant_scoped': True}, 'rules': [], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Operations', 'path': '/ops', 'component': 'OperationsScreen'}]}, 'theme': {'name': 'ops_theme', 'tokens': {'accent': '#126E82', 'surface': '#F7FAFC'}}, 'runtime': {'backend': 'python', 'streaming': {'processor': 'bytewax'}}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {'supported_languages': ['en', 'sw', 'ha', 'yo', 'zu', 'am', 'rw'], 'default_language': 'en', 'fallback_language': 'en'}, 'streaming': {'processor': 'bytewax', 'state': 'operations_feed_state'}, 'screens': {}}}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {'OperationsFeed': []}}, 'contracts': {'OperationsFeed': {'id': 'operations_feed', 'provides': ['operations_events', 'operations_dashboard'], 'configuration': {'tenant_scoped': True}, 'ui': {'shell': 'python', 'routes': [{'name': 'Operations', 'path': '/ops', 'component': 'OperationsScreen'}]}, 'theme': {'name': 'ops_theme', 'tokens': {'accent': '#126E82', 'surface': '#F7FAFC'}}, 'runtime': {'backend': 'python', 'streaming': {'processor': 'bytewax'}}}}, 'deployment': {'target': 'python', 'source': 'localized_streaming_capability.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 2, 'edges': 1}, 'workflow': {'kind': 'workflow', 'nodes': 2, 'edges': 1}, 'handler': {'kind': 'handler', 'nodes': 2, 'edges': 1}, 'capability': {'kind': 'capability', 'nodes': 1, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 2, 'edges': 1}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 2, 'edges': 1}, 'package': {'kind': 'package', 'nodes': 2, 'edges': 1}}, 'diagnostics': []}
