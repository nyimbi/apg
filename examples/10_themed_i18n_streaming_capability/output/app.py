"""
localised_inventory - APG Python Application
============================================
...
MODULE_NAME = 'localised_inventory'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
LANDING_STYLE = 'default'
ENTITIES = [{'name': 'LocalisedInventory', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'LocalisedInventoryApp', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['localised_inventory.apg'], 'app': {'name': 'localised_inventory', 'version': '1.0.0', 'description': None, 'entity_count': 2}, 'symbols': {'module.localised_inventory': {'id': 'module.localised_inventory', 'kind': 'module', 'name': 'localised_inventory', 'file': 'localised_inventory.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.LocalisedInventory': {'id': 'capability.LocalisedInventory', 'kind': 'capability', 'name': 'LocalisedInventory', 'file': 'localised_inventory.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.LocalisedInventoryApp': {'id': 'app.LocalisedInventoryApp', 'kind': 'app', 'name': 'LocalisedInventoryApp', 'file': 'localised_inventory.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {'LocalisedInventory.no_negative_stock': {'name': 'no_negative_stock', 'when': 'on_hand - reserved < 0', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'on_hand', 'op': '==', 'value': True}}, 'LocalisedInventory.reorder_required': {'name': 'reorder_required', 'when': 'on_hand <= low_stock_threshold', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'on_hand', 'op': '<=', 'value': 'low_stock_threshold'}}}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {'LocalisedInventory': {'name': 'LocalisedInventory', 'provides': ['stock_balances', 'inventory_events', 'reorder_alerts'], 'requires': ['audit_events'], 'configuration': {'tenant_id': 'default', 'default_warehouse': 'NBO-01', 'low_stock_threshold': 10, 'auto_reorder': True}, 'rules': [{'name': 'no_negative_stock', 'when': 'on_hand - reserved < 0', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'on_hand', 'op': '==', 'value': True}}, {'name': 'reorder_required', 'when': 'on_hand <= low_stock_threshold', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'on_hand', 'op': '<=', 'value': 'low_stock_threshold'}}], 'rule_engine': {}, 'ui': {'shell': 'python', 'requires_theme': True, 'routes': [{'name': 'Stock', 'path': '/inventory', 'component': 'StockDashboard', 'permission': 'inventory:view'}, {'name': 'Reorders', 'path': '/inventory/reorder', 'component': 'ReorderQueue', 'permission': 'inventory:reorder'}, {'name': 'Movements', 'path': '/inventory/movements', 'component': 'MovementLog', 'permission': 'inventory:movements'}]}, 'theme': {'name': 'inventory_theme', 'tokens': {'color.primary': '#1B5E20', 'color.accent': '#F57F17', 'color.surface': '#FFFFFF', 'color.background': '#F5F5F5', 'color.error': '#C62828', 'color.warning': '#E65100', 'color.success': '#2E7D32', 'color.text.primary': '#212121', 'color.text.muted': '#757575', 'border.radius': '4px', 'shadow.card': '0 2px 4px rgba(0,0,0,0.12)', 'density': 'comfortable', 'font.family': 'Inter, sans-serif', 'font.size.base': '14px'}, 'components': {'stock_level_badge': {'variant': 'filled', 'color_scheme': 'status'}, 'movement_table': {'stripe': True, 'compact': False}, 'reorder_alert': {'icon': 'alert-circle', 'position': 'top-right'}}, 'allow_tenant_overrides': True}, 'runtime': {'target': 'python', 'streaming': {'processor': 'bytewax'}}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {'entities': ['warehouse', 'bin_location', 'item_category', 'unit_of_measure']}, 'i18n': {'supported_languages': ['en', 'sw', 'fr', 'pt', 'ar', 'rw', 'rn', 'yo', 'ig', 'ha', 'tw', 'ak', 'ee', 'gaa', 'fon', 'zu', 'xh', 'st', 'tn', 'ss', 've', 'nr', 'nso', 'ts', 'am', 'ti', 'so', 'om', 'ln', 'lu', 'kg', 'sg'], 'default_language': 'en', 'fallback_language': 'en'}, 'streaming': {'processor': 'bytewax', 'input': 'inventory_event_bus', 'output': 'reorder_alert_stream', 'state': 'inventory_state', 'window': '15min'}, 'screens': {}}}, 'composition': {'applications': {'LocalisedInventoryApp': {'name': 'LocalisedInventoryApp', 'description': 'Localised inventory management with streaming', 'capabilities': ['LocalisedInventory'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/inventory'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {'LocalisedInventory': ['audit_events']}}, 'contracts': {'LocalisedInventory': {'id': 'localised_inventory', 'provides': ['stock_balances', 'inventory_events', 'reorder_alerts'], 'requires': ['audit_events'], 'configuration': {'tenant_id': 'default', 'default_warehouse': 'NBO-01', 'low_stock_threshold': 10, 'auto_reorder': True}, 'rules': [{'name': 'no_negative_stock', 'when': 'on_hand - reserved < 0', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'on_hand', 'op': '==', 'value': True}}, {'name': 'reorder_required', 'when': 'on_hand <= low_stock_threshold', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'on_hand', 'op': '<=', 'value': 'low_stock_threshold'}}], 'ui': {'shell': 'python', 'requires_theme': True, 'routes': [{'name': 'Stock', 'path': '/inventory', 'component': 'StockDashboard', 'permission': 'inventory:view'}, {'name': 'Reorders', 'path': '/inventory/reorder', 'component': 'ReorderQueue', 'permission': 'inventory:reorder'}, {'name': 'Movements', 'path': '/inventory/movements', 'component': 'MovementLog', 'permission': 'inventory:movements'}]}, 'theme': {'name': 'inventory_theme', 'tokens': {'color.primary': '#1B5E20', 'color.accent': '#F57F17', 'color.surface': '#FFFFFF', 'color.background': '#F5F5F5', 'color.error': '#C62828', 'color.warning': '#E65100', 'color.success': '#2E7D32', 'color.text.primary': '#212121', 'color.text.muted': '#757575', 'border.radius': '4px', 'shadow.card': '0 2px 4px rgba(0,0,0,0.12)', 'density': 'comfortable', 'font.family': 'Inter, sans-serif', 'font.size.base': '14px'}, 'components': {'stock_level_badge': {'variant': 'filled', 'color_scheme': 'status'}, 'movement_table': {'stripe': True, 'compact': False}, 'reorder_alert': {'icon': 'alert-circle', 'position': 'top-right'}}, 'allow_tenant_overrides': True}, 'runtime': {'target': 'python', 'streaming': {'processor': 'bytewax'}}}}, 'deployment': {'target': 'python', 'source': 'localised_inventory.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 3, 'edges': 2}, 'workflow': {'kind': 'workflow', 'nodes': 3, 'edges': 2}, 'handler': {'kind': 'handler', 'nodes': 3, 'edges': 2}, 'capability': {'kind': 'capability', 'nodes': 3, 'edges': 2}, 'security': {'kind': 'security', 'nodes': 3, 'edges': 2}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 3, 'edges': 2}, 'package': {'kind': 'package', 'nodes': 3, 'edges': 2}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Capability 'LocalisedInventory' requires 'audit_events' which is not declared in this module", 'file': 'localised_inventory.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
...
APG_SUPPORTED_LANGUAGES: list[str] = ['en', 'sw', 'fr', 'pt', 'ar', 'rw', 'rn', 'yo', 'ig', 'ha', 'tw', 'ak', 'ee', 'gaa', 'fon', 'zu', 'xh', 'st', 'tn', 'ss', 've', 'nr', 'nso', 'ts', 'am', 'ti', 'so', 'om', 'ln', 'lu', 'kg', 'sg']
APG_DEFAULT_LANGUAGE = 'en'
APG_FALLBACK_LANGUAGE = 'en'
APG_I18N: Dict[str, Dict[str, str]] = {'en': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'sw': {'home': 'Nyumbani', 'workflows': 'Mitiririko', 'marketplace': 'Soko', 'theme_system': 'Mfumo', 'language': 'Lugha', 'logout': 'Toka', 'sign_in': 'Ingia', 'open_app': 'Fungua Programu', 'api_docs': 'Nyaraka za API', 'data_entities': 'Vyombo vya Data', 'view_manifest': 'Tazama Manifesti', 'entities': 'Vyombo', 'capabilities': 'Uwezo', 'records': 'Rekodi', 'ai_agents': 'Mawakala wa AI'}, 'fr': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'pt': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'ar': {'home': 'الرئيسية', 'workflows': 'سير العمل', 'marketplace': 'السوق', 'theme_system': 'النظام', 'language': 'اللغة', 'logout': 'تسجيل الخروج', 'sign_in': 'تسجيل الدخول', 'open_app': 'فتح التطبيق', 'api_docs': 'وثائق API', 'data_entities': 'كيانات البيانات', 'view_manifest': 'عرض البيان', 'entities': 'الكيانات', 'capabilities': 'القدرات', 'records': 'السجلات', 'ai_agents': 'وكلاء الذكاء الاصطناعي'}, 'rw': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'rn': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'yo': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'ig': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'ha': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'tw': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'ak': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'ee': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'gaa': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'fon': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'zu': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'xh': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'st': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'tn': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'ss': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 've': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'nr': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'nso': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'ts': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'am': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'ti': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'so': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'om': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'ln': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'lu': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'kg': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}, 'sg': {'home': 'Home', 'workflows': 'Workflows', 'marketplace': 'Marketplace', 'theme_system': 'System', 'language': 'Language', 'logout': 'Logout', 'sign_in': 'Sign in', 'open_app': 'Open App', 'api_docs': 'API Docs', 'data_entities': 'Data Entities', 'view_manifest': 'View Manifest', 'entities': 'Entities', 'capabilities': 'Capabilities', 'records': 'Records', 'ai_agents': 'AI Agents'}}
