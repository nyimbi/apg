...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'LocalisedInventoryApp': {'description': 'Localised inventory management with streaming', 'capabilities': ['LocalisedInventory'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/inventory'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
