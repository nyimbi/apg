...
CAPABILITY_DATA: Dict[str, Dict[str, Any]] = {'OperationsFeed': {'contract': {'id': 'operations_feed', 'provides': ['operations_events', 'operations_dashboard'], 'configuration': {'tenant_scoped': True}, 'ui': {'shell': 'python', 'routes': [{'name': 'Operations', 'path': '/ops', 'component': 'OperationsScreen'}]}, 'theme': {'name': 'ops_theme', 'tokens': {'accent': '#126E82', 'surface': '#F7FAFC'}}, 'runtime': {'backend': 'python', 'streaming': {'processor': 'bytewax'}}}, 'provides': ['operations_events', 'operations_dashboard'], 'requires': [], 'configuration': {'tenant_scoped': True}, 'rules': [], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Operations', 'path': '/ops', 'component': 'OperationsScreen'}]}, 'theme': {'name': 'ops_theme', 'tokens': {'accent': '#126E82', 'surface': '#F7FAFC'}}, 'runtime': {'backend': 'python', 'streaming': {'processor': 'bytewax'}}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {'supported_languages': ['en', 'sw', 'ha', 'yo', 'zu', 'am', 'rw'], 'default_language': 'en', 'fallback_language': 'en'}, 'streaming': {'processor': 'bytewax', 'state': 'operations_feed_state'}, 'screens': {}}}
