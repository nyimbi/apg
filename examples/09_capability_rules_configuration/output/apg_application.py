...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'CreditControlApp': {'description': 'Credit control and risk management', 'capabilities': ['CreditControl'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/credit', '/credit/checks', '/credit/approvals'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
