...
class ERPAssistant(AgentBase):
    name = 'ERPAssistant'
    role = 'erp analyst'
    model = 'openai:gpt-4.1-mini'
    runtime = 'codex'
    system = 'You assist with ERP operations: procurement analysis, cash flow forecasting, payroll queries, and in'
