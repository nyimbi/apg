...
AI_AGENT_DATA: Dict[str, Dict[str, Any]] = {'SalesAssistant': {'role': 'sales assistant', 'model': 'openai:gpt-4.1-mini', 'runtime': None, 'system': 'Analyse CRM context and suggest next best actions, talking points, and risk factors.', 'capabilities': ['contact_lifecycle', 'opportunity_pipeline'], 'tools': ['contact_search', 'deal_analysis'], 'memory': {'kind': 'vector', 'name': 'sales_memory'}, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {'temperature': 0.2, 'max_turns': 6}, 'rules': [], 'ui': {}, 'theme': {}}}
