...
- `SalesAssistant` - runtime `local`, invoke with `POST /agents/SalesAssistant/invoke`
...
- `CRMCore` - provides contact_lifecycle, account_management, opportunity_pipeline, sales_analytics
