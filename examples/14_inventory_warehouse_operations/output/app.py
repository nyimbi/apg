"""
inventory_warehouse_operations - APG Python Application
=======================================================
...
MODULE_NAME = 'inventory_warehouse_operations'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'StockItem', 'type': 'entity', 'properties': ['sku', 'description', 'on_hand', 'reserved', 'reorder_level', 'active'], 'fields': [{'name': 'sku', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str', 'required': True}, {'name': 'on_hand', 'type': 'int', 'required': True}, {'name': 'reserved', 'type': 'int', 'required': True}, {'name': 'reorder_level', 'type': 'int', 'required': True}, {'name': 'active', 'type': 'bool', 'required': True}], 'methods': []}, {'name': 'StockMovement', 'type': 'entity', 'properties': ['stock_item_id', 'movement_type', 'quantity', 'reference'], 'fields': [{'name': 'stock_item_id', 'type': 'int', 'required': True}, {'name': 'movement_type', 'type': 'str', 'required': True}, {'name': 'quantity', 'type': 'int', 'required': True}, {'name': 'reference', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'WarehouseInventory', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}]
