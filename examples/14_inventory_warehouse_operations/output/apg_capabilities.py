...
CAPABILITY_DATA: Dict[str, Dict[str, Any]] = {'WarehouseInventory': {'contract': {'id': 'warehouse_inventory', 'provides': ['stock_balances', 'stock_movements', 'reorder_alerts'], 'requires': ['audit_events'], 'configuration': {'default_warehouse': 'NBO-01', 'cycle_count_days': 30}, 'rules': [{'name': 'no_negative_stock', 'when': 'on_hand - reserved < 0', 'action': 'deny'}, {'name': 'reorder_needed', 'when': 'on_hand <= reorder_level', 'action': 'warn'}], 'ui': {'shell': 'python', 'routes': [{'name': 'Inventory', 'path': '/warehouse/inventory', 'component': 'InventoryScreen'}]}, 'theme': {'name': 'warehouse_theme', 'tokens': {'accent': '#2F855A'}}}, 'provides': ['stock_balances', 'stock_movements', 'reorder_alerts'], 'requires': ['audit_events'], 'configuration': {'default_warehouse': 'NBO-01', 'cycle_count_days': 30}, 'rules': [{'name': 'no_negative_stock', 'when': 'on_hand - reserved < 0', 'action': 'deny'}, {'name': 'reorder_needed', 'when': 'on_hand <= reorder_level', 'action': 'warn'}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Inventory', 'path': '/warehouse/inventory', 'component': 'InventoryScreen'}]}, 'theme': {'name': 'warehouse_theme', 'tokens': {'accent': '#2F855A'}}, 'runtime': {}, 'erp_modules': ['inventory', 'warehouse', 'procurement'], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {'entities': ['stock_item', 'warehouse', 'bin_location']}, 'i18n': {}, 'streaming': {'processor': 'bytewax', 'state': 'inventory_movement_state'}, 'screens': {}}}
