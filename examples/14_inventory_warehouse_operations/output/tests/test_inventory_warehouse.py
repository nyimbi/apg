...
def test_crud_inventoryitem(generated_app_client):
	payload = {'sku': 'InventoryItem Wave K Needle', 'description': 'sample description', 'unit_of_measure': 'sample unit_of_measure', 'quantity_on_hand': 7, 'quantity_reserved': 7, 'reorder_point': 7, 'cost_price': 7.5, 'status': 'sample status', 'bin_location': 'sample bin_location'}
