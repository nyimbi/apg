...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'WarehouseOpsApp': {'description': 'Warehouse operations management', 'capabilities': ['WarehouseOps'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/warehouse'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
