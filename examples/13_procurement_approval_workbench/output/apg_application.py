...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'ProcurementApp': {'description': 'Procurement approval workbench', 'capabilities': ['ProcurementWorkbench'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/procurement'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
