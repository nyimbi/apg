...
ENTITIES = [{'name': 'ProcurementDB', 'type': 'database', 'properties': ['engine', 'schema', 'migrations'], 'fields': [{'name': 'engine', 'type': 'str', 'required': True, 'default': 'postgresql'}, {'name': 'schema', 'type': 'str', 'required': True, 'default': 'procurement'}, {'name': 'migrations', 'type': 'str', 'required': True, 'default': 'alembic'}], 'methods': [], 'connection_config': {'engine': 'postgresql', 'schema': 'procurement', 'migrations': 'alembic'}, 'schemas': []}, {'name': 'PurchaseRequest', 'type': 'entity', 'properties': ['request_id', 'requestor_id', 'department', 'description', 'amount', 'currency', 'priority', 'status', 'justification', 'budget_code', 'created_at'], 'fields': [{'name': 'request_id', 'type': 'str', 'required': True}, {'name': 'requestor_id', 'type': 'str', 'required': True}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str', 'required': True}, {'name': 'amount', 'type': 'decimal', 'required': True}, {'name': 'currency', 'type': 'str', 'required': True, 'default': '"KES"'}, {'name': 'priority', 'type': 'str', 'required': True, 'default': '"normal"'}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"draft"'}, {'name': 'justification', 'type': 'str?', 'required': True}, {'name': 'budget_code', 'type': 'str?', 'required': True}, {'name': 'created_at', 'type': 'datetime', 'required': True}], 'methods': []}, {'name': 'SupplierQuote', 'type': 'entity', 'properties': ['quote_id', 'request_id', 'supplier_id', 'amount', 'validity_days', 'submitted_at', 'status'], 'fields': [{'name': 'quote_id', 'type': 'str', 'required': True}, {'name': 'request_id', 'type': 'str', 'required': True}, {'name': 'supplier_id', 'type': 'str', 'required': True}, {'name': 'amount', 'type': 'decimal', 'required': True}, {'name': 'validity_days', 'type': 'int', 'required': True, 'default': '30'}, {'name': 'submitted_at', 'type': 'datetime', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"pending"'}], 'methods': []}, {'name': 'ProcurementWorkbench', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ProcurementApproval', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ProcurementApp', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
