...
ENTITIES = [{'name': 'ProcurementWorkbench', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ProcurementApproval', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['procurement_approval_workbench.apg'], 'app': {'name': 'procurement_approval_workbench', 'version': '1.0.0', 'description': None, 'entity_count': 2}, 'symbols': {'module.procurement_approval_workbench': {'id': 'module.procurement_approval_workbench', 'kind': 'module', 'name': 'procurement_approval_workbench', 'file': 'procurement_approval_workbench.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.ProcurementWorkbench': {'id': 'capability.ProcurementWorkbench', 'kind': 'capability', 'name': 'ProcurementWorkbench', 'file': 'procurement_approval_workbench.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'workflow.ProcurementApproval': {'id': 'workflow.ProcurementApproval', 'kind': 'workflow', 'name': 'ProcurementApproval', 'file': 'procurement_approval_workbench.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {'ProcurementApproval': {'name': 'ProcurementApproval', 'type': 'workflow', 'properties': {}, 'methods': [], 'states': ['draft', 'budget_review', 'procurement_review', 'finance_approval', 'approved'], 'transitions': [{'source': 'draft', 'target': 'budget_review', 'guard': None}, {'source': 'budget_review', 'target': 'procurement_review', 'guard': None}, {'source': 'procurement_review', 'target': 'finance_approval', 'guard': None}, {'source': 'finance_approval', 'target': 'approved', 'guard': None}], 'steps': ['draft', 'budget_review', 'procurement_review', 'finance_approval', 'approved'], 'step_transitions': [{'from': 'draft', 'to': 'budget_review', 'guard': None}, {'from': 'budget_review', 'to': 'procurement_review', 'guard': None}, {'from': 'procurement_review', 'to': 'finance_approval', 'guard': None}, {'from': 'finance_approval', 'to': 'approved', 'guard': None}], 'human_tasks': [], 'guards': {}, 'assignments': {}, 'timers': {}, 'waits': {}, 'retry_policy': {}, 'compensation': {}, 'steps_raw': 'draft -> budget_review -> procurement_review -> finance_approval -> approved'}}, 'operations': {}, 'rules': {'ProcurementWorkbench.budget_required': {'name': 'budget_required', 'when': 'budget_code missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'budget_code', 'negated': False}}, 'ProcurementWorkbench.high_value_approval': {'name': 'high_value_approval', 'when': 'amount > approval_threshold', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'amount', 'op': '>', 'value': 'approval_threshold'}}}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {'ProcurementWorkbench': {'name': 'ProcurementWorkbench', 'provides': ['purchase_requests', 'supplier_quotes', 'approval_plans'], 'requires': ['audit_events', 'supplier_master'], 'configuration': {'currency': 'KES', 'approval_threshold': 50000}, 'rules': [{'name': 'budget_required', 'when': 'budget_code missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'budget_code', 'negated': False}}, {'name': 'high_value_approval', 'when': 'amount > approval_threshold', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'amount', 'op': '>', 'value': 'approval_threshold'}}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Procurement', 'path': '/procurement', 'component': 'ProcurementScreen'}]}, 'theme': {'name': 'procurement_theme', 'tokens': {'accent': '#6C8EAD'}}, 'runtime': {}, 'erp_modules': ['procurement', 'finance', 'inventory'], 'components': {'requesting': {'capability': 'purchase_requests', 'permissions': ['create', 'approve']}}, 'business_rules': [], 'approvals': {'levels': 3, 'approvers': ['request_manager', 'procurement_lead', 'finance_controller']}, 'master_data': {'entities': ['supplier', 'item_catalog', 'cost_center']}, 'i18n': {}, 'streaming': {}, 'screens': {'ApprovalQueue': {'route': '/procurement/approvals', 'layout': 'split', 'contains': ['RequestList', 'ApprovalPanel'], 'binds': ['purchase_requests.pending'], 'actions': ['approve', 'reject', 'request_changes']}}}}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {'ProcurementWorkbench': ['audit_events', 'supplier_master']}}, 'contracts': {'ProcurementWorkbench': {'id': 'procurement_workbench', 'provides': ['purchase_requests', 'supplier_quotes', 'approval_plans'], 'requires': ['audit_events', 'supplier_master'], 'configuration': {'currency': 'KES', 'approval_threshold': 50000}, 'rules': [{'name': 'budget_required', 'when': 'budget_code missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'budget_code', 'negated': False}}, {'name': 'high_value_approval', 'when': 'amount > approval_threshold', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'amount', 'op': '>', 'value': 'approval_threshold'}}], 'ui': {'shell': 'python', 'routes': [{'name': 'Procurement', 'path': '/procurement', 'component': 'ProcurementScreen'}]}, 'theme': {'name': 'procurement_theme', 'tokens': {'accent': '#6C8EAD'}}}}, 'deployment': {'target': 'python', 'source': 'procurement_approval_workbench.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 3, 'edges': 2}, 'workflow': {'kind': 'workflow', 'nodes': 3, 'edges': 2}, 'handler': {'kind': 'handler', 'nodes': 3, 'edges': 2}, 'capability': {'kind': 'capability', 'nodes': 3, 'edges': 2}, 'security': {'kind': 'security', 'nodes': 3, 'edges': 2}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 3, 'edges': 2}, 'package': {'kind': 'package', 'nodes': 3, 'edges': 2}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Workflow 'ProcurementApproval' should define steps or stages", 'file': 'procurement_approval_workbench.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Capability 'ProcurementWorkbench' requires 'audit_events' which is not declared in this module", 'file': 'procurement_approval_workbench.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Capability 'ProcurementWorkbench' requires 'supplier_master' which is not declared in this module", 'file': 'procurement_approval_workbench.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
