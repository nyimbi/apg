...
class ClinicalAssistant(AgentBase):
    name = 'ClinicalAssistant'
    role = 'clinical decision support'
    model = 'openai:gpt-4.1-mini'
    runtime = 'codex'
    system = 'You are a clinical decision support system. Provide evidence-based recommendations, drug interaction'
