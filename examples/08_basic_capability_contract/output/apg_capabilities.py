...
CAPABILITY_DATA: Dict[str, Dict[str, Any]] = {'AuditLog': {'contract': {'id': 'audit_log', 'provides': ['audit_events'], 'configuration': {'retention_days': 365}}, 'provides': ['audit_events'], 'requires': [], 'configuration': {'retention_days': 365}, 'rules': [], 'rule_engine': {}, 'ui': {}, 'theme': {}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {'entities': ['audit_event']}, 'i18n': {}, 'streaming': {}, 'screens': {}}}
