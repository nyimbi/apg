"""
capability_basics - APG Python Application
==========================================
...
MODULE_NAME = 'capability_basics'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'AuditLog', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['capability_basics.apg'], 'app': {'name': 'capability_basics', 'version': '1.0.0', 'description': None, 'entity_count': 1}, 'symbols': {'module.capability_basics': {'id': 'module.capability_basics', 'kind': 'module', 'name': 'capability_basics', 'file': 'capability_basics.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.AuditLog': {'id': 'capability.AuditLog', 'kind': 'capability', 'name': 'AuditLog', 'file': 'capability_basics.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {'AuditLog': {'name': 'AuditLog', 'provides': ['audit_events'], 'requires': [], 'configuration': {'retention_days': 365}, 'rules': [], 'rule_engine': {}, 'ui': {}, 'theme': {}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {'entities': ['audit_event']}, 'i18n': {}, 'streaming': {}, 'screens': {}}}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {'AuditLog': []}}, 'contracts': {'AuditLog': {'id': 'audit_log', 'provides': ['audit_events'], 'configuration': {'retention_days': 365}}}, 'deployment': {'target': 'python', 'source': 'capability_basics.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 2, 'edges': 1}, 'workflow': {'kind': 'workflow', 'nodes': 2, 'edges': 1}, 'handler': {'kind': 'handler', 'nodes': 2, 'edges': 1}, 'capability': {'kind': 'capability', 'nodes': 1, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 2, 'edges': 1}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 2, 'edges': 1}, 'package': {'kind': 'package', 'nodes': 2, 'edges': 1}}, 'diagnostics': []}
