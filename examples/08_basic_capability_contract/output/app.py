"""
capability_contract - APG Python Application
============================================
...
MODULE_NAME = 'capability_contract'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
LANDING_STYLE = 'default'
ENTITIES = [{'name': 'AuditLog', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'NotificationEngine', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'CapabilityContractApp', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['capability_contract.apg'], 'app': {'name': 'capability_contract', 'version': '1.0.0', 'description': None, 'entity_count': 3}, 'symbols': {'module.capability_contract': {'id': 'module.capability_contract', 'kind': 'module', 'name': 'capability_contract', 'file': 'capability_contract.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.AuditLog': {'id': 'capability.AuditLog', 'kind': 'capability', 'name': 'AuditLog', 'file': 'capability_contract.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.NotificationEngine': {'id': 'capability.NotificationEngine', 'kind': 'capability', 'name': 'NotificationEngine', 'file': 'capability_contract.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.CapabilityContractApp': {'id': 'app.CapabilityContractApp', 'kind': 'app', 'name': 'CapabilityContractApp', 'file': 'capability_contract.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {'AuditLog.tenant_required': {'name': 'tenant_required', 'when': 'tenant_id missing', 'action': 'deny', 'priority': 100}, 'AuditLog.size_limit': {'name': 'size_limit', 'when': 'event_size_kb > max_event_size_kb', 'action': 'deny', 'priority': 90}, 'AuditLog.sensitive_data': {'name': 'sensitive_data', 'when': 'contains_pii == true', 'action': 'require_review', 'priority': 80}, 'NotificationEngine.rate_limit': {'name': 'rate_limit', 'when': 'notifications_per_hour > 1000', 'action': 'deny'}, 'NotificationEngine.valid_channel': {'name': 'valid_channel', 'when': 'channel in [email, sms, push, webhook]', 'action': 'allow'}, 'NotificationEngine.invalid_channel': {'name': 'invalid_channel', 'when': 'channel not in [email, sms, push, webhook]', 'action': 'deny'}}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {'AuditLog': {'name': 'AuditLog', 'provides': ['audit_events', 'audit_reports', 'compliance_trail'], 'requires': [], 'configuration': {'tenant_id': 'default', 'retention_days': 2555, 'max_event_size_kb': 64, 'compress_after_days': 90, 'encrypt_at_rest': True}, 'rules': [], 'rule_engine': {'type': 'deterministic', 'default_decision': 'allow', 'rules': [{'name': 'tenant_required', 'when': 'tenant_id missing', 'action': 'deny', 'priority': 100}, {'name': 'size_limit', 'when': 'event_size_kb > max_event_size_kb', 'action': 'deny', 'priority': 90}, {'name': 'sensitive_data', 'when': 'contains_pii == true', 'action': 'require_review', 'priority': 80}]}, 'ui': {'shell': 'python', 'routes': [{'name': 'Audit Log', 'path': '/audit', 'component': 'AuditLogViewer', 'permission': 'audit:view'}, {'name': 'Compliance', 'path': '/audit/compliance', 'component': 'ComplianceView', 'permission': 'audit:compliance'}]}, 'theme': {'name': 'audit_theme', 'tokens': {'accent': '#5C6BC0'}}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {'entities': ['audit_event', 'audit_session', 'compliance_rule']}, 'i18n': {}, 'streaming': {}, 'screens': {}}, 'NotificationEngine': {'name': 'NotificationEngine', 'provides': ['notifications', 'alert_dispatch', 'delivery_tracking'], 'requires': ['audit_events'], 'configuration': {'tenant_id': 'default', 'default_channel': 'email', 'retry_attempts': 3, 'retry_delay_seconds': 60}, 'rules': [], 'rule_engine': {'type': 'policy', 'default_decision': 'allow', 'rules': [{'name': 'rate_limit', 'when': 'notifications_per_hour > 1000', 'action': 'deny'}, {'name': 'valid_channel', 'when': 'channel in [email, sms, push, webhook]', 'action': 'allow'}, {'name': 'invalid_channel', 'when': 'channel not in [email, sms, push, webhook]', 'action': 'deny'}]}, 'ui': {}, 'theme': {}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {}, 'screens': {}}}, 'composition': {'applications': {'CapabilityContractApp': {'name': 'CapabilityContractApp', 'description': 'Audit and notification capabilities', 'capabilities': ['AuditLog', 'NotificationEngine'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/audit', '/notifications'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {'AuditLog': [], 'NotificationEngine': ['audit_events']}}, 'contracts': {'AuditLog': {'id': 'audit_log', 'provides': ['audit_events', 'audit_reports', 'compliance_trail'], 'requires': [], 'configuration': {'tenant_id': 'default', 'retention_days': 2555, 'max_event_size_kb': 64, 'compress_after_days': 90, 'encrypt_at_rest': True}, 'configuration_schema': {'required': ['tenant_id', 'retention_days']}, 'rule_engine': {'type': 'deterministic', 'default_decision': 'allow', 'rules': [{'name': 'tenant_required', 'when': 'tenant_id missing', 'action': 'deny', 'priority': 100}, {'name': 'size_limit', 'when': 'event_size_kb > max_event_size_kb', 'action': 'deny', 'priority': 90}, {'name': 'sensitive_data', 'when': 'contains_pii == true', 'action': 'require_review', 'priority': 80}]}, 'ui': {'shell': 'python', 'routes': [{'name': 'Audit Log', 'path': '/audit', 'component': 'AuditLogViewer', 'permission': 'audit:view'}, {'name': 'Compliance', 'path': '/audit/compliance', 'component': 'ComplianceView', 'permission': 'audit:compliance'}]}, 'theme': {'name': 'audit_theme', 'tokens': {'accent': '#5C6BC0'}}}, 'NotificationEngine': {'id': 'notification_engine', 'provides': ['notifications', 'alert_dispatch', 'delivery_tracking'], 'requires': ['audit_events'], 'configuration': {'tenant_id': 'default', 'default_channel': 'email', 'retry_attempts': 3, 'retry_delay_seconds': 60}, 'configuration_schema': {'required': ['tenant_id', 'default_channel']}, 'rule_engine': {'type': 'policy', 'default_decision': 'allow', 'rules': [{'name': 'rate_limit', 'when': 'notifications_per_hour > 1000', 'action': 'deny'}, {'name': 'valid_channel', 'when': 'channel in [email, sms, push, webhook]', 'action': 'allow'}, {'name': 'invalid_channel', 'when': 'channel not in [email, sms, push, webhook]', 'action': 'deny'}]}}}, 'deployment': {'target': 'python', 'source': 'capability_contract.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 4, 'edges': 3}, 'workflow': {'kind': 'workflow', 'nodes': 4, 'edges': 3}, 'handler': {'kind': 'handler', 'nodes': 4, 'edges': 3}, 'capability': {'kind': 'capability', 'nodes': 4, 'edges': 3}, 'security': {'kind': 'security', 'nodes': 4, 'edges': 3}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 4, 'edges': 3}, 'package': {'kind': 'package', 'nodes': 4, 'edges': 3}}, 'diagnostics': []}
