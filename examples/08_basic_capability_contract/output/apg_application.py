...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'CapabilityContractApp': {'description': 'Audit and notification capabilities', 'capabilities': ['AuditLog', 'NotificationEngine'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/audit', '/notifications'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
