...
class FintechRiskOfficer(AgentBase):
    name = 'FintechRiskOfficer'
    role = 'risk and compliance officer'
    model = 'openai:gpt-4.1-mini'
    runtime = 'codex'
    system = 'You are a fintech compliance officer for Kenya/East Africa. Review AML alerts, assess transaction pa'
...
AGENTS = {
    'FintechRiskOfficer': FintechRiskOfficer,
}
