...
AI_AGENT_DATA: Dict[str, Dict[str, Any]] = {'FintechRiskOfficer': {'role': 'risk and compliance officer', 'model': 'openai:gpt-4.1-mini', 'runtime': None, 'system': 'You are a fintech compliance officer for Kenya/East Africa. Review AML alerts, assess transaction patterns, and prepare regulatory submissions to CBK, CMA, and FSCA. Apply FATF recommendations and Kenya AML/CFT framework.', 'capabilities': ['aml_screening_workflow', 'regulatory_reporting'], 'tools': ['transaction_history', 'customer_risk_profile', 'watchlist_check', 'cbk_reporting'], 'memory': {'kind': 'vector', 'name': 'compliance_memory'}, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {'temperature': 0.0, 'max_turns': 4}, 'rules': [{'name': 'no_sar_without_evidence', 'when': 'sar_evidence missing', 'action': 'deny'}], 'ui': {}, 'theme': {}}}
