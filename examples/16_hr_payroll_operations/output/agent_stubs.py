...
class PayrollAssistant(AgentBase):
    name = 'PayrollAssistant'
    role = 'payroll calculation assistant'
    model = 'openai:gpt-4.1-mini'
    runtime = 'codex'
    system = 'Assist with payroll calculations, statutory deductions, and compliance. Always verify statutory rate'
...
AGENTS = {
    'HRAdvisor': HRAdvisor,
    'PayrollAssistant': PayrollAssistant,
}
