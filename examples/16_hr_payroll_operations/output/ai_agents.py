...
AI_AGENT_DATA: Dict[str, Dict[str, Any]] = {'HRAdvisor': {'role': 'HR policy advisor', 'model': 'openai:gpt-4.1-mini', 'runtime': None, 'system': 'Advise on HR policies, leave entitlements, and employment law compliance. Cite relevant sections.', 'capabilities': ['employee_records', 'hr_policies'], 'tools': ['policy.lookup', 'employment_law.search', 'leave_balance.check'], 'memory': {'kind': 'vector', 'name': 'hr_memory'}, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {'temperature': 0.1, 'max_turns': 6}, 'rules': [], 'ui': {}, 'theme': {}}, 'PayrollAssistant': {'role': 'payroll calculation assistant', 'model': 'openai:gpt-4.1-mini', 'runtime': None, 'system': 'Assist with payroll calculations, statutory deductions, and compliance. Always verify statutory rates.', 'capabilities': ['payroll_runs', 'statutory_deductions'], 'tools': ['tax_table.lookup', 'statutory_rates.fetch', 'payslip.calculate'], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {'temperature': 0.0, 'max_turns': 4}, 'rules': [], 'ui': {}, 'theme': {}}}
