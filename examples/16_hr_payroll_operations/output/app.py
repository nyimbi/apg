"""
hr_payroll - APG Python Application
===================================
...
ENTITIES = [{'name': 'Employee', 'type': 'entity', 'properties': ['employee_number', 'first_name', 'last_name', 'email', 'department', 'position', 'employment_type', 'hire_date', 'termination_date', 'salary', 'currency', 'bank_account', 'tax_pin', 'nssf_number', 'nhif_number', 'is_active'], 'fields': [{'name': 'employee_number', 'type': 'str', 'required': True}, {'name': 'first_name', 'type': 'str', 'required': True}, {'name': 'last_name', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'position', 'type': 'str', 'required': True}, {'name': 'employment_type', 'type': 'str', 'required': True, 'default': '"permanent"'}, {'name': 'hire_date', 'type': 'str', 'required': True}, {'name': 'termination_date', 'type': 'str?', 'required': True}, {'name': 'salary', 'type': 'float', 'required': True}, {'name': 'currency', 'type': 'str', 'required': True, 'default': '"KES"'}, {'name': 'bank_account', 'type': 'str?', 'required': True}, {'name': 'tax_pin', 'type': 'str?', 'required': True}, {'name': 'nssf_number', 'type': 'str?', 'required': True}, {'name': 'nhif_number', 'type': 'str?', 'required': True}, {'name': 'is_active', 'type': 'bool', 'required': True, 'default': 'true'}], 'methods': []}, {'name': 'PayRun', 'type': 'entity', 'properties': ['pay_run_id', 'period', 'pay_date', 'status', 'total_gross', 'total_deductions', 'total_net', 'approved_by', 'approved_at'], 'fields': [{'name': 'pay_run_id', 'type': 'str', 'required': True}, {'name': 'period', 'type': 'str', 'required': True}, {'name': 'pay_date', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"draft"'}, {'name': 'total_gross', 'type': 'float', 'required': True, 'default': '0.0'}, {'name': 'total_deductions', 'type': 'float', 'required': True, 'default': '0.0'}, {'name': 'total_net', 'type': 'float', 'required': True, 'default': '0.0'}, {'name': 'approved_by', 'type': 'str?', 'required': True}, {'name': 'approved_at', 'type': 'str?', 'required': True}], 'methods': []}, {'name': 'Payslip', 'type': 'entity', 'properties': ['payslip_id', 'pay_run_id', 'employee_id', 'gross_pay', 'paye_tax', 'nssf_employee', 'nhif_employee', 'other_deductions', 'net_pay', 'payment_status'], 'fields': [{'name': 'payslip_id', 'type': 'str', 'required': True}, {'name': 'pay_run_id', 'type': 'str', 'required': True}, {'name': 'employee_id', 'type': 'str', 'required': True}, {'name': 'gross_pay', 'type': 'float', 'required': True}, {'name': 'paye_tax', 'type': 'float', 'required': True}, {'name': 'nssf_employee', 'type': 'float', 'required': True}, {'name': 'nhif_employee', 'type': 'float', 'required': True}, {'name': 'other_deductions', 'type': 'float', 'required': True, 'default': '0.0'}, {'name': 'net_pay', 'type': 'float', 'required': True}, {'name': 'payment_status', 'type': 'str', 'required': True, 'default': '"pending"'}], 'methods': []}, {'name': 'HRAdvisor', 'type': 'agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'PayrollAssistant', 'type': 'agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'HRPayrollTeam', 'type': 'agent_team', 'properties': ['agents', 'flow', 'capabilities'], 'fields': [{'name': 'agents', 'type': '[HRAdvisor, PayrollAssistant]', 'required': True}, {'name': 'flow', 'type': 'HRAdvisor -> PayrollAssistant', 'required': True}, {'name': 'capabilities', 'type': '[employee_records, payroll_runs]', 'required': True}], 'methods': []}, {'name': 'HRPayroll', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'PayRunProcess', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'EmployeeOnboarding', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'LeaveRequest', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'HRPayrollApp', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
