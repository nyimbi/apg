"""
finance_general_ledger - APG Python Application
===============================================
...
ENTITIES = [{'name': 'GeneralLedger', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['finance_general_ledger.apg'], 'app': {'name': 'finance_general_ledger', 'version': '1.0.0', 'description': None, 'entity_count': 1}, 'symbols': {'module.finance_general_ledger': {'id': 'module.finance_general_ledger', 'kind': 'module', 'name': 'finance_general_ledger', 'file': 'finance_general_ledger.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.GeneralLedger': {'id': 'capability.GeneralLedger', 'kind': 'capability', 'name': 'GeneralLedger', 'file': 'finance_general_ledger.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {'GeneralLedger.balanced_journal': {'name': 'balanced_journal', 'when': 'debits != credits', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'debits', 'op': '!=', 'value': 'credits'}}, 'GeneralLedger.period_open': {'name': 'period_open', 'when': 'period.closed', 'action': 'deny', 'priority': 100, 'when_ast': {'type': 'compare', 'field': 'period.closed', 'op': '==', 'value': True}}}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {'GeneralLedger': {'name': 'GeneralLedger', 'provides': ['journal_entries', 'chart_of_accounts', 'financial_periods'], 'requires': ['audit_events'], 'configuration': {'currency': 'KES', 'fiscal_calendar': 'monthly'}, 'rules': [{'name': 'balanced_journal', 'when': 'debits != credits', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'debits', 'op': '!=', 'value': 'credits'}}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Journals', 'path': '/finance/gl/journals', 'component': 'JournalScreen'}]}, 'theme': {'name': 'finance_ops', 'tokens': {'accent': '#126E82'}}, 'runtime': {}, 'erp_modules': ['finance', 'general_ledger', 'accounts_payable'], 'components': {'posting': {'capability': 'journal_entries', 'permissions': ['post', 'reverse']}}, 'business_rules': [{'name': 'period_open', 'when': 'period.closed', 'action': 'deny', 'priority': 100, 'when_ast': {'type': 'compare', 'field': 'period.closed', 'op': '==', 'value': True}}], 'approvals': {'levels': 2, 'approvers': ['controller', 'cfo']}, 'master_data': {'entities': ['account', 'cost_center', 'financial_period']}, 'i18n': {'supported_languages': ['en', 'sw', 'ha', 'yo', 'zu'], 'default_language': 'en', 'fallback_language': 'en'}, 'streaming': {'processor': 'bytewax', 'state': 'ledger_posting_state'}, 'screens': {}}}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {'GeneralLedger': ['audit_events']}}, 'contracts': {'GeneralLedger': {'id': 'general_ledger', 'name': 'General Ledger', 'version': '1.0.0', 'provides': ['journal_entries', 'chart_of_accounts', 'financial_periods'], 'requires': ['audit_events'], 'configuration': {'currency': 'KES', 'fiscal_calendar': 'monthly'}, 'rules': [{'name': 'balanced_journal', 'when': 'debits != credits', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'debits', 'op': '!=', 'value': 'credits'}}], 'ui': {'shell': 'python', 'routes': [{'name': 'Journals', 'path': '/finance/gl/journals', 'component': 'JournalScreen'}]}, 'theme': {'name': 'finance_ops', 'tokens': {'accent': '#126E82'}}}}, 'deployment': {'target': 'python', 'source': 'finance_general_ledger.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 2, 'edges': 1}, 'workflow': {'kind': 'workflow', 'nodes': 2, 'edges': 1}, 'handler': {'kind': 'handler', 'nodes': 2, 'edges': 1}, 'capability': {'kind': 'capability', 'nodes': 2, 'edges': 1}, 'security': {'kind': 'security', 'nodes': 2, 'edges': 1}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 2, 'edges': 1}, 'package': {'kind': 'package', 'nodes': 2, 'edges': 1}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Capability 'GeneralLedger' requires 'audit_events' which is not declared in this module", 'file': 'finance_general_ledger.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
