...
ENTITIES = [{'name': 'Account', 'type': 'entity', 'properties': ['account_code', 'account_name', 'account_type', 'parent_code', 'currency', 'is_active', 'is_control', 'normal_balance'], 'fields': [{'name': 'account_code', 'type': 'str', 'required': True}, {'name': 'account_name', 'type': 'str', 'required': True}, {'name': 'account_type', 'type': 'str', 'required': True}, {'name': 'parent_code', 'type': 'str?', 'required': True}, {'name': 'currency', 'type': 'str', 'required': True, 'default': '"KES"'}, {'name': 'is_active', 'type': 'bool', 'required': True, 'default': 'true'}, {'name': 'is_control', 'type': 'bool', 'required': True, 'default': 'false'}, {'name': 'normal_balance', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'JournalEntry', 'type': 'entity', 'properties': ['journal_id', 'reference', 'period', 'entry_date', 'description', 'status', 'total_debit', 'total_credit', 'posted_by', 'posted_at'], 'fields': [{'name': 'journal_id', 'type': 'str', 'required': True}, {'name': 'reference', 'type': 'str', 'required': True}, {'name': 'period', 'type': 'str', 'required': True}, {'name': 'entry_date', 'type': 'date', 'required': True}, {'name': 'description', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"draft"'}, {'name': 'total_debit', 'type': 'decimal', 'required': True, 'default': '0.0'}, {'name': 'total_credit', 'type': 'decimal', 'required': True, 'default': '0.0'}, {'name': 'posted_by', 'type': 'str?', 'required': True}, {'name': 'posted_at', 'type': 'datetime?', 'required': True}], 'methods': []}, {'name': 'JournalLine', 'type': 'entity', 'properties': ['line_id', 'journal_id', 'account_code', 'debit', 'credit', 'cost_centre', 'project', 'memo'], 'fields': [{'name': 'line_id', 'type': 'str', 'required': True}, {'name': 'journal_id', 'type': 'str', 'required': True}, {'name': 'account_code', 'type': 'str', 'required': True}, {'name': 'debit', 'type': 'decimal', 'required': True, 'default': '0.0'}, {'name': 'credit', 'type': 'decimal', 'required': True, 'default': '0.0'}, {'name': 'cost_centre', 'type': 'str?', 'required': True}, {'name': 'project', 'type': 'str?', 'required': True}, {'name': 'memo', 'type': 'str?', 'required': True}], 'methods': []}, {'name': 'GeneralLedger', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'FinanceGL', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
