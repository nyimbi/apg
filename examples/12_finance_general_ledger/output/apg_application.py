...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'FinanceGL': {'description': 'General ledger financial application', 'capabilities': ['GeneralLedger'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/gl'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
