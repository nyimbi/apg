...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'MultiRuntimeApp': {'description': 'Multi-runtime agent platform with model diversity', 'capabilities': [], 'agents': ['ConversationalAgent', 'OpenSourceCoder'], 'agent_teams': ['AnalyticsCrew'], 'components': {}, 'screens': {}, 'routes': ['/analytics', '/conversations', '/codegen'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
