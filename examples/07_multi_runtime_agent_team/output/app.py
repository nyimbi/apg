"""
agent_runtime_portfolio - APG Python Application
================================================
...
MODULE_NAME = 'agent_runtime_portfolio'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = 'Agent team that can route work across several AI runtimes'
ENTITIES = [{'name': 'Researcher', 'type': 'ai_agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'Coder', 'type': 'ai_agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'LocalReviewer', 'type': 'ai_agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'DeliverySwarm', 'type': 'agent_team', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['agent_runtime_portfolio.apg'], 'app': {'name': 'agent_runtime_portfolio', 'version': '1.0.0', 'description': 'Agent team that can route work across several AI runtimes', 'entity_count': 4}, 'symbols': {'module.agent_runtime_portfolio': {'id': 'module.agent_runtime_portfolio', 'kind': 'module', 'name': 'agent_runtime_portfolio', 'file': 'agent_runtime_portfolio.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'agent.Researcher': {'id': 'agent.Researcher', 'kind': 'agent', 'name': 'Researcher', 'file': 'agent_runtime_portfolio.apg', 'range': {'start': {'line': 8, 'character': 0}, 'end': {'line': 8, 'character': 1}}, 'references': []}, 'llm.openai:gpt-4.1-mini': {'id': 'llm.openai:gpt-4.1-mini', 'kind': 'llm', 'name': 'openai:gpt-4.1-mini', 'file': 'agent_runtime_portfolio.apg', 'range': {'start': {'line': 8, 'character': 0}, 'end': {'line': 8, 'character': 1}}, 'references': []}, 'agent.Coder': {'id': 'agent.Coder', 'kind': 'agent', 'name': 'Coder', 'file': 'agent_runtime_portfolio.apg', 'range': {'start': {'line': 16, 'character': 0}, 'end': {'line': 16, 'character': 1}}, 'references': []}, 'llm.claude:sonnet': {'id': 'llm.claude:sonnet', 'kind': 'llm', 'name': 'claude:sonnet', 'file': 'agent_runtime_portfolio.apg', 'range': {'start': {'line': 16, 'character': 0}, 'end': {'line': 16, 'character': 1}}, 'references': []}, 'agent.LocalReviewer': {'id': 'agent.LocalReviewer', 'kind': 'agent', 'name': 'LocalReviewer', 'file': 'agent_runtime_portfolio.apg', 'range': {'start': {'line': 24, 'character': 0}, 'end': {'line': 24, 'character': 1}}, 'references': []}, 'llm.ollama:llama3.1': {'id': 'llm.ollama:llama3.1', 'kind': 'llm', 'name': 'ollama:llama3.1', 'file': 'agent_runtime_portfolio.apg', 'range': {'start': {'line': 24, 'character': 0}, 'end': {'line': 24, 'character': 1}}, 'references': []}, 'composition.DeliverySwarm': {'id': 'composition.DeliverySwarm', 'kind': 'composition', 'name': 'DeliverySwarm', 'file': 'agent_runtime_portfolio.apg', 'range': {'start': {'line': 31, 'character': 0}, 'end': {'line': 31, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {'Researcher': {'name': 'Researcher', 'role': 'researcher', 'model': 'openai:gpt-4.1-mini', 'runtime': 'codex', 'system': 'Gather structured evidence and cite source IDs.', 'capabilities': [], 'tools': ['web.search', 'docs.read'], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {}, 'rules': [], 'ui': {}, 'theme': {}}, 'Coder': {'name': 'Coder', 'role': 'implementation_engineer', 'model': 'claude:sonnet', 'runtime': 'claude_code', 'system': 'Implement focused code changes from accepted plans.', 'capabilities': [], 'tools': ['repo.edit', 'tests.run'], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {}, 'rules': [], 'ui': {}, 'theme': {}}, 'LocalReviewer': {'name': 'LocalReviewer', 'role': 'local_review', 'model': 'ollama:llama3.1', 'runtime': 'ollama', 'system': 'Review diffs locally without sending code to external services.', 'capabilities': [], 'tools': [], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {}, 'rules': [], 'ui': {}, 'theme': {}}}, 'llms': {'Researcher': {'model': 'openai:gpt-4.1-mini', 'runtime': 'codex'}, 'Coder': {'model': 'claude:sonnet', 'runtime': 'claude_code'}, 'LocalReviewer': {'model': 'ollama:llama3.1', 'runtime': 'ollama'}}, 'capabilities': {}, 'composition': {'applications': {}, 'agent_teams': {'DeliverySwarm': {'agents': ['Researcher', 'Coder', 'LocalReviewer'], 'flow': [{'from': 'Researcher', 'to': 'Coder', 'condition': 'done'}, {'from': 'Coder', 'to': 'LocalReviewer', 'condition': 'done'}], 'capabilities': [], 'configuration': {'handoff_mode': 'sequential', 'fallback_runtime': 'opencode'}, 'rules': [{'name': 'local_review_required', 'when': 'code_changed', 'action': 'require_review'}], 'ui': {}, 'theme': {}}}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'agent_runtime_portfolio.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 5, 'edges': 4}, 'workflow': {'kind': 'workflow', 'nodes': 5, 'edges': 4}, 'handler': {'kind': 'handler', 'nodes': 5, 'edges': 4}, 'capability': {'kind': 'capability', 'nodes': 0, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 5, 'edges': 4}, 'agent': {'kind': 'agent', 'nodes': 4, 'edges': 3}, 'deployment': {'kind': 'deployment', 'nodes': 5, 'edges': 4}, 'package': {'kind': 'package', 'nodes': 5, 'edges': 4}}, 'diagnostics': []}
