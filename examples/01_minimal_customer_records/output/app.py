...
ENTITIES = [{'name': 'Customer', 'type': 'entity', 'properties': ['customer_number', 'legal_name', 'email', 'phone', 'secondary_email', 'company_name', 'credit_limit', 'loyalty_points', 'discount_rate', 'is_active', 'is_verified', 'registered_at', 'date_of_birth', 'tags', 'preferences', 'status', 'metadata'], 'fields': [{'name': 'customer_number', 'type': 'str', 'required': True}, {'name': 'legal_name', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str', 'required': True}, {'name': 'secondary_email', 'type': 'str?', 'required': True}, {'name': 'company_name', 'type': 'str | None', 'required': True}, {'name': 'credit_limit', 'type': 'decimal', 'required': True, 'default': '50000.0'}, {'name': 'loyalty_points', 'type': 'int', 'required': True, 'default': '0'}, {'name': 'discount_rate', 'type': 'float', 'required': True, 'default': '0.0'}, {'name': 'is_active', 'type': 'bool', 'required': True, 'default': 'true'}, {'name': 'is_verified', 'type': 'bool', 'required': True, 'default': 'false'}, {'name': 'registered_at', 'type': 'datetime', 'required': True}, {'name': 'date_of_birth', 'type': 'date?', 'required': True}, {'name': 'tags', 'type': 'List', 'required': True}, {'name': 'preferences', 'type': 'Dict', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"prospect"'}, {'name': 'metadata', 'type': 'Dict', 'required': True}], 'methods': []}, {'name': 'CustomerRecords', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
