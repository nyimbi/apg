"""
customer_records - APG Python Application
=========================================
...
MODULE_NAME = 'customer_records'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
LANDING_STYLE = 'default'
ENTITIES = [{'name': 'Customer', 'type': 'entity', 'properties': ['customer_number', 'legal_name', 'email', 'phone', 'secondary_email', 'company_name', 'credit_limit', 'loyalty_points', 'discount_rate', 'is_active', 'is_verified', 'registered_at', 'date_of_birth', 'tags', 'preferences', 'status', 'metadata'], 'fields': [{'name': 'customer_number', 'type': 'str', 'required': True}, {'name': 'legal_name', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str', 'required': True}, {'name': 'secondary_email', 'type': 'str?', 'required': True}, {'name': 'company_name', 'type': 'str | None', 'required': True}, {'name': 'credit_limit', 'type': 'decimal', 'required': False, 'default': '50000.0'}, {'name': 'loyalty_points', 'type': 'int', 'required': False, 'default': '0'}, {'name': 'discount_rate', 'type': 'float', 'required': False, 'default': '0.0'}, {'name': 'is_active', 'type': 'bool', 'required': False, 'default': 'true'}, {'name': 'is_verified', 'type': 'bool', 'required': False, 'default': 'false'}, {'name': 'registered_at', 'type': 'datetime', 'required': True}, {'name': 'date_of_birth', 'type': 'date?', 'required': True}, {'name': 'tags', 'type': 'List', 'required': True}, {'name': 'preferences', 'type': 'Dict', 'required': True}, {'name': 'status', 'type': 'str', 'required': False, 'default': '"prospect"'}, {'name': 'metadata', 'type': 'Dict', 'required': True}], 'methods': []}, {'name': 'CustomerRecords', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['customer_records.apg'], 'app': {'name': 'customer_records', 'version': '1.0.0', 'description': None, 'entity_count': 2}, 'symbols': {'module.customer_records': {'id': 'module.customer_records', 'kind': 'module', 'name': 'customer_records', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Customer': {'id': 'table.Customer', 'kind': 'table', 'name': 'Customer', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.customer_number': {'id': 'field.Customer.customer_number', 'kind': 'field', 'name': 'Customer.customer_number', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.legal_name': {'id': 'field.Customer.legal_name', 'kind': 'field', 'name': 'Customer.legal_name', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.email': {'id': 'field.Customer.email', 'kind': 'field', 'name': 'Customer.email', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.phone': {'id': 'field.Customer.phone', 'kind': 'field', 'name': 'Customer.phone', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.secondary_email': {'id': 'field.Customer.secondary_email', 'kind': 'field', 'name': 'Customer.secondary_email', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.company_name': {'id': 'field.Customer.company_name', 'kind': 'field', 'name': 'Customer.company_name', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.credit_limit': {'id': 'field.Customer.credit_limit', 'kind': 'field', 'name': 'Customer.credit_limit', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.loyalty_points': {'id': 'field.Customer.loyalty_points', 'kind': 'field', 'name': 'Customer.loyalty_points', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.discount_rate': {'id': 'field.Customer.discount_rate', 'kind': 'field', 'name': 'Customer.discount_rate', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.is_active': {'id': 'field.Customer.is_active', 'kind': 'field', 'name': 'Customer.is_active', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.is_verified': {'id': 'field.Customer.is_verified', 'kind': 'field', 'name': 'Customer.is_verified', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.registered_at': {'id': 'field.Customer.registered_at', 'kind': 'field', 'name': 'Customer.registered_at', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.date_of_birth': {'id': 'field.Customer.date_of_birth', 'kind': 'field', 'name': 'Customer.date_of_birth', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.tags': {'id': 'field.Customer.tags', 'kind': 'field', 'name': 'Customer.tags', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.preferences': {'id': 'field.Customer.preferences', 'kind': 'field', 'name': 'Customer.preferences', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.status': {'id': 'field.Customer.status', 'kind': 'field', 'name': 'Customer.status', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.metadata': {'id': 'field.Customer.metadata', 'kind': 'field', 'name': 'Customer.metadata', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.CustomerRecords': {'id': 'app.CustomerRecords', 'kind': 'app', 'name': 'CustomerRecords', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'Customer': {'name': 'Customer', 'fields': {'customer_number': {'type': 'str', 'required': True, 'relationship': None}, 'legal_name': {'type': 'str', 'required': True, 'relationship': None}, 'email': {'type': 'str', 'required': True, 'relationship': None}, 'phone': {'type': 'str', 'required': True, 'relationship': None}, 'secondary_email': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'company_name': {'type': 'str | None', 'required': True, 'relationship': {'target_table': 'str | None', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'credit_limit': {'type': 'decimal', 'required': False, 'relationship': {'target_table': 'decimal', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'loyalty_points': {'type': 'int', 'required': False, 'relationship': None}, 'discount_rate': {'type': 'float', 'required': False, 'relationship': None}, 'is_active': {'type': 'bool', 'required': False, 'relationship': None}, 'is_verified': {'type': 'bool', 'required': False, 'relationship': None}, 'registered_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'date_of_birth': {'type': 'date?', 'required': True, 'relationship': {'target_table': 'date?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'tags': {'type': 'List', 'required': True, 'relationship': {'target_table': 'List', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'preferences': {'type': 'Dict', 'required': True, 'relationship': {'target_table': 'Dict', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'status': {'type': 'str', 'required': False, 'relationship': None}, 'metadata': {'type': 'Dict', 'required': True, 'relationship': {'target_table': 'Dict', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'secondary_email.id': {'chain': ['Customer.secondary_email', 'str?.id'], 'valid': True}, 'company_name.id': {'chain': ['Customer.company_name', 'str | None.id'], 'valid': True}, 'credit_limit.id': {'chain': ['Customer.credit_limit', 'decimal.id'], 'valid': True}, 'registered_at.id': {'chain': ['Customer.registered_at', 'datetime.id'], 'valid': True}, 'date_of_birth.id': {'chain': ['Customer.date_of_birth', 'date?.id'], 'valid': True}, 'tags.id': {'chain': ['Customer.tags', 'List.id'], 'valid': True}, 'preferences.id': {'chain': ['Customer.preferences', 'Dict.id'], 'valid': True}, 'metadata.id': {'chain': ['Customer.metadata', 'Dict.id'], 'valid': True}}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {'CustomerRecords': {'name': 'CustomerRecords', 'description': 'Customer records application', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/customers'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'customer_records.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 18, 'edges': 17}, 'lookup': {'kind': 'lookup', 'nodes': 3, 'edges': 2}, 'workflow': {'kind': 'workflow', 'nodes': 3, 'edges': 2}, 'handler': {'kind': 'handler', 'nodes': 3, 'edges': 2}, 'capability': {'kind': 'capability', 'nodes': 1, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 3, 'edges': 2}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 3, 'edges': 2}, 'package': {'kind': 'package', 'nodes': 3, 'edges': 2}}, 'diagnostics': []}
