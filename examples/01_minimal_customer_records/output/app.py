...
ENTITIES = [{'name': 'Customer', 'type': 'entity', 'properties': ['name', 'email'], 'fields': [{'name': 'name', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}], 'methods': []}]
...
NEXT_EVENT_ID = 1
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['customer_records.apg'], 'app': {'name': 'customer_records', 'version': '1.0.0', 'description': None, 'entity_count': 1}, 'symbols': {'module.customer_records': {'id': 'module.customer_records', 'kind': 'module', 'name': 'customer_records', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Customer': {'id': 'table.Customer', 'kind': 'table', 'name': 'Customer', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.name': {'id': 'field.Customer.name', 'kind': 'field', 'name': 'Customer.name', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Customer.email': {'id': 'field.Customer.email', 'kind': 'field', 'name': 'Customer.email', 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'Customer': {'name': 'Customer', 'fields': {'name': {'type': 'str', 'required': True, 'relationship': None}, 'email': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'customer_records.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 3, 'edges': 2}, 'lookup': {'kind': 'lookup', 'nodes': 2, 'edges': 1}, 'workflow': {'kind': 'workflow', 'nodes': 2, 'edges': 1}, 'handler': {'kind': 'handler', 'nodes': 2, 'edges': 1}, 'capability': {'kind': 'capability', 'nodes': 0, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 2, 'edges': 1}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 2, 'edges': 1}, 'package': {'kind': 'package', 'nodes': 2, 'edges': 1}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'name' appears to be unused", 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Property 'email' appears to be unused", 'file': 'customer_records.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
