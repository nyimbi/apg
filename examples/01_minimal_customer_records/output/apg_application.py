...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'CustomerRecords': {'description': 'Customer records application', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/customers'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
