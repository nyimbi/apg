...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'OperationsWorkbenchApp': {'description': 'Operations management workbench', 'capabilities': ['OperationsWorkbench'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/ops'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
