...
CAPABILITY_DATA: Dict[str, Dict[str, Any]] = {'OperationsWorkbench': {'contract': {'id': 'operations_workbench', 'provides': ['operations_ui'], 'configuration': {'tenant_scoped': True}, 'ui': {'shell': 'python'}, 'theme': {'name': 'ops_theme', 'tokens': {'accent': '#345995'}}}, 'provides': ['operations_ui'], 'requires': [], 'configuration': {'tenant_scoped': True}, 'rules': [], 'rule_engine': {}, 'ui': {'shell': 'python'}, 'theme': {'name': 'ops_theme', 'tokens': {'accent': '#345995'}}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {}, 'screens': {'Dashboard': {'route': '/ops', 'title': 'Operations Dashboard', 'layout': 'dashboard', 'contains': ['KpiStrip', 'ApprovalQueue'], 'composes': ['LedgerTable'], 'binds': ['ledger.entries'], 'actions': ['approve', 'reject'], 'events': [{'on': 'select', 'do': 'filter', 'target': 'LedgerTable'}], 'relationships': [{'from': 'KpiStrip', 'to': 'LedgerTable', 'via': 'filters'}, 'ApprovalQueue -> LedgerTable']}}}}
