"""
screen_composition - APG Python Application
===========================================
...
MODULE_NAME = 'screen_composition'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'OperationsWorkbench', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['screen_composition.apg'], 'app': {'name': 'screen_composition', 'version': '1.0.0', 'description': None, 'entity_count': 1}, 'symbols': {'module.screen_composition': {'id': 'module.screen_composition', 'kind': 'module', 'name': 'screen_composition', 'file': 'screen_composition.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.OperationsWorkbench': {'id': 'capability.OperationsWorkbench', 'kind': 'capability', 'name': 'OperationsWorkbench', 'file': 'screen_composition.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {'OperationsWorkbench': {'name': 'OperationsWorkbench', 'provides': ['operations_ui'], 'requires': [], 'configuration': {'tenant_scoped': True}, 'rules': [], 'rule_engine': {}, 'ui': {'shell': 'python'}, 'theme': {'name': 'ops_theme', 'tokens': {'accent': '#345995'}}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {}, 'screens': {'Dashboard': {'route': '/ops', 'title': 'Operations Dashboard', 'layout': 'dashboard', 'contains': ['KpiStrip', 'ApprovalQueue'], 'composes': ['LedgerTable'], 'binds': ['ledger.entries'], 'actions': ['approve', 'reject'], 'events': [{'on': 'select', 'do': 'filter', 'target': 'LedgerTable'}], 'relationships': [{'from': 'KpiStrip', 'to': 'LedgerTable', 'via': 'filters'}, 'ApprovalQueue -> LedgerTable']}}}}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {'OperationsWorkbench': []}}, 'contracts': {'OperationsWorkbench': {'id': 'operations_workbench', 'provides': ['operations_ui'], 'configuration': {'tenant_scoped': True}, 'ui': {'shell': 'python'}, 'theme': {'name': 'ops_theme', 'tokens': {'accent': '#345995'}}}}, 'deployment': {'target': 'python', 'source': 'screen_composition.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 2, 'edges': 1}, 'workflow': {'kind': 'workflow', 'nodes': 2, 'edges': 1}, 'handler': {'kind': 'handler', 'nodes': 2, 'edges': 1}, 'capability': {'kind': 'capability', 'nodes': 1, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 2, 'edges': 1}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 2, 'edges': 1}, 'package': {'kind': 'package', 'nodes': 2, 'edges': 1}}, 'diagnostics': []}
