...
AI_AGENT_DATA: Dict[str, Dict[str, Any]] = {'Planner': {'role': 'planner', 'model': 'openai:gpt-4.1-mini', 'runtime': 'codex', 'system': 'Break the ticket into concrete resolution steps.', 'capabilities': [], 'tools': ['tickets.read', 'docs.search'], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {}, 'rules': [], 'ui': {}, 'theme': {}}, 'Writer': {'role': 'writer', 'model': 'openai:gpt-4.1-mini', 'runtime': 'codex', 'system': 'Write concise customer-facing replies from a plan.', 'capabilities': [], 'tools': ['tickets.update'], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {}, 'rules': [], 'ui': {}, 'theme': {}}}
AI_TEAM_DATA: Dict[str, Dict[str, Any]] = {'SupportCrew': {'agents': ['Planner', 'Writer'], 'capabilities': [], 'flow': [{'source': 'Planner', 'target': 'Writer', 'condition': 'done'}], 'policy': {}, 'configuration': {'handoff_mode': 'sequential'}, 'rules': [{'name': 'low_confidence', 'when': 'confidence < 0.6', 'action': 'human_review'}], 'ui': {}, 'theme': {}}}
