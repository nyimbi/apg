...
AI_AGENT_DATA: Dict[str, Dict[str, Any]] = {'Planner': {'role': 'support planner', 'model': 'openai:gpt-4.1-mini', 'runtime': None, 'system': "Break the customer's support request into a concrete resolution plan.", 'capabilities': [], 'tools': ['tickets.read', 'docs.search', 'product.lookup'], 'memory': {'kind': 'vector', 'name': 'planner_memory'}, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {'temperature': 0.1, 'max_turns': 5}, 'rules': [], 'ui': {}, 'theme': {}}, 'Writer': {'role': 'support writer', 'model': 'openai:gpt-4.1-mini', 'runtime': None, 'system': 'Write concise, empathetic customer-facing replies based on the resolution plan.', 'capabilities': [], 'tools': ['tickets.update', 'templates.fetch'], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {'temperature': 0.3, 'max_turns': 4}, 'rules': [], 'ui': {}, 'theme': {}}, 'Reviewer': {'role': 'quality reviewer', 'model': 'openai:gpt-4.1-mini', 'runtime': None, 'system': 'Review the draft reply for accuracy, tone, and completeness. Flag any issues.', 'capabilities': [], 'tools': ['knowledge.verify', 'compliance.check'], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {'temperature': 0.0, 'max_turns': 3}, 'rules': [], 'ui': {}, 'theme': {}}}
