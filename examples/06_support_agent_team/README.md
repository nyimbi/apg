...
Composes two agents into a sequential support crew.

## What This Example Demonstrates

- Planner and writer agents
- Team flow
- Team configuration and review rule
...
```bash
apg compile examples/06_support_agent_team/main.apg --output examples/06_support_agent_team/output
```

Equivalent direct Python invocation from this repository:

```bash
.venv/bin/python -m cli.main compile examples/06_support_agent_team/main.apg --output examples/06_support_agent_team/output
```

## Run Generated App

```bash
cd examples/06_support_agent_team/output
