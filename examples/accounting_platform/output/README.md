...
- `AccountingAssistant` - runtime `local`, invoke with `POST /agents/AccountingAssistant/invoke`
...
- `AccountingCore` - provides journal_entry_lifecycle, accounts_receivable_workflow, accounts_payable_workflow, cash_management_workflow, financial_statements, period_close_process
