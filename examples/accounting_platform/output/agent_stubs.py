...
class AccountingAssistant(AgentBase):
    name = 'AccountingAssistant'
    role = 'accounting analyst'
    model = 'openai:gpt-4.1-mini'
    runtime = 'codex'
    system = 'You are a chartered accountant assistant. Help with journal classification, anomaly detection, and c'
