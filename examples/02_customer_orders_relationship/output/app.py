...
ENTITIES = [{'name': 'Customer', 'type': 'entity', 'properties': ['customer_number', 'legal_name', 'email', 'phone', 'segment', 'credit_limit', 'is_active', 'tags', 'attributes'], 'fields': [{'name': 'customer_number', 'type': 'str', 'required': True}, {'name': 'legal_name', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str?', 'required': True}, {'name': 'segment', 'type': 'str', 'required': True, 'default': '"standard"'}, {'name': 'credit_limit', 'type': 'decimal', 'required': True, 'default': '10000.0'}, {'name': 'is_active', 'type': 'bool', 'required': True, 'default': 'true'}, {'name': 'tags', 'type': 'List', 'required': True}, {'name': 'attributes', 'type': 'Dict', 'required': True}], 'methods': []}, {'name': 'Order', 'type': 'entity', 'properties': ['order_number', 'customer_id', 'order_date', 'delivery_date', 'status', 'currency', 'subtotal', 'tax', 'total', 'notes', 'line_items', 'metadata'], 'fields': [{'name': 'order_number', 'type': 'str', 'required': True}, {'name': 'customer_id', 'type': 'str', 'required': True}, {'name': 'order_date', 'type': 'date', 'required': True}, {'name': 'delivery_date', 'type': 'date?', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"draft"'}, {'name': 'currency', 'type': 'str', 'required': True, 'default': '"KES"'}, {'name': 'subtotal', 'type': 'decimal', 'required': True, 'default': '0.0'}, {'name': 'tax', 'type': 'decimal', 'required': True, 'default': '0.0'}, {'name': 'total', 'type': 'decimal', 'required': True, 'default': '0.0'}, {'name': 'notes', 'type': 'str | None', 'required': True}, {'name': 'line_items', 'type': 'List', 'required': True}, {'name': 'metadata', 'type': 'Dict', 'required': True}], 'methods': []}, {'name': 'OrderLine', 'type': 'entity', 'properties': ['line_id', 'order_id', 'product_code', 'description', 'quantity', 'unit_price', 'discount_pct', 'line_total', 'is_taxable'], 'fields': [{'name': 'line_id', 'type': 'str', 'required': True}, {'name': 'order_id', 'type': 'str', 'required': True}, {'name': 'product_code', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str', 'required': True}, {'name': 'quantity', 'type': 'int', 'required': True, 'default': '1'}, {'name': 'unit_price', 'type': 'decimal', 'required': True}, {'name': 'discount_pct', 'type': 'float', 'required': True, 'default': '0.0'}, {'name': 'line_total', 'type': 'decimal', 'required': True, 'default': '0.0'}, {'name': 'is_taxable', 'type': 'bool', 'required': True, 'default': 'true'}], 'methods': []}, {'name': 'CustomerOrders', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
