...
def test_crud_customer(generated_app_client):
	payload = {'customer_number': 'Customer Wave K Needle', 'legal_name': 'sample legal_name', 'email': 'sample email', 'phone': 'sample phone', 'segment': 'sample segment', 'credit_limit': 7.5, 'is_active': True, 'tags': [], 'attributes': {}}
