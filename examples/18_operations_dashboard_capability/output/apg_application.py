...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'OperationsDashboardApp': {'description': 'Operations centre with all layout types', 'capabilities': ['OperationsDashboard'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/ops'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
