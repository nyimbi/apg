"""
operations_dashboard_capability - APG Python Application
========================================================
...
MODULE_NAME = 'operations_dashboard_capability'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'OperationsDashboard', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['operations_dashboard_capability.apg'], 'app': {'name': 'operations_dashboard_capability', 'version': '1.0.0', 'description': None, 'entity_count': 1}, 'symbols': {'module.operations_dashboard_capability': {'id': 'module.operations_dashboard_capability', 'kind': 'module', 'name': 'operations_dashboard_capability', 'file': 'operations_dashboard_capability.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.OperationsDashboard': {'id': 'capability.OperationsDashboard', 'kind': 'capability', 'name': 'OperationsDashboard', 'file': 'operations_dashboard_capability.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {'OperationsDashboard.critical_exception_review': {'name': 'critical_exception_review', 'when': 'severity == critical', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'severity', 'op': '==', 'value': 'critical'}}, 'OperationsDashboard.stale_metric_warning': {'name': 'stale_metric_warning', 'when': 'metric_age_minutes > 15', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'metric_age_minutes', 'op': '>', 'value': 15}}}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {'OperationsDashboard': {'name': 'OperationsDashboard', 'provides': ['executive_kpis', 'exception_queue', 'operations_scorecards'], 'requires': ['journal_entries', 'stock_balances', 'production_oee', 'forecast_metrics'], 'configuration': {'refresh_seconds': 30, 'tenant_scoped': True}, 'rules': [{'name': 'critical_exception_review', 'when': 'severity == critical', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'severity', 'op': '==', 'value': 'critical'}}, {'name': 'stale_metric_warning', 'when': 'metric_age_minutes > 15', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'metric_age_minutes', 'op': '>', 'value': 15}}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Operations', 'path': '/ops/dashboard', 'component': 'OpsDashboard'}]}, 'theme': {'name': 'executive_theme', 'tokens': {'accent': '#1A365D', 'surface': '#F7FAFC'}}, 'runtime': {}, 'erp_modules': ['finance', 'inventory', 'manufacturing', 'sales', 'hr'], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {'processor': 'bytewax', 'state': 'operations_dashboard_state'}, 'screens': {'ExecutiveDashboard': {'route': '/ops/executive', 'layout': 'dashboard', 'contains': ['FinanceKpis', 'InventoryKpis', 'ProductionKpis', 'SalesKpis'], 'composes': ['ExceptionQueue'], 'binds': ['executive_kpis.current'], 'relationships': ['FinanceKpis -> ExceptionQueue', 'InventoryKpis -> ExceptionQueue', 'ProductionKpis -> ExceptionQueue', 'SalesKpis -> ExceptionQueue']}}}}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {'OperationsDashboard': ['journal_entries', 'stock_balances', 'production_oee', 'forecast_metrics']}}, 'contracts': {'OperationsDashboard': {'id': 'operations_dashboard', 'provides': ['executive_kpis', 'exception_queue', 'operations_scorecards'], 'requires': ['journal_entries', 'stock_balances', 'production_oee', 'forecast_metrics'], 'configuration': {'refresh_seconds': 30, 'tenant_scoped': True}, 'rules': [{'name': 'critical_exception_review', 'when': 'severity == critical', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'severity', 'op': '==', 'value': 'critical'}}, {'name': 'stale_metric_warning', 'when': 'metric_age_minutes > 15', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'metric_age_minutes', 'op': '>', 'value': 15}}], 'ui': {'shell': 'python', 'routes': [{'name': 'Operations', 'path': '/ops/dashboard', 'component': 'OpsDashboard'}]}, 'theme': {'name': 'executive_theme', 'tokens': {'accent': '#1A365D', 'surface': '#F7FAFC'}}}}, 'deployment': {'target': 'python', 'source': 'operations_dashboard_capability.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 2, 'edges': 1}, 'workflow': {'kind': 'workflow', 'nodes': 2, 'edges': 1}, 'handler': {'kind': 'handler', 'nodes': 2, 'edges': 1}, 'capability': {'kind': 'capability', 'nodes': 5, 'edges': 4}, 'security': {'kind': 'security', 'nodes': 2, 'edges': 1}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 2, 'edges': 1}, 'package': {'kind': 'package', 'nodes': 2, 'edges': 1}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Capability 'OperationsDashboard' requires 'journal_entries' which is not declared in this module", 'file': 'operations_dashboard_capability.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Capability 'OperationsDashboard' requires 'stock_balances' which is not declared in this module", 'file': 'operations_dashboard_capability.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Capability 'OperationsDashboard' requires 'production_oee' which is not declared in this module", 'file': 'operations_dashboard_capability.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Capability 'OperationsDashboard' requires 'forecast_metrics' which is not declared in this module", 'file': 'operations_dashboard_capability.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
