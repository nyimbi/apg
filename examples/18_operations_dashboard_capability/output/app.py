"""
operations_dashboard - APG Python Application
=============================================
...
MODULE_NAME = 'operations_dashboard'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
LANDING_STYLE = 'default'
ENTITIES = [{'name': 'OperationsDashboard', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'OperationsDashboardApp', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['operations_dashboard.apg'], 'app': {'name': 'operations_dashboard', 'version': '1.0.0', 'description': None, 'entity_count': 2}, 'symbols': {'module.operations_dashboard': {'id': 'module.operations_dashboard', 'kind': 'module', 'name': 'operations_dashboard', 'file': 'operations_dashboard.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.OperationsDashboard': {'id': 'capability.OperationsDashboard', 'kind': 'capability', 'name': 'OperationsDashboard', 'file': 'operations_dashboard.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.OperationsDashboardApp': {'id': 'app.OperationsDashboardApp', 'kind': 'app', 'name': 'OperationsDashboardApp', 'file': 'operations_dashboard.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {'OperationsDashboard': {'name': 'OperationsDashboard', 'provides': ['operations_ui', 'kpi_views', 'approval_interfaces'], 'requires': [], 'configuration': {'tenant_id': 'default'}, 'rules': [], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Home', 'path': '/ops', 'component': 'OpsDashboard', 'permission': 'ops:view'}, {'name': 'Approvals', 'path': '/ops/approvals', 'component': 'Approvals', 'permission': 'ops:approve'}]}, 'theme': {'name': 'ops_theme', 'tokens': {'accent': '#1565C0'}}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {'processor': 'bytewax', 'input': 'operations_event_bus', 'output': 'operations_alerts', 'state': 'ops_state', 'window': '10min'}, 'screens': {'MainDashboard': {'route': '/ops', 'title': 'Operations Centre', 'layout': 'dashboard', 'contains': ['RevenueKpi', 'CostKpi', 'MarginKpi', 'AlertBanner'], 'composes': ['LedgerSummary'], 'binds': ['kpis.daily', 'alerts.active', 'ledger.summary'], 'actions': ['refresh', 'export', 'drill_down'], 'events': [{'on': 'click', 'do': 'navigate', 'target': 'LedgerSummary'}], 'relationships': ['RevenueKpi -> LedgerSummary', 'AlertBanner -> LedgerSummary']}, 'KpiGrid': {'route': '/ops/kpis', 'title': 'KPI Grid', 'layout': 'grid', 'contains': ['SalesKpi', 'InventoryKpi', 'PayrollKpi', 'ComplianceKpi'], 'binds': ['kpis.all'], 'actions': ['compare', 'export', 'date_range']}, 'ReportsTabs': {'route': '/ops/reports', 'title': 'Reports', 'layout': 'tabs', 'contains': ['FinancialReports', 'OperationalReports', 'ComplianceReports'], 'binds': ['reports.all'], 'actions': ['download', 'schedule', 'share']}, 'ApprovalSplit': {'route': '/ops/approvals', 'title': 'Approvals', 'layout': 'split', 'contains': ['ApprovalList', 'ApprovalDetail'], 'binds': ['approvals.pending'], 'actions': ['approve', 'reject', 'request_changes'], 'relationships': ['ApprovalList -> ApprovalDetail']}, 'ActivityStack': {'route': '/ops/activity', 'title': 'Activity Feed', 'layout': 'stack', 'contains': ['ActivityItem'], 'binds': ['activity.recent'], 'actions': ['load_more', 'filter', 'mark_read']}, 'PeriodCloseWizard': {'route': '/ops/period-close', 'title': 'Period Close', 'layout': 'wizard', 'contains': ['ReconciliationStep', 'ReviewStep', 'ApprovalStep', 'CloseStep'], 'binds': ['period.status'], 'actions': ['next', 'previous', 'save_progress']}, 'ConfigurationForm': {'route': '/ops/config', 'title': 'Configuration', 'layout': 'form', 'contains': ['GeneralSettings', 'NotificationSettings', 'IntegrationSettings'], 'binds': ['config.current'], 'actions': ['save', 'reset', 'test_connection']}}}}, 'composition': {'applications': {'OperationsDashboardApp': {'name': 'OperationsDashboardApp', 'description': 'Operations centre with all layout types', 'capabilities': ['OperationsDashboard'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/ops'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {'OperationsDashboard': []}}, 'contracts': {'OperationsDashboard': {'id': 'operations_dashboard', 'provides': ['operations_ui', 'kpi_views', 'approval_interfaces'], 'configuration': {'tenant_id': 'default'}, 'ui': {'shell': 'python', 'routes': [{'name': 'Home', 'path': '/ops', 'component': 'OpsDashboard', 'permission': 'ops:view'}, {'name': 'Approvals', 'path': '/ops/approvals', 'component': 'Approvals', 'permission': 'ops:approve'}]}, 'theme': {'name': 'ops_theme', 'tokens': {'accent': '#1565C0'}}}}, 'deployment': {'target': 'python', 'source': 'operations_dashboard.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 3, 'edges': 2}, 'workflow': {'kind': 'workflow', 'nodes': 3, 'edges': 2}, 'handler': {'kind': 'handler', 'nodes': 3, 'edges': 2}, 'capability': {'kind': 'capability', 'nodes': 2, 'edges': 1}, 'security': {'kind': 'security', 'nodes': 3, 'edges': 2}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 3, 'edges': 2}, 'package': {'kind': 'package', 'nodes': 3, 'edges': 2}}, 'diagnostics': []}
