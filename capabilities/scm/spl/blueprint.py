"""
Scm Spl — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "scm_spl")
		return {"success": True, "capability_id": "scm_spl"}
	except Exception as exc:
		_log.error("Blueprint registration failed for scm_spl: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "scm_spl"}
