...
Complete supply chain and logistics management including procurement,
inventory management, warehouse operations, and supplier relationships.
"""
...
CAPABILITY_INFO = {
	...
	'description': 'Complete supply chain management with procurement, inventory, and logistics',
	'version': '1.0.0',
	'category': 'ERP Core',
	'status': 'Active',
	'dependencies': [
	...
	'subcapabilities': [
		# Procurement modules
		{'code': 'req', 'name': 'Requisitioning', 'description': 'Employee requisition management and approval workflows'},
		{'code': 'pom', 'name': 'Purchase Order Management', 'description': 'PO creation, tracking, receiving, and three-way matching'},
		{'code': 'ven', 'name': 'Vendor Management', 'description': 'Vendor master data, performance tracking, and relationships'},
		{'code': 'src', 'name': 'Sourcing & Supplier Selection', 'description': 'Supplier evaluation, RFQ/RFP processes, and selection'},
		{'code': 'ctm', 'name': 'Contract Management', 'description': 'Contract lifecycle, terms, compliance, and renewals'},
		# Inventory modules
		{'code': 'inv', 'name': 'Inventory Management', 'description': 'Stock tracking, control, and optimization'},
		{'code': 'wms', 'name': 'Warehouse Management', 'description': 'Warehouse operations, picking, and storage'},
		{'code': 'blt', 'name': 'Batch/Lot Tracking', 'description': 'Batch and lot number tracking for traceability'},
		{'code': 'dpl', 'name': 'Demand Planning', 'description': 'Demand forecasting and planning'},
		{'code': 'rep', 'name': 'Replenishment & Reordering', 'description': 'Automated replenishment and reorder management'},
		{'code': 'edm', 'name': 'Expiry Date Management', 'description': 'Expiration date tracking and management'},
		{'code': 'log', 'name': 'Logistics & Transportation', 'description': 'Transportation and logistics management'},
		{'code': 'srm', 'name': 'Supplier Relationship Management', 'description': 'Strategic supplier relationships and performance'},
	],
	'models': [
