"""
Scm Wms — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "scm_wms")
		return {"success": True, "capability_id": "scm_wms"}
	except Exception as exc:
		_log.error("Blueprint registration failed for scm_wms: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "scm_wms"}
