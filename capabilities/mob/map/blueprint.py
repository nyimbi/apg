"""
Mob Map — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "mob_map")
		return {"success": True, "capability_id": "mob_map"}
	except Exception as exc:
		_log.error("Blueprint registration failed for mob_map: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "mob_map"}
