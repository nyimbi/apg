"""
Mob Rwf — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "mob_rwf")
		return {"success": True, "capability_id": "mob_rwf"}
	except Exception as exc:
		_log.error("Blueprint registration failed for mob_rwf: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "mob_rwf"}
