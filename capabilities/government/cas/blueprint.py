"""
Gov Cas — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "gov_cas")
		return {"success": True, "capability_id": "gov_cas"}
	except Exception as exc:
		_log.error("Blueprint registration failed for gov_cas: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "gov_cas"}
