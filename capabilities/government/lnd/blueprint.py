"""
Gov Lnd — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "gov_lnd")
		return {"success": True, "capability_id": "gov_lnd"}
	except Exception as exc:
		_log.error("Blueprint registration failed for gov_lnd: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "gov_lnd"}
