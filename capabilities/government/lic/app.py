"""Standalone APG Licensing and Permits application.

Run directly::

    python -m apg_government_lic
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-government-lic",
        description=f"APG Licensing and Permits capability server",
    )
