"""
Gov Lic — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "gov_lic")
		return {"success": True, "capability_id": "gov_lic"}
	except Exception as exc:
		_log.error("Blueprint registration failed for gov_lic: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "gov_lic"}
