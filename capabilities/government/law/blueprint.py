"""
Gov Law — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "gov_law")
		return {"success": True, "capability_id": "gov_law"}
	except Exception as exc:
		_log.error("Blueprint registration failed for gov_law: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "gov_law"}
