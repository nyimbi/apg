"""Standalone APG Law Enforcement and Justice application.

Run directly::

    python -m apg_government_law
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-government-law",
        description=f"APG Law Enforcement and Justice capability server",
    )
