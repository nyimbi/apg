"""
Gov Eme — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "gov_eme")
		return {"success": True, "capability_id": "gov_eme"}
	except Exception as exc:
		_log.error("Blueprint registration failed for gov_eme: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "gov_eme"}
