"""Standalone APG Emergency Management application.

Run directly::

    python -m apg_government_eme
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-government-eme",
        description=f"APG Emergency Management capability server",
    )
