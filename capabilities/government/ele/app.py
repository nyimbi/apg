"""Standalone APG Electoral and Civil Registration application.

Run directly::

    python -m apg_government_ele
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-government-ele",
        description=f"APG Electoral and Civil Registration capability server",
    )
