"""
Gov Csr — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "gov_csr")
		return {"success": True, "capability_id": "gov_csr"}
	except Exception as exc:
		_log.error("Blueprint registration failed for gov_csr: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "gov_csr"}
