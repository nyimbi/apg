"""Standalone APG Citizen Services Portal application.

Run directly::

    python -m apg_government_csr
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-government-csr",
        description=f"APG Citizen Services Portal capability server",
    )
