"""Standalone APG Government Contracts and Procurement application.

Run directly::

    python -m apg_government_con
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-government-con",
        description=f"APG Government Contracts and Procurement capability server",
    )
