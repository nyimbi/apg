"""
Gov Cty — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "gov_cty")
		return {"success": True, "capability_id": "gov_cty"}
	except Exception as exc:
		_log.error("Blueprint registration failed for gov_cty: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "gov_cty"}
