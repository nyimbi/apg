"""
Pha Pvi — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "pha_pvi")
		return {"success": True, "capability_id": "pha_pvi"}
	except Exception as exc:
		_log.error("Blueprint registration failed for pha_pvi: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "pha_pvi"}
