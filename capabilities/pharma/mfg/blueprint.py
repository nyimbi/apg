"""
Pha Mfg — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "pha_mfg")
		return {"success": True, "capability_id": "pha_mfg"}
	except Exception as exc:
		_log.error("Blueprint registration failed for pha_mfg: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "pha_mfg"}
