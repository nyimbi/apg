...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
    return {
        ...
        "ui": {
            ...
            "routes": [{'name': 'dashboard', 'path': '/agr-ins/dashboard', 'component': 'AgrInsDashboard', 'permission': 'agr_ins:view', 'nav_group': 'Overview'}, {'name': 'list', 'path': '/agr-ins/list', 'component': 'AgrInsList', 'permission': 'agr_ins:view', 'nav_group': 'Overview'}, {'name': 'settings', 'path': '/agr-ins/settings', 'component': 'AgrInsSettings', 'permission': 'agr_ins:admin', 'nav_group': 'Administration'}],
        },
