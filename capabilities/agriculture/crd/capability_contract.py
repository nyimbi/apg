...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
    return {
        ...
        "ui": {
            ...
            "routes": [{'name': 'dashboard', 'path': '/agr-crd/dashboard', 'component': 'AgrCrdDashboard', 'permission': 'agr_crd:view', 'nav_group': 'Overview'}, {'name': 'list', 'path': '/agr-crd/list', 'component': 'AgrCrdList', 'permission': 'agr_crd:view', 'nav_group': 'Overview'}, {'name': 'settings', 'path': '/agr-crd/settings', 'component': 'AgrCrdSettings', 'permission': 'agr_crd:admin', 'nav_group': 'Administration'}],
        },
