...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
    return {
        ...
        "ui": {
            ...
            "routes": [{'name': 'dashboard', 'path': '/agr-irg/dashboard', 'component': 'AgrIrgDashboard', 'permission': 'agr_irg:view', 'nav_group': 'Overview'}, {'name': 'list', 'path': '/agr-irg/list', 'component': 'AgrIrgList', 'permission': 'agr_irg:view', 'nav_group': 'Overview'}, {'name': 'settings', 'path': '/agr-irg/settings', 'component': 'AgrIrgSettings', 'permission': 'agr_irg:admin', 'nav_group': 'Administration'}],
        },
