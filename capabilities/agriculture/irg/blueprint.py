"""
Agr Irg — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "agr_irg")
		return {"success": True, "capability_id": "agr_irg"}
	except Exception as exc:
		_log.error("Blueprint registration failed for agr_irg: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "agr_irg"}
