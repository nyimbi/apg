...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
    return {
        ...
        "ui": {
            ...
            "routes": [{'name': 'dashboard', 'path': '/agr-wth/dashboard', 'component': 'AgrWthDashboard', 'permission': 'agr_wth:view', 'nav_group': 'Overview'}, {'name': 'list', 'path': '/agr-wth/list', 'component': 'AgrWthList', 'permission': 'agr_wth:view', 'nav_group': 'Overview'}, {'name': 'settings', 'path': '/agr-wth/settings', 'component': 'AgrWthSettings', 'permission': 'agr_wth:admin', 'nav_group': 'Administration'}],
        },
