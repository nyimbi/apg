"""
Agr Ext — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "agr_ext")
		return {"success": True, "capability_id": "agr_ext"}
	except Exception as exc:
		_log.error("Blueprint registration failed for agr_ext: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "agr_ext"}
