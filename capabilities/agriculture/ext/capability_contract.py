...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
    return {
        ...
        "ui": {
            ...
            "routes": [{'name': 'dashboard', 'path': '/agr-ext/dashboard', 'component': 'AgrExtDashboard', 'permission': 'agr_ext:view', 'nav_group': 'Overview'}, {'name': 'list', 'path': '/agr-ext/list', 'component': 'AgrExtList', 'permission': 'agr_ext:view', 'nav_group': 'Overview'}, {'name': 'settings', 'path': '/agr-ext/settings', 'component': 'AgrExtSettings', 'permission': 'agr_ext:admin', 'nav_group': 'Administration'}],
        },
