"""
Loc Mlg — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "loc_mlg")
		return {"success": True, "capability_id": "loc_mlg"}
	except Exception as exc:
		_log.error("Blueprint registration failed for loc_mlg: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "loc_mlg"}
