"""
Loc Mcy — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "loc_mcy")
		return {"success": True, "capability_id": "loc_mcy"}
	except Exception as exc:
		_log.error("Blueprint registration failed for loc_mcy: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "loc_mcy"}
