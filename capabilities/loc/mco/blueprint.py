"""
Loc Mco — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "loc_mco")
		return {"success": True, "capability_id": "loc_mco"}
	except Exception as exc:
		_log.error("Blueprint registration failed for loc_mco: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "loc_mco"}
