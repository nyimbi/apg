"""
Fin Regtech — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "fin_regtech")
		return {"success": True, "capability_id": "fin_regtech"}
	except Exception as exc:
		_log.error("Blueprint registration failed for fin_regtech: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "fin_regtech"}
