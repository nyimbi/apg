"""
Fin Mobile — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "fin_mobile")
		return {"success": True, "capability_id": "fin_mobile"}
	except Exception as exc:
		_log.error("Blueprint registration failed for fin_mobile: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "fin_mobile"}
