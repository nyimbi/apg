"""Adapter protocols for Payment Switch.
...
Usage (standalone)::
    ...
    svc = PaymentSwitchService()                   # null adapters, in-memory store
    svc = PaymentSwitchService(db_url="postgresql+asyncpg://...")
...
def get_audit_adapter(audit_service: Any | None = None) -> AuditAdapter:
    ...
    try:
        ...
        _nats = get_nats_audit_adapter("fintech_switch")
