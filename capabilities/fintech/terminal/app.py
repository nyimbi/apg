"""Standalone APG Terminal Management System application.

Run directly::

    python -m apg_fintech_terminal
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-fintech-terminal",
        description=f"APG Terminal Management System capability server",
    )
