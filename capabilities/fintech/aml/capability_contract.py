...
RULES: list[dict[str, Any]] = [
	...
	{"name": "cross_tenant_aml_access_denied", "description": "AML data cannot be accessed across tenant boundaries.", "condition": {"cross_tenant_access": True}, "effect": {"decision": "deny", "reason": "cross_tenant_access_denied", "required_action": "use_tenant_scoped_credentials"}},
	{"name": "privilege_escalation_denied", "description": "AML privilege escalation without approval is denied.", "condition": {"privilege_escalation_attempt": True, "approval_recorded": False}, "effect": {"decision": "deny", "reason": "privilege_escalation_denied", "required_action": "obtain_escalation_approval"}},

	# Africa-specific AML rules
	{"name": "ke_frc_sar_filing_required", "description": "Kenya FRC (Financial Reporting Centre) STR/SAR must be filed within 72 hours of suspicion.", "condition": {"operation": "draft_sar", "jurisdiction": "KE", "frc_filing_deadline_breached": True}, "effect": {"decision": "deny", "reason": "ke_frc_sar_deadline_breached", "required_action": "file_frc_sar_immediately"}},
	{"name": "ng_nfiu_str_required", "description": "Nigeria NFIU suspicious transaction reports require NFIU reference.", "condition": {"operation": "draft_sar", "jurisdiction": "NG", "nfiu_reference_present": False}, "effect": {"decision": "deny", "reason": "ng_nfiu_str_reference_required", "required_action": "obtain_nfiu_reference"}},
	{"name": "za_fic_str_required", "description": "South Africa FIC suspicious transaction reports require FIC registration.", "condition": {"operation": "draft_sar", "jurisdiction": "ZA", "fic_registered": False}, "effect": {"decision": "deny", "reason": "za_fic_registration_required", "required_action": "register_with_fic"}},
	{"name": "mobile_money_structuring_threshold_ke", "description": "Kenya CBK mobile money structuring threshold (KES 1M/day) triggers review.", "condition": {"operation": "monitor_transaction", "jurisdiction": "KE", "mobile_money_structuring_ke": True, "review_recorded": False}, "effect": {"decision": "require_review", "reason": "ke_mobile_money_structuring_review_required", "required_action": "review_mobile_money_structuring"}},
	{"name": "mpesa_agent_float_aml_check", "description": "M-Pesa agent float top-ups above threshold require AML screening.", "condition": {"operation": "monitor_transaction", "transaction_type": "mpesa_agent_float", "large_transaction": True, "aml_screened": False}, "effect": {"decision": "require_review", "reason": "mpesa_agent_float_aml_screening_required", "required_action": "screen_mpesa_agent_float"}},
	{"name": "mobile_money_mule_account_detection", "description": "Mobile money accounts showing mule patterns must be escalated.", "condition": {"operation": "monitor_transaction", "mule_account_indicator": True, "review_recorded": False}, "effect": {"decision": "require_review", "reason": "mobile_money_mule_account_review_required", "required_action": "escalate_mule_account"}},
	{"name": "ke_aml_cbk_reporting_threshold", "description": "Kenya CBK requires AML reports for cash transactions above KES 1,000,000.", "condition": {"operation": "monitor_transaction", "jurisdiction": "KE", "instrument_type": "cash", "exceeds_cbk_aml_threshold": True, "cbk_report_filed": False}, "effect": {"decision": "require_review", "reason": "ke_cbk_aml_reporting_required", "required_action": "file_cbk_aml_report"}},
	{"name": "cross_border_mobile_money_sanctions_required", "description": "Cross-border mobile money transactions require sanctions screening.", "condition": {"operation": "monitor_transaction", "cross_border": True, "instrument_type": "mobile_money", "sanctions_screened": False}, "effect": {"decision": "deny", "reason": "cross_border_mobile_money_sanctions_required", "required_action": "screen_cross_border_mobile_money"}},
	{"name": "case_escalation_requires_evidence_update", "description": "AML case escalation to investigation requires updated evidence.", "condition": {"operation": "open_case", "escalated_without_evidence_update": True}, "effect": {"decision": "deny", "reason": "evidence_update_required_for_escalation", "required_action": "update_case_evidence"}},
]
