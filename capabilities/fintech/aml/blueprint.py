"""
Fin Aml — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "fin_aml")
		return {"success": True, "capability_id": "fin_aml"}
	except Exception as exc:
		_log.error("Blueprint registration failed for fin_aml: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "fin_aml"}
