"""Standalone APG Treasury Management System application.

Run directly::

    python -m apg_fintech_treasury
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-fintech-treasury",
        description=f"APG Treasury Management System capability server",
    )
