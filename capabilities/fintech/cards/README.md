...
| 7 | **Async Event Streaming (Bytewax / Redpanda)** — typed `CloudEvent` records on `apg.fintech.cards.lifecycle` with transactional outbox pattern | Enables real-time downstream reaction in `fintech_payments`, `fintech_wallets` |
