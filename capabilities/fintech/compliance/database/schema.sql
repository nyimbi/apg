-- APG FinTech Compliance Automation — PostgreSQL schema
...
CREATE INDEX IF NOT EXISTS idx_apg_compliance_tenant
    ON apg_records (collection, tenant_id);

CREATE INDEX IF NOT EXISTS idx_apg_compliance_data
