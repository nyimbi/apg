"""
Fin Robo — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "fin_robo")
		return {"success": True, "capability_id": "fin_robo"}
	except Exception as exc:
		_log.error("Blueprint registration failed for fin_robo: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "fin_robo"}
