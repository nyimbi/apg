"""
Edu Sch Mgmt — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "edu_sch_mgmt")
		return {"success": True, "capability_id": "edu_sch_mgmt"}
	except Exception as exc:
		_log.error("Blueprint registration failed for edu_sch_mgmt: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "edu_sch_mgmt"}
