"""Standalone APG School Management application.

Run directly::

    python -m apg_education_sch_mgmt
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-education-sch_mgmt",
        description=f"APG School Management capability server",
    )
