"""Standalone APG Learning Management System application.

Run directly::

    python -m apg_education_lms
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-education-lms",
        description=f"APG Learning Management System capability server",
    )
