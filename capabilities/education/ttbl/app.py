"""Standalone APG Timetabling & Scheduling application.

Run directly::

    python -m apg_education_ttbl
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-education-ttbl",
        description=f"APG Timetabling & Scheduling capability server",
    )
