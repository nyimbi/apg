...
class DatabaseManager:
	...
	def __init__(self) -> None:
		...
		# typed stores — values are model instances
		self._leads: dict[str, Any] = {}
		self._accounts: dict[str, Any] = {}
		self._opportunities: dict[str, Any] = {}
	...
	async def create_lead(self, lead: Any) -> Any:
		self._leads[lead.id] = lead
		return deepcopy(lead)

	async def get_lead(self, lead_id: str, tenant_id: str) -> Any | None:
	...
	async def create_account(self, account: Any) -> Any:
		self._accounts[account.id] = account
		return deepcopy(account)

	async def get_account(self, account_id: str, tenant_id: str) -> Any | None:
	...
	async def create_opportunity(self, opportunity: Any) -> Any:
		self._opportunities[opportunity.id] = opportunity
		return deepcopy(opportunity)

	async def get_opportunity(self, opp_id: str, tenant_id: str) -> Any | None:
	...
	async def create_activity(self, activity: Any) -> Any:
		self._activities[activity.id] = activity
		return deepcopy(activity)

	async def get_activity(self, activity_id: str, tenant_id: str) -> Any | None:
	...
	async def find_contacts_by_emails(
		...
		return [
			...
			and (c.get("email") or "").lower() in email_set
		]
	...
	def count_contacts(self, tenant_id: str) -> int:
		return sum(
			1 for c in self._contacts.values() if c.get("tenant_id") == tenant_id
		)
