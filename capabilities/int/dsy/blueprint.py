"""
Int Dsy — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "int_dsy")
		return {"success": True, "capability_id": "int_dsy"}
	except Exception as exc:
		_log.error("Blueprint registration failed for int_dsy: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "int_dsy"}
