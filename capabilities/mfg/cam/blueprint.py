"""
Mfg Cam — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "mfg_cam")
		return {"success": True, "capability_id": "mfg_cam"}
	except Exception as exc:
		_log.error("Blueprint registration failed for mfg_cam: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "mfg_cam"}
