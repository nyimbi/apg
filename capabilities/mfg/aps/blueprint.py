"""
Mfg Aps — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "mfg_aps")
		return {"success": True, "capability_id": "mfg_aps"}
	except Exception as exc:
		_log.error("Blueprint registration failed for mfg_aps: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "mfg_aps"}
