...
THEME = {
	"name": "mfg_sfc_theme",
	"tokens": {"color.primary": "#2C3E50", "color.accent": "#E67E22", "color.success": "#10B981", "color.danger": "#EF4444", "surface.canvas": "#F8FAFC", "surface.panel": "#FFFFFF", "text.primary": "#111827", "border.radius": "6px", "density": "compact"},
}
