...
def test_materialized_contract_shape_is_valid():
	module = _load_module("materialized_contract_apy_accounts_payable", PACKAGE_DIR / "capability_contract.py")
...
def test_materialized_app_entrypoint_is_publishable():
	module = _load_module("materialized_app_apy_accounts_payable", PACKAGE_DIR / "app.py")
