-- APG Accounts Payable — PostgreSQL schema
...
CREATE INDEX IF NOT EXISTS idx_apg_accounts_payable_tenant
    ON apg_records (collection, tenant_id);

CREATE INDEX IF NOT EXISTS idx_apg_accounts_payable_data
