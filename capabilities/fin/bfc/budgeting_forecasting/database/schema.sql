-- APG Budgeting and Forecasting — PostgreSQL schema
...
CREATE INDEX IF NOT EXISTS idx_apg_budgeting_forecasting_tenant
    ON apg_records (collection, tenant_id);

CREATE INDEX IF NOT EXISTS idx_apg_budgeting_forecasting_data
