...
def get_capability_contract(tenant_id: str = "default", overrides: dict[str, Any] | None = None) -> dict[str, Any]:
	...
	return {
		...
		"requires": ["auth", "audl", "ntfy", "composition_events", "composition_config", "glr_general_ledger", "apy_accounts_payable", "arc_accounts_receivable", "cbm_cash_management", "grc_doc", "bia_anl"],
