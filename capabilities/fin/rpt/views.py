...
def dashboard_model(service: FinancialReportingService, tenant_id: str = "default") -> dict[str, Any]:
	return {"screen": "dashboard", "title": "Financial Reporting", "summary": service.dashboard_summary(tenant_id), "sections": ["templates", "generation", "statements", "consolidation", "distribution"]}


def template_model(service: FinancialReportingService, tenant_id: str = "default") -> dict[str, Any]:
...
def report_line_model(service: FinancialReportingService, tenant_id: str = "default") -> dict[str, Any]:
...
def period_model(service: FinancialReportingService, tenant_id: str = "default") -> dict[str, Any]:
...
def generation_model(service: FinancialReportingService, tenant_id: str = "default") -> dict[str, Any]:
...
def statement_model(service: FinancialReportingService, tenant_id: str = "default") -> dict[str, Any]:
	return {"screen": "statements", "records": service.list_statements(tenant_id), "summary": service.statement_summary(tenant_id), "columns": ["statement_id", "title", "approved_by", "narrative_reviewed_by", "status"], "actions": ["publish_statement", "record_disclosure", "distribute_statement"]}


def consolidation_model(service: FinancialReportingService, tenant_id: str = "default") -> dict[str, Any]:
...
def disclosure_model(service: FinancialReportingService, tenant_id: str = "default") -> dict[str, Any]:
...
def distribution_model(service: FinancialReportingService, tenant_id: str = "default") -> dict[str, Any]:
...
def agent_workbench_model(service: FinancialReportingService, tenant_id: str = "default") -> dict[str, Any]:
