-- APG Accounts Receivable — PostgreSQL schema
...
CREATE INDEX IF NOT EXISTS idx_apg_accounts_receivable_tenant
    ON apg_records (collection, tenant_id);

CREATE INDEX IF NOT EXISTS idx_apg_accounts_receivable_data
