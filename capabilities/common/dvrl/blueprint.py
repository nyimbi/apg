"""
Com Dvrl — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "com_dvrl")
		return {"success": True, "capability_id": "com_dvrl"}
	except Exception as exc:
		_log.error("Blueprint registration failed for com_dvrl: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "com_dvrl"}
