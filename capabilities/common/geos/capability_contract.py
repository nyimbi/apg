...
RULES: list[dict[str, Any]] = [
	...
	{"name": "write_requires_policy", "description": "Geo-spatial write operations require an explicit authorization policy.", "condition": {"operation_type": "write", "write_policy_present": False}, "effect": {"decision": "deny", "reason": "geos_write_policy_required", "required_action": "attach_write_policy"}},
	{"name": "privilege_escalation_denied", "description": "Geo-spatial operators cannot self-grant elevated location data permissions.", "condition": {"operation": "assign_geos_permission", "target_tier_exceeds_actor_tier": True}, "effect": {"decision": "deny", "reason": "privilege_escalation_prevented", "required_action": "route_to_higher_authority_approver"}},
]
