...
RULES: list[dict[str, Any]] = [
	...
	{"name": "write_requires_policy", "description": "Ledger write operations require an explicit authorization policy.", "condition": {"operation_type": "write", "write_policy_present": False}, "effect": {"decision": "deny", "reason": "bclg_write_policy_required", "required_action": "attach_write_policy"}},
	{"name": "privilege_escalation_denied", "description": "Ledger operators cannot self-grant elevated ledger permissions.", "condition": {"operation": "assign_bclg_permission", "target_tier_exceeds_actor_tier": True}, "effect": {"decision": "deny", "reason": "privilege_escalation_prevented", "required_action": "route_to_higher_authority_approver"}},
	{"name": "cross_tenant_ledger_access_denied", "description": "Ledger data may not cross tenant boundaries without confirmed membership.", "condition": {"cross_tenant_access": True, "cross_tenant_membership_confirmed": False}, "effect": {"decision": "deny", "reason": "cross_tenant_ledger_access_denied", "required_action": "confirm_cross_tenant_membership"}},
	{"name": "fork_event_requires_review", "description": "Chain fork events require mandatory governance review.", "condition": {"operation": "record_fork_event", "fork_review_recorded": False}, "effect": {"decision": "require_review", "reason": "chain_fork_review_required", "required_action": "review_chain_fork"}},
	{"name": "key_rotation_policy_required_for_ledger", "description": "Ledgers require a key rotation policy before activation.", "condition": {"operation": "activate_ledger", "key_rotation_policy_attached": False}, "effect": {"decision": "deny", "reason": "ledger_key_rotation_policy_required", "required_action": "attach_key_rotation_policy"}},
]
