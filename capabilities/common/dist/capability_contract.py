...
RULES: list[dict[str, Any]] = [
	...
	{"name": "write_requires_policy", "description": "Distributed compute write operations require an explicit authorization policy.", "condition": {"operation_type": "write", "write_policy_present": False}, "effect": {"decision": "deny", "reason": "dist_write_policy_required", "required_action": "attach_write_policy"}},
]
