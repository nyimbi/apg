...
| 9 | Federation Event Streaming to External Sinks | High | Pluggable `FederationEventSink` protocol with Bytewax, Webhook, and Null implementations. `_audit()` becomes async and publishes to the configured sink. Enables SIEM integration. |
