...
__apg_dependencies__ = ["moni", "hlth", "bkup"]
...
capability_metadata: dict[str, Any] = {
	...
	"provides": ["service_lifecycle", "shutdown_orchestration", "restart_plans", "backup_gates", "operational_safety"],
...
def register_capability() -> dict[str, Any]:
	...
	return {
		...
		"optional_dependencies": ["depl", "logt", "envm", "cicd"],
		...
		"endpoints": {"services": "/shdn/api/v1/services", "plans": "/shdn/api/v1/plans", "executions": "/shdn/api/v1/executions", "approvals": "/shdn/api/v1/approvals", "recovery": "/shdn/api/v1/recovery"},
