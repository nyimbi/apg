"""
Gql Gw — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "gql_gw")
		return {"success": True, "capability_id": "gql_gw"}
	except Exception as exc:
		_log.error("Blueprint registration failed for gql_gw: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "gql_gw"}
