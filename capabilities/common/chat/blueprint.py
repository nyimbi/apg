"""
Com Chat — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "com_chat")
		return {"success": True, "capability_id": "com_chat"}
	except Exception as exc:
		_log.error("Blueprint registration failed for com_chat: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "com_chat"}
