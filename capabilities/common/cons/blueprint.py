"""
Com Cons — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "com_cons")
		return {"success": True, "capability_id": "com_cons"}
	except Exception as exc:
		_log.error("Blueprint registration failed for com_cons: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "com_cons"}
