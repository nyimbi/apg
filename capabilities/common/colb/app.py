"""Publishable APG capability package entrypoint for Collaboration Tools."""
...
try:
	...
	_SPEC = importlib.util.spec_from_file_location("colb_capability_contract", _CONTRACT_PATH)
...
def semantic_model() -> dict[str, Any]:
	...
	return {
		...
		"ok": True,
		"app": {"name": "colb", "version": "1.0.0", "description": "Collaboration Tools package-backed APG capability", "entity_count": 0},
		"packages": {"colb": {"profile": "capability", "entrypoint": "app.py"}},
		"capabilities": {
			"colb": {
				...
				"runtime": {
					...
					"production_app": contract["configuration"]["adapters"]["production_app"],
				},
				...
				"components": {},
				"approvals": {
					"workspace_membership_review": "WorkspaceMembershipReview",
					"external_access_review": "ExternalAccessReview",
					"workspace_export": "WorkspaceExportApproval",
				},
				"i18n": {},
				"master_data": {},
			}
...
def self_test() -> dict[str, Any]:
	...
	errors: list[str] = []
	capability = model.get("capabilities", {}).get("colb", {})
	routes = capability.get("ui", {}).get("routes", [])
	rules = capability.get("rule_engine", {}).get("rules", [])
	adapters = capability.get("adapters", {})
	if model.get("format") != "apg.semantic-model.v1":
		errors.append("semantic model format mismatch")
	if "colb" not in model.get("capabilities", {}):
