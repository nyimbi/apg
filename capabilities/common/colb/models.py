...
try:
	...
	class BaseMixin:
		"""Fallback primary-key mixin when APG auth/RBAC models are unavailable."""

		id = Column(Integer, primary_key=True)

	class AuditMixin:
		"""Fallback audit columns matching the fields this module expects."""
...
class RTCActivity(Model, AuditMixin, BaseMixin):
	...
	activity_metadata = Column("metadata", JSON, default=dict)  # Additional context data
