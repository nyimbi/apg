...
capability_metadata: dict[str, Any] = {
	...
	"description": "Tenant-aware collaborative workspaces, sessions, shared artifacts, annotations, decisions, presence, first-class AI-agent composition, Bytewax lifecycle batches, and protocol orchestration",
	...
	"provides": ["collaborative_workspaces", "shared_sessions", "shared_artifacts", "annotation_threads", "decision_records", "presence_sync", "agent_collaboration", "collaboration_agent_composition", "bytewax_lifecycle_batches", "realtime_protocols"],
...
def register_capability() -> dict[str, Any]:
	...
	return {
		...
		"optional_dependencies": ["audl", "mqeb", "vidc", "wflo", "mten", "nlpc", "secu", "cach", "aicr"],
		...
		"capabilities": {
			...
			"collaboration_agent_composition": "Compose Codex, Claude Code, OpenCode, Pi, and future runtimes through provider-neutral collaboration-agent adapters",
			"bytewax_lifecycle_batches": "Validate workspace, session, artifact, annotation, decision, presence, protocol, guest, and collaboration-agent lifecycle batches through Bytewax",
		...
		"endpoints": {
			...
			"lifecycle": "/colb/api/v1/lifecycle",
