...
RULES: list[dict[str, Any]] = [
	...
	{"name": "custom_component_registration_requires_review", "description": "New custom components require review evidence before use.", "condition": {"operation": "create_component", "custom_component_present": True, "component_review_recorded": False}, "effect": {"decision": "require_review", "reason": "custom_component_review_required", "required_action": "review_custom_component"}},
	...
	{"name": "write_requires_policy", "description": "Website builder write operations require an explicit authorization policy.", "condition": {"operation_type": "write", "write_policy_present": False}, "effect": {"decision": "deny", "reason": "wsbl_write_policy_required", "required_action": "attach_write_policy"}},
	{"name": "privilege_escalation_denied", "description": "Website builder operators cannot self-grant elevated site management permissions.", "condition": {"operation": "assign_wsbl_permission", "target_tier_exceeds_actor_tier": True}, "effect": {"decision": "deny", "reason": "privilege_escalation_prevented", "required_action": "route_to_higher_authority_approver"}},
	{"name": "site_delete_requires_approval", "description": "Site deletion requires explicit approval before execution.", "condition": {"operation": "delete_site", "delete_approved": False}, "effect": {"decision": "deny", "reason": "site_delete_approval_required", "required_action": "record_site_delete_approval"}},
]
