"""
Com Recs — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "com_recs")
		return {"success": True, "capability_id": "com_recs"}
	except Exception as exc:
		_log.error("Blueprint registration failed for com_recs: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "com_recs"}
