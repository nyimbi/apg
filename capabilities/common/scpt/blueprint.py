"""
Com Scpt — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "com_scpt")
		return {"success": True, "capability_id": "com_scpt"}
	except Exception as exc:
		_log.error("Blueprint registration failed for com_scpt: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "com_scpt"}
