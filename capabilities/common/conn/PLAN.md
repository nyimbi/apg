...
- Lifecycle records did not consistently expose durable policy/review evidence
  or a composed pending-review queue for generated connector consoles.
...
3. Dependency-light lifecycle service
   ...
   - Preserve policy decisions, matched rules, review reasons, and required
     actions across connector, connection, flow, sync, schedule, review,
     connector-agent, lifecycle-batch, and audit records.
