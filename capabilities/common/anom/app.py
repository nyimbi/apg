"""Publishable APG capability package entrypoint for Anomaly Detection."""
...
try:
	...
	_SPEC = importlib.util.spec_from_file_location("anom_capability_contract", _CONTRACT_PATH)
...
def semantic_model() -> dict[str, Any]:
	...
	return {
		...
		"app": {
			"name": "anom",
			"version": "1.0.0",
			"description": "Anomaly Detection package-backed APG capability",
			"entity_count": 0,
		},
		"packages": {"anom": {"profile": "capability", "entrypoint": "app.py"}},
		"capabilities": {
			"anom": {
...
def self_test() -> dict[str, Any]:
	...
	errors: list[str] = []
	capability = model.get("capabilities", {}).get("anom", {})
