...
__apg_dependencies__ = ["secu", "anom", "moni"]
...
capability_metadata: dict[str, Any] = {
	...
	"provides": ["detection_pipeline", "incident_response", "threat_triage", "response_playbooks", "security_posture"],
...
def register_capability() -> dict[str, Any]:
	...
	return {
		...
		"optional_dependencies": ["logt", "ztna", "dlpd", "comp"],
		...
		"endpoints": {"detections": "/seop/api/v1/detections", "incidents": "/seop/api/v1/incidents", "playbooks": "/seop/api/v1/playbooks", "responses": "/seop/api/v1/responses", "posture": "/seop/api/v1/posture"},
