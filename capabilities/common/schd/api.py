...
def register_scheduler_agent(service: SchdService, **payload: Any) -> dict[str, Any]:
	...
	return service.register_scheduler_agent(**normalized_payload)
...
def validate_lifecycle_batch(service: SchdService, **payload: Any) -> dict[str, Any]:
...
def list_lifecycle_batches(service: SchdService, tenant_id: str | None = None) -> list[dict[str, Any]]:
