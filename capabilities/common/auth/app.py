"""Publishable APG capability package entrypoint for Authentication & RBAC."""
...
def semantic_model() -> dict[str, Any]:
	...
	return {
		...
		"capabilities": {
			"auth": {
				...
				"approvals": {
					...
					"security_agent": "AuthSecurityAgent",
				},
				"i18n": {},
				"master_data": {},
		...
		"composition": {
			"capability_dependencies": {"auth": contract["requires"]},
			"applications": {},
			"agent_teams": {
		...
		"agents": {
			"auth_security_agent_contract": contract["agents"],
		},
		"flows": {},
		"llms": {},
		"operations": {},
