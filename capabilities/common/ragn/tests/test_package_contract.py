"""RAGN package contract and runtime tests."""
...
def test_ragn_contract_shape_is_valid():
	module = _load_module("package_contract_ragn", PACKAGE_DIR / "capability_contract.py")
...
def test_ragn_app_entrypoint_is_publishable():
	module = _load_module("package_app_ragn", PACKAGE_DIR / "app.py")
...
def test_ragn_package_evidence_matches_entrypoint():
	module = _load_module("package_evidence_app_ragn", PACKAGE_DIR / "app.py")
...
def test_ragn_api_imports_without_production_dependencies():
	module = importlib.import_module("capabilities.common.ragn.api")
