...
RULES: list[dict[str, Any]] = [
	...
	{"name": "generation_from_pending_context_requires_review", "description": "Answers generated from pending-review retrieval context remain in review until grounding is approved.", "condition": {"operation": "generate_answer", "upstream_review_pending": True, "review_recorded": False}, "effect": {"decision": "require_review", "reason": "pending_context_generation_review_required", "required_action": "review_generated_answer_grounding"}},
...
STREAMING: dict[str, Any] = {
	...
	"guardrails": [
		"ragn_batch_requires_bytewax",
		"ragn_privileged_action_requires_human_approval",
	],
}
