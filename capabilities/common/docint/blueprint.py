"""
Docint — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "docint")
		return {"success": True, "capability_id": "docint"}
	except Exception as exc:
		_log.error("Blueprint registration failed for docint: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "docint"}
