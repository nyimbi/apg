"""
Pmin — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "pmin")
		return {"success": True, "capability_id": "pmin"}
	except Exception as exc:
		_log.error("Blueprint registration failed for pmin: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "pmin"}
