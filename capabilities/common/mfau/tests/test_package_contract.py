"""Capability package tests for MFAU."""
...
def test_package_contract_shape_is_valid():
	module = _load_module("package_contract_mfau", PACKAGE_DIR / "capability_contract.py")
...
def test_package_app_entrypoint_is_publishable():
	module = _load_module("package_app_mfau", PACKAGE_DIR / "app.py")
