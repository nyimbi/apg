...
RULES: list[dict[str, Any]] = [
	...
	{"name": "reasoning_from_pending_retrieval_requires_review", "description": "Reasoning paths built from pending-review retrieval remain in review until retrieval is approved.", "condition": {"operation": "build_reasoning_path", "upstream_review_pending": True, "review_recorded": False}, "effect": {"decision": "require_review", "reason": "pending_retrieval_reasoning_review_required", "required_action": "review_reasoning_against_retrieval"}},
	...
	{"name": "generation_from_pending_graph_context_requires_review", "description": "Answers generated from pending-review retrieval or reasoning remain in review until grounding is approved.", "condition": {"operation": "generate_answer", "upstream_review_pending": True, "review_recorded": False}, "effect": {"decision": "require_review", "reason": "pending_graph_context_generation_review_required", "required_action": "review_graph_grounded_answer"}},
