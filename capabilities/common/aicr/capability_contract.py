...
RULES: list[dict[str, Any]] = [
	...
	{"name": "model_metric_requires_registered_model", "description": "Model metrics require a registered model.", "condition": {"operation": "record_model_metric", "model_registered": False}, "effect": {"decision": "deny", "reason": "model_metric_registered_model_required", "required_action": "register_model_before_metric"}},
	{"name": "model_metric_requires_name", "description": "Model metrics require a metric name.", "condition": {"operation": "record_model_metric", "metric_name_present": False}, "effect": {"decision": "deny", "reason": "model_metric_name_required", "required_action": "declare_model_metric_name"}},
	{"name": "model_metric_requires_recorder", "description": "Model metrics require recorder identity.", "condition": {"operation": "record_model_metric", "metric_recorder_present": False}, "effect": {"decision": "deny", "reason": "model_metric_recorder_required", "required_action": "declare_model_metric_recorder"}},
...
UI_ROUTES: list[dict[str, str]] = [
	...
	{"name": "model_metrics", "path": "/aicr/model-metrics", "component": "ModelMetricConsole", "permission": "aicr:govern", "nav_group": "Runtime"},
...
THEME: dict[str, Any] = {
	...
	"components": {
		...
		"model_metric_console": {"visual": "metric-ledger", "status_style": "drift-chip"},
