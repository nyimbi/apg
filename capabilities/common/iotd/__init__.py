...
__apg_dependencies__ = ["mqeb", "auth", "encr"]
...
capability_metadata: dict[str, Any] = {
	...
	"provides": ["device_registry", "telemetry_ingestion", "command_dispatch", "firmware_lifecycle", "device_security"],
...
def register_capability() -> dict[str, Any]:
	...
	return {
		...
		"endpoints": {"devices": "/iotd/api/v1/devices", "telemetry": "/iotd/api/v1/telemetry", "commands": "/iotd/api/v1/commands", "firmware": "/iotd/api/v1/firmware", "security": "/iotd/api/v1/security"},
