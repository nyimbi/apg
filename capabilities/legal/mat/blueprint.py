"""
Leg Mat — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "leg_mat")
		return {"success": True, "capability_id": "leg_mat"}
	except Exception as exc:
		_log.error("Blueprint registration failed for leg_mat: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "leg_mat"}
