...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
    return {
        ...
        "ui": {
            ...
            "routes": [{'name': 'dashboard', 'path': '/leg-bil/dashboard', 'component': 'LegBilDashboard', 'permission': 'leg_bil:view', 'nav_group': 'Overview'}, {'name': 'list', 'path': '/leg-bil/list', 'component': 'LegBilList', 'permission': 'leg_bil:view', 'nav_group': 'Overview'}, {'name': 'settings', 'path': '/leg-bil/settings', 'component': 'LegBilSettings', 'permission': 'leg_bil:admin', 'nav_group': 'Administration'}],
        },
