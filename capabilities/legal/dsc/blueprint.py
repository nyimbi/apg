"""
Leg Dsc — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "leg_dsc")
		return {"success": True, "capability_id": "leg_dsc"}
	except Exception as exc:
		_log.error("Blueprint registration failed for leg_dsc: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "leg_dsc"}
