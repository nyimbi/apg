...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
    return {
        ...
        "ui": {
            ...
            "routes": [{'name': 'dashboard', 'path': '/leg-cpl/dashboard', 'component': 'LegCplDashboard', 'permission': 'leg_cpl:view', 'nav_group': 'Overview'}, {'name': 'list', 'path': '/leg-cpl/list', 'component': 'LegCplList', 'permission': 'leg_cpl:view', 'nav_group': 'Overview'}, {'name': 'settings', 'path': '/leg-cpl/settings', 'component': 'LegCplSettings', 'permission': 'leg_cpl:admin', 'nav_group': 'Administration'}],
        },
