"""
Leg Cpl — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "leg_cpl")
		return {"success": True, "capability_id": "leg_cpl"}
	except Exception as exc:
		_log.error("Blueprint registration failed for leg_cpl: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "leg_cpl"}
