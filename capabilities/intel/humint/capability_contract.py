...
DEFAULT_CONFIGURATION: dict[str, Any] = {
	...
	"governance": {"require_tenant_context": True, "policy_attached_for_writes": True, "audit_events": True, "lawful_authority_required": True, "source_welfare_required": True, "coercion_prohibited": True, "cross_tenant_humint_denied": True, "privilege_escalation_denied": True, "source_identity_disclosure_denied": True, "autonomous_dissemination_denied": True, "source_endangerment_denied": True},
...
RULES: list[dict[str, Any]] = [
	...
	{"name": "cross_tenant_humint_action_denied", "condition": {"operation": "humint_agent_action", "cross_tenant_humint_scope": True}, "effect": {"decision": "deny", "reason": "cross_tenant_humint_scope_denied", "required_action": "remove_cross_tenant_scope"}},
	{"name": "privilege_escalation_action_denied", "condition": {"operation": "humint_agent_action", "privilege_escalation_scope": True}, "effect": {"decision": "deny", "reason": "privilege_escalation_scope_denied", "required_action": "remove_privilege_escalation_scope"}},
	{"name": "source_identity_disclosure_action_denied", "condition": {"operation": "humint_agent_action", "source_identity_disclosure_scope": True}, "effect": {"decision": "deny", "reason": "source_identity_disclosure_scope_denied", "required_action": "remove_identity_disclosure_scope"}},
	{"name": "autonomous_dissemination_action_denied", "condition": {"operation": "humint_agent_action", "autonomous_dissemination_scope": True}, "effect": {"decision": "deny", "reason": "autonomous_dissemination_scope_denied", "required_action": "remove_autonomous_dissemination_scope"}},
	{"name": "source_endangerment_action_denied", "condition": {"operation": "humint_agent_action", "source_endangerment_scope": True}, "effect": {"decision": "deny", "reason": "source_endangerment_scope_denied", "required_action": "remove_source_endangerment_scope"}},
	{"name": "cross_tenant_humint_write_denied", "condition": {"operation_type": "write", "cross_tenant_access": True}, "effect": {"decision": "deny", "reason": "cross_tenant_humint_write_denied", "required_action": "remove_cross_tenant_scope"}},
]
