...
DEFAULT_CONFIGURATION: dict[str, Any] = {
	...
	"governance": {"require_tenant_context": True, "policy_attached_for_writes": True, "audit_events": True, "lawful_authority_required": True, "minimization_required": True},
