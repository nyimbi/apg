...
RULES: list[dict[str, Any]] = [
	...
	{"name": "cross_tenant_cybint_action_denied", "condition": {"operation": "cybint_agent_action", "cross_tenant_cybint_scope": True}, "effect": {"decision": "deny", "reason": "cross_tenant_cybint_scope_denied", "required_action": "remove_cross_tenant_scope"}},
	{"name": "privilege_escalation_action_denied", "condition": {"operation": "cybint_agent_action", "privilege_escalation_scope": True}, "effect": {"decision": "deny", "reason": "privilege_escalation_scope_denied", "required_action": "remove_privilege_escalation_scope"}},
	{"name": "indicator_fabrication_action_denied", "condition": {"operation": "cybint_agent_action", "indicator_fabrication_scope": True}, "effect": {"decision": "deny", "reason": "indicator_fabrication_scope_denied", "required_action": "remove_indicator_fabrication_scope"}},
	{"name": "autonomous_dissemination_action_denied", "condition": {"operation": "cybint_agent_action", "autonomous_dissemination_scope": True}, "effect": {"decision": "deny", "reason": "autonomous_dissemination_scope_denied", "required_action": "remove_autonomous_dissemination_scope"}},
	{"name": "unapproved_attribution_action_denied", "condition": {"operation": "cybint_agent_action", "unapproved_attribution_scope": True}, "effect": {"decision": "deny", "reason": "unapproved_attribution_scope_denied", "required_action": "remove_unapproved_attribution_scope"}},
	{"name": "cross_tenant_cybint_write_denied", "condition": {"operation_type": "write", "cross_tenant_access": True}, "effect": {"decision": "deny", "reason": "cross_tenant_cybint_write_denied", "required_action": "remove_cross_tenant_scope"}},
]
