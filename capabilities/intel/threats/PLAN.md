# Threat Intelligence Build Plan

## Packet 1: Contract And Specification

- Define `intel_threats` as a Python executable capability package.
...
- Add tenant-keyed dataclasses for authorities, workspaces, sources,
  indicators, actors, campaigns, assessments, reports, mitigations, reviews,
  and agents.
...
- Add dashboard, threat console, and AI-agent workbench view models.
...
- Add `threats` to implemented Intel subcapabilities.
