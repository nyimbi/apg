"""
Int Threats — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "int_threats")
		return {"success": True, "capability_id": "int_threats"}
	except Exception as exc:
		_log.error("Blueprint registration failed for int_threats: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "int_threats"}
