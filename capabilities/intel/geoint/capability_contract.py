...
RULES: list[dict[str, Any]] = [
	...
	{"name": "cross_tenant_geoint_action_denied", "condition": {"operation": "geoint_agent_action", "cross_tenant_geoint_scope": True}, "effect": {"decision": "deny", "reason": "cross_tenant_geoint_scope_denied", "required_action": "remove_cross_tenant_scope"}},
	{"name": "privilege_escalation_action_denied", "condition": {"operation": "geoint_agent_action", "privilege_escalation_scope": True}, "effect": {"decision": "deny", "reason": "privilege_escalation_scope_denied", "required_action": "remove_privilege_escalation_scope"}},
	{"name": "unapproved_collection_plan_action_denied", "condition": {"operation": "geoint_agent_action", "unapproved_collection_plan_scope": True}, "effect": {"decision": "deny", "reason": "unapproved_collection_plan_scope_denied", "required_action": "obtain_collection_plan_approval"}},
	{"name": "evidence_fabrication_action_denied", "condition": {"operation": "geoint_agent_action", "evidence_fabrication_scope": True}, "effect": {"decision": "deny", "reason": "evidence_fabrication_scope_denied", "required_action": "remove_evidence_fabrication_scope"}},
	{"name": "autonomous_dissemination_action_denied", "condition": {"operation": "geoint_agent_action", "autonomous_dissemination_scope": True}, "effect": {"decision": "deny", "reason": "autonomous_dissemination_scope_denied", "required_action": "remove_autonomous_dissemination_scope"}},
	{"name": "cross_tenant_geoint_write_denied", "condition": {"operation_type": "write", "cross_tenant_access": True}, "effect": {"decision": "deny", "reason": "cross_tenant_geoint_write_denied", "required_action": "remove_cross_tenant_scope"}},
]
