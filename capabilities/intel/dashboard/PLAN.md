# Intelligence Dashboard Build Plan

## Packet 1: Contract And Specification

- Define `intel_dashboard` as a Python executable capability package.
...
- Add tenant-keyed dataclasses for authorities, workspaces, dashboards,
  sources, metrics, widgets, filters, views, shares, reviews, and agents.
...
- Add dashboard, composition console, and AI-agent workbench view models.
...
- Add `dashboard` to implemented Intel subcapabilities.
