"""Adapter protocols for Financial Intelligence.
...
Usage (standalone)::
    ...
    svc = FinancialIntelligenceService()                   # null adapters, in-memory store
    svc = FinancialIntelligenceService(db_url="postgresql+asyncpg://...")

Usage (platform)::

    from apg_common_auth import AuthService
    svc = FinancialIntelligenceService(auth=AuthService.from_env())
"""
