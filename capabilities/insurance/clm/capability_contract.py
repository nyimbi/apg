...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
    return {
        ...
        "ui": {
            ...
            "routes": [{'name': 'dashboard', 'path': '/ins-clm/dashboard', 'component': 'InsClmDashboard', 'permission': 'ins_clm:view', 'nav_group': 'Overview'}, {'name': 'list', 'path': '/ins-clm/list', 'component': 'InsClmList', 'permission': 'ins_clm:view', 'nav_group': 'Overview'}, {'name': 'settings', 'path': '/ins-clm/settings', 'component': 'InsClmSettings', 'permission': 'ins_clm:admin', 'nav_group': 'Administration'}],
        },
