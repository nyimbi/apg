"""
Ins Clm — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "ins_clm")
		return {"success": True, "capability_id": "ins_clm"}
	except Exception as exc:
		_log.error("Blueprint registration failed for ins_clm: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "ins_clm"}
