...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
    return {
        ...
        "ui": {
            ...
            "routes": [{'name': 'dashboard', 'path': '/ins-dst/dashboard', 'component': 'InsDstDashboard', 'permission': 'ins_dst:view', 'nav_group': 'Overview'}, {'name': 'list', 'path': '/ins-dst/list', 'component': 'InsDstList', 'permission': 'ins_dst:view', 'nav_group': 'Overview'}, {'name': 'settings', 'path': '/ins-dst/settings', 'component': 'InsDstSettings', 'permission': 'ins_dst:admin', 'nav_group': 'Administration'}],
        },
