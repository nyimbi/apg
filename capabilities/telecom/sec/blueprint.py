"""
Tel Sec — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "tel_sec")
		return {"success": True, "capability_id": "tel_sec"}
	except Exception as exc:
		_log.error("Blueprint registration failed for tel_sec: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "tel_sec"}
