"""
Tel Ord — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "tel_ord")
		return {"success": True, "capability_id": "tel_ord"}
	except Exception as exc:
		_log.error("Blueprint registration failed for tel_ord: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "tel_ord"}
