"""Standalone APG Performance Management application.

Run directly::

    python -m apg_telecom_per
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-telecom-per",
        description=f"APG Performance Management capability server",
    )
