"""
Tel Per — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "tel_per")
		return {"success": True, "capability_id": "tel_per"}
	except Exception as exc:
		_log.error("Blueprint registration failed for tel_per: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "tel_per"}
