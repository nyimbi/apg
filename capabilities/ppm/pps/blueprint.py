"""
Ppm Pps — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "ppm_pps")
		return {"success": True, "capability_id": "ppm_pps"}
	except Exception as exc:
		_log.error("Blueprint registration failed for ppm_pps: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "ppm_pps"}
