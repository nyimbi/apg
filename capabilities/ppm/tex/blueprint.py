"""
Ppm Tex — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "ppm_tex")
		return {"success": True, "capability_id": "ppm_tex"}
	except Exception as exc:
		_log.error("Blueprint registration failed for ppm_tex: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "ppm_tex"}
