...
The current registry exposes 143 valid capability contracts. The latest focused
implementation audit reports:

- 143 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 143
operable contracts, 143 complete package artifact sets, 0 package gaps, 0
...
| `intel` | 9 | Intelligence crawler services, open source intelligence, signals intelligence, human intelligence, geospatial intelligence, cyber intelligence, financial intelligence, social media intelligence, and dark web monitoring. |
