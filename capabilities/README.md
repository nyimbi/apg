...
The current registry exposes 129 valid capability contracts. The latest focused
implementation audit reports:

- 129 domain-specific capability packages;
...
operable contracts, 129 complete package artifact sets, 0 package gaps, 0
...
| `fintech` | 21 | Fintech gateway, digital payments, digital cards, digital wallet, mobile banking, banking APIs, embedded finance, wealth management, robo advisory, portfolio management, algorithmic trading, crowdfunding, digital neobanking, digital lending, buy now pay later, agency banking, remittance, insurtech, KYC, AML, and fraud services. |
