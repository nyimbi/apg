...
The current registry exposes 133 valid capability contracts. The latest focused
implementation audit reports:

- 133 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 133
operable contracts, 133 complete package artifact sets, 0 package gaps, 0
...
| `fintech` | 25 | Fintech gateway, digital payments, digital cards, digital wallet, mobile banking, banking APIs, embedded finance, wealth management, robo advisory, portfolio management, algorithmic trading, crowdfunding, digital neobanking, digital lending, buy now pay later, agency banking, remittance, insurtech, risk management, regulatory technology, KYC, AML, fraud, compliance automation, and blockchain services. |
