...
The current registry exposes 116 valid capability contracts. The latest focused
implementation audit reports:

- 116 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 116
operable contracts, 116 complete package artifact sets, 0 package gaps, 0
...
| `fintech` | 8 | Fintech gateway, digital payments, digital cards, digital wallet, remittance, KYC, AML, and fraud services. |
