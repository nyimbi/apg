...
The current registry exposes 125 valid capability contracts. The latest focused
implementation audit reports:

- 125 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 125
operable contracts, 125 complete package artifact sets, 0 package gaps, 0
...
| `fintech` | 17 | Fintech gateway, digital payments, digital cards, digital wallet, mobile banking, banking APIs, embedded finance, wealth management, robo advisory, digital neobanking, digital lending, buy now pay later, agency banking, remittance, KYC, AML, and fraud services. |
