...
The current registry exposes 123 valid capability contracts. The latest focused
implementation audit reports:

- 123 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 123
operable contracts, 123 complete package artifact sets, 0 package gaps, 0
...
| `fintech` | 15 | Fintech gateway, digital payments, digital cards, digital wallet, mobile banking, banking APIs, embedded finance, digital neobanking, digital lending, buy now pay later, agency banking, remittance, KYC, AML, and fraud services. |
