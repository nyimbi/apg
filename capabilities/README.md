...
The current registry exposes 122 valid capability contracts. The latest focused
implementation audit reports:

- 122 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 122
operable contracts, 122 complete package artifact sets, 0 package gaps, 0
...
| `fintech` | 14 | Fintech gateway, digital payments, digital cards, digital wallet, mobile banking, banking APIs, digital neobanking, digital lending, buy now pay later, agency banking, remittance, KYC, AML, and fraud services. |
