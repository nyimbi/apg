...
The current registry exposes 130 valid capability contracts. The latest focused
implementation audit reports:

- 130 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 129
operable contracts, 130 complete package artifact sets, 0 package gaps, 0
...
| `fintech` | 22 | Fintech gateway, digital payments, digital cards, digital wallet, mobile banking, banking APIs, embedded finance, wealth management, robo advisory, portfolio management, algorithmic trading, crowdfunding, digital neobanking, digital lending, buy now pay later, agency banking, remittance, insurtech, risk management, KYC, AML, and fraud services. |
