...
The current registry exposes 139 valid capability contracts. The latest focused
implementation audit reports:

- 139 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 139
operable contracts, 139 complete package artifact sets, 0 package gaps, 0
...
| `intel` | 5 | Intelligence crawler services, open source intelligence, signals intelligence, human intelligence, and geospatial intelligence. |
