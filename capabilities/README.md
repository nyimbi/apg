...
The current registry exposes 121 valid capability contracts. The latest focused
implementation audit reports:

- 121 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 121
operable contracts, 121 complete package artifact sets, 0 package gaps, 0
...
| `fintech` | 13 | Fintech gateway, digital payments, digital cards, digital wallet, mobile banking, digital neobanking, digital lending, buy now pay later, agency banking, remittance, KYC, AML, and fraud services. |
