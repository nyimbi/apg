...
The current registry exposes 119 valid capability contracts. The latest focused
implementation audit reports:

- 119 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 119
operable contracts, 119 complete package artifact sets, 0 package gaps, 0
...
| `fintech` | 11 | Fintech gateway, digital payments, digital cards, digital wallet, digital neobanking, digital lending, buy now pay later, remittance, KYC, AML, and fraud services. |
