...
The current registry exposes 138 valid capability contracts. The latest focused
implementation audit reports:

- 138 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 138
operable contracts, 138 complete package artifact sets, 0 package gaps, 0
...
| `intel` | 4 | Intelligence crawler services, open source intelligence, signals intelligence, and human intelligence. |
