...
The current registry exposes 120 valid capability contracts. The latest focused
implementation audit reports:

- 120 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 120
operable contracts, 120 complete package artifact sets, 0 package gaps, 0
...
| `fintech` | 12 | Fintech gateway, digital payments, digital cards, digital wallet, digital neobanking, digital lending, buy now pay later, agency banking, remittance, KYC, AML, and fraud services. |
