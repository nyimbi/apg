...
The current registry exposes 144 valid capability contracts. The latest focused
implementation audit reports:

- 144 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 144
operable contracts, 144 complete package artifact sets, 0 package gaps, 0
...
| `intel` | 10 | Intelligence crawler services, open source intelligence, signals intelligence, human intelligence, geospatial intelligence, cyber intelligence, financial intelligence, social media intelligence, dark web monitoring, and radio intelligence listening. |
