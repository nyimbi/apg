...
The current registry exposes 111 valid capability contracts. The latest focused
implementation audit reports:

- 111 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 111
operable contracts, 111 complete package artifact sets, 0 package gaps, 0
...
| `fintech` | 3 | Fintech gateway, digital payments, and digital wallet services. |
