...
The current registry exposes 142 valid capability contracts. The latest focused
implementation audit reports:

- 142 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 142
operable contracts, 142 complete package artifact sets, 0 package gaps, 0
...
| `intel` | 8 | Intelligence crawler services, open source intelligence, signals intelligence, human intelligence, geospatial intelligence, cyber intelligence, financial intelligence, and social media intelligence. |
