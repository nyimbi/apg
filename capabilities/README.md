...
The current registry exposes 124 valid capability contracts. The latest focused
implementation audit reports:

- 124 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 124
operable contracts, 124 complete package artifact sets, 0 package gaps, 0
...
| `fintech` | 16 | Fintech gateway, digital payments, digital cards, digital wallet, mobile banking, banking APIs, embedded finance, wealth management, digital neobanking, digital lending, buy now pay later, agency banking, remittance, KYC, AML, and fraud services. |
