...
The current registry exposes 109 valid capability contracts. The latest focused
implementation audit reports:

- 109 domain-specific capability packages;
...
| `fintech` | 1 | Fintech gateway services. |
