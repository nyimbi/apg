...
The current registry exposes 135 valid capability contracts. The latest focused
implementation audit reports:

- 135 domain-specific capability packages;
...
The strict package-artifact operability audit also currently reports 135
operable contracts, 135 complete package artifact sets, 0 package gaps, 0
