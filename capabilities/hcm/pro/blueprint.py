"""
Hcm Pro — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "hcm_pro")
		return {"success": True, "capability_id": "hcm_pro"}
	except Exception as exc:
		_log.error("Blueprint registration failed for hcm_pro: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "hcm_pro"}
