"""
Hcm Ess — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "hcm_ess")
		return {"success": True, "capability_id": "hcm_ess"}
	except Exception as exc:
		_log.error("Blueprint registration failed for hcm_ess: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "hcm_ess"}
