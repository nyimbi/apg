-- APG Employee Data Management — PostgreSQL schema
...
CREATE INDEX IF NOT EXISTS idx_apg_employee_data_management_tenant
    ON apg_records (collection, tenant_id);

CREATE INDEX IF NOT EXISTS idx_apg_employee_data_management_data
