"""
Hcm Org — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "hcm_org")
		return {"success": True, "capability_id": "hcm_org"}
	except Exception as exc:
		_log.error("Blueprint registration failed for hcm_org: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "hcm_org"}
