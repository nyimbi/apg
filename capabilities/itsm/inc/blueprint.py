"""
Its Inc — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "its_inc")
		return {"success": True, "capability_id": "its_inc"}
	except Exception as exc:
		_log.error("Blueprint registration failed for its_inc: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "its_inc"}
