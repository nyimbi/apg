"""
Ngo Don — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "ngo_don")
		return {"success": True, "capability_id": "ngo_don"}
	except Exception as exc:
		_log.error("Blueprint registration failed for ngo_don: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "ngo_don"}
