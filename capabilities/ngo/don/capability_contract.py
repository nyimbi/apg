...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
    return {
        ...
        "ui": {
            ...
            "routes": [{'name': 'dashboard', 'path': '/ngo-don/dashboard', 'component': 'NgoDonDashboard', 'permission': 'ngo_don:view', 'nav_group': 'Overview'}, {'name': 'list', 'path': '/ngo-don/list', 'component': 'NgoDonList', 'permission': 'ngo_don:view', 'nav_group': 'Overview'}, {'name': 'settings', 'path': '/ngo-don/settings', 'component': 'NgoDonSettings', 'permission': 'ngo_don:admin', 'nav_group': 'Administration'}],
        },
