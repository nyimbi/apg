...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
    return {
        ...
        "ui": {
            ...
            "routes": [{'name': 'dashboard', 'path': '/ngo-rbf/dashboard', 'component': 'NgoRbfDashboard', 'permission': 'ngo_rbf:view', 'nav_group': 'Overview'}, {'name': 'list', 'path': '/ngo-rbf/list', 'component': 'NgoRbfList', 'permission': 'ngo_rbf:view', 'nav_group': 'Overview'}, {'name': 'settings', 'path': '/ngo-rbf/settings', 'component': 'NgoRbfSettings', 'permission': 'ngo_rbf:admin', 'nav_group': 'Administration'}],
        },
