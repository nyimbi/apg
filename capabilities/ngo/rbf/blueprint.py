"""
Ngo Rbf — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "ngo_rbf")
		return {"success": True, "capability_id": "ngo_rbf"}
	except Exception as exc:
		_log.error("Blueprint registration failed for ngo_rbf: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "ngo_rbf"}
