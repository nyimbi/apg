"""
Ngo Grn — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "ngo_grn")
		return {"success": True, "capability_id": "ngo_grn"}
	except Exception as exc:
		_log.error("Blueprint registration failed for ngo_grn: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "ngo_grn"}
