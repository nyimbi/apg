"""Standalone APG Medical Device Management application.

Run directly::

    python -m apg_healthcare_dev
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-healthcare-dev",
        description=f"APG Medical Device Management capability server",
    )
