"""Standalone APG Pharmacy Management application.

Run directly::

    python -m apg_healthcare_pha
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-healthcare-pha",
        description=f"APG Pharmacy Management capability server",
    )
