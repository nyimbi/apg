"""
Hea Pha — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "hea_pha")
		return {"success": True, "capability_id": "hea_pha"}
	except Exception as exc:
		_log.error("Blueprint registration failed for hea_pha: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "hea_pha"}
