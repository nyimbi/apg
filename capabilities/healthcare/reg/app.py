"""Standalone APG Healthcare Regulatory application.

Run directly::

    python -m apg_healthcare_reg
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-healthcare-reg",
        description=f"APG Healthcare Regulatory capability server",
    )
