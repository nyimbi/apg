"""Standalone APG Electronic Medical Records application.

Run directly::

    python -m apg_healthcare_emr
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-healthcare-emr",
        description=f"APG Electronic Medical Records capability server",
    )
