"""Standalone APG Clinical Management application.

Run directly::

    python -m apg_healthcare_cli
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-healthcare-cli",
        description=f"APG Clinical Management capability server",
    )
