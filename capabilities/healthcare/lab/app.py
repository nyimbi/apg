"""Standalone APG Laboratory Information System application.

Run directly::

    python -m apg_healthcare_lab
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-healthcare-lab",
        description=f"APG Laboratory Information System capability server",
    )
