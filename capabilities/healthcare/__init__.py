"""
Healthcare & Medical (HCR) Industry Vertical

Healthcare industry-specific capabilities including patient management,
medical records, regulatory compliance, and clinical workflows.
...
# Sub-capability Registry with 3-character naming
SUBCAPABILITIES = [
