...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
    return {
        ...
        "ui": {
            ...
            "routes": [{'name': 'dashboard', 'path': '/hos-evn/dashboard', 'component': 'HosEvnDashboard', 'permission': 'hos_evn:view', 'nav_group': 'Overview'}, {'name': 'list', 'path': '/hos-evn/list', 'component': 'HosEvnList', 'permission': 'hos_evn:view', 'nav_group': 'Overview'}, {'name': 'settings', 'path': '/hos-evn/settings', 'component': 'HosEvnSettings', 'permission': 'hos_evn:admin', 'nav_group': 'Administration'}],
        },
