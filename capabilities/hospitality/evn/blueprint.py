"""
Hos Evn — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "hos_evn")
		return {"success": True, "capability_id": "hos_evn"}
	except Exception as exc:
		_log.error("Blueprint registration failed for hos_evn: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "hos_evn"}
