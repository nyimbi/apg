"""
Hos Spa — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "hos_spa")
		return {"success": True, "capability_id": "hos_spa"}
	except Exception as exc:
		_log.error("Blueprint registration failed for hos_spa: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "hos_spa"}
