"""
Hos Rms — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "hos_rms")
		return {"success": True, "capability_id": "hos_rms"}
	except Exception as exc:
		_log.error("Blueprint registration failed for hos_rms: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "hos_rms"}
