"""
Ene Dis — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "ene_dis")
		return {"success": True, "capability_id": "ene_dis"}
	except Exception as exc:
		_log.error("Blueprint registration failed for ene_dis: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "ene_dis"}
