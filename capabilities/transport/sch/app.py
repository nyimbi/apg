"""Standalone APG Transport Scheduling application.

Run directly::

    python -m apg_transport_sch
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-transport-sch",
        description=f"APG Transport Scheduling capability server",
    )
