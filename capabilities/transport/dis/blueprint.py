"""
Tra Dis — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "tra_dis")
		return {"success": True, "capability_id": "tra_dis"}
	except Exception as exc:
		_log.error("Blueprint registration failed for tra_dis: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "tra_dis"}
