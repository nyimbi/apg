"""
Tra War — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "tra_war")
		return {"success": True, "capability_id": "tra_war"}
	except Exception as exc:
		_log.error("Blueprint registration failed for tra_war: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "tra_war"}
