"""Standalone APG Warehouse Operations application.

Run directly::

    python -m apg_transport_war
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-transport-war",
        description=f"APG Warehouse Operations capability server",
    )
