"""
Tra Car — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "tra_car")
		return {"success": True, "capability_id": "tra_car"}
	except Exception as exc:
		_log.error("Blueprint registration failed for tra_car: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "tra_car"}
