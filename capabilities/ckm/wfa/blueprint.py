"""
Ckm Wfa — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "ckm_wfa")
		return {"success": True, "capability_id": "ckm_wfa"}
	except Exception as exc:
		_log.error("Blueprint registration failed for ckm_wfa: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "ckm_wfa"}
