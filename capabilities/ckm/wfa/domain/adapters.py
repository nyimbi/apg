"""Adapter protocols for Workflow Automation.
...
Usage (standalone)::
    ...
    svc = WorkflowAutomationService()                   # null adapters, in-memory store
    svc = WorkflowAutomationService(db_url="postgresql+asyncpg://...")

Usage (platform)::

    from apg_common_auth import AuthService
    svc = WorkflowAutomationService(auth=AuthService.from_env())
"""
