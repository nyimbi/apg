"""Standalone APG Property Management application.

Run directly::

    python -m apg_realestate_prm
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-realestate-prm",
        description=f"APG Property Management capability server",
    )
