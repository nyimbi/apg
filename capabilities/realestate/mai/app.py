"""Standalone APG Facilities Maintenance application.

Run directly::

    python -m apg_realestate_mai
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-realestate-mai",
        description=f"APG Facilities Maintenance capability server",
    )
