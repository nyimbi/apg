"""
Rea Ins — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "rea_ins")
		return {"success": True, "capability_id": "rea_ins"}
	except Exception as exc:
		_log.error("Blueprint registration failed for rea_ins: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "rea_ins"}
