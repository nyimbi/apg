"""Standalone APG Real Estate Accounting application.

Run directly::

    python -m apg_realestate_acc
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-realestate-acc",
        description=f"APG Real Estate Accounting capability server",
    )
