"""Standalone APG Space Planning & Management application.

Run directly::

    python -m apg_realestate_spa
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="apg-realestate-spa",
        description=f"APG Space Planning & Management capability server",
    )
