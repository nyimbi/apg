"""
Rea Val — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "rea_val")
		return {"success": True, "capability_id": "rea_val"}
	except Exception as exc:
		_log.error("Blueprint registration failed for rea_val: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "rea_val"}
