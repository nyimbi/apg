"""
Ret Omc — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "ret_omc")
		return {"success": True, "capability_id": "ret_omc"}
	except Exception as exc:
		_log.error("Blueprint registration failed for ret_omc: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "ret_omc"}
