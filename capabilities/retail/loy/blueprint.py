"""
Ret Loy — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "ret_loy")
		return {"success": True, "capability_id": "ret_loy"}
	except Exception as exc:
		_log.error("Blueprint registration failed for ret_loy: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "ret_loy"}
