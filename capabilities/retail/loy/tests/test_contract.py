"""Contract validation tests for retail_loy capability."""
...
def test_capability_id():
	assert get_capability_contract()["capability"] == "retail_loy"
...
def test_evaluate_rules_deny_earn_no_receipt():
...
def test_evaluate_rules_deny_redeem_insufficient_balance():
	result = evaluate_capability_rules({
		"tenant_context_present": True,
