"""
Ret Pos — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "ret_pos")
		return {"success": True, "capability_id": "ret_pos"}
	except Exception as exc:
		_log.error("Blueprint registration failed for ret_pos: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "ret_pos"}
