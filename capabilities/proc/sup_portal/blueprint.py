"""
Pro Sup Portal — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "pro_sup_portal")
		return {"success": True, "capability_id": "pro_sup_portal"}
	except Exception as exc:
		_log.error("Blueprint registration failed for pro_sup_portal: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "pro_sup_portal"}
