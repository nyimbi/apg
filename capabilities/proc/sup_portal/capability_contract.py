...
THEME = {
	...
	"tokens": {"color.primary": "#1A3A5C", "color.accent": "#F59E0B", "color.success": "#10B981", "color.danger": "#EF4444", "surface.canvas": "#F8FAFC", "surface.panel": "#FFFFFF", "text.primary": "#111827", "border.radius": "8px", "density": "compact"},
}
...
def get_capability_contract(tenant_id: str = "default") -> dict[str, Any]:
	return {"id": CAPABILITY_ID, "name": CAPABILITY_NAME, "version": CAPABILITY_VERSION,
		...
		"ui": {
			...
			"routes": [{'name': 'dashboard', 'path': '/supplier/dashboard', 'component': 'SupplierDashboard', 'permission': 'proc_sup_portal:view', 'nav_group': 'Overview'}, {'name': 'pos', 'path': '/supplier/purchase-orders', 'component': 'SupplierPOList', 'permission': 'proc_sup_portal:view', 'nav_group': 'Orders'}, {'name': 'invoices', 'path': '/supplier/invoices', 'component': 'SupplierInvoices', 'permission': 'proc_sup_portal:invoice', 'nav_group': 'Invoices'}, {'name': 'disputes', 'path': '/supplier/disputes', 'component': 'SupplierDisputes', 'permission': 'proc_sup_portal:dispute', 'nav_group': 'Disputes'}, {'name': 'profile', 'path': '/supplier/profile', 'component': 'SupplierProfile', 'permission': 'proc_sup_portal:manage', 'nav_group': 'Account'}],
		},
