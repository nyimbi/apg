"""
Pro Twy — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "pro_twy")
		return {"success": True, "capability_id": "pro_twy"}
	except Exception as exc:
		_log.error("Blueprint registration failed for pro_twy: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "pro_twy"}
