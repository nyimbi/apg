"""Adapter protocols for Policy Management.
...
Usage (standalone)::
    ...
    svc = PolicyManagementService()                   # null adapters, in-memory store
    svc = PolicyManagementService(db_url="postgresql+asyncpg://...")
...
def get_audit_adapter(audit_service: Any | None = None) -> AuditAdapter:
    ...
    try:
        ...
        _nats = get_nats_audit_adapter("grc_pol")
