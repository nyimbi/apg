"""
Grc Rcm — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "grc_rcm")
		return {"success": True, "capability_id": "grc_rcm"}
	except Exception as exc:
		_log.error("Blueprint registration failed for grc_rcm: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "grc_rcm"}
