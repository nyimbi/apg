"""Adapter protocols for Audit Management.
...
Usage (standalone)::
    ...
    svc = AuditManagementService()                   # null adapters, in-memory store
    svc = AuditManagementService(db_url="postgresql+asyncpg://...")
...
def get_audit_adapter(audit_service: Any | None = None) -> AuditAdapter:
    ...
    try:
        ...
        _nats = get_nats_audit_adapter("grc_aud")
