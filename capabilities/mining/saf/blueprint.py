"""
Min Saf — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "min_saf")
		return {"success": True, "capability_id": "min_saf"}
	except Exception as exc:
		_log.error("Blueprint registration failed for min_saf: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "min_saf"}
