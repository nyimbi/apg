"""
Min Pro — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "min_pro")
		return {"success": True, "capability_id": "min_pro"}
	except Exception as exc:
		_log.error("Blueprint registration failed for min_pro: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "min_pro"}
