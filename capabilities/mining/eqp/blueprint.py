"""
Min Eqp — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "min_eqp")
		return {"success": True, "capability_id": "min_eqp"}
	except Exception as exc:
		_log.error("Blueprint registration failed for min_eqp: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "min_eqp"}
