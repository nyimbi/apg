"""
Min Ore — APG Blueprint Registration
...
def init_subcapability(appbuilder) -> dict[str, Any]:
	...
	try:
		...
		_log.info("Registered blueprint: %s", "min_ore")
		return {"success": True, "capability_id": "min_ore"}
	except Exception as exc:
		_log.error("Blueprint registration failed for min_ore: %s", exc)
...
def get_health_status() -> dict[str, Any]:
	...
	return {"status": "healthy", "capability_id": "min_ore"}
