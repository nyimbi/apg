...
try:
	...
	_spec = importlib.util.spec_from_file_location("composition_access_capability_contract", _contract_path)
...
def semantic_model() -> dict[str, Any]:
	...
	return {
		...
		"app": {
			"name": capability_id,
			"description": "Composition access-control package-backed APG capability",
			"version": "2.1.0",
			"entity_count": 7,
		},
		"capabilities": {
...
def self_test() -> dict[str, Any]:
	...
	errors: list[str] = []
	capability = model.get("capabilities", {}).get("composition_access", {})
	...
	if "access_agents" not in capability.get("provides", []):
