"""Tests for bia_pda capability contract."""
...
def test_capability_id(): assert CAPABILITY_ID == "bia_pda"
...
def test_allow_no_match(): assert evaluate_capability_rules({"operation": "list"})["decision"] == "allow"
