"""Tests for bia_psa capability contract."""
...
def test_capability_id(): assert CAPABILITY_ID == "bia_psa"
def test_contract_keys():
	for k in ["capability","display_name","version","configuration","configuration_schema","rule_engine","ui","theme","streaming","provides","requires"]: assert k in get_capability_contract()
...
def test_allow_no_match(): assert evaluate_capability_rules({"op": "list"})["decision"] == "allow"
