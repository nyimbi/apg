"""Adapter protocols for Report Builder.
...
Usage (standalone)::
    ...
    svc = ReportBuilderService()                   # null adapters, in-memory store
    svc = ReportBuilderService(db_url="postgresql+asyncpg://...")

Usage (platform)::

    from apg_common_auth import AuthService
    svc = ReportBuilderService(auth=AuthService.from_env())
"""
...
def get_audit_adapter(audit_service: Any | None = None) -> AuditAdapter:
    ...
    try:
        ...
        _nats = get_nats_audit_adapter("bia_rpt")
