...
| Compiler baseline | `./.venv/bin/apg baseline examples --json` for numbered examples, generated source hygiene, self-test, smoke-test, graph, model, and release agreement |
