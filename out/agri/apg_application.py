...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'AgriMarketApp': {'description': 'Farm-to-buyer produce marketplace', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': [], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
