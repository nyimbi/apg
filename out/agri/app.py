"""
agri_marketplace - APG Python Application
=========================================
...
MODULE_NAME = 'agri_marketplace'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'Farmer', 'type': 'entity', 'properties': ['id', 'farmer_code', 'full_name', 'phone', 'county', 'sub_county', 'ward', 'farm_size_acres', 'primary_crop', 'cooperative_id', 'verified', 'mpesa_number'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'farmer_code', 'type': 'str', 'required': True}, {'name': 'full_name', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str', 'required': True}, {'name': 'county', 'type': 'str', 'required': True}, {'name': 'sub_county', 'type': 'str', 'required': True}, {'name': 'ward', 'type': 'str', 'required': True}, {'name': 'farm_size_acres', 'type': 'float', 'required': True}, {'name': 'primary_crop', 'type': 'str', 'required': True}, {'name': 'cooperative_id', 'type': 'str', 'required': True}, {'name': 'verified', 'type': 'bool', 'required': True}, {'name': 'mpesa_number', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Produce', 'type': 'entity', 'properties': ['id', 'farmer_id', 'crop_name', 'variety', 'quantity_kg', 'asking_price_per_kg', 'harvest_date', 'quality_grade', 'location', 'available_from', 'available_until', 'status', 'description'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'farmer_id', 'type': 'str', 'required': True}, {'name': 'crop_name', 'type': 'str', 'required': True}, {'name': 'variety', 'type': 'str', 'required': True}, {'name': 'quantity_kg', 'type': 'float', 'required': True}, {'name': 'asking_price_per_kg', 'type': 'float', 'required': True}, {'name': 'harvest_date', 'type': 'date', 'required': True}, {'name': 'quality_grade', 'type': 'str', 'required': True}, {'name': 'location', 'type': 'str', 'required': True}, {'name': 'available_from', 'type': 'date', 'required': True}, {'name': 'available_until', 'type': 'date', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Buyer', 'type': 'entity', 'properties': ['id', 'company_name', 'contact_person', 'phone', 'email', 'buyer_type', 'county', 'credit_limit', 'payment_terms', 'verified'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'company_name', 'type': 'str', 'required': True}, {'name': 'contact_person', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'buyer_type', 'type': 'str', 'required': True}, {'name': 'county', 'type': 'str', 'required': True}, {'name': 'credit_limit', 'type': 'float', 'required': True}, {'name': 'payment_terms', 'type': 'str', 'required': True}, {'name': 'verified', 'type': 'bool', 'required': True}], 'methods': []}, {'name': 'Order', 'type': 'entity', 'properties': ['id', 'order_number', 'buyer_id', 'produce_id', 'farmer_id', 'quantity_kg', 'agreed_price_per_kg', 'total_amount', 'order_date', 'delivery_date', 'delivery_location', 'payment_method', 'payment_status', 'order_status'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'order_number', 'type': 'str', 'required': True}, {'name': 'buyer_id', 'type': 'str', 'required': True}, {'name': 'produce_id', 'type': 'str', 'required': True}, {'name': 'farmer_id', 'type': 'str', 'required': True}, {'name': 'quantity_kg', 'type': 'float', 'required': True}, {'name': 'agreed_price_per_kg', 'type': 'float', 'required': True}, {'name': 'total_amount', 'type': 'float', 'required': True}, {'name': 'order_date', 'type': 'date', 'required': True}, {'name': 'delivery_date', 'type': 'date', 'required': True}, {'name': 'delivery_location', 'type': 'str', 'required': True}, {'name': 'payment_method', 'type': 'str', 'required': True}, {'name': 'payment_status', 'type': 'str', 'required': True}, {'name': 'order_status', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'PriceIndex', 'type': 'entity', 'properties': ['id', 'crop_name', 'market_name', 'price_per_kg', 'recorded_date', 'source', 'county'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'crop_name', 'type': 'str', 'required': True}, {'name': 'market_name', 'type': 'str', 'required': True}, {'name': 'price_per_kg', 'type': 'float', 'required': True}, {'name': 'recorded_date', 'type': 'date', 'required': True}, {'name': 'source', 'type': 'str', 'required': True}, {'name': 'county', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'WeatherAlert', 'type': 'entity', 'properties': ['id', 'alert_type', 'county', 'severity', 'message', 'issued_date', 'valid_until', 'affected_crops'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'alert_type', 'type': 'str', 'required': True}, {'name': 'county', 'type': 'str', 'required': True}, {'name': 'severity', 'type': 'str', 'required': True}, {'name': 'message', 'type': 'str', 'required': True}, {'name': 'issued_date', 'type': 'date', 'required': True}, {'name': 'valid_until', 'type': 'date', 'required': True}, {'name': 'affected_crops', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'AgriMarketApp', 'type': 'application', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['agri_marketplace.apg'], 'app': {'name': 'agri_marketplace', 'version': '1.0.0', 'description': None, 'entity_count': 7}, 'symbols': {'module.agri_marketplace': {'id': 'module.agri_marketplace', 'kind': 'module', 'name': 'agri_marketplace', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Farmer': {'id': 'table.Farmer', 'kind': 'table', 'name': 'Farmer', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Farmer.id': {'id': 'field.Farmer.id', 'kind': 'field', 'name': 'Farmer.id', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Farmer.farmer_code': {'id': 'field.Farmer.farmer_code', 'kind': 'field', 'name': 'Farmer.farmer_code', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Farmer.full_name': {'id': 'field.Farmer.full_name', 'kind': 'field', 'name': 'Farmer.full_name', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Farmer.phone': {'id': 'field.Farmer.phone', 'kind': 'field', 'name': 'Farmer.phone', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Farmer.county': {'id': 'field.Farmer.county', 'kind': 'field', 'name': 'Farmer.county', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Farmer.sub_county': {'id': 'field.Farmer.sub_county', 'kind': 'field', 'name': 'Farmer.sub_county', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Farmer.ward': {'id': 'field.Farmer.ward', 'kind': 'field', 'name': 'Farmer.ward', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Farmer.farm_size_acres': {'id': 'field.Farmer.farm_size_acres', 'kind': 'field', 'name': 'Farmer.farm_size_acres', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Farmer.primary_crop': {'id': 'field.Farmer.primary_crop', 'kind': 'field', 'name': 'Farmer.primary_crop', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Farmer.cooperative_id': {'id': 'field.Farmer.cooperative_id', 'kind': 'field', 'name': 'Farmer.cooperative_id', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Farmer.verified': {'id': 'field.Farmer.verified', 'kind': 'field', 'name': 'Farmer.verified', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Farmer.mpesa_number': {'id': 'field.Farmer.mpesa_number', 'kind': 'field', 'name': 'Farmer.mpesa_number', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Produce': {'id': 'table.Produce', 'kind': 'table', 'name': 'Produce', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.id': {'id': 'field.Produce.id', 'kind': 'field', 'name': 'Produce.id', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.farmer_id': {'id': 'field.Produce.farmer_id', 'kind': 'field', 'name': 'Produce.farmer_id', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.crop_name': {'id': 'field.Produce.crop_name', 'kind': 'field', 'name': 'Produce.crop_name', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.variety': {'id': 'field.Produce.variety', 'kind': 'field', 'name': 'Produce.variety', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.quantity_kg': {'id': 'field.Produce.quantity_kg', 'kind': 'field', 'name': 'Produce.quantity_kg', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.asking_price_per_kg': {'id': 'field.Produce.asking_price_per_kg', 'kind': 'field', 'name': 'Produce.asking_price_per_kg', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.harvest_date': {'id': 'field.Produce.harvest_date', 'kind': 'field', 'name': 'Produce.harvest_date', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.quality_grade': {'id': 'field.Produce.quality_grade', 'kind': 'field', 'name': 'Produce.quality_grade', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.location': {'id': 'field.Produce.location', 'kind': 'field', 'name': 'Produce.location', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.available_from': {'id': 'field.Produce.available_from', 'kind': 'field', 'name': 'Produce.available_from', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.available_until': {'id': 'field.Produce.available_until', 'kind': 'field', 'name': 'Produce.available_until', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.status': {'id': 'field.Produce.status', 'kind': 'field', 'name': 'Produce.status', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Produce.description': {'id': 'field.Produce.description', 'kind': 'field', 'name': 'Produce.description', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Buyer': {'id': 'table.Buyer', 'kind': 'table', 'name': 'Buyer', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Buyer.id': {'id': 'field.Buyer.id', 'kind': 'field', 'name': 'Buyer.id', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Buyer.company_name': {'id': 'field.Buyer.company_name', 'kind': 'field', 'name': 'Buyer.company_name', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Buyer.contact_person': {'id': 'field.Buyer.contact_person', 'kind': 'field', 'name': 'Buyer.contact_person', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Buyer.phone': {'id': 'field.Buyer.phone', 'kind': 'field', 'name': 'Buyer.phone', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Buyer.email': {'id': 'field.Buyer.email', 'kind': 'field', 'name': 'Buyer.email', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Buyer.buyer_type': {'id': 'field.Buyer.buyer_type', 'kind': 'field', 'name': 'Buyer.buyer_type', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Buyer.county': {'id': 'field.Buyer.county', 'kind': 'field', 'name': 'Buyer.county', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Buyer.credit_limit': {'id': 'field.Buyer.credit_limit', 'kind': 'field', 'name': 'Buyer.credit_limit', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Buyer.payment_terms': {'id': 'field.Buyer.payment_terms', 'kind': 'field', 'name': 'Buyer.payment_terms', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Buyer.verified': {'id': 'field.Buyer.verified', 'kind': 'field', 'name': 'Buyer.verified', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Order': {'id': 'table.Order', 'kind': 'table', 'name': 'Order', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.id': {'id': 'field.Order.id', 'kind': 'field', 'name': 'Order.id', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.order_number': {'id': 'field.Order.order_number', 'kind': 'field', 'name': 'Order.order_number', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.buyer_id': {'id': 'field.Order.buyer_id', 'kind': 'field', 'name': 'Order.buyer_id', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.produce_id': {'id': 'field.Order.produce_id', 'kind': 'field', 'name': 'Order.produce_id', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.farmer_id': {'id': 'field.Order.farmer_id', 'kind': 'field', 'name': 'Order.farmer_id', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.quantity_kg': {'id': 'field.Order.quantity_kg', 'kind': 'field', 'name': 'Order.quantity_kg', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.agreed_price_per_kg': {'id': 'field.Order.agreed_price_per_kg', 'kind': 'field', 'name': 'Order.agreed_price_per_kg', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.total_amount': {'id': 'field.Order.total_amount', 'kind': 'field', 'name': 'Order.total_amount', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.order_date': {'id': 'field.Order.order_date', 'kind': 'field', 'name': 'Order.order_date', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.delivery_date': {'id': 'field.Order.delivery_date', 'kind': 'field', 'name': 'Order.delivery_date', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.delivery_location': {'id': 'field.Order.delivery_location', 'kind': 'field', 'name': 'Order.delivery_location', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.payment_method': {'id': 'field.Order.payment_method', 'kind': 'field', 'name': 'Order.payment_method', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.payment_status': {'id': 'field.Order.payment_status', 'kind': 'field', 'name': 'Order.payment_status', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.order_status': {'id': 'field.Order.order_status', 'kind': 'field', 'name': 'Order.order_status', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.PriceIndex': {'id': 'table.PriceIndex', 'kind': 'table', 'name': 'PriceIndex', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.PriceIndex.id': {'id': 'field.PriceIndex.id', 'kind': 'field', 'name': 'PriceIndex.id', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.PriceIndex.crop_name': {'id': 'field.PriceIndex.crop_name', 'kind': 'field', 'name': 'PriceIndex.crop_name', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.PriceIndex.market_name': {'id': 'field.PriceIndex.market_name', 'kind': 'field', 'name': 'PriceIndex.market_name', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.PriceIndex.price_per_kg': {'id': 'field.PriceIndex.price_per_kg', 'kind': 'field', 'name': 'PriceIndex.price_per_kg', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.PriceIndex.recorded_date': {'id': 'field.PriceIndex.recorded_date', 'kind': 'field', 'name': 'PriceIndex.recorded_date', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.PriceIndex.source': {'id': 'field.PriceIndex.source', 'kind': 'field', 'name': 'PriceIndex.source', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.PriceIndex.county': {'id': 'field.PriceIndex.county', 'kind': 'field', 'name': 'PriceIndex.county', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.WeatherAlert': {'id': 'table.WeatherAlert', 'kind': 'table', 'name': 'WeatherAlert', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WeatherAlert.id': {'id': 'field.WeatherAlert.id', 'kind': 'field', 'name': 'WeatherAlert.id', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WeatherAlert.alert_type': {'id': 'field.WeatherAlert.alert_type', 'kind': 'field', 'name': 'WeatherAlert.alert_type', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WeatherAlert.county': {'id': 'field.WeatherAlert.county', 'kind': 'field', 'name': 'WeatherAlert.county', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WeatherAlert.severity': {'id': 'field.WeatherAlert.severity', 'kind': 'field', 'name': 'WeatherAlert.severity', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WeatherAlert.message': {'id': 'field.WeatherAlert.message', 'kind': 'field', 'name': 'WeatherAlert.message', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WeatherAlert.issued_date': {'id': 'field.WeatherAlert.issued_date', 'kind': 'field', 'name': 'WeatherAlert.issued_date', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WeatherAlert.valid_until': {'id': 'field.WeatherAlert.valid_until', 'kind': 'field', 'name': 'WeatherAlert.valid_until', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.WeatherAlert.affected_crops': {'id': 'field.WeatherAlert.affected_crops', 'kind': 'field', 'name': 'WeatherAlert.affected_crops', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.AgriMarketApp': {'id': 'app.AgriMarketApp', 'kind': 'app', 'name': 'AgriMarketApp', 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'Farmer': {'name': 'Farmer', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'farmer_code': {'type': 'str', 'required': True, 'relationship': None}, 'full_name': {'type': 'str', 'required': True, 'relationship': None}, 'phone': {'type': 'str', 'required': True, 'relationship': None}, 'county': {'type': 'str', 'required': True, 'relationship': None}, 'sub_county': {'type': 'str', 'required': True, 'relationship': None}, 'ward': {'type': 'str', 'required': True, 'relationship': None}, 'farm_size_acres': {'type': 'float', 'required': True, 'relationship': None}, 'primary_crop': {'type': 'str', 'required': True, 'relationship': None}, 'cooperative_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Cooperative', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'cooperative'}}, 'verified': {'type': 'bool', 'required': True, 'relationship': None}, 'mpesa_number': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {}}, 'Produce': {'name': 'Produce', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'farmer_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Farmer', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'farmer'}}, 'crop_name': {'type': 'str', 'required': True, 'relationship': None}, 'variety': {'type': 'str', 'required': True, 'relationship': None}, 'quantity_kg': {'type': 'float', 'required': True, 'relationship': None}, 'asking_price_per_kg': {'type': 'float', 'required': True, 'relationship': None}, 'harvest_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'quality_grade': {'type': 'str', 'required': True, 'relationship': None}, 'location': {'type': 'str', 'required': True, 'relationship': None}, 'available_from': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'available_until': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'description': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'harvest_date.id': {'chain': ['Produce.harvest_date', 'date.id'], 'valid': True}, 'available_from.id': {'chain': ['Produce.available_from', 'date.id'], 'valid': True}, 'available_until.id': {'chain': ['Produce.available_until', 'date.id'], 'valid': True}}}, 'Buyer': {'name': 'Buyer', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'company_name': {'type': 'str', 'required': True, 'relationship': None}, 'contact_person': {'type': 'str', 'required': True, 'relationship': None}, 'phone': {'type': 'str', 'required': True, 'relationship': None}, 'email': {'type': 'str', 'required': True, 'relationship': None}, 'buyer_type': {'type': 'str', 'required': True, 'relationship': None}, 'county': {'type': 'str', 'required': True, 'relationship': None}, 'credit_limit': {'type': 'float', 'required': True, 'relationship': None}, 'payment_terms': {'type': 'str', 'required': True, 'relationship': None}, 'verified': {'type': 'bool', 'required': True, 'relationship': None}}, 'lookup_paths': {}}, 'Order': {'name': 'Order', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'order_number': {'type': 'str', 'required': True, 'relationship': None}, 'buyer_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Buyer', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'buyer'}}, 'produce_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Produce', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'produce'}}, 'farmer_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Farmer', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'farmer'}}, 'quantity_kg': {'type': 'float', 'required': True, 'relationship': None}, 'agreed_price_per_kg': {'type': 'float', 'required': True, 'relationship': None}, 'total_amount': {'type': 'float', 'required': True, 'relationship': None}, 'order_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'delivery_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'delivery_location': {'type': 'str', 'required': True, 'relationship': None}, 'payment_method': {'type': 'str', 'required': True, 'relationship': None}, 'payment_status': {'type': 'str', 'required': True, 'relationship': None}, 'order_status': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'order_date.id': {'chain': ['Order.order_date', 'date.id'], 'valid': True}, 'delivery_date.id': {'chain': ['Order.delivery_date', 'date.id'], 'valid': True}}}, 'PriceIndex': {'name': 'PriceIndex', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'crop_name': {'type': 'str', 'required': True, 'relationship': None}, 'market_name': {'type': 'str', 'required': True, 'relationship': None}, 'price_per_kg': {'type': 'float', 'required': True, 'relationship': None}, 'recorded_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'source': {'type': 'str', 'required': True, 'relationship': None}, 'county': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'recorded_date.id': {'chain': ['PriceIndex.recorded_date', 'date.id'], 'valid': True}}}, 'WeatherAlert': {'name': 'WeatherAlert', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'alert_type': {'type': 'str', 'required': True, 'relationship': None}, 'county': {'type': 'str', 'required': True, 'relationship': None}, 'severity': {'type': 'str', 'required': True, 'relationship': None}, 'message': {'type': 'str', 'required': True, 'relationship': None}, 'issued_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'valid_until': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'affected_crops': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'issued_date.id': {'chain': ['WeatherAlert.issued_date', 'date.id'], 'valid': True}, 'valid_until.id': {'chain': ['WeatherAlert.valid_until', 'date.id'], 'valid': True}}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {'AgriMarketApp': {'name': 'AgriMarketApp', 'description': 'Farm-to-buyer produce marketplace', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': [], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'agri_marketplace.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 70, 'edges': 68}, 'lookup': {'kind': 'lookup', 'nodes': 8, 'edges': 7}, 'workflow': {'kind': 'workflow', 'nodes': 8, 'edges': 7}, 'handler': {'kind': 'handler', 'nodes': 8, 'edges': 7}, 'capability': {'kind': 'capability', 'nodes': 1, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 8, 'edges': 7}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 8, 'edges': 7}, 'package': {'kind': 'package', 'nodes': 8, 'edges': 7}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Application 'AgriMarketApp' should compose capabilities, components, or routes", 'file': 'agri_marketplace.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
