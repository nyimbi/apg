...
ENTITIES = [{'name': 'AutoAssemblyLine', 'type': 'entity', 'properties': ['cycle_time', 'takt_time', 'throughput', 'bottleneck_detection'], 'fields': [{'name': 'cycle_time', 'type': 'target(180s) ± tolerance(10s)', 'required': True}, {'name': 'takt_time', 'type': 'customer_demand(480_units/day) / operating_time(16h)', 'required': True}, {'name': 'throughput', 'type': 'float', 'required': True}, {'name': 'bottleneck_detection', 'type': 'string', 'required': True}], 'methods': []}, {'name': 'PharmaceuticalProduction', 'type': 'entity', 'properties': [], 'fields': [], 'methods': []}, {'name': 'SemiconductorWaferInspection', 'type': 'entity', 'properties': ['training_data'], 'fields': [{'name': 'training_data', 'type': 'string', 'required': True}], 'methods': []}, {'name': 'FoodProcessingQC', 'type': 'entity', 'properties': [], 'fields': [], 'methods': []}, {'name': 'TextileQualityControl', 'type': 'entity', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ElectronicsAssemblyInspection', 'type': 'entity', 'properties': [], 'fields': [], 'methods': []}, {'name': 'IntegratedQualitySystem', 'type': 'entity', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['main.apg'], 'app': {'name': 'main', 'version': '1.0.0', 'description': None, 'entity_count': 7}, 'symbols': {'module.main': {'id': 'module.main', 'kind': 'module', 'name': 'main', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.AutoAssemblyLine': {'id': 'table.AutoAssemblyLine', 'kind': 'table', 'name': 'AutoAssemblyLine', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.AutoAssemblyLine.cycle_time': {'id': 'field.AutoAssemblyLine.cycle_time', 'kind': 'field', 'name': 'AutoAssemblyLine.cycle_time', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.AutoAssemblyLine.takt_time': {'id': 'field.AutoAssemblyLine.takt_time', 'kind': 'field', 'name': 'AutoAssemblyLine.takt_time', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.AutoAssemblyLine.throughput': {'id': 'field.AutoAssemblyLine.throughput', 'kind': 'field', 'name': 'AutoAssemblyLine.throughput', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.AutoAssemblyLine.bottleneck_detection': {'id': 'field.AutoAssemblyLine.bottleneck_detection', 'kind': 'field', 'name': 'AutoAssemblyLine.bottleneck_detection', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'entity.PharmaceuticalProduction': {'id': 'entity.PharmaceuticalProduction', 'kind': 'entity', 'name': 'PharmaceuticalProduction', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.SemiconductorWaferInspection': {'id': 'table.SemiconductorWaferInspection', 'kind': 'table', 'name': 'SemiconductorWaferInspection', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SemiconductorWaferInspection.training_data': {'id': 'field.SemiconductorWaferInspection.training_data', 'kind': 'field', 'name': 'SemiconductorWaferInspection.training_data', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'entity.FoodProcessingQC': {'id': 'entity.FoodProcessingQC', 'kind': 'entity', 'name': 'FoodProcessingQC', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'entity.TextileQualityControl': {'id': 'entity.TextileQualityControl', 'kind': 'entity', 'name': 'TextileQualityControl', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'entity.ElectronicsAssemblyInspection': {'id': 'entity.ElectronicsAssemblyInspection', 'kind': 'entity', 'name': 'ElectronicsAssemblyInspection', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'entity.IntegratedQualitySystem': {'id': 'entity.IntegratedQualitySystem', 'kind': 'entity', 'name': 'IntegratedQualitySystem', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'AutoAssemblyLine': {'name': 'AutoAssemblyLine', 'fields': {'cycle_time': {'type': 'target(180s) ± tolerance(10s)', 'required': True, 'relationship': {'target_table': 'target(180s) ± tolerance(10s)', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'takt_time': {'type': 'customer_demand(480_units/day) / operating_time(16h)', 'required': True, 'relationship': {'target_table': 'customer_demand(480_units/day) / operating_time(16h)', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'throughput': {'type': 'float', 'required': True, 'relationship': None}, 'bottleneck_detection': {'type': 'string', 'required': True, 'relationship': {'target_table': 'string', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'cycle_time.id': {'chain': ['AutoAssemblyLine.cycle_time', 'target(180s) ± tolerance(10s).id'], 'valid': True}, 'takt_time.id': {'chain': ['AutoAssemblyLine.takt_time', 'customer_demand(480_units/day) / operating_time(16h).id'], 'valid': True}, 'bottleneck_detection.id': {'chain': ['AutoAssemblyLine.bottleneck_detection', 'string.id'], 'valid': True}}}, 'SemiconductorWaferInspection': {'name': 'SemiconductorWaferInspection', 'fields': {'training_data': {'type': 'string', 'required': True, 'relationship': {'target_table': 'string', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'training_data.id': {'chain': ['SemiconductorWaferInspection.training_data', 'string.id'], 'valid': True}}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'main.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 12, 'edges': 5}, 'lookup': {'kind': 'lookup', 'nodes': 8, 'edges': 7}, 'workflow': {'kind': 'workflow', 'nodes': 8, 'edges': 7}, 'handler': {'kind': 'handler', 'nodes': 8, 'edges': 7}, 'capability': {'kind': 'capability', 'nodes': 0, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 8, 'edges': 7}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 8, 'edges': 7}, 'package': {'kind': 'package', 'nodes': 8, 'edges': 7}}, 'diagnostics': []}
