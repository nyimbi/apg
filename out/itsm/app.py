"""
itsm_helpdesk - APG Python Application
======================================
...
MODULE_NAME = 'itsm_helpdesk'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'Ticket', 'type': 'entity', 'properties': ['id', 'ticket_number', 'title', 'description', 'category', 'priority', 'status', 'reporter_id', 'assignee_id', 'department', 'created_date', 'resolved_date', 'sla_breach', 'resolution', 'impact', 'urgency'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'ticket_number', 'type': 'str', 'required': True}, {'name': 'title', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str', 'required': True}, {'name': 'category', 'type': 'str', 'required': True}, {'name': 'priority', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'reporter_id', 'type': 'str', 'required': True}, {'name': 'assignee_id', 'type': 'str', 'required': True}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'created_date', 'type': 'date', 'required': True}, {'name': 'resolved_date', 'type': 'date', 'required': True}, {'name': 'sla_breach', 'type': 'bool', 'required': True}, {'name': 'resolution', 'type': 'str', 'required': True}, {'name': 'impact', 'type': 'str', 'required': True}, {'name': 'urgency', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Asset', 'type': 'entity', 'properties': ['id', 'asset_tag', 'asset_name', 'asset_type', 'manufacturer', 'model', 'serial_number', 'purchase_date', 'warranty_expiry', 'location', 'assigned_to', 'department', 'status', 'ip_address', 'operating_system', 'cost'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'asset_tag', 'type': 'str', 'required': True}, {'name': 'asset_name', 'type': 'str', 'required': True}, {'name': 'asset_type', 'type': 'str', 'required': True}, {'name': 'manufacturer', 'type': 'str', 'required': True}, {'name': 'model', 'type': 'str', 'required': True}, {'name': 'serial_number', 'type': 'str', 'required': True}, {'name': 'purchase_date', 'type': 'date', 'required': True}, {'name': 'warranty_expiry', 'type': 'date', 'required': True}, {'name': 'location', 'type': 'str', 'required': True}, {'name': 'assigned_to', 'type': 'str', 'required': True}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'ip_address', 'type': 'str', 'required': True}, {'name': 'operating_system', 'type': 'str', 'required': True}, {'name': 'cost', 'type': 'float', 'required': True}], 'methods': []}, {'name': 'ChangeRequest', 'type': 'entity', 'properties': ['id', 'change_number', 'title', 'description', 'change_type', 'risk_level', 'status', 'requester_id', 'implementer_id', 'cab_approval', 'scheduled_date', 'implementation_date', 'rollback_plan', 'business_justification', 'affected_systems', 'post_implementation_review'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'change_number', 'type': 'str', 'required': True}, {'name': 'title', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str', 'required': True}, {'name': 'change_type', 'type': 'str', 'required': True}, {'name': 'risk_level', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'requester_id', 'type': 'str', 'required': True}, {'name': 'implementer_id', 'type': 'str', 'required': True}, {'name': 'cab_approval', 'type': 'bool', 'required': True}, {'name': 'scheduled_date', 'type': 'date', 'required': True}, {'name': 'implementation_date', 'type': 'date', 'required': True}, {'name': 'rollback_plan', 'type': 'str', 'required': True}, {'name': 'business_justification', 'type': 'str', 'required': True}, {'name': 'affected_systems', 'type': 'str', 'required': True}, {'name': 'post_implementation_review', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'KnowledgeArticle', 'type': 'entity', 'properties': ['id', 'article_number', 'title', 'category', 'content', 'author_id', 'published_date', 'last_updated', 'views', 'helpful_votes', 'status', 'tags'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'article_number', 'type': 'str', 'required': True}, {'name': 'title', 'type': 'str', 'required': True}, {'name': 'category', 'type': 'str', 'required': True}, {'name': 'content', 'type': 'str', 'required': True}, {'name': 'author_id', 'type': 'str', 'required': True}, {'name': 'published_date', 'type': 'date', 'required': True}, {'name': 'last_updated', 'type': 'date', 'required': True}, {'name': 'views', 'type': 'int', 'required': True}, {'name': 'helpful_votes', 'type': 'int', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'tags', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Problem', 'type': 'entity', 'properties': ['id', 'problem_number', 'title', 'description', 'root_cause', 'workaround', 'permanent_fix', 'status', 'priority', 'linked_incidents', 'identified_date', 'resolved_date', 'problem_manager'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'problem_number', 'type': 'str', 'required': True}, {'name': 'title', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str', 'required': True}, {'name': 'root_cause', 'type': 'str', 'required': True}, {'name': 'workaround', 'type': 'str', 'required': True}, {'name': 'permanent_fix', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'priority', 'type': 'str', 'required': True}, {'name': 'linked_incidents', 'type': 'int', 'required': True}, {'name': 'identified_date', 'type': 'date', 'required': True}, {'name': 'resolved_date', 'type': 'date', 'required': True}, {'name': 'problem_manager', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'SLAPolicy', 'type': 'entity', 'properties': ['id', 'policy_name', 'priority', 'response_time_hours', 'resolution_time_hours', 'escalation_time_hours', 'applicable_categories', 'business_hours_only'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'policy_name', 'type': 'str', 'required': True}, {'name': 'priority', 'type': 'str', 'required': True}, {'name': 'response_time_hours', 'type': 'int', 'required': True}, {'name': 'resolution_time_hours', 'type': 'int', 'required': True}, {'name': 'escalation_time_hours', 'type': 'int', 'required': True}, {'name': 'applicable_categories', 'type': 'str', 'required': True}, {'name': 'business_hours_only', 'type': 'bool', 'required': True}], 'methods': []}, {'name': 'ITSMApp', 'type': 'application', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['itsm_helpdesk.apg'], 'app': {'name': 'itsm_helpdesk', 'version': '1.0.0', 'description': None, 'entity_count': 7}, 'symbols': {'module.itsm_helpdesk': {'id': 'module.itsm_helpdesk', 'kind': 'module', 'name': 'itsm_helpdesk', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Ticket': {'id': 'table.Ticket', 'kind': 'table', 'name': 'Ticket', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.id': {'id': 'field.Ticket.id', 'kind': 'field', 'name': 'Ticket.id', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.ticket_number': {'id': 'field.Ticket.ticket_number', 'kind': 'field', 'name': 'Ticket.ticket_number', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.title': {'id': 'field.Ticket.title', 'kind': 'field', 'name': 'Ticket.title', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.description': {'id': 'field.Ticket.description', 'kind': 'field', 'name': 'Ticket.description', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.category': {'id': 'field.Ticket.category', 'kind': 'field', 'name': 'Ticket.category', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.priority': {'id': 'field.Ticket.priority', 'kind': 'field', 'name': 'Ticket.priority', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.status': {'id': 'field.Ticket.status', 'kind': 'field', 'name': 'Ticket.status', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.reporter_id': {'id': 'field.Ticket.reporter_id', 'kind': 'field', 'name': 'Ticket.reporter_id', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.assignee_id': {'id': 'field.Ticket.assignee_id', 'kind': 'field', 'name': 'Ticket.assignee_id', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.department': {'id': 'field.Ticket.department', 'kind': 'field', 'name': 'Ticket.department', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.created_date': {'id': 'field.Ticket.created_date', 'kind': 'field', 'name': 'Ticket.created_date', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.resolved_date': {'id': 'field.Ticket.resolved_date', 'kind': 'field', 'name': 'Ticket.resolved_date', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.sla_breach': {'id': 'field.Ticket.sla_breach', 'kind': 'field', 'name': 'Ticket.sla_breach', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.resolution': {'id': 'field.Ticket.resolution', 'kind': 'field', 'name': 'Ticket.resolution', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.impact': {'id': 'field.Ticket.impact', 'kind': 'field', 'name': 'Ticket.impact', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Ticket.urgency': {'id': 'field.Ticket.urgency', 'kind': 'field', 'name': 'Ticket.urgency', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Asset': {'id': 'table.Asset', 'kind': 'table', 'name': 'Asset', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.id': {'id': 'field.Asset.id', 'kind': 'field', 'name': 'Asset.id', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.asset_tag': {'id': 'field.Asset.asset_tag', 'kind': 'field', 'name': 'Asset.asset_tag', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.asset_name': {'id': 'field.Asset.asset_name', 'kind': 'field', 'name': 'Asset.asset_name', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.asset_type': {'id': 'field.Asset.asset_type', 'kind': 'field', 'name': 'Asset.asset_type', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.manufacturer': {'id': 'field.Asset.manufacturer', 'kind': 'field', 'name': 'Asset.manufacturer', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.model': {'id': 'field.Asset.model', 'kind': 'field', 'name': 'Asset.model', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.serial_number': {'id': 'field.Asset.serial_number', 'kind': 'field', 'name': 'Asset.serial_number', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.purchase_date': {'id': 'field.Asset.purchase_date', 'kind': 'field', 'name': 'Asset.purchase_date', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.warranty_expiry': {'id': 'field.Asset.warranty_expiry', 'kind': 'field', 'name': 'Asset.warranty_expiry', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.location': {'id': 'field.Asset.location', 'kind': 'field', 'name': 'Asset.location', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.assigned_to': {'id': 'field.Asset.assigned_to', 'kind': 'field', 'name': 'Asset.assigned_to', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.department': {'id': 'field.Asset.department', 'kind': 'field', 'name': 'Asset.department', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.status': {'id': 'field.Asset.status', 'kind': 'field', 'name': 'Asset.status', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.ip_address': {'id': 'field.Asset.ip_address', 'kind': 'field', 'name': 'Asset.ip_address', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.operating_system': {'id': 'field.Asset.operating_system', 'kind': 'field', 'name': 'Asset.operating_system', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Asset.cost': {'id': 'field.Asset.cost', 'kind': 'field', 'name': 'Asset.cost', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.ChangeRequest': {'id': 'table.ChangeRequest', 'kind': 'table', 'name': 'ChangeRequest', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.id': {'id': 'field.ChangeRequest.id', 'kind': 'field', 'name': 'ChangeRequest.id', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.change_number': {'id': 'field.ChangeRequest.change_number', 'kind': 'field', 'name': 'ChangeRequest.change_number', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.title': {'id': 'field.ChangeRequest.title', 'kind': 'field', 'name': 'ChangeRequest.title', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.description': {'id': 'field.ChangeRequest.description', 'kind': 'field', 'name': 'ChangeRequest.description', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.change_type': {'id': 'field.ChangeRequest.change_type', 'kind': 'field', 'name': 'ChangeRequest.change_type', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.risk_level': {'id': 'field.ChangeRequest.risk_level', 'kind': 'field', 'name': 'ChangeRequest.risk_level', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.status': {'id': 'field.ChangeRequest.status', 'kind': 'field', 'name': 'ChangeRequest.status', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.requester_id': {'id': 'field.ChangeRequest.requester_id', 'kind': 'field', 'name': 'ChangeRequest.requester_id', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.implementer_id': {'id': 'field.ChangeRequest.implementer_id', 'kind': 'field', 'name': 'ChangeRequest.implementer_id', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.cab_approval': {'id': 'field.ChangeRequest.cab_approval', 'kind': 'field', 'name': 'ChangeRequest.cab_approval', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.scheduled_date': {'id': 'field.ChangeRequest.scheduled_date', 'kind': 'field', 'name': 'ChangeRequest.scheduled_date', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.implementation_date': {'id': 'field.ChangeRequest.implementation_date', 'kind': 'field', 'name': 'ChangeRequest.implementation_date', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.rollback_plan': {'id': 'field.ChangeRequest.rollback_plan', 'kind': 'field', 'name': 'ChangeRequest.rollback_plan', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.business_justification': {'id': 'field.ChangeRequest.business_justification', 'kind': 'field', 'name': 'ChangeRequest.business_justification', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.affected_systems': {'id': 'field.ChangeRequest.affected_systems', 'kind': 'field', 'name': 'ChangeRequest.affected_systems', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ChangeRequest.post_implementation_review': {'id': 'field.ChangeRequest.post_implementation_review', 'kind': 'field', 'name': 'ChangeRequest.post_implementation_review', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.KnowledgeArticle': {'id': 'table.KnowledgeArticle', 'kind': 'table', 'name': 'KnowledgeArticle', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.KnowledgeArticle.id': {'id': 'field.KnowledgeArticle.id', 'kind': 'field', 'name': 'KnowledgeArticle.id', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.KnowledgeArticle.article_number': {'id': 'field.KnowledgeArticle.article_number', 'kind': 'field', 'name': 'KnowledgeArticle.article_number', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.KnowledgeArticle.title': {'id': 'field.KnowledgeArticle.title', 'kind': 'field', 'name': 'KnowledgeArticle.title', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.KnowledgeArticle.category': {'id': 'field.KnowledgeArticle.category', 'kind': 'field', 'name': 'KnowledgeArticle.category', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.KnowledgeArticle.content': {'id': 'field.KnowledgeArticle.content', 'kind': 'field', 'name': 'KnowledgeArticle.content', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.KnowledgeArticle.author_id': {'id': 'field.KnowledgeArticle.author_id', 'kind': 'field', 'name': 'KnowledgeArticle.author_id', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.KnowledgeArticle.published_date': {'id': 'field.KnowledgeArticle.published_date', 'kind': 'field', 'name': 'KnowledgeArticle.published_date', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.KnowledgeArticle.last_updated': {'id': 'field.KnowledgeArticle.last_updated', 'kind': 'field', 'name': 'KnowledgeArticle.last_updated', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.KnowledgeArticle.views': {'id': 'field.KnowledgeArticle.views', 'kind': 'field', 'name': 'KnowledgeArticle.views', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.KnowledgeArticle.helpful_votes': {'id': 'field.KnowledgeArticle.helpful_votes', 'kind': 'field', 'name': 'KnowledgeArticle.helpful_votes', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.KnowledgeArticle.status': {'id': 'field.KnowledgeArticle.status', 'kind': 'field', 'name': 'KnowledgeArticle.status', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.KnowledgeArticle.tags': {'id': 'field.KnowledgeArticle.tags', 'kind': 'field', 'name': 'KnowledgeArticle.tags', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Problem': {'id': 'table.Problem', 'kind': 'table', 'name': 'Problem', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.id': {'id': 'field.Problem.id', 'kind': 'field', 'name': 'Problem.id', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.problem_number': {'id': 'field.Problem.problem_number', 'kind': 'field', 'name': 'Problem.problem_number', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.title': {'id': 'field.Problem.title', 'kind': 'field', 'name': 'Problem.title', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.description': {'id': 'field.Problem.description', 'kind': 'field', 'name': 'Problem.description', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.root_cause': {'id': 'field.Problem.root_cause', 'kind': 'field', 'name': 'Problem.root_cause', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.workaround': {'id': 'field.Problem.workaround', 'kind': 'field', 'name': 'Problem.workaround', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.permanent_fix': {'id': 'field.Problem.permanent_fix', 'kind': 'field', 'name': 'Problem.permanent_fix', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.status': {'id': 'field.Problem.status', 'kind': 'field', 'name': 'Problem.status', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.priority': {'id': 'field.Problem.priority', 'kind': 'field', 'name': 'Problem.priority', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.linked_incidents': {'id': 'field.Problem.linked_incidents', 'kind': 'field', 'name': 'Problem.linked_incidents', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.identified_date': {'id': 'field.Problem.identified_date', 'kind': 'field', 'name': 'Problem.identified_date', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.resolved_date': {'id': 'field.Problem.resolved_date', 'kind': 'field', 'name': 'Problem.resolved_date', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Problem.problem_manager': {'id': 'field.Problem.problem_manager', 'kind': 'field', 'name': 'Problem.problem_manager', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.SLAPolicy': {'id': 'table.SLAPolicy', 'kind': 'table', 'name': 'SLAPolicy', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SLAPolicy.id': {'id': 'field.SLAPolicy.id', 'kind': 'field', 'name': 'SLAPolicy.id', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SLAPolicy.policy_name': {'id': 'field.SLAPolicy.policy_name', 'kind': 'field', 'name': 'SLAPolicy.policy_name', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SLAPolicy.priority': {'id': 'field.SLAPolicy.priority', 'kind': 'field', 'name': 'SLAPolicy.priority', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SLAPolicy.response_time_hours': {'id': 'field.SLAPolicy.response_time_hours', 'kind': 'field', 'name': 'SLAPolicy.response_time_hours', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SLAPolicy.resolution_time_hours': {'id': 'field.SLAPolicy.resolution_time_hours', 'kind': 'field', 'name': 'SLAPolicy.resolution_time_hours', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SLAPolicy.escalation_time_hours': {'id': 'field.SLAPolicy.escalation_time_hours', 'kind': 'field', 'name': 'SLAPolicy.escalation_time_hours', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SLAPolicy.applicable_categories': {'id': 'field.SLAPolicy.applicable_categories', 'kind': 'field', 'name': 'SLAPolicy.applicable_categories', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SLAPolicy.business_hours_only': {'id': 'field.SLAPolicy.business_hours_only', 'kind': 'field', 'name': 'SLAPolicy.business_hours_only', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.ITSMApp': {'id': 'app.ITSMApp', 'kind': 'app', 'name': 'ITSMApp', 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'Ticket': {'name': 'Ticket', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'ticket_number': {'type': 'str', 'required': True, 'relationship': None}, 'title': {'type': 'str', 'required': True, 'relationship': None}, 'description': {'type': 'str', 'required': True, 'relationship': None}, 'category': {'type': 'str', 'required': True, 'relationship': None}, 'priority': {'type': 'str', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'reporter_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Reporter', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'reporter'}}, 'assignee_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Assignee', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'assignee'}}, 'department': {'type': 'str', 'required': True, 'relationship': None}, 'created_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'resolved_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'sla_breach': {'type': 'bool', 'required': True, 'relationship': None}, 'resolution': {'type': 'str', 'required': True, 'relationship': None}, 'impact': {'type': 'str', 'required': True, 'relationship': None}, 'urgency': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'created_date.id': {'chain': ['Ticket.created_date', 'date.id'], 'valid': True}, 'resolved_date.id': {'chain': ['Ticket.resolved_date', 'date.id'], 'valid': True}}}, 'Asset': {'name': 'Asset', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'asset_tag': {'type': 'str', 'required': True, 'relationship': None}, 'asset_name': {'type': 'str', 'required': True, 'relationship': None}, 'asset_type': {'type': 'str', 'required': True, 'relationship': None}, 'manufacturer': {'type': 'str', 'required': True, 'relationship': None}, 'model': {'type': 'str', 'required': True, 'relationship': None}, 'serial_number': {'type': 'str', 'required': True, 'relationship': None}, 'purchase_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'warranty_expiry': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'location': {'type': 'str', 'required': True, 'relationship': None}, 'assigned_to': {'type': 'str', 'required': True, 'relationship': None}, 'department': {'type': 'str', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'ip_address': {'type': 'str', 'required': True, 'relationship': None}, 'operating_system': {'type': 'str', 'required': True, 'relationship': None}, 'cost': {'type': 'float', 'required': True, 'relationship': None}}, 'lookup_paths': {'purchase_date.id': {'chain': ['Asset.purchase_date', 'date.id'], 'valid': True}, 'warranty_expiry.id': {'chain': ['Asset.warranty_expiry', 'date.id'], 'valid': True}}}, 'ChangeRequest': {'name': 'ChangeRequest', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'change_number': {'type': 'str', 'required': True, 'relationship': None}, 'title': {'type': 'str', 'required': True, 'relationship': None}, 'description': {'type': 'str', 'required': True, 'relationship': None}, 'change_type': {'type': 'str', 'required': True, 'relationship': None}, 'risk_level': {'type': 'str', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'requester_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Requester', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'requester'}}, 'implementer_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Implementer', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'implementer'}}, 'cab_approval': {'type': 'bool', 'required': True, 'relationship': None}, 'scheduled_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'implementation_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'rollback_plan': {'type': 'str', 'required': True, 'relationship': None}, 'business_justification': {'type': 'str', 'required': True, 'relationship': None}, 'affected_systems': {'type': 'str', 'required': True, 'relationship': None}, 'post_implementation_review': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'scheduled_date.id': {'chain': ['ChangeRequest.scheduled_date', 'date.id'], 'valid': True}, 'implementation_date.id': {'chain': ['ChangeRequest.implementation_date', 'date.id'], 'valid': True}}}, 'KnowledgeArticle': {'name': 'KnowledgeArticle', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'article_number': {'type': 'str', 'required': True, 'relationship': None}, 'title': {'type': 'str', 'required': True, 'relationship': None}, 'category': {'type': 'str', 'required': True, 'relationship': None}, 'content': {'type': 'str', 'required': True, 'relationship': None}, 'author_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Author', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'author'}}, 'published_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'last_updated': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'views': {'type': 'int', 'required': True, 'relationship': None}, 'helpful_votes': {'type': 'int', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'tags': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'published_date.id': {'chain': ['KnowledgeArticle.published_date', 'date.id'], 'valid': True}, 'last_updated.id': {'chain': ['KnowledgeArticle.last_updated', 'date.id'], 'valid': True}}}, 'Problem': {'name': 'Problem', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'problem_number': {'type': 'str', 'required': True, 'relationship': None}, 'title': {'type': 'str', 'required': True, 'relationship': None}, 'description': {'type': 'str', 'required': True, 'relationship': None}, 'root_cause': {'type': 'str', 'required': True, 'relationship': None}, 'workaround': {'type': 'str', 'required': True, 'relationship': None}, 'permanent_fix': {'type': 'str', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'priority': {'type': 'str', 'required': True, 'relationship': None}, 'linked_incidents': {'type': 'int', 'required': True, 'relationship': None}, 'identified_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'resolved_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'problem_manager': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'identified_date.id': {'chain': ['Problem.identified_date', 'date.id'], 'valid': True}, 'resolved_date.id': {'chain': ['Problem.resolved_date', 'date.id'], 'valid': True}}}, 'SLAPolicy': {'name': 'SLAPolicy', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'policy_name': {'type': 'str', 'required': True, 'relationship': None}, 'priority': {'type': 'str', 'required': True, 'relationship': None}, 'response_time_hours': {'type': 'int', 'required': True, 'relationship': None}, 'resolution_time_hours': {'type': 'int', 'required': True, 'relationship': None}, 'escalation_time_hours': {'type': 'int', 'required': True, 'relationship': None}, 'applicable_categories': {'type': 'str', 'required': True, 'relationship': None}, 'business_hours_only': {'type': 'bool', 'required': True, 'relationship': None}}, 'lookup_paths': {}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {'ITSMApp': {'name': 'ITSMApp', 'description': 'Enterprise IT service management', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': [], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'itsm_helpdesk.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 87, 'edges': 81}, 'lookup': {'kind': 'lookup', 'nodes': 8, 'edges': 7}, 'workflow': {'kind': 'workflow', 'nodes': 8, 'edges': 7}, 'handler': {'kind': 'handler', 'nodes': 8, 'edges': 7}, 'capability': {'kind': 'capability', 'nodes': 1, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 8, 'edges': 7}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 8, 'edges': 7}, 'package': {'kind': 'package', 'nodes': 8, 'edges': 7}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Application 'ITSMApp' should compose capabilities, components, or routes", 'file': 'itsm_helpdesk.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
