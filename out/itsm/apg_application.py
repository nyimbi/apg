...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'ITSMApp': {'description': 'Enterprise IT service management', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': [], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
