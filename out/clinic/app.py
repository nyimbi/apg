"""
clinic_demo - APG Python Application
====================================
...
MODULE_NAME = 'clinic_demo'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'Patient', 'type': 'entity', 'properties': ['id', 'patient_number', 'full_name', 'date_of_birth', 'gender', 'phone', 'emergency_contact', 'national_id', 'blood_group', 'allergies', 'insurance_provider', 'insurance_number', 'next_of_kin', 'county'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'patient_number', 'type': 'str', 'required': True}, {'name': 'full_name', 'type': 'str', 'required': True}, {'name': 'date_of_birth', 'type': 'date', 'required': True}, {'name': 'gender', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str', 'required': True}, {'name': 'emergency_contact', 'type': 'str', 'required': True}, {'name': 'national_id', 'type': 'str', 'required': True}, {'name': 'blood_group', 'type': 'str', 'required': True}, {'name': 'allergies', 'type': 'str', 'required': True}, {'name': 'insurance_provider', 'type': 'str', 'required': True}, {'name': 'insurance_number', 'type': 'str', 'required': True}, {'name': 'next_of_kin', 'type': 'str', 'required': True}, {'name': 'county', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Appointment', 'type': 'entity', 'properties': ['id', 'patient_id', 'doctor_id', 'appointment_date', 'appointment_time', 'appointment_type', 'status', 'reason', 'notes', 'room'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'patient_id', 'type': 'str', 'required': True}, {'name': 'doctor_id', 'type': 'str', 'required': True}, {'name': 'appointment_date', 'type': 'date', 'required': True}, {'name': 'appointment_time', 'type': 'str', 'required': True}, {'name': 'appointment_type', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'reason', 'type': 'str', 'required': True}, {'name': 'notes', 'type': 'str', 'required': True}, {'name': 'room', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Consultation', 'type': 'entity', 'properties': ['id', 'appointment_id', 'patient_id', 'doctor_id', 'consultation_date', 'chief_complaint', 'history', 'examination_findings', 'diagnosis', 'icd10_code', 'treatment_plan', 'follow_up_date'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'appointment_id', 'type': 'str', 'required': True}, {'name': 'patient_id', 'type': 'str', 'required': True}, {'name': 'doctor_id', 'type': 'str', 'required': True}, {'name': 'consultation_date', 'type': 'date', 'required': True}, {'name': 'chief_complaint', 'type': 'str', 'required': True}, {'name': 'history', 'type': 'str', 'required': True}, {'name': 'examination_findings', 'type': 'str', 'required': True}, {'name': 'diagnosis', 'type': 'str', 'required': True}, {'name': 'icd10_code', 'type': 'str', 'required': True}, {'name': 'treatment_plan', 'type': 'str', 'required': True}, {'name': 'follow_up_date', 'type': 'date', 'required': True}], 'methods': []}, {'name': 'Prescription', 'type': 'entity', 'properties': ['id', 'consultation_id', 'patient_id', 'doctor_id', 'drug_name', 'dosage', 'frequency', 'duration_days', 'instructions', 'quantity', 'dispensed', 'prescribed_date'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'consultation_id', 'type': 'str', 'required': True}, {'name': 'patient_id', 'type': 'str', 'required': True}, {'name': 'doctor_id', 'type': 'str', 'required': True}, {'name': 'drug_name', 'type': 'str', 'required': True}, {'name': 'dosage', 'type': 'str', 'required': True}, {'name': 'frequency', 'type': 'str', 'required': True}, {'name': 'duration_days', 'type': 'int', 'required': True}, {'name': 'instructions', 'type': 'str', 'required': True}, {'name': 'quantity', 'type': 'int', 'required': True}, {'name': 'dispensed', 'type': 'bool', 'required': True}, {'name': 'prescribed_date', 'type': 'date', 'required': True}], 'methods': []}, {'name': 'LabTest', 'type': 'entity', 'properties': ['id', 'patient_id', 'consultation_id', 'test_name', 'ordered_date', 'collected_date', 'result_date', 'result', 'reference_range', 'status', 'technician'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'patient_id', 'type': 'str', 'required': True}, {'name': 'consultation_id', 'type': 'str', 'required': True}, {'name': 'test_name', 'type': 'str', 'required': True}, {'name': 'ordered_date', 'type': 'date', 'required': True}, {'name': 'collected_date', 'type': 'date', 'required': True}, {'name': 'result_date', 'type': 'date', 'required': True}, {'name': 'result', 'type': 'str', 'required': True}, {'name': 'reference_range', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'technician', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Bill', 'type': 'entity', 'properties': ['id', 'patient_id', 'visit_date', 'consultation_fee', 'lab_fees', 'drug_fees', 'procedure_fees', 'total_amount', 'amount_paid', 'balance', 'payment_method', 'insurance_claim', 'status'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'patient_id', 'type': 'str', 'required': True}, {'name': 'visit_date', 'type': 'date', 'required': True}, {'name': 'consultation_fee', 'type': 'float', 'required': True}, {'name': 'lab_fees', 'type': 'float', 'required': True}, {'name': 'drug_fees', 'type': 'float', 'required': True}, {'name': 'procedure_fees', 'type': 'float', 'required': True}, {'name': 'total_amount', 'type': 'float', 'required': True}, {'name': 'amount_paid', 'type': 'float', 'required': True}, {'name': 'balance', 'type': 'float', 'required': True}, {'name': 'payment_method', 'type': 'str', 'required': True}, {'name': 'insurance_claim', 'type': 'float', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Staff', 'type': 'entity', 'properties': ['id', 'staff_number', 'full_name', 'role', 'specialization', 'phone', 'email', 'license_number', 'department', 'shift'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'staff_number', 'type': 'str', 'required': True}, {'name': 'full_name', 'type': 'str', 'required': True}, {'name': 'role', 'type': 'str', 'required': True}, {'name': 'specialization', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'license_number', 'type': 'str', 'required': True}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'shift', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'ClinicApp', 'type': 'application', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['clinic_demo.apg'], 'app': {'name': 'clinic_demo', 'version': '1.0.0', 'description': None, 'entity_count': 8}, 'symbols': {'module.clinic_demo': {'id': 'module.clinic_demo', 'kind': 'module', 'name': 'clinic_demo', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Patient': {'id': 'table.Patient', 'kind': 'table', 'name': 'Patient', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.id': {'id': 'field.Patient.id', 'kind': 'field', 'name': 'Patient.id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.patient_number': {'id': 'field.Patient.patient_number', 'kind': 'field', 'name': 'Patient.patient_number', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.full_name': {'id': 'field.Patient.full_name', 'kind': 'field', 'name': 'Patient.full_name', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.date_of_birth': {'id': 'field.Patient.date_of_birth', 'kind': 'field', 'name': 'Patient.date_of_birth', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.gender': {'id': 'field.Patient.gender', 'kind': 'field', 'name': 'Patient.gender', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.phone': {'id': 'field.Patient.phone', 'kind': 'field', 'name': 'Patient.phone', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.emergency_contact': {'id': 'field.Patient.emergency_contact', 'kind': 'field', 'name': 'Patient.emergency_contact', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.national_id': {'id': 'field.Patient.national_id', 'kind': 'field', 'name': 'Patient.national_id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.blood_group': {'id': 'field.Patient.blood_group', 'kind': 'field', 'name': 'Patient.blood_group', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.allergies': {'id': 'field.Patient.allergies', 'kind': 'field', 'name': 'Patient.allergies', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.insurance_provider': {'id': 'field.Patient.insurance_provider', 'kind': 'field', 'name': 'Patient.insurance_provider', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.insurance_number': {'id': 'field.Patient.insurance_number', 'kind': 'field', 'name': 'Patient.insurance_number', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.next_of_kin': {'id': 'field.Patient.next_of_kin', 'kind': 'field', 'name': 'Patient.next_of_kin', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Patient.county': {'id': 'field.Patient.county', 'kind': 'field', 'name': 'Patient.county', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Appointment': {'id': 'table.Appointment', 'kind': 'table', 'name': 'Appointment', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Appointment.id': {'id': 'field.Appointment.id', 'kind': 'field', 'name': 'Appointment.id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Appointment.patient_id': {'id': 'field.Appointment.patient_id', 'kind': 'field', 'name': 'Appointment.patient_id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Appointment.doctor_id': {'id': 'field.Appointment.doctor_id', 'kind': 'field', 'name': 'Appointment.doctor_id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Appointment.appointment_date': {'id': 'field.Appointment.appointment_date', 'kind': 'field', 'name': 'Appointment.appointment_date', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Appointment.appointment_time': {'id': 'field.Appointment.appointment_time', 'kind': 'field', 'name': 'Appointment.appointment_time', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Appointment.appointment_type': {'id': 'field.Appointment.appointment_type', 'kind': 'field', 'name': 'Appointment.appointment_type', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Appointment.status': {'id': 'field.Appointment.status', 'kind': 'field', 'name': 'Appointment.status', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Appointment.reason': {'id': 'field.Appointment.reason', 'kind': 'field', 'name': 'Appointment.reason', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Appointment.notes': {'id': 'field.Appointment.notes', 'kind': 'field', 'name': 'Appointment.notes', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Appointment.room': {'id': 'field.Appointment.room', 'kind': 'field', 'name': 'Appointment.room', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Consultation': {'id': 'table.Consultation', 'kind': 'table', 'name': 'Consultation', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Consultation.id': {'id': 'field.Consultation.id', 'kind': 'field', 'name': 'Consultation.id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Consultation.appointment_id': {'id': 'field.Consultation.appointment_id', 'kind': 'field', 'name': 'Consultation.appointment_id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Consultation.patient_id': {'id': 'field.Consultation.patient_id', 'kind': 'field', 'name': 'Consultation.patient_id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Consultation.doctor_id': {'id': 'field.Consultation.doctor_id', 'kind': 'field', 'name': 'Consultation.doctor_id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Consultation.consultation_date': {'id': 'field.Consultation.consultation_date', 'kind': 'field', 'name': 'Consultation.consultation_date', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Consultation.chief_complaint': {'id': 'field.Consultation.chief_complaint', 'kind': 'field', 'name': 'Consultation.chief_complaint', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Consultation.history': {'id': 'field.Consultation.history', 'kind': 'field', 'name': 'Consultation.history', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Consultation.examination_findings': {'id': 'field.Consultation.examination_findings', 'kind': 'field', 'name': 'Consultation.examination_findings', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Consultation.diagnosis': {'id': 'field.Consultation.diagnosis', 'kind': 'field', 'name': 'Consultation.diagnosis', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Consultation.icd10_code': {'id': 'field.Consultation.icd10_code', 'kind': 'field', 'name': 'Consultation.icd10_code', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Consultation.treatment_plan': {'id': 'field.Consultation.treatment_plan', 'kind': 'field', 'name': 'Consultation.treatment_plan', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Consultation.follow_up_date': {'id': 'field.Consultation.follow_up_date', 'kind': 'field', 'name': 'Consultation.follow_up_date', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Prescription': {'id': 'table.Prescription', 'kind': 'table', 'name': 'Prescription', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Prescription.id': {'id': 'field.Prescription.id', 'kind': 'field', 'name': 'Prescription.id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Prescription.consultation_id': {'id': 'field.Prescription.consultation_id', 'kind': 'field', 'name': 'Prescription.consultation_id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Prescription.patient_id': {'id': 'field.Prescription.patient_id', 'kind': 'field', 'name': 'Prescription.patient_id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Prescription.doctor_id': {'id': 'field.Prescription.doctor_id', 'kind': 'field', 'name': 'Prescription.doctor_id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Prescription.drug_name': {'id': 'field.Prescription.drug_name', 'kind': 'field', 'name': 'Prescription.drug_name', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Prescription.dosage': {'id': 'field.Prescription.dosage', 'kind': 'field', 'name': 'Prescription.dosage', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Prescription.frequency': {'id': 'field.Prescription.frequency', 'kind': 'field', 'name': 'Prescription.frequency', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Prescription.duration_days': {'id': 'field.Prescription.duration_days', 'kind': 'field', 'name': 'Prescription.duration_days', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Prescription.instructions': {'id': 'field.Prescription.instructions', 'kind': 'field', 'name': 'Prescription.instructions', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Prescription.quantity': {'id': 'field.Prescription.quantity', 'kind': 'field', 'name': 'Prescription.quantity', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Prescription.dispensed': {'id': 'field.Prescription.dispensed', 'kind': 'field', 'name': 'Prescription.dispensed', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Prescription.prescribed_date': {'id': 'field.Prescription.prescribed_date', 'kind': 'field', 'name': 'Prescription.prescribed_date', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.LabTest': {'id': 'table.LabTest', 'kind': 'table', 'name': 'LabTest', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LabTest.id': {'id': 'field.LabTest.id', 'kind': 'field', 'name': 'LabTest.id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LabTest.patient_id': {'id': 'field.LabTest.patient_id', 'kind': 'field', 'name': 'LabTest.patient_id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LabTest.consultation_id': {'id': 'field.LabTest.consultation_id', 'kind': 'field', 'name': 'LabTest.consultation_id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LabTest.test_name': {'id': 'field.LabTest.test_name', 'kind': 'field', 'name': 'LabTest.test_name', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LabTest.ordered_date': {'id': 'field.LabTest.ordered_date', 'kind': 'field', 'name': 'LabTest.ordered_date', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LabTest.collected_date': {'id': 'field.LabTest.collected_date', 'kind': 'field', 'name': 'LabTest.collected_date', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LabTest.result_date': {'id': 'field.LabTest.result_date', 'kind': 'field', 'name': 'LabTest.result_date', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LabTest.result': {'id': 'field.LabTest.result', 'kind': 'field', 'name': 'LabTest.result', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LabTest.reference_range': {'id': 'field.LabTest.reference_range', 'kind': 'field', 'name': 'LabTest.reference_range', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LabTest.status': {'id': 'field.LabTest.status', 'kind': 'field', 'name': 'LabTest.status', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LabTest.technician': {'id': 'field.LabTest.technician', 'kind': 'field', 'name': 'LabTest.technician', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Bill': {'id': 'table.Bill', 'kind': 'table', 'name': 'Bill', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.id': {'id': 'field.Bill.id', 'kind': 'field', 'name': 'Bill.id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.patient_id': {'id': 'field.Bill.patient_id', 'kind': 'field', 'name': 'Bill.patient_id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.visit_date': {'id': 'field.Bill.visit_date', 'kind': 'field', 'name': 'Bill.visit_date', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.consultation_fee': {'id': 'field.Bill.consultation_fee', 'kind': 'field', 'name': 'Bill.consultation_fee', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.lab_fees': {'id': 'field.Bill.lab_fees', 'kind': 'field', 'name': 'Bill.lab_fees', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.drug_fees': {'id': 'field.Bill.drug_fees', 'kind': 'field', 'name': 'Bill.drug_fees', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.procedure_fees': {'id': 'field.Bill.procedure_fees', 'kind': 'field', 'name': 'Bill.procedure_fees', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.total_amount': {'id': 'field.Bill.total_amount', 'kind': 'field', 'name': 'Bill.total_amount', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.amount_paid': {'id': 'field.Bill.amount_paid', 'kind': 'field', 'name': 'Bill.amount_paid', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.balance': {'id': 'field.Bill.balance', 'kind': 'field', 'name': 'Bill.balance', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.payment_method': {'id': 'field.Bill.payment_method', 'kind': 'field', 'name': 'Bill.payment_method', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.insurance_claim': {'id': 'field.Bill.insurance_claim', 'kind': 'field', 'name': 'Bill.insurance_claim', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Bill.status': {'id': 'field.Bill.status', 'kind': 'field', 'name': 'Bill.status', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Staff': {'id': 'table.Staff', 'kind': 'table', 'name': 'Staff', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Staff.id': {'id': 'field.Staff.id', 'kind': 'field', 'name': 'Staff.id', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Staff.staff_number': {'id': 'field.Staff.staff_number', 'kind': 'field', 'name': 'Staff.staff_number', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Staff.full_name': {'id': 'field.Staff.full_name', 'kind': 'field', 'name': 'Staff.full_name', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Staff.role': {'id': 'field.Staff.role', 'kind': 'field', 'name': 'Staff.role', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Staff.specialization': {'id': 'field.Staff.specialization', 'kind': 'field', 'name': 'Staff.specialization', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Staff.phone': {'id': 'field.Staff.phone', 'kind': 'field', 'name': 'Staff.phone', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Staff.email': {'id': 'field.Staff.email', 'kind': 'field', 'name': 'Staff.email', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Staff.license_number': {'id': 'field.Staff.license_number', 'kind': 'field', 'name': 'Staff.license_number', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Staff.department': {'id': 'field.Staff.department', 'kind': 'field', 'name': 'Staff.department', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Staff.shift': {'id': 'field.Staff.shift', 'kind': 'field', 'name': 'Staff.shift', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.ClinicApp': {'id': 'app.ClinicApp', 'kind': 'app', 'name': 'ClinicApp', 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'Patient': {'name': 'Patient', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'patient_number': {'type': 'str', 'required': True, 'relationship': None}, 'full_name': {'type': 'str', 'required': True, 'relationship': None}, 'date_of_birth': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'gender': {'type': 'str', 'required': True, 'relationship': None}, 'phone': {'type': 'str', 'required': True, 'relationship': None}, 'emergency_contact': {'type': 'str', 'required': True, 'relationship': None}, 'national_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'National', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'national'}}, 'blood_group': {'type': 'str', 'required': True, 'relationship': None}, 'allergies': {'type': 'str', 'required': True, 'relationship': None}, 'insurance_provider': {'type': 'str', 'required': True, 'relationship': None}, 'insurance_number': {'type': 'str', 'required': True, 'relationship': None}, 'next_of_kin': {'type': 'str', 'required': True, 'relationship': None}, 'county': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'date_of_birth.id': {'chain': ['Patient.date_of_birth', 'date.id'], 'valid': True}}}, 'Appointment': {'name': 'Appointment', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'patient_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Patient', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'patient'}}, 'doctor_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Doctor', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'doctor'}}, 'appointment_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'appointment_time': {'type': 'str', 'required': True, 'relationship': None}, 'appointment_type': {'type': 'str', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'reason': {'type': 'str', 'required': True, 'relationship': None}, 'notes': {'type': 'str', 'required': True, 'relationship': None}, 'room': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'appointment_date.id': {'chain': ['Appointment.appointment_date', 'date.id'], 'valid': True}}}, 'Consultation': {'name': 'Consultation', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'appointment_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Appointment', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'appointment'}}, 'patient_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Patient', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'patient'}}, 'doctor_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Doctor', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'doctor'}}, 'consultation_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'chief_complaint': {'type': 'str', 'required': True, 'relationship': None}, 'history': {'type': 'str', 'required': True, 'relationship': None}, 'examination_findings': {'type': 'str', 'required': True, 'relationship': None}, 'diagnosis': {'type': 'str', 'required': True, 'relationship': None}, 'icd10_code': {'type': 'str', 'required': True, 'relationship': None}, 'treatment_plan': {'type': 'str', 'required': True, 'relationship': None}, 'follow_up_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'consultation_date.id': {'chain': ['Consultation.consultation_date', 'date.id'], 'valid': True}, 'follow_up_date.id': {'chain': ['Consultation.follow_up_date', 'date.id'], 'valid': True}}}, 'Prescription': {'name': 'Prescription', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'consultation_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Consultation', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'consultation'}}, 'patient_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Patient', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'patient'}}, 'doctor_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Doctor', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'doctor'}}, 'drug_name': {'type': 'str', 'required': True, 'relationship': None}, 'dosage': {'type': 'str', 'required': True, 'relationship': None}, 'frequency': {'type': 'str', 'required': True, 'relationship': None}, 'duration_days': {'type': 'int', 'required': True, 'relationship': None}, 'instructions': {'type': 'str', 'required': True, 'relationship': None}, 'quantity': {'type': 'int', 'required': True, 'relationship': None}, 'dispensed': {'type': 'bool', 'required': True, 'relationship': None}, 'prescribed_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'prescribed_date.id': {'chain': ['Prescription.prescribed_date', 'date.id'], 'valid': True}}}, 'LabTest': {'name': 'LabTest', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'patient_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Patient', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'patient'}}, 'consultation_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Consultation', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'consultation'}}, 'test_name': {'type': 'str', 'required': True, 'relationship': None}, 'ordered_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'collected_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'result_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'result': {'type': 'str', 'required': True, 'relationship': None}, 'reference_range': {'type': 'str', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'technician': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'ordered_date.id': {'chain': ['LabTest.ordered_date', 'date.id'], 'valid': True}, 'collected_date.id': {'chain': ['LabTest.collected_date', 'date.id'], 'valid': True}, 'result_date.id': {'chain': ['LabTest.result_date', 'date.id'], 'valid': True}}}, 'Bill': {'name': 'Bill', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'patient_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Patient', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'patient'}}, 'visit_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'consultation_fee': {'type': 'float', 'required': True, 'relationship': None}, 'lab_fees': {'type': 'float', 'required': True, 'relationship': None}, 'drug_fees': {'type': 'float', 'required': True, 'relationship': None}, 'procedure_fees': {'type': 'float', 'required': True, 'relationship': None}, 'total_amount': {'type': 'float', 'required': True, 'relationship': None}, 'amount_paid': {'type': 'float', 'required': True, 'relationship': None}, 'balance': {'type': 'float', 'required': True, 'relationship': None}, 'payment_method': {'type': 'str', 'required': True, 'relationship': None}, 'insurance_claim': {'type': 'float', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'visit_date.id': {'chain': ['Bill.visit_date', 'date.id'], 'valid': True}}}, 'Staff': {'name': 'Staff', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'staff_number': {'type': 'str', 'required': True, 'relationship': None}, 'full_name': {'type': 'str', 'required': True, 'relationship': None}, 'role': {'type': 'str', 'required': True, 'relationship': None}, 'specialization': {'type': 'str', 'required': True, 'relationship': None}, 'phone': {'type': 'str', 'required': True, 'relationship': None}, 'email': {'type': 'str', 'required': True, 'relationship': None}, 'license_number': {'type': 'str', 'required': True, 'relationship': None}, 'department': {'type': 'str', 'required': True, 'relationship': None}, 'shift': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {'ClinicApp': {'name': 'ClinicApp', 'description': 'Integrated health facility management', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': [], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'clinic_demo.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 89, 'edges': 90}, 'lookup': {'kind': 'lookup', 'nodes': 9, 'edges': 8}, 'workflow': {'kind': 'workflow', 'nodes': 9, 'edges': 8}, 'handler': {'kind': 'handler', 'nodes': 9, 'edges': 8}, 'capability': {'kind': 'capability', 'nodes': 1, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 9, 'edges': 8}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 9, 'edges': 8}, 'package': {'kind': 'package', 'nodes': 9, 'edges': 8}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Application 'ClinicApp' should compose capabilities, components, or routes", 'file': 'clinic_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
