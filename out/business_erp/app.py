...
ENTITIES = [{'name': 'ManufacturingERP', 'type': 'entity', 'properties': ['master_production_schedule', 'material_requirements_planning', 'capacity_requirements_planning', 'shop_floor_control', 'warehouse_management', 'stock_control', 'material_handling', 'inventory_accounting', 'quality_planning', 'quality_control', 'quality_assurance', 'compliance_management', 'preventive_maintenance', 'work_order_management', 'asset_management', 'spare_parts_management', 'production_monitoring', 'process_control', 'traceability', 'labor_management', 'supplier_relationship', 'procurement', 'logistics', 'demand_planning', 'sales_management', 'marketing_automation', 'service_management', 'e_commerce_integration', 'general_ledger', 'accounts_payable', 'accounts_receivable', 'cost_accounting', 'fixed_assets', 'operational_dashboards', 'financial_dashboards', 'executive_dashboards', 'regulatory_reporting'], 'fields': [{'name': 'master_production_schedule', 'type': 'demand_forecasting + capacity_planning + resource_allocation', 'required': True}, {'name': 'material_requirements_planning', 'type': 'bom_explosion + lead_time_calculation + supplier_scheduling', 'required': True}, {'name': 'capacity_requirements_planning', 'type': 'work_center_loading + bottleneck_analysis + scheduling_optimization', 'required': True}, {'name': 'shop_floor_control', 'type': 'work_order_management + progress_tracking + quality_control_integration', 'required': True}, {'name': 'warehouse_management', 'type': 'location_tracking + picking_optimization + cycle_counting + abc_analysis', 'required': True}, {'name': 'stock_control', 'type': 'safety_stock_calculation + reorder_point_optimization + economic_order_quantity', 'required': True}, {'name': 'material_handling', 'type': 'receiving + put_away + picking + shipping + cross_docking', 'required': True}, {'name': 'inventory_accounting', 'type': 'fifo + lifo + weighted_average + standard_costing + variance_analysis', 'required': True}, {'name': 'quality_planning', 'type': 'quality_objectives + control_plans + inspection_procedures + statistical_process_control', 'required': True}, {'name': 'quality_control', 'type': 'incoming_inspection + in_process_inspection + final_inspection + testing_protocols', 'required': True}, {'name': 'quality_assurance', 'type': 'quality_audits + corrective_actions + preventive_actions + continuous_improvement', 'required': True}, {'name': 'compliance_management', 'type': 'iso_standards + regulatory_compliance + documentation_control + training_records', 'required': True}, {'name': 'preventive_maintenance', 'type': 'scheduled_maintenance + condition_based_maintenance + predictive_maintenance', 'required': True}, {'name': 'work_order_management', 'type': 'maintenance_requests + work_scheduling + resource_allocation + completion_tracking', 'required': True}, {'name': 'asset_management', 'type': 'equipment_records + maintenance_history + depreciation + replacement_planning', 'required': True}, {'name': 'spare_parts_management', 'type': 'inventory_optimization + critical_parts_identification + supplier_management', 'required': True}, {'name': 'production_monitoring', 'type': 'real_time_data_collection + oee_calculation + downtime_tracking', 'required': True}, {'name': 'process_control', 'type': 'recipe_management + batch_tracking + process_parameters + quality_data', 'required': True}, {'name': 'traceability', 'type': 'lot_tracking + genealogy + recall_management + serialization', 'required': True}, {'name': 'labor_management', 'type': 'time_tracking + skill_matching + performance_monitoring + incentive_calculation', 'required': True}, {'name': 'supplier_relationship', 'type': 'vendor_evaluation + performance_monitoring + contract_management + collaboration', 'required': True}, {'name': 'procurement', 'type': 'purchase_requisitions + rfq_management + purchase_orders + receipt_matching', 'required': True}, {'name': 'logistics', 'type': 'transportation_planning + carrier_selection + freight_optimization + delivery_tracking', 'required': True}, {'name': 'demand_planning', 'type': 'sales_forecasting + demand_sensing + collaborative_planning + scenario_modeling', 'required': True}, {'name': 'sales_management', 'type': 'opportunity_tracking + quote_management + order_processing + customer_service', 'required': True}, {'name': 'marketing_automation', 'type': 'campaign_management + lead_generation + customer_segmentation + analytics', 'required': True}, {'name': 'service_management', 'type': 'warranty_tracking + service_requests + field_service + customer_satisfaction', 'required': True}, {'name': 'e_commerce_integration', 'type': 'online_catalog + order_integration + inventory_synchronization + customer_portal', 'required': True}, {'name': 'general_ledger', 'type': 'chart_of_accounts + journal_entries + financial_reporting + budget_management', 'required': True}, {'name': 'accounts_payable', 'type': 'vendor_invoicing + payment_processing + cash_management + expense_reporting', 'required': True}, {'name': 'accounts_receivable', 'type': 'customer_invoicing + payment_tracking + credit_management + collections', 'required': True}, {'name': 'cost_accounting', 'type': 'standard_costing + actual_costing + variance_analysis + activity_based_costing', 'required': True}, {'name': 'fixed_assets', 'type': 'asset_tracking + depreciation + maintenance_capitalization + disposal_management', 'required': True}, {'name': 'operational_dashboards', 'type': 'production_metrics + quality_metrics + inventory_levels + delivery_performance', 'required': True}, {'name': 'financial_dashboards', 'type': 'revenue_analysis + cost_analysis + profitability + cash_flow', 'required': True}, {'name': 'executive_dashboards', 'type': 'kpi_monitoring + trend_analysis + exception_reporting + drill_down_capability', 'required': True}, {'name': 'regulatory_reporting', 'type': 'financial_statements + tax_reporting + compliance_reports + audit_trails', 'required': True}], 'methods': []}, {'name': 'RetailERP', 'type': 'entity', 'properties': ['transaction_processing', 'inventory_integration', 'customer_management', 'staff_management', 'product_catalog', 'buying_planning', 'price_management', 'visual_merchandising', 'e_commerce_platform', 'mobile_commerce', 'social_commerce', 'marketplace_integration', 'personalization', 'loyalty_management', 'customer_service', 'feedback_management', 'demand_forecasting', 'inventory_optimization', 'distribution_management', 'vendor_management', 'sales_analytics', 'inventory_analytics', 'customer_analytics', 'financial_analytics'], 'fields': [{'name': 'transaction_processing', 'type': 'barcode_scanning + payment_processing + receipt_generation + customer_identification', 'required': True}, {'name': 'inventory_integration', 'type': 'real_time_stock_updates + automatic_reordering + stock_alerts + transfer_requests', 'required': True}, {'name': 'customer_management', 'type': 'loyalty_programs + customer_history + personalized_offers + birthday_promotions', 'required': True}, {'name': 'staff_management', 'type': 'cashier_authentication + sales_performance + commission_calculation + shift_management', 'required': True}, {'name': 'product_catalog', 'type': 'item_master + category_hierarchy + attributes + variants + pricing', 'required': True}, {'name': 'buying_planning', 'type': 'open_to_buy + assortment_planning + seasonal_planning + vendor_negotiations', 'required': True}, {'name': 'price_management', 'type': 'regular_pricing + promotional_pricing + markdown_optimization + competitive_pricing', 'required': True}, {'name': 'visual_merchandising', 'type': 'planogram_management + space_allocation + display_guidelines + seasonal_changes', 'required': True}, {'name': 'e_commerce_platform', 'type': 'online_catalog + shopping_cart + payment_gateway + order_fulfillment', 'required': True}, {'name': 'mobile_commerce', 'type': 'mobile_app + mobile_payments + location_services + push_notifications', 'required': True}, {'name': 'social_commerce', 'type': 'social_media_integration + influencer_partnerships + user_generated_content', 'required': True}, {'name': 'marketplace_integration', 'type': 'amazon + ebay + etsy + google_shopping + comparison_engines', 'required': True}, {'name': 'personalization', 'type': 'recommendation_engine + targeted_marketing + customized_content + personal_shopping', 'required': True}, {'name': 'loyalty_management', 'type': 'points_accumulation + rewards_redemption + tier_management + gamification', 'required': True}, {'name': 'customer_service', 'type': 'help_desk + live_chat + knowledge_base + returns_management', 'required': True}, {'name': 'feedback_management', 'type': 'review_collection + sentiment_analysis + response_management + improvement_tracking', 'required': True}, {'name': 'demand_forecasting', 'type': 'sales_history_analysis + trend_identification + seasonal_adjustment + promotional_impact', 'required': True}, {'name': 'inventory_optimization', 'type': 'safety_stock_calculation + reorder_points + economic_order_quantities + abc_analysis', 'required': True}, {'name': 'distribution_management', 'type': 'warehouse_operations + cross_docking + drop_shipping + last_mile_delivery', 'required': True}, {'name': 'vendor_management', 'type': 'supplier_onboarding + performance_evaluation + contract_negotiations + collaborative_planning', 'required': True}, {'name': 'sales_analytics', 'type': 'sales_performance + product_performance + customer_analytics + market_basket_analysis', 'required': True}, {'name': 'inventory_analytics', 'type': 'stock_levels + turnover_rates + sell_through_rates + markdown_analysis', 'required': True}, {'name': 'customer_analytics', 'type': 'customer_lifetime_value + churn_prediction + segmentation + behavior_analysis', 'required': True}, {'name': 'financial_analytics', 'type': 'gross_margin_analysis + expense_tracking + profitability_analysis + budget_variance', 'required': True}], 'methods': []}, {'name': 'HealthcareERP', 'type': 'entity', 'properties': ['registration', 'medical_records', 'care_coordination', 'quality_measures', 'order_management', 'medication_management', 'laboratory_integration', 'imaging_integration', 'care_planning', 'medication_administration', 'patient_monitoring', 'documentation', 'hipaa_compliance', 'meaningful_use', 'joint_commission', 'cms_reporting', 'revenue_cycle', 'insurance_management', 'cost_accounting', 'budgeting_planning', 'patient_registries', 'analytics_reporting', 'care_management', 'research_support'], 'fields': [{'name': 'registration', 'type': 'patient_demographics + insurance_verification + consent_management + appointment_scheduling', 'required': True}, {'name': 'medical_records', 'type': 'electronic_health_records + clinical_documentation + medical_history + care_plans', 'required': True}, {'name': 'care_coordination', 'type': 'referral_management + care_team_communication + discharge_planning + follow_up_scheduling', 'required': True}, {'name': 'quality_measures', 'type': 'clinical_quality_indicators + patient_safety_metrics + outcome_measurements + reporting', 'required': True}, {'name': 'order_management', 'type': 'physician_orders + computerized_order_entry + clinical_decision_support + order_tracking', 'required': True}, {'name': 'medication_management', 'type': 'e_prescribing + medication_reconciliation + drug_interaction_checking + formulary_management', 'required': True}, {'name': 'laboratory_integration', 'type': 'test_ordering + result_reporting + critical_value_alerts + trending_analysis', 'required': True}, {'name': 'imaging_integration', 'type': 'radiology_orders + image_storage + reporting + diagnostic_support', 'required': True}, {'name': 'care_planning', 'type': 'nursing_assessments + care_plan_development + intervention_tracking + outcome_evaluation', 'required': True}, {'name': 'medication_administration', 'type': 'barcode_scanning + dosage_verification + administration_documentation + adverse_event_reporting', 'required': True}, {'name': 'patient_monitoring', 'type': 'vital_signs + fluid_balance + pain_assessment + fall_risk_assessment', 'required': True}, {'name': 'documentation', 'type': 'nursing_notes + shift_reports + care_summaries + incident_reporting', 'required': True}, {'name': 'hipaa_compliance', 'type': 'privacy_controls + security_safeguards + audit_logging + breach_notification', 'required': True}, {'name': 'meaningful_use', 'type': 'clinical_quality_measures + patient_engagement + care_coordination + population_health', 'required': True}, {'name': 'joint_commission', 'type': 'quality_standards + patient_safety + performance_improvement + accreditation_reporting', 'required': True}, {'name': 'cms_reporting', 'type': 'quality_reporting + value_based_care + medicare_reporting + medicaid_reporting', 'required': True}, {'name': 'revenue_cycle', 'type': 'patient_registration + charge_capture + coding + billing + collections', 'required': True}, {'name': 'insurance_management', 'type': 'eligibility_verification + prior_authorization + claims_processing + denial_management', 'required': True}, {'name': 'cost_accounting', 'type': 'departmental_costing + procedure_costing + physician_productivity + resource_utilization', 'required': True}, {'name': 'budgeting_planning', 'type': 'annual_budgets + capital_planning + staffing_models + financial_forecasting', 'required': True}, {'name': 'patient_registries', 'type': 'chronic_disease_management + preventive_care + risk_stratification + care_gaps', 'required': True}, {'name': 'analytics_reporting', 'type': 'population_analytics + outcomes_measurement + quality_improvement + public_health_reporting', 'required': True}, {'name': 'care_management', 'type': 'care_coordination + case_management + disease_management + wellness_programs', 'required': True}, {'name': 'research_support', 'type': 'clinical_trials + research_protocols + data_collection + regulatory_reporting', 'required': True}], 'methods': []}, {'name': 'FinancialServicesERP', 'type': 'entity', 'properties': ['customer_onboarding', 'account_maintenance', 'transaction_processing', 'interest_calculation', 'loan_origination', 'loan_servicing', 'loan_portfolio_management', 'regulatory_reporting', 'portfolio_management', 'trading_operations', 'risk_management', 'client_reporting', 'anti_money_laundering', 'know_your_customer', 'fair_lending', 'consumer_protection', 'credit_risk', 'market_risk', 'operational_risk', 'liquidity_risk'], 'fields': [{'name': 'customer_onboarding', 'type': 'kyc_verification + aml_screening + account_opening + documentation', 'required': True}, {'name': 'account_maintenance', 'type': 'profile_updates + service_requests + relationship_management + cross_selling', 'required': True}, {'name': 'transaction_processing', 'type': 'deposits + withdrawals + transfers + payments + reconciliation', 'required': True}, {'name': 'interest_calculation', 'type': 'compound_interest + simple_interest + fee_calculation + statement_generation', 'required': True}, {'name': 'loan_origination', 'type': 'application_processing + credit_scoring + underwriting + approval_workflows', 'required': True}, {'name': 'loan_servicing', 'type': 'payment_processing + escrow_management + customer_communications + collections', 'required': True}, {'name': 'loan_portfolio_management', 'type': 'risk_assessment + performance_monitoring + provisioning + reporting', 'required': True}, {'name': 'regulatory_reporting', 'type': 'call_reports + stress_testing + capital_adequacy + fair_lending', 'required': True}, {'name': 'portfolio_management', 'type': 'asset_allocation + performance_tracking + rebalancing + tax_optimization', 'required': True}, {'name': 'trading_operations', 'type': 'order_management + execution + settlement + clearing', 'required': True}, {'name': 'risk_management', 'type': 'market_risk + credit_risk + operational_risk + liquidity_risk', 'required': True}, {'name': 'client_reporting', 'type': 'performance_reports + tax_reports + regulatory_reports + client_statements', 'required': True}, {'name': 'anti_money_laundering', 'type': 'transaction_monitoring + suspicious_activity_reporting + customer_screening + training', 'required': True}, {'name': 'know_your_customer', 'type': 'identity_verification + beneficial_ownership + enhanced_due_diligence + ongoing_monitoring', 'required': True}, {'name': 'fair_lending', 'type': 'lending_practices + disparate_impact_analysis + complaint_management + corrective_actions', 'required': True}, {'name': 'consumer_protection', 'type': 'truth_in_lending + fair_credit_reporting + privacy_protection + complaint_resolution', 'required': True}, {'name': 'credit_risk', 'type': 'credit_scoring + portfolio_monitoring + loan_loss_provisioning + stress_testing', 'required': True}, {'name': 'market_risk', 'type': 'value_at_risk + sensitivity_analysis + scenario_testing + hedging_strategies', 'required': True}, {'name': 'operational_risk', 'type': 'process_risk + technology_risk + fraud_risk + business_continuity', 'required': True}, {'name': 'liquidity_risk', 'type': 'cash_flow_forecasting + funding_strategies + contingency_planning + regulatory_ratios', 'required': True}], 'methods': []}, {'name': 'EducationERP', 'type': 'entity', 'properties': ['admissions', 'registration', 'academic_records', 'student_services', 'course_catalog', 'program_management', 'schedule_management', 'assessment_management', 'human_resources', 'workload_management', 'payroll_management', 'research_administration', 'learning_management', 'student_portal', 'communication_tools', 'mobile_applications', 'student_accounts', 'financial_aid', 'budgeting_planning', 'grants_management'], 'fields': [{'name': 'admissions', 'type': 'application_processing + evaluation + acceptance + enrollment', 'required': True}, {'name': 'registration', 'type': 'course_selection + schedule_building + prerequisite_checking + waitlist_management', 'required': True}, {'name': 'academic_records', 'type': 'grades + transcripts + degree_audits + graduation_requirements', 'required': True}, {'name': 'student_services', 'type': 'advising + counseling + disability_services + career_services', 'required': True}, {'name': 'course_catalog', 'type': 'course_descriptions + prerequisites + learning_outcomes + credit_hours', 'required': True}, {'name': 'program_management', 'type': 'degree_requirements + program_outcomes + accreditation + assessment', 'required': True}, {'name': 'schedule_management', 'type': 'room_scheduling + faculty_assignment + resource_allocation + conflict_resolution', 'required': True}, {'name': 'assessment_management', 'type': 'learning_outcomes + rubrics + portfolio_assessment + program_review', 'required': True}, {'name': 'human_resources', 'type': 'hiring + onboarding + performance_evaluation + professional_development', 'required': True}, {'name': 'workload_management', 'type': 'teaching_loads + research_time + service_assignments + sabbatical_planning', 'required': True}, {'name': 'payroll_management', 'type': 'salary_calculation + benefits_administration + tax_reporting + retirement_planning', 'required': True}, {'name': 'research_administration', 'type': 'grant_management + compliance + intellectual_property + collaboration', 'required': True}, {'name': 'learning_management', 'type': 'course_content + assignments + discussions + gradebook + analytics', 'required': True}, {'name': 'student_portal', 'type': 'registration + grades + financial_aid + housing + dining', 'required': True}, {'name': 'communication_tools', 'type': 'announcements + messaging + notifications + emergency_alerts', 'required': True}, {'name': 'mobile_applications', 'type': 'course_access + grades + schedules + campus_services', 'required': True}, {'name': 'student_accounts', 'type': 'tuition_billing + fee_assessment + payment_processing + financial_aid_integration', 'required': True}, {'name': 'financial_aid', 'type': 'fafsa_processing + aid_packaging + disbursement + compliance_reporting', 'required': True}, {'name': 'budgeting_planning', 'type': 'departmental_budgets + enrollment_planning + revenue_forecasting + cost_analysis', 'required': True}, {'name': 'grants_management', 'type': 'proposal_development + award_management + compliance + reporting', 'required': True}], 'methods': []}, {'name': 'BusinessIntelligenceSuite', 'type': 'entity', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ERPInfrastructure', 'type': 'entity', 'properties': ['tenant_isolation', 'resource_sharing', 'scaling_strategies', 'cost_optimization', 'service_decomposition', 'container_orchestration', 'api_management', 'event_driven_architecture', 'polyglot_persistence', 'data_streaming', 'data_security', 'backup_recovery', 'api_integration', 'message_integration', 'data_integration', 'process_integration', 'identity_management', 'data_protection', 'security_monitoring', 'audit_compliance'], 'fields': [{'name': 'tenant_isolation', 'type': 'data_isolation + security_isolation + performance_isolation + customization_isolation', 'required': True}, {'name': 'resource_sharing', 'type': 'compute_resources + storage_resources + network_resources + application_services', 'required': True}, {'name': 'scaling_strategies', 'type': 'horizontal_scaling + vertical_scaling + auto_scaling + elastic_scaling', 'required': True}, {'name': 'cost_optimization', 'type': 'resource_optimization + usage_monitoring + cost_allocation + billing_transparency', 'required': True}, {'name': 'service_decomposition', 'type': 'domain_driven_design + bounded_contexts + service_boundaries + api_design', 'required': True}, {'name': 'container_orchestration', 'type': 'kubernetes + docker + service_mesh + load_balancing', 'required': True}, {'name': 'api_management', 'type': 'api_gateway + rate_limiting + authentication + documentation', 'required': True}, {'name': 'event_driven_architecture', 'type': 'event_sourcing + message_queues + publish_subscribe + saga_patterns', 'required': True}, {'name': 'polyglot_persistence', 'type': 'relational_databases + nosql_databases + data_lakes + data_warehouses', 'required': True}, {'name': 'data_streaming', 'type': 'real_time_processing + batch_processing + stream_processing + event_processing', 'required': True}, {'name': 'data_security', 'type': 'encryption + access_control + audit_logging + privacy_protection', 'required': True}, {'name': 'backup_recovery', 'type': 'automated_backups + point_in_time_recovery + disaster_recovery + business_continuity', 'required': True}, {'name': 'api_integration', 'type': 'rest_apis + graphql + soap_services + webhook_integration', 'required': True}, {'name': 'message_integration', 'type': 'message_queues + publish_subscribe + request_reply + message_routing', 'required': True}, {'name': 'data_integration', 'type': 'etl_processes + real_time_synchronization + change_data_capture + bulk_transfers', 'required': True}, {'name': 'process_integration', 'type': 'workflow_orchestration + business_process_management + robotic_process_automation', 'required': True}, {'name': 'identity_management', 'type': 'single_sign_on + multi_factor_authentication + role_based_access + privileged_access', 'required': True}, {'name': 'data_protection', 'type': 'gdpr_compliance + hipaa_compliance + pci_compliance + sox_compliance', 'required': True}, {'name': 'security_monitoring', 'type': 'intrusion_detection + vulnerability_scanning + security_information_event_management', 'required': True}, {'name': 'audit_compliance', 'type': 'audit_trails + compliance_reporting + regulatory_reporting + internal_controls', 'required': True}], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['main.apg'], 'app': {'name': 'main', 'version': '1.0.0', 'description': None, 'entity_count': 7}, 'symbols': {'module.main': {'id': 'module.main', 'kind': 'module', 'name': 'main', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.ManufacturingERP': {'id': 'table.ManufacturingERP', 'kind': 'table', 'name': 'ManufacturingERP', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.master_production_schedule': {'id': 'field.ManufacturingERP.master_production_schedule', 'kind': 'field', 'name': 'ManufacturingERP.master_production_schedule', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.material_requirements_planning': {'id': 'field.ManufacturingERP.material_requirements_planning', 'kind': 'field', 'name': 'ManufacturingERP.material_requirements_planning', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.capacity_requirements_planning': {'id': 'field.ManufacturingERP.capacity_requirements_planning', 'kind': 'field', 'name': 'ManufacturingERP.capacity_requirements_planning', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.shop_floor_control': {'id': 'field.ManufacturingERP.shop_floor_control', 'kind': 'field', 'name': 'ManufacturingERP.shop_floor_control', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.warehouse_management': {'id': 'field.ManufacturingERP.warehouse_management', 'kind': 'field', 'name': 'ManufacturingERP.warehouse_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.stock_control': {'id': 'field.ManufacturingERP.stock_control', 'kind': 'field', 'name': 'ManufacturingERP.stock_control', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.material_handling': {'id': 'field.ManufacturingERP.material_handling', 'kind': 'field', 'name': 'ManufacturingERP.material_handling', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.inventory_accounting': {'id': 'field.ManufacturingERP.inventory_accounting', 'kind': 'field', 'name': 'ManufacturingERP.inventory_accounting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.quality_planning': {'id': 'field.ManufacturingERP.quality_planning', 'kind': 'field', 'name': 'ManufacturingERP.quality_planning', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.quality_control': {'id': 'field.ManufacturingERP.quality_control', 'kind': 'field', 'name': 'ManufacturingERP.quality_control', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.quality_assurance': {'id': 'field.ManufacturingERP.quality_assurance', 'kind': 'field', 'name': 'ManufacturingERP.quality_assurance', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.compliance_management': {'id': 'field.ManufacturingERP.compliance_management', 'kind': 'field', 'name': 'ManufacturingERP.compliance_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.preventive_maintenance': {'id': 'field.ManufacturingERP.preventive_maintenance', 'kind': 'field', 'name': 'ManufacturingERP.preventive_maintenance', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.work_order_management': {'id': 'field.ManufacturingERP.work_order_management', 'kind': 'field', 'name': 'ManufacturingERP.work_order_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.asset_management': {'id': 'field.ManufacturingERP.asset_management', 'kind': 'field', 'name': 'ManufacturingERP.asset_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.spare_parts_management': {'id': 'field.ManufacturingERP.spare_parts_management', 'kind': 'field', 'name': 'ManufacturingERP.spare_parts_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.production_monitoring': {'id': 'field.ManufacturingERP.production_monitoring', 'kind': 'field', 'name': 'ManufacturingERP.production_monitoring', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.process_control': {'id': 'field.ManufacturingERP.process_control', 'kind': 'field', 'name': 'ManufacturingERP.process_control', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.traceability': {'id': 'field.ManufacturingERP.traceability', 'kind': 'field', 'name': 'ManufacturingERP.traceability', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.labor_management': {'id': 'field.ManufacturingERP.labor_management', 'kind': 'field', 'name': 'ManufacturingERP.labor_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.supplier_relationship': {'id': 'field.ManufacturingERP.supplier_relationship', 'kind': 'field', 'name': 'ManufacturingERP.supplier_relationship', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.procurement': {'id': 'field.ManufacturingERP.procurement', 'kind': 'field', 'name': 'ManufacturingERP.procurement', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.logistics': {'id': 'field.ManufacturingERP.logistics', 'kind': 'field', 'name': 'ManufacturingERP.logistics', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.demand_planning': {'id': 'field.ManufacturingERP.demand_planning', 'kind': 'field', 'name': 'ManufacturingERP.demand_planning', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.sales_management': {'id': 'field.ManufacturingERP.sales_management', 'kind': 'field', 'name': 'ManufacturingERP.sales_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.marketing_automation': {'id': 'field.ManufacturingERP.marketing_automation', 'kind': 'field', 'name': 'ManufacturingERP.marketing_automation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.service_management': {'id': 'field.ManufacturingERP.service_management', 'kind': 'field', 'name': 'ManufacturingERP.service_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.e_commerce_integration': {'id': 'field.ManufacturingERP.e_commerce_integration', 'kind': 'field', 'name': 'ManufacturingERP.e_commerce_integration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.general_ledger': {'id': 'field.ManufacturingERP.general_ledger', 'kind': 'field', 'name': 'ManufacturingERP.general_ledger', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.accounts_payable': {'id': 'field.ManufacturingERP.accounts_payable', 'kind': 'field', 'name': 'ManufacturingERP.accounts_payable', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.accounts_receivable': {'id': 'field.ManufacturingERP.accounts_receivable', 'kind': 'field', 'name': 'ManufacturingERP.accounts_receivable', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.cost_accounting': {'id': 'field.ManufacturingERP.cost_accounting', 'kind': 'field', 'name': 'ManufacturingERP.cost_accounting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.fixed_assets': {'id': 'field.ManufacturingERP.fixed_assets', 'kind': 'field', 'name': 'ManufacturingERP.fixed_assets', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.operational_dashboards': {'id': 'field.ManufacturingERP.operational_dashboards', 'kind': 'field', 'name': 'ManufacturingERP.operational_dashboards', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.financial_dashboards': {'id': 'field.ManufacturingERP.financial_dashboards', 'kind': 'field', 'name': 'ManufacturingERP.financial_dashboards', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.executive_dashboards': {'id': 'field.ManufacturingERP.executive_dashboards', 'kind': 'field', 'name': 'ManufacturingERP.executive_dashboards', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ManufacturingERP.regulatory_reporting': {'id': 'field.ManufacturingERP.regulatory_reporting', 'kind': 'field', 'name': 'ManufacturingERP.regulatory_reporting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.RetailERP': {'id': 'table.RetailERP', 'kind': 'table', 'name': 'RetailERP', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.transaction_processing': {'id': 'field.RetailERP.transaction_processing', 'kind': 'field', 'name': 'RetailERP.transaction_processing', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.inventory_integration': {'id': 'field.RetailERP.inventory_integration', 'kind': 'field', 'name': 'RetailERP.inventory_integration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.customer_management': {'id': 'field.RetailERP.customer_management', 'kind': 'field', 'name': 'RetailERP.customer_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.staff_management': {'id': 'field.RetailERP.staff_management', 'kind': 'field', 'name': 'RetailERP.staff_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.product_catalog': {'id': 'field.RetailERP.product_catalog', 'kind': 'field', 'name': 'RetailERP.product_catalog', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.buying_planning': {'id': 'field.RetailERP.buying_planning', 'kind': 'field', 'name': 'RetailERP.buying_planning', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.price_management': {'id': 'field.RetailERP.price_management', 'kind': 'field', 'name': 'RetailERP.price_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.visual_merchandising': {'id': 'field.RetailERP.visual_merchandising', 'kind': 'field', 'name': 'RetailERP.visual_merchandising', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.e_commerce_platform': {'id': 'field.RetailERP.e_commerce_platform', 'kind': 'field', 'name': 'RetailERP.e_commerce_platform', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.mobile_commerce': {'id': 'field.RetailERP.mobile_commerce', 'kind': 'field', 'name': 'RetailERP.mobile_commerce', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.social_commerce': {'id': 'field.RetailERP.social_commerce', 'kind': 'field', 'name': 'RetailERP.social_commerce', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.marketplace_integration': {'id': 'field.RetailERP.marketplace_integration', 'kind': 'field', 'name': 'RetailERP.marketplace_integration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.personalization': {'id': 'field.RetailERP.personalization', 'kind': 'field', 'name': 'RetailERP.personalization', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.loyalty_management': {'id': 'field.RetailERP.loyalty_management', 'kind': 'field', 'name': 'RetailERP.loyalty_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.customer_service': {'id': 'field.RetailERP.customer_service', 'kind': 'field', 'name': 'RetailERP.customer_service', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.feedback_management': {'id': 'field.RetailERP.feedback_management', 'kind': 'field', 'name': 'RetailERP.feedback_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.demand_forecasting': {'id': 'field.RetailERP.demand_forecasting', 'kind': 'field', 'name': 'RetailERP.demand_forecasting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.inventory_optimization': {'id': 'field.RetailERP.inventory_optimization', 'kind': 'field', 'name': 'RetailERP.inventory_optimization', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.distribution_management': {'id': 'field.RetailERP.distribution_management', 'kind': 'field', 'name': 'RetailERP.distribution_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.vendor_management': {'id': 'field.RetailERP.vendor_management', 'kind': 'field', 'name': 'RetailERP.vendor_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.sales_analytics': {'id': 'field.RetailERP.sales_analytics', 'kind': 'field', 'name': 'RetailERP.sales_analytics', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.inventory_analytics': {'id': 'field.RetailERP.inventory_analytics', 'kind': 'field', 'name': 'RetailERP.inventory_analytics', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.customer_analytics': {'id': 'field.RetailERP.customer_analytics', 'kind': 'field', 'name': 'RetailERP.customer_analytics', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.RetailERP.financial_analytics': {'id': 'field.RetailERP.financial_analytics', 'kind': 'field', 'name': 'RetailERP.financial_analytics', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.HealthcareERP': {'id': 'table.HealthcareERP', 'kind': 'table', 'name': 'HealthcareERP', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.registration': {'id': 'field.HealthcareERP.registration', 'kind': 'field', 'name': 'HealthcareERP.registration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.medical_records': {'id': 'field.HealthcareERP.medical_records', 'kind': 'field', 'name': 'HealthcareERP.medical_records', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.care_coordination': {'id': 'field.HealthcareERP.care_coordination', 'kind': 'field', 'name': 'HealthcareERP.care_coordination', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.quality_measures': {'id': 'field.HealthcareERP.quality_measures', 'kind': 'field', 'name': 'HealthcareERP.quality_measures', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.order_management': {'id': 'field.HealthcareERP.order_management', 'kind': 'field', 'name': 'HealthcareERP.order_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.medication_management': {'id': 'field.HealthcareERP.medication_management', 'kind': 'field', 'name': 'HealthcareERP.medication_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.laboratory_integration': {'id': 'field.HealthcareERP.laboratory_integration', 'kind': 'field', 'name': 'HealthcareERP.laboratory_integration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.imaging_integration': {'id': 'field.HealthcareERP.imaging_integration', 'kind': 'field', 'name': 'HealthcareERP.imaging_integration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.care_planning': {'id': 'field.HealthcareERP.care_planning', 'kind': 'field', 'name': 'HealthcareERP.care_planning', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.medication_administration': {'id': 'field.HealthcareERP.medication_administration', 'kind': 'field', 'name': 'HealthcareERP.medication_administration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.patient_monitoring': {'id': 'field.HealthcareERP.patient_monitoring', 'kind': 'field', 'name': 'HealthcareERP.patient_monitoring', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.documentation': {'id': 'field.HealthcareERP.documentation', 'kind': 'field', 'name': 'HealthcareERP.documentation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.hipaa_compliance': {'id': 'field.HealthcareERP.hipaa_compliance', 'kind': 'field', 'name': 'HealthcareERP.hipaa_compliance', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.meaningful_use': {'id': 'field.HealthcareERP.meaningful_use', 'kind': 'field', 'name': 'HealthcareERP.meaningful_use', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.joint_commission': {'id': 'field.HealthcareERP.joint_commission', 'kind': 'field', 'name': 'HealthcareERP.joint_commission', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.cms_reporting': {'id': 'field.HealthcareERP.cms_reporting', 'kind': 'field', 'name': 'HealthcareERP.cms_reporting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.revenue_cycle': {'id': 'field.HealthcareERP.revenue_cycle', 'kind': 'field', 'name': 'HealthcareERP.revenue_cycle', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.insurance_management': {'id': 'field.HealthcareERP.insurance_management', 'kind': 'field', 'name': 'HealthcareERP.insurance_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.cost_accounting': {'id': 'field.HealthcareERP.cost_accounting', 'kind': 'field', 'name': 'HealthcareERP.cost_accounting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.budgeting_planning': {'id': 'field.HealthcareERP.budgeting_planning', 'kind': 'field', 'name': 'HealthcareERP.budgeting_planning', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.patient_registries': {'id': 'field.HealthcareERP.patient_registries', 'kind': 'field', 'name': 'HealthcareERP.patient_registries', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.analytics_reporting': {'id': 'field.HealthcareERP.analytics_reporting', 'kind': 'field', 'name': 'HealthcareERP.analytics_reporting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.care_management': {'id': 'field.HealthcareERP.care_management', 'kind': 'field', 'name': 'HealthcareERP.care_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.HealthcareERP.research_support': {'id': 'field.HealthcareERP.research_support', 'kind': 'field', 'name': 'HealthcareERP.research_support', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.FinancialServicesERP': {'id': 'table.FinancialServicesERP', 'kind': 'table', 'name': 'FinancialServicesERP', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.customer_onboarding': {'id': 'field.FinancialServicesERP.customer_onboarding', 'kind': 'field', 'name': 'FinancialServicesERP.customer_onboarding', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.account_maintenance': {'id': 'field.FinancialServicesERP.account_maintenance', 'kind': 'field', 'name': 'FinancialServicesERP.account_maintenance', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.transaction_processing': {'id': 'field.FinancialServicesERP.transaction_processing', 'kind': 'field', 'name': 'FinancialServicesERP.transaction_processing', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.interest_calculation': {'id': 'field.FinancialServicesERP.interest_calculation', 'kind': 'field', 'name': 'FinancialServicesERP.interest_calculation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.loan_origination': {'id': 'field.FinancialServicesERP.loan_origination', 'kind': 'field', 'name': 'FinancialServicesERP.loan_origination', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.loan_servicing': {'id': 'field.FinancialServicesERP.loan_servicing', 'kind': 'field', 'name': 'FinancialServicesERP.loan_servicing', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.loan_portfolio_management': {'id': 'field.FinancialServicesERP.loan_portfolio_management', 'kind': 'field', 'name': 'FinancialServicesERP.loan_portfolio_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.regulatory_reporting': {'id': 'field.FinancialServicesERP.regulatory_reporting', 'kind': 'field', 'name': 'FinancialServicesERP.regulatory_reporting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.portfolio_management': {'id': 'field.FinancialServicesERP.portfolio_management', 'kind': 'field', 'name': 'FinancialServicesERP.portfolio_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.trading_operations': {'id': 'field.FinancialServicesERP.trading_operations', 'kind': 'field', 'name': 'FinancialServicesERP.trading_operations', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.risk_management': {'id': 'field.FinancialServicesERP.risk_management', 'kind': 'field', 'name': 'FinancialServicesERP.risk_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.client_reporting': {'id': 'field.FinancialServicesERP.client_reporting', 'kind': 'field', 'name': 'FinancialServicesERP.client_reporting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.anti_money_laundering': {'id': 'field.FinancialServicesERP.anti_money_laundering', 'kind': 'field', 'name': 'FinancialServicesERP.anti_money_laundering', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.know_your_customer': {'id': 'field.FinancialServicesERP.know_your_customer', 'kind': 'field', 'name': 'FinancialServicesERP.know_your_customer', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.fair_lending': {'id': 'field.FinancialServicesERP.fair_lending', 'kind': 'field', 'name': 'FinancialServicesERP.fair_lending', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.consumer_protection': {'id': 'field.FinancialServicesERP.consumer_protection', 'kind': 'field', 'name': 'FinancialServicesERP.consumer_protection', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.credit_risk': {'id': 'field.FinancialServicesERP.credit_risk', 'kind': 'field', 'name': 'FinancialServicesERP.credit_risk', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.market_risk': {'id': 'field.FinancialServicesERP.market_risk', 'kind': 'field', 'name': 'FinancialServicesERP.market_risk', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.operational_risk': {'id': 'field.FinancialServicesERP.operational_risk', 'kind': 'field', 'name': 'FinancialServicesERP.operational_risk', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialServicesERP.liquidity_risk': {'id': 'field.FinancialServicesERP.liquidity_risk', 'kind': 'field', 'name': 'FinancialServicesERP.liquidity_risk', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.EducationERP': {'id': 'table.EducationERP', 'kind': 'table', 'name': 'EducationERP', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.admissions': {'id': 'field.EducationERP.admissions', 'kind': 'field', 'name': 'EducationERP.admissions', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.registration': {'id': 'field.EducationERP.registration', 'kind': 'field', 'name': 'EducationERP.registration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.academic_records': {'id': 'field.EducationERP.academic_records', 'kind': 'field', 'name': 'EducationERP.academic_records', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.student_services': {'id': 'field.EducationERP.student_services', 'kind': 'field', 'name': 'EducationERP.student_services', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.course_catalog': {'id': 'field.EducationERP.course_catalog', 'kind': 'field', 'name': 'EducationERP.course_catalog', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.program_management': {'id': 'field.EducationERP.program_management', 'kind': 'field', 'name': 'EducationERP.program_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.schedule_management': {'id': 'field.EducationERP.schedule_management', 'kind': 'field', 'name': 'EducationERP.schedule_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.assessment_management': {'id': 'field.EducationERP.assessment_management', 'kind': 'field', 'name': 'EducationERP.assessment_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.human_resources': {'id': 'field.EducationERP.human_resources', 'kind': 'field', 'name': 'EducationERP.human_resources', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.workload_management': {'id': 'field.EducationERP.workload_management', 'kind': 'field', 'name': 'EducationERP.workload_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.payroll_management': {'id': 'field.EducationERP.payroll_management', 'kind': 'field', 'name': 'EducationERP.payroll_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.research_administration': {'id': 'field.EducationERP.research_administration', 'kind': 'field', 'name': 'EducationERP.research_administration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.learning_management': {'id': 'field.EducationERP.learning_management', 'kind': 'field', 'name': 'EducationERP.learning_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.student_portal': {'id': 'field.EducationERP.student_portal', 'kind': 'field', 'name': 'EducationERP.student_portal', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.communication_tools': {'id': 'field.EducationERP.communication_tools', 'kind': 'field', 'name': 'EducationERP.communication_tools', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.mobile_applications': {'id': 'field.EducationERP.mobile_applications', 'kind': 'field', 'name': 'EducationERP.mobile_applications', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.student_accounts': {'id': 'field.EducationERP.student_accounts', 'kind': 'field', 'name': 'EducationERP.student_accounts', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.financial_aid': {'id': 'field.EducationERP.financial_aid', 'kind': 'field', 'name': 'EducationERP.financial_aid', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.budgeting_planning': {'id': 'field.EducationERP.budgeting_planning', 'kind': 'field', 'name': 'EducationERP.budgeting_planning', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.EducationERP.grants_management': {'id': 'field.EducationERP.grants_management', 'kind': 'field', 'name': 'EducationERP.grants_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'entity.BusinessIntelligenceSuite': {'id': 'entity.BusinessIntelligenceSuite', 'kind': 'entity', 'name': 'BusinessIntelligenceSuite', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.ERPInfrastructure': {'id': 'table.ERPInfrastructure', 'kind': 'table', 'name': 'ERPInfrastructure', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.tenant_isolation': {'id': 'field.ERPInfrastructure.tenant_isolation', 'kind': 'field', 'name': 'ERPInfrastructure.tenant_isolation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.resource_sharing': {'id': 'field.ERPInfrastructure.resource_sharing', 'kind': 'field', 'name': 'ERPInfrastructure.resource_sharing', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.scaling_strategies': {'id': 'field.ERPInfrastructure.scaling_strategies', 'kind': 'field', 'name': 'ERPInfrastructure.scaling_strategies', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.cost_optimization': {'id': 'field.ERPInfrastructure.cost_optimization', 'kind': 'field', 'name': 'ERPInfrastructure.cost_optimization', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.service_decomposition': {'id': 'field.ERPInfrastructure.service_decomposition', 'kind': 'field', 'name': 'ERPInfrastructure.service_decomposition', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.container_orchestration': {'id': 'field.ERPInfrastructure.container_orchestration', 'kind': 'field', 'name': 'ERPInfrastructure.container_orchestration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.api_management': {'id': 'field.ERPInfrastructure.api_management', 'kind': 'field', 'name': 'ERPInfrastructure.api_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.event_driven_architecture': {'id': 'field.ERPInfrastructure.event_driven_architecture', 'kind': 'field', 'name': 'ERPInfrastructure.event_driven_architecture', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.polyglot_persistence': {'id': 'field.ERPInfrastructure.polyglot_persistence', 'kind': 'field', 'name': 'ERPInfrastructure.polyglot_persistence', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.data_streaming': {'id': 'field.ERPInfrastructure.data_streaming', 'kind': 'field', 'name': 'ERPInfrastructure.data_streaming', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.data_security': {'id': 'field.ERPInfrastructure.data_security', 'kind': 'field', 'name': 'ERPInfrastructure.data_security', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.backup_recovery': {'id': 'field.ERPInfrastructure.backup_recovery', 'kind': 'field', 'name': 'ERPInfrastructure.backup_recovery', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.api_integration': {'id': 'field.ERPInfrastructure.api_integration', 'kind': 'field', 'name': 'ERPInfrastructure.api_integration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.message_integration': {'id': 'field.ERPInfrastructure.message_integration', 'kind': 'field', 'name': 'ERPInfrastructure.message_integration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.data_integration': {'id': 'field.ERPInfrastructure.data_integration', 'kind': 'field', 'name': 'ERPInfrastructure.data_integration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.process_integration': {'id': 'field.ERPInfrastructure.process_integration', 'kind': 'field', 'name': 'ERPInfrastructure.process_integration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.identity_management': {'id': 'field.ERPInfrastructure.identity_management', 'kind': 'field', 'name': 'ERPInfrastructure.identity_management', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.data_protection': {'id': 'field.ERPInfrastructure.data_protection', 'kind': 'field', 'name': 'ERPInfrastructure.data_protection', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.security_monitoring': {'id': 'field.ERPInfrastructure.security_monitoring', 'kind': 'field', 'name': 'ERPInfrastructure.security_monitoring', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ERPInfrastructure.audit_compliance': {'id': 'field.ERPInfrastructure.audit_compliance', 'kind': 'field', 'name': 'ERPInfrastructure.audit_compliance', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'ManufacturingERP': {'name': 'ManufacturingERP', 'fields': {'master_production_schedule': {'type': 'demand_forecasting + capacity_planning + resource_allocation', 'required': True, 'relationship': {'target_table': 'demand_forecasting + capacity_planning + resource_allocation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'material_requirements_planning': {'type': 'bom_explosion + lead_time_calculation + supplier_scheduling', 'required': True, 'relationship': {'target_table': 'bom_explosion + lead_time_calculation + supplier_scheduling', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'capacity_requirements_planning': {'type': 'work_center_loading + bottleneck_analysis + scheduling_optimization', 'required': True, 'relationship': {'target_table': 'work_center_loading + bottleneck_analysis + scheduling_optimization', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'shop_floor_control': {'type': 'work_order_management + progress_tracking + quality_control_integration', 'required': True, 'relationship': {'target_table': 'work_order_management + progress_tracking + quality_control_integration', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'warehouse_management': {'type': 'location_tracking + picking_optimization + cycle_counting + abc_analysis', 'required': True, 'relationship': {'target_table': 'location_tracking + picking_optimization + cycle_counting + abc_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'stock_control': {'type': 'safety_stock_calculation + reorder_point_optimization + economic_order_quantity', 'required': True, 'relationship': {'target_table': 'safety_stock_calculation + reorder_point_optimization + economic_order_quantity', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'material_handling': {'type': 'receiving + put_away + picking + shipping + cross_docking', 'required': True, 'relationship': {'target_table': 'receiving + put_away + picking + shipping + cross_docking', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'inventory_accounting': {'type': 'fifo + lifo + weighted_average + standard_costing + variance_analysis', 'required': True, 'relationship': {'target_table': 'fifo + lifo + weighted_average + standard_costing + variance_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'quality_planning': {'type': 'quality_objectives + control_plans + inspection_procedures + statistical_process_control', 'required': True, 'relationship': {'target_table': 'quality_objectives + control_plans + inspection_procedures + statistical_process_control', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'quality_control': {'type': 'incoming_inspection + in_process_inspection + final_inspection + testing_protocols', 'required': True, 'relationship': {'target_table': 'incoming_inspection + in_process_inspection + final_inspection + testing_protocols', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'quality_assurance': {'type': 'quality_audits + corrective_actions + preventive_actions + continuous_improvement', 'required': True, 'relationship': {'target_table': 'quality_audits + corrective_actions + preventive_actions + continuous_improvement', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'compliance_management': {'type': 'iso_standards + regulatory_compliance + documentation_control + training_records', 'required': True, 'relationship': {'target_table': 'iso_standards + regulatory_compliance + documentation_control + training_records', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'preventive_maintenance': {'type': 'scheduled_maintenance + condition_based_maintenance + predictive_maintenance', 'required': True, 'relationship': {'target_table': 'scheduled_maintenance + condition_based_maintenance + predictive_maintenance', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'work_order_management': {'type': 'maintenance_requests + work_scheduling + resource_allocation + completion_tracking', 'required': True, 'relationship': {'target_table': 'maintenance_requests + work_scheduling + resource_allocation + completion_tracking', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'asset_management': {'type': 'equipment_records + maintenance_history + depreciation + replacement_planning', 'required': True, 'relationship': {'target_table': 'equipment_records + maintenance_history + depreciation + replacement_planning', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'spare_parts_management': {'type': 'inventory_optimization + critical_parts_identification + supplier_management', 'required': True, 'relationship': {'target_table': 'inventory_optimization + critical_parts_identification + supplier_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'production_monitoring': {'type': 'real_time_data_collection + oee_calculation + downtime_tracking', 'required': True, 'relationship': {'target_table': 'real_time_data_collection + oee_calculation + downtime_tracking', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'process_control': {'type': 'recipe_management + batch_tracking + process_parameters + quality_data', 'required': True, 'relationship': {'target_table': 'recipe_management + batch_tracking + process_parameters + quality_data', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'traceability': {'type': 'lot_tracking + genealogy + recall_management + serialization', 'required': True, 'relationship': {'target_table': 'lot_tracking + genealogy + recall_management + serialization', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'labor_management': {'type': 'time_tracking + skill_matching + performance_monitoring + incentive_calculation', 'required': True, 'relationship': {'target_table': 'time_tracking + skill_matching + performance_monitoring + incentive_calculation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'supplier_relationship': {'type': 'vendor_evaluation + performance_monitoring + contract_management + collaboration', 'required': True, 'relationship': {'target_table': 'vendor_evaluation + performance_monitoring + contract_management + collaboration', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'procurement': {'type': 'purchase_requisitions + rfq_management + purchase_orders + receipt_matching', 'required': True, 'relationship': {'target_table': 'purchase_requisitions + rfq_management + purchase_orders + receipt_matching', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'logistics': {'type': 'transportation_planning + carrier_selection + freight_optimization + delivery_tracking', 'required': True, 'relationship': {'target_table': 'transportation_planning + carrier_selection + freight_optimization + delivery_tracking', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'demand_planning': {'type': 'sales_forecasting + demand_sensing + collaborative_planning + scenario_modeling', 'required': True, 'relationship': {'target_table': 'sales_forecasting + demand_sensing + collaborative_planning + scenario_modeling', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'sales_management': {'type': 'opportunity_tracking + quote_management + order_processing + customer_service', 'required': True, 'relationship': {'target_table': 'opportunity_tracking + quote_management + order_processing + customer_service', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'marketing_automation': {'type': 'campaign_management + lead_generation + customer_segmentation + analytics', 'required': True, 'relationship': {'target_table': 'campaign_management + lead_generation + customer_segmentation + analytics', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'service_management': {'type': 'warranty_tracking + service_requests + field_service + customer_satisfaction', 'required': True, 'relationship': {'target_table': 'warranty_tracking + service_requests + field_service + customer_satisfaction', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'e_commerce_integration': {'type': 'online_catalog + order_integration + inventory_synchronization + customer_portal', 'required': True, 'relationship': {'target_table': 'online_catalog + order_integration + inventory_synchronization + customer_portal', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'general_ledger': {'type': 'chart_of_accounts + journal_entries + financial_reporting + budget_management', 'required': True, 'relationship': {'target_table': 'chart_of_accounts + journal_entries + financial_reporting + budget_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'accounts_payable': {'type': 'vendor_invoicing + payment_processing + cash_management + expense_reporting', 'required': True, 'relationship': {'target_table': 'vendor_invoicing + payment_processing + cash_management + expense_reporting', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'accounts_receivable': {'type': 'customer_invoicing + payment_tracking + credit_management + collections', 'required': True, 'relationship': {'target_table': 'customer_invoicing + payment_tracking + credit_management + collections', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'cost_accounting': {'type': 'standard_costing + actual_costing + variance_analysis + activity_based_costing', 'required': True, 'relationship': {'target_table': 'standard_costing + actual_costing + variance_analysis + activity_based_costing', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'fixed_assets': {'type': 'asset_tracking + depreciation + maintenance_capitalization + disposal_management', 'required': True, 'relationship': {'target_table': 'asset_tracking + depreciation + maintenance_capitalization + disposal_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'operational_dashboards': {'type': 'production_metrics + quality_metrics + inventory_levels + delivery_performance', 'required': True, 'relationship': {'target_table': 'production_metrics + quality_metrics + inventory_levels + delivery_performance', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'financial_dashboards': {'type': 'revenue_analysis + cost_analysis + profitability + cash_flow', 'required': True, 'relationship': {'target_table': 'revenue_analysis + cost_analysis + profitability + cash_flow', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'executive_dashboards': {'type': 'kpi_monitoring + trend_analysis + exception_reporting + drill_down_capability', 'required': True, 'relationship': {'target_table': 'kpi_monitoring + trend_analysis + exception_reporting + drill_down_capability', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'regulatory_reporting': {'type': 'financial_statements + tax_reporting + compliance_reports + audit_trails', 'required': True, 'relationship': {'target_table': 'financial_statements + tax_reporting + compliance_reports + audit_trails', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'master_production_schedule.id': {'chain': ['ManufacturingERP.master_production_schedule', 'demand_forecasting + capacity_planning + resource_allocation.id'], 'valid': True}, 'material_requirements_planning.id': {'chain': ['ManufacturingERP.material_requirements_planning', 'bom_explosion + lead_time_calculation + supplier_scheduling.id'], 'valid': True}, 'capacity_requirements_planning.id': {'chain': ['ManufacturingERP.capacity_requirements_planning', 'work_center_loading + bottleneck_analysis + scheduling_optimization.id'], 'valid': True}, 'shop_floor_control.id': {'chain': ['ManufacturingERP.shop_floor_control', 'work_order_management + progress_tracking + quality_control_integration.id'], 'valid': True}, 'warehouse_management.id': {'chain': ['ManufacturingERP.warehouse_management', 'location_tracking + picking_optimization + cycle_counting + abc_analysis.id'], 'valid': True}, 'stock_control.id': {'chain': ['ManufacturingERP.stock_control', 'safety_stock_calculation + reorder_point_optimization + economic_order_quantity.id'], 'valid': True}, 'material_handling.id': {'chain': ['ManufacturingERP.material_handling', 'receiving + put_away + picking + shipping + cross_docking.id'], 'valid': True}, 'inventory_accounting.id': {'chain': ['ManufacturingERP.inventory_accounting', 'fifo + lifo + weighted_average + standard_costing + variance_analysis.id'], 'valid': True}, 'quality_planning.id': {'chain': ['ManufacturingERP.quality_planning', 'quality_objectives + control_plans + inspection_procedures + statistical_process_control.id'], 'valid': True}, 'quality_control.id': {'chain': ['ManufacturingERP.quality_control', 'incoming_inspection + in_process_inspection + final_inspection + testing_protocols.id'], 'valid': True}, 'quality_assurance.id': {'chain': ['ManufacturingERP.quality_assurance', 'quality_audits + corrective_actions + preventive_actions + continuous_improvement.id'], 'valid': True}, 'compliance_management.id': {'chain': ['ManufacturingERP.compliance_management', 'iso_standards + regulatory_compliance + documentation_control + training_records.id'], 'valid': True}, 'preventive_maintenance.id': {'chain': ['ManufacturingERP.preventive_maintenance', 'scheduled_maintenance + condition_based_maintenance + predictive_maintenance.id'], 'valid': True}, 'work_order_management.id': {'chain': ['ManufacturingERP.work_order_management', 'maintenance_requests + work_scheduling + resource_allocation + completion_tracking.id'], 'valid': True}, 'asset_management.id': {'chain': ['ManufacturingERP.asset_management', 'equipment_records + maintenance_history + depreciation + replacement_planning.id'], 'valid': True}, 'spare_parts_management.id': {'chain': ['ManufacturingERP.spare_parts_management', 'inventory_optimization + critical_parts_identification + supplier_management.id'], 'valid': True}, 'production_monitoring.id': {'chain': ['ManufacturingERP.production_monitoring', 'real_time_data_collection + oee_calculation + downtime_tracking.id'], 'valid': True}, 'process_control.id': {'chain': ['ManufacturingERP.process_control', 'recipe_management + batch_tracking + process_parameters + quality_data.id'], 'valid': True}, 'traceability.id': {'chain': ['ManufacturingERP.traceability', 'lot_tracking + genealogy + recall_management + serialization.id'], 'valid': True}, 'labor_management.id': {'chain': ['ManufacturingERP.labor_management', 'time_tracking + skill_matching + performance_monitoring + incentive_calculation.id'], 'valid': True}, 'supplier_relationship.id': {'chain': ['ManufacturingERP.supplier_relationship', 'vendor_evaluation + performance_monitoring + contract_management + collaboration.id'], 'valid': True}, 'procurement.id': {'chain': ['ManufacturingERP.procurement', 'purchase_requisitions + rfq_management + purchase_orders + receipt_matching.id'], 'valid': True}, 'logistics.id': {'chain': ['ManufacturingERP.logistics', 'transportation_planning + carrier_selection + freight_optimization + delivery_tracking.id'], 'valid': True}, 'demand_planning.id': {'chain': ['ManufacturingERP.demand_planning', 'sales_forecasting + demand_sensing + collaborative_planning + scenario_modeling.id'], 'valid': True}, 'sales_management.id': {'chain': ['ManufacturingERP.sales_management', 'opportunity_tracking + quote_management + order_processing + customer_service.id'], 'valid': True}, 'marketing_automation.id': {'chain': ['ManufacturingERP.marketing_automation', 'campaign_management + lead_generation + customer_segmentation + analytics.id'], 'valid': True}, 'service_management.id': {'chain': ['ManufacturingERP.service_management', 'warranty_tracking + service_requests + field_service + customer_satisfaction.id'], 'valid': True}, 'e_commerce_integration.id': {'chain': ['ManufacturingERP.e_commerce_integration', 'online_catalog + order_integration + inventory_synchronization + customer_portal.id'], 'valid': True}, 'general_ledger.id': {'chain': ['ManufacturingERP.general_ledger', 'chart_of_accounts + journal_entries + financial_reporting + budget_management.id'], 'valid': True}, 'accounts_payable.id': {'chain': ['ManufacturingERP.accounts_payable', 'vendor_invoicing + payment_processing + cash_management + expense_reporting.id'], 'valid': True}, 'accounts_receivable.id': {'chain': ['ManufacturingERP.accounts_receivable', 'customer_invoicing + payment_tracking + credit_management + collections.id'], 'valid': True}, 'cost_accounting.id': {'chain': ['ManufacturingERP.cost_accounting', 'standard_costing + actual_costing + variance_analysis + activity_based_costing.id'], 'valid': True}, 'fixed_assets.id': {'chain': ['ManufacturingERP.fixed_assets', 'asset_tracking + depreciation + maintenance_capitalization + disposal_management.id'], 'valid': True}, 'operational_dashboards.id': {'chain': ['ManufacturingERP.operational_dashboards', 'production_metrics + quality_metrics + inventory_levels + delivery_performance.id'], 'valid': True}, 'financial_dashboards.id': {'chain': ['ManufacturingERP.financial_dashboards', 'revenue_analysis + cost_analysis + profitability + cash_flow.id'], 'valid': True}, 'executive_dashboards.id': {'chain': ['ManufacturingERP.executive_dashboards', 'kpi_monitoring + trend_analysis + exception_reporting + drill_down_capability.id'], 'valid': True}, 'regulatory_reporting.id': {'chain': ['ManufacturingERP.regulatory_reporting', 'financial_statements + tax_reporting + compliance_reports + audit_trails.id'], 'valid': True}}}, 'RetailERP': {'name': 'RetailERP', 'fields': {'transaction_processing': {'type': 'barcode_scanning + payment_processing + receipt_generation + customer_identification', 'required': True, 'relationship': {'target_table': 'barcode_scanning + payment_processing + receipt_generation + customer_identification', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'inventory_integration': {'type': 'real_time_stock_updates + automatic_reordering + stock_alerts + transfer_requests', 'required': True, 'relationship': {'target_table': 'real_time_stock_updates + automatic_reordering + stock_alerts + transfer_requests', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'customer_management': {'type': 'loyalty_programs + customer_history + personalized_offers + birthday_promotions', 'required': True, 'relationship': {'target_table': 'loyalty_programs + customer_history + personalized_offers + birthday_promotions', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'staff_management': {'type': 'cashier_authentication + sales_performance + commission_calculation + shift_management', 'required': True, 'relationship': {'target_table': 'cashier_authentication + sales_performance + commission_calculation + shift_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'product_catalog': {'type': 'item_master + category_hierarchy + attributes + variants + pricing', 'required': True, 'relationship': {'target_table': 'item_master + category_hierarchy + attributes + variants + pricing', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'buying_planning': {'type': 'open_to_buy + assortment_planning + seasonal_planning + vendor_negotiations', 'required': True, 'relationship': {'target_table': 'open_to_buy + assortment_planning + seasonal_planning + vendor_negotiations', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'price_management': {'type': 'regular_pricing + promotional_pricing + markdown_optimization + competitive_pricing', 'required': True, 'relationship': {'target_table': 'regular_pricing + promotional_pricing + markdown_optimization + competitive_pricing', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'visual_merchandising': {'type': 'planogram_management + space_allocation + display_guidelines + seasonal_changes', 'required': True, 'relationship': {'target_table': 'planogram_management + space_allocation + display_guidelines + seasonal_changes', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'e_commerce_platform': {'type': 'online_catalog + shopping_cart + payment_gateway + order_fulfillment', 'required': True, 'relationship': {'target_table': 'online_catalog + shopping_cart + payment_gateway + order_fulfillment', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'mobile_commerce': {'type': 'mobile_app + mobile_payments + location_services + push_notifications', 'required': True, 'relationship': {'target_table': 'mobile_app + mobile_payments + location_services + push_notifications', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'social_commerce': {'type': 'social_media_integration + influencer_partnerships + user_generated_content', 'required': True, 'relationship': {'target_table': 'social_media_integration + influencer_partnerships + user_generated_content', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'marketplace_integration': {'type': 'amazon + ebay + etsy + google_shopping + comparison_engines', 'required': True, 'relationship': {'target_table': 'amazon + ebay + etsy + google_shopping + comparison_engines', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'personalization': {'type': 'recommendation_engine + targeted_marketing + customized_content + personal_shopping', 'required': True, 'relationship': {'target_table': 'recommendation_engine + targeted_marketing + customized_content + personal_shopping', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'loyalty_management': {'type': 'points_accumulation + rewards_redemption + tier_management + gamification', 'required': True, 'relationship': {'target_table': 'points_accumulation + rewards_redemption + tier_management + gamification', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'customer_service': {'type': 'help_desk + live_chat + knowledge_base + returns_management', 'required': True, 'relationship': {'target_table': 'help_desk + live_chat + knowledge_base + returns_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'feedback_management': {'type': 'review_collection + sentiment_analysis + response_management + improvement_tracking', 'required': True, 'relationship': {'target_table': 'review_collection + sentiment_analysis + response_management + improvement_tracking', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'demand_forecasting': {'type': 'sales_history_analysis + trend_identification + seasonal_adjustment + promotional_impact', 'required': True, 'relationship': {'target_table': 'sales_history_analysis + trend_identification + seasonal_adjustment + promotional_impact', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'inventory_optimization': {'type': 'safety_stock_calculation + reorder_points + economic_order_quantities + abc_analysis', 'required': True, 'relationship': {'target_table': 'safety_stock_calculation + reorder_points + economic_order_quantities + abc_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'distribution_management': {'type': 'warehouse_operations + cross_docking + drop_shipping + last_mile_delivery', 'required': True, 'relationship': {'target_table': 'warehouse_operations + cross_docking + drop_shipping + last_mile_delivery', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'vendor_management': {'type': 'supplier_onboarding + performance_evaluation + contract_negotiations + collaborative_planning', 'required': True, 'relationship': {'target_table': 'supplier_onboarding + performance_evaluation + contract_negotiations + collaborative_planning', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'sales_analytics': {'type': 'sales_performance + product_performance + customer_analytics + market_basket_analysis', 'required': True, 'relationship': {'target_table': 'sales_performance + product_performance + customer_analytics + market_basket_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'inventory_analytics': {'type': 'stock_levels + turnover_rates + sell_through_rates + markdown_analysis', 'required': True, 'relationship': {'target_table': 'stock_levels + turnover_rates + sell_through_rates + markdown_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'customer_analytics': {'type': 'customer_lifetime_value + churn_prediction + segmentation + behavior_analysis', 'required': True, 'relationship': {'target_table': 'customer_lifetime_value + churn_prediction + segmentation + behavior_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'financial_analytics': {'type': 'gross_margin_analysis + expense_tracking + profitability_analysis + budget_variance', 'required': True, 'relationship': {'target_table': 'gross_margin_analysis + expense_tracking + profitability_analysis + budget_variance', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'transaction_processing.id': {'chain': ['RetailERP.transaction_processing', 'barcode_scanning + payment_processing + receipt_generation + customer_identification.id'], 'valid': True}, 'inventory_integration.id': {'chain': ['RetailERP.inventory_integration', 'real_time_stock_updates + automatic_reordering + stock_alerts + transfer_requests.id'], 'valid': True}, 'customer_management.id': {'chain': ['RetailERP.customer_management', 'loyalty_programs + customer_history + personalized_offers + birthday_promotions.id'], 'valid': True}, 'staff_management.id': {'chain': ['RetailERP.staff_management', 'cashier_authentication + sales_performance + commission_calculation + shift_management.id'], 'valid': True}, 'product_catalog.id': {'chain': ['RetailERP.product_catalog', 'item_master + category_hierarchy + attributes + variants + pricing.id'], 'valid': True}, 'buying_planning.id': {'chain': ['RetailERP.buying_planning', 'open_to_buy + assortment_planning + seasonal_planning + vendor_negotiations.id'], 'valid': True}, 'price_management.id': {'chain': ['RetailERP.price_management', 'regular_pricing + promotional_pricing + markdown_optimization + competitive_pricing.id'], 'valid': True}, 'visual_merchandising.id': {'chain': ['RetailERP.visual_merchandising', 'planogram_management + space_allocation + display_guidelines + seasonal_changes.id'], 'valid': True}, 'e_commerce_platform.id': {'chain': ['RetailERP.e_commerce_platform', 'online_catalog + shopping_cart + payment_gateway + order_fulfillment.id'], 'valid': True}, 'mobile_commerce.id': {'chain': ['RetailERP.mobile_commerce', 'mobile_app + mobile_payments + location_services + push_notifications.id'], 'valid': True}, 'social_commerce.id': {'chain': ['RetailERP.social_commerce', 'social_media_integration + influencer_partnerships + user_generated_content.id'], 'valid': True}, 'marketplace_integration.id': {'chain': ['RetailERP.marketplace_integration', 'amazon + ebay + etsy + google_shopping + comparison_engines.id'], 'valid': True}, 'personalization.id': {'chain': ['RetailERP.personalization', 'recommendation_engine + targeted_marketing + customized_content + personal_shopping.id'], 'valid': True}, 'loyalty_management.id': {'chain': ['RetailERP.loyalty_management', 'points_accumulation + rewards_redemption + tier_management + gamification.id'], 'valid': True}, 'customer_service.id': {'chain': ['RetailERP.customer_service', 'help_desk + live_chat + knowledge_base + returns_management.id'], 'valid': True}, 'feedback_management.id': {'chain': ['RetailERP.feedback_management', 'review_collection + sentiment_analysis + response_management + improvement_tracking.id'], 'valid': True}, 'demand_forecasting.id': {'chain': ['RetailERP.demand_forecasting', 'sales_history_analysis + trend_identification + seasonal_adjustment + promotional_impact.id'], 'valid': True}, 'inventory_optimization.id': {'chain': ['RetailERP.inventory_optimization', 'safety_stock_calculation + reorder_points + economic_order_quantities + abc_analysis.id'], 'valid': True}, 'distribution_management.id': {'chain': ['RetailERP.distribution_management', 'warehouse_operations + cross_docking + drop_shipping + last_mile_delivery.id'], 'valid': True}, 'vendor_management.id': {'chain': ['RetailERP.vendor_management', 'supplier_onboarding + performance_evaluation + contract_negotiations + collaborative_planning.id'], 'valid': True}, 'sales_analytics.id': {'chain': ['RetailERP.sales_analytics', 'sales_performance + product_performance + customer_analytics + market_basket_analysis.id'], 'valid': True}, 'inventory_analytics.id': {'chain': ['RetailERP.inventory_analytics', 'stock_levels + turnover_rates + sell_through_rates + markdown_analysis.id'], 'valid': True}, 'customer_analytics.id': {'chain': ['RetailERP.customer_analytics', 'customer_lifetime_value + churn_prediction + segmentation + behavior_analysis.id'], 'valid': True}, 'financial_analytics.id': {'chain': ['RetailERP.financial_analytics', 'gross_margin_analysis + expense_tracking + profitability_analysis + budget_variance.id'], 'valid': True}}}, 'HealthcareERP': {'name': 'HealthcareERP', 'fields': {'registration': {'type': 'patient_demographics + insurance_verification + consent_management + appointment_scheduling', 'required': True, 'relationship': {'target_table': 'patient_demographics + insurance_verification + consent_management + appointment_scheduling', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'medical_records': {'type': 'electronic_health_records + clinical_documentation + medical_history + care_plans', 'required': True, 'relationship': {'target_table': 'electronic_health_records + clinical_documentation + medical_history + care_plans', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'care_coordination': {'type': 'referral_management + care_team_communication + discharge_planning + follow_up_scheduling', 'required': True, 'relationship': {'target_table': 'referral_management + care_team_communication + discharge_planning + follow_up_scheduling', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'quality_measures': {'type': 'clinical_quality_indicators + patient_safety_metrics + outcome_measurements + reporting', 'required': True, 'relationship': {'target_table': 'clinical_quality_indicators + patient_safety_metrics + outcome_measurements + reporting', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'order_management': {'type': 'physician_orders + computerized_order_entry + clinical_decision_support + order_tracking', 'required': True, 'relationship': {'target_table': 'physician_orders + computerized_order_entry + clinical_decision_support + order_tracking', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'medication_management': {'type': 'e_prescribing + medication_reconciliation + drug_interaction_checking + formulary_management', 'required': True, 'relationship': {'target_table': 'e_prescribing + medication_reconciliation + drug_interaction_checking + formulary_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'laboratory_integration': {'type': 'test_ordering + result_reporting + critical_value_alerts + trending_analysis', 'required': True, 'relationship': {'target_table': 'test_ordering + result_reporting + critical_value_alerts + trending_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'imaging_integration': {'type': 'radiology_orders + image_storage + reporting + diagnostic_support', 'required': True, 'relationship': {'target_table': 'radiology_orders + image_storage + reporting + diagnostic_support', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'care_planning': {'type': 'nursing_assessments + care_plan_development + intervention_tracking + outcome_evaluation', 'required': True, 'relationship': {'target_table': 'nursing_assessments + care_plan_development + intervention_tracking + outcome_evaluation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'medication_administration': {'type': 'barcode_scanning + dosage_verification + administration_documentation + adverse_event_reporting', 'required': True, 'relationship': {'target_table': 'barcode_scanning + dosage_verification + administration_documentation + adverse_event_reporting', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'patient_monitoring': {'type': 'vital_signs + fluid_balance + pain_assessment + fall_risk_assessment', 'required': True, 'relationship': {'target_table': 'vital_signs + fluid_balance + pain_assessment + fall_risk_assessment', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'documentation': {'type': 'nursing_notes + shift_reports + care_summaries + incident_reporting', 'required': True, 'relationship': {'target_table': 'nursing_notes + shift_reports + care_summaries + incident_reporting', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'hipaa_compliance': {'type': 'privacy_controls + security_safeguards + audit_logging + breach_notification', 'required': True, 'relationship': {'target_table': 'privacy_controls + security_safeguards + audit_logging + breach_notification', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'meaningful_use': {'type': 'clinical_quality_measures + patient_engagement + care_coordination + population_health', 'required': True, 'relationship': {'target_table': 'clinical_quality_measures + patient_engagement + care_coordination + population_health', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'joint_commission': {'type': 'quality_standards + patient_safety + performance_improvement + accreditation_reporting', 'required': True, 'relationship': {'target_table': 'quality_standards + patient_safety + performance_improvement + accreditation_reporting', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'cms_reporting': {'type': 'quality_reporting + value_based_care + medicare_reporting + medicaid_reporting', 'required': True, 'relationship': {'target_table': 'quality_reporting + value_based_care + medicare_reporting + medicaid_reporting', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'revenue_cycle': {'type': 'patient_registration + charge_capture + coding + billing + collections', 'required': True, 'relationship': {'target_table': 'patient_registration + charge_capture + coding + billing + collections', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'insurance_management': {'type': 'eligibility_verification + prior_authorization + claims_processing + denial_management', 'required': True, 'relationship': {'target_table': 'eligibility_verification + prior_authorization + claims_processing + denial_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'cost_accounting': {'type': 'departmental_costing + procedure_costing + physician_productivity + resource_utilization', 'required': True, 'relationship': {'target_table': 'departmental_costing + procedure_costing + physician_productivity + resource_utilization', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'budgeting_planning': {'type': 'annual_budgets + capital_planning + staffing_models + financial_forecasting', 'required': True, 'relationship': {'target_table': 'annual_budgets + capital_planning + staffing_models + financial_forecasting', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'patient_registries': {'type': 'chronic_disease_management + preventive_care + risk_stratification + care_gaps', 'required': True, 'relationship': {'target_table': 'chronic_disease_management + preventive_care + risk_stratification + care_gaps', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'analytics_reporting': {'type': 'population_analytics + outcomes_measurement + quality_improvement + public_health_reporting', 'required': True, 'relationship': {'target_table': 'population_analytics + outcomes_measurement + quality_improvement + public_health_reporting', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'care_management': {'type': 'care_coordination + case_management + disease_management + wellness_programs', 'required': True, 'relationship': {'target_table': 'care_coordination + case_management + disease_management + wellness_programs', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'research_support': {'type': 'clinical_trials + research_protocols + data_collection + regulatory_reporting', 'required': True, 'relationship': {'target_table': 'clinical_trials + research_protocols + data_collection + regulatory_reporting', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'registration.id': {'chain': ['HealthcareERP.registration', 'patient_demographics + insurance_verification + consent_management + appointment_scheduling.id'], 'valid': True}, 'medical_records.id': {'chain': ['HealthcareERP.medical_records', 'electronic_health_records + clinical_documentation + medical_history + care_plans.id'], 'valid': True}, 'care_coordination.id': {'chain': ['HealthcareERP.care_coordination', 'referral_management + care_team_communication + discharge_planning + follow_up_scheduling.id'], 'valid': True}, 'quality_measures.id': {'chain': ['HealthcareERP.quality_measures', 'clinical_quality_indicators + patient_safety_metrics + outcome_measurements + reporting.id'], 'valid': True}, 'order_management.id': {'chain': ['HealthcareERP.order_management', 'physician_orders + computerized_order_entry + clinical_decision_support + order_tracking.id'], 'valid': True}, 'medication_management.id': {'chain': ['HealthcareERP.medication_management', 'e_prescribing + medication_reconciliation + drug_interaction_checking + formulary_management.id'], 'valid': True}, 'laboratory_integration.id': {'chain': ['HealthcareERP.laboratory_integration', 'test_ordering + result_reporting + critical_value_alerts + trending_analysis.id'], 'valid': True}, 'imaging_integration.id': {'chain': ['HealthcareERP.imaging_integration', 'radiology_orders + image_storage + reporting + diagnostic_support.id'], 'valid': True}, 'care_planning.id': {'chain': ['HealthcareERP.care_planning', 'nursing_assessments + care_plan_development + intervention_tracking + outcome_evaluation.id'], 'valid': True}, 'medication_administration.id': {'chain': ['HealthcareERP.medication_administration', 'barcode_scanning + dosage_verification + administration_documentation + adverse_event_reporting.id'], 'valid': True}, 'patient_monitoring.id': {'chain': ['HealthcareERP.patient_monitoring', 'vital_signs + fluid_balance + pain_assessment + fall_risk_assessment.id'], 'valid': True}, 'documentation.id': {'chain': ['HealthcareERP.documentation', 'nursing_notes + shift_reports + care_summaries + incident_reporting.id'], 'valid': True}, 'hipaa_compliance.id': {'chain': ['HealthcareERP.hipaa_compliance', 'privacy_controls + security_safeguards + audit_logging + breach_notification.id'], 'valid': True}, 'meaningful_use.id': {'chain': ['HealthcareERP.meaningful_use', 'clinical_quality_measures + patient_engagement + care_coordination + population_health.id'], 'valid': True}, 'joint_commission.id': {'chain': ['HealthcareERP.joint_commission', 'quality_standards + patient_safety + performance_improvement + accreditation_reporting.id'], 'valid': True}, 'cms_reporting.id': {'chain': ['HealthcareERP.cms_reporting', 'quality_reporting + value_based_care + medicare_reporting + medicaid_reporting.id'], 'valid': True}, 'revenue_cycle.id': {'chain': ['HealthcareERP.revenue_cycle', 'patient_registration + charge_capture + coding + billing + collections.id'], 'valid': True}, 'insurance_management.id': {'chain': ['HealthcareERP.insurance_management', 'eligibility_verification + prior_authorization + claims_processing + denial_management.id'], 'valid': True}, 'cost_accounting.id': {'chain': ['HealthcareERP.cost_accounting', 'departmental_costing + procedure_costing + physician_productivity + resource_utilization.id'], 'valid': True}, 'budgeting_planning.id': {'chain': ['HealthcareERP.budgeting_planning', 'annual_budgets + capital_planning + staffing_models + financial_forecasting.id'], 'valid': True}, 'patient_registries.id': {'chain': ['HealthcareERP.patient_registries', 'chronic_disease_management + preventive_care + risk_stratification + care_gaps.id'], 'valid': True}, 'analytics_reporting.id': {'chain': ['HealthcareERP.analytics_reporting', 'population_analytics + outcomes_measurement + quality_improvement + public_health_reporting.id'], 'valid': True}, 'care_management.id': {'chain': ['HealthcareERP.care_management', 'care_coordination + case_management + disease_management + wellness_programs.id'], 'valid': True}, 'research_support.id': {'chain': ['HealthcareERP.research_support', 'clinical_trials + research_protocols + data_collection + regulatory_reporting.id'], 'valid': True}}}, 'FinancialServicesERP': {'name': 'FinancialServicesERP', 'fields': {'customer_onboarding': {'type': 'kyc_verification + aml_screening + account_opening + documentation', 'required': True, 'relationship': {'target_table': 'kyc_verification + aml_screening + account_opening + documentation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'account_maintenance': {'type': 'profile_updates + service_requests + relationship_management + cross_selling', 'required': True, 'relationship': {'target_table': 'profile_updates + service_requests + relationship_management + cross_selling', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'transaction_processing': {'type': 'deposits + withdrawals + transfers + payments + reconciliation', 'required': True, 'relationship': {'target_table': 'deposits + withdrawals + transfers + payments + reconciliation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'interest_calculation': {'type': 'compound_interest + simple_interest + fee_calculation + statement_generation', 'required': True, 'relationship': {'target_table': 'compound_interest + simple_interest + fee_calculation + statement_generation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'loan_origination': {'type': 'application_processing + credit_scoring + underwriting + approval_workflows', 'required': True, 'relationship': {'target_table': 'application_processing + credit_scoring + underwriting + approval_workflows', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'loan_servicing': {'type': 'payment_processing + escrow_management + customer_communications + collections', 'required': True, 'relationship': {'target_table': 'payment_processing + escrow_management + customer_communications + collections', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'loan_portfolio_management': {'type': 'risk_assessment + performance_monitoring + provisioning + reporting', 'required': True, 'relationship': {'target_table': 'risk_assessment + performance_monitoring + provisioning + reporting', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'regulatory_reporting': {'type': 'call_reports + stress_testing + capital_adequacy + fair_lending', 'required': True, 'relationship': {'target_table': 'call_reports + stress_testing + capital_adequacy + fair_lending', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'portfolio_management': {'type': 'asset_allocation + performance_tracking + rebalancing + tax_optimization', 'required': True, 'relationship': {'target_table': 'asset_allocation + performance_tracking + rebalancing + tax_optimization', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'trading_operations': {'type': 'order_management + execution + settlement + clearing', 'required': True, 'relationship': {'target_table': 'order_management + execution + settlement + clearing', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'risk_management': {'type': 'market_risk + credit_risk + operational_risk + liquidity_risk', 'required': True, 'relationship': {'target_table': 'market_risk + credit_risk + operational_risk + liquidity_risk', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'client_reporting': {'type': 'performance_reports + tax_reports + regulatory_reports + client_statements', 'required': True, 'relationship': {'target_table': 'performance_reports + tax_reports + regulatory_reports + client_statements', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'anti_money_laundering': {'type': 'transaction_monitoring + suspicious_activity_reporting + customer_screening + training', 'required': True, 'relationship': {'target_table': 'transaction_monitoring + suspicious_activity_reporting + customer_screening + training', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'know_your_customer': {'type': 'identity_verification + beneficial_ownership + enhanced_due_diligence + ongoing_monitoring', 'required': True, 'relationship': {'target_table': 'identity_verification + beneficial_ownership + enhanced_due_diligence + ongoing_monitoring', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'fair_lending': {'type': 'lending_practices + disparate_impact_analysis + complaint_management + corrective_actions', 'required': True, 'relationship': {'target_table': 'lending_practices + disparate_impact_analysis + complaint_management + corrective_actions', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'consumer_protection': {'type': 'truth_in_lending + fair_credit_reporting + privacy_protection + complaint_resolution', 'required': True, 'relationship': {'target_table': 'truth_in_lending + fair_credit_reporting + privacy_protection + complaint_resolution', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'credit_risk': {'type': 'credit_scoring + portfolio_monitoring + loan_loss_provisioning + stress_testing', 'required': True, 'relationship': {'target_table': 'credit_scoring + portfolio_monitoring + loan_loss_provisioning + stress_testing', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'market_risk': {'type': 'value_at_risk + sensitivity_analysis + scenario_testing + hedging_strategies', 'required': True, 'relationship': {'target_table': 'value_at_risk + sensitivity_analysis + scenario_testing + hedging_strategies', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'operational_risk': {'type': 'process_risk + technology_risk + fraud_risk + business_continuity', 'required': True, 'relationship': {'target_table': 'process_risk + technology_risk + fraud_risk + business_continuity', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'liquidity_risk': {'type': 'cash_flow_forecasting + funding_strategies + contingency_planning + regulatory_ratios', 'required': True, 'relationship': {'target_table': 'cash_flow_forecasting + funding_strategies + contingency_planning + regulatory_ratios', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'customer_onboarding.id': {'chain': ['FinancialServicesERP.customer_onboarding', 'kyc_verification + aml_screening + account_opening + documentation.id'], 'valid': True}, 'account_maintenance.id': {'chain': ['FinancialServicesERP.account_maintenance', 'profile_updates + service_requests + relationship_management + cross_selling.id'], 'valid': True}, 'transaction_processing.id': {'chain': ['FinancialServicesERP.transaction_processing', 'deposits + withdrawals + transfers + payments + reconciliation.id'], 'valid': True}, 'interest_calculation.id': {'chain': ['FinancialServicesERP.interest_calculation', 'compound_interest + simple_interest + fee_calculation + statement_generation.id'], 'valid': True}, 'loan_origination.id': {'chain': ['FinancialServicesERP.loan_origination', 'application_processing + credit_scoring + underwriting + approval_workflows.id'], 'valid': True}, 'loan_servicing.id': {'chain': ['FinancialServicesERP.loan_servicing', 'payment_processing + escrow_management + customer_communications + collections.id'], 'valid': True}, 'loan_portfolio_management.id': {'chain': ['FinancialServicesERP.loan_portfolio_management', 'risk_assessment + performance_monitoring + provisioning + reporting.id'], 'valid': True}, 'regulatory_reporting.id': {'chain': ['FinancialServicesERP.regulatory_reporting', 'call_reports + stress_testing + capital_adequacy + fair_lending.id'], 'valid': True}, 'portfolio_management.id': {'chain': ['FinancialServicesERP.portfolio_management', 'asset_allocation + performance_tracking + rebalancing + tax_optimization.id'], 'valid': True}, 'trading_operations.id': {'chain': ['FinancialServicesERP.trading_operations', 'order_management + execution + settlement + clearing.id'], 'valid': True}, 'risk_management.id': {'chain': ['FinancialServicesERP.risk_management', 'market_risk + credit_risk + operational_risk + liquidity_risk.id'], 'valid': True}, 'client_reporting.id': {'chain': ['FinancialServicesERP.client_reporting', 'performance_reports + tax_reports + regulatory_reports + client_statements.id'], 'valid': True}, 'anti_money_laundering.id': {'chain': ['FinancialServicesERP.anti_money_laundering', 'transaction_monitoring + suspicious_activity_reporting + customer_screening + training.id'], 'valid': True}, 'know_your_customer.id': {'chain': ['FinancialServicesERP.know_your_customer', 'identity_verification + beneficial_ownership + enhanced_due_diligence + ongoing_monitoring.id'], 'valid': True}, 'fair_lending.id': {'chain': ['FinancialServicesERP.fair_lending', 'lending_practices + disparate_impact_analysis + complaint_management + corrective_actions.id'], 'valid': True}, 'consumer_protection.id': {'chain': ['FinancialServicesERP.consumer_protection', 'truth_in_lending + fair_credit_reporting + privacy_protection + complaint_resolution.id'], 'valid': True}, 'credit_risk.id': {'chain': ['FinancialServicesERP.credit_risk', 'credit_scoring + portfolio_monitoring + loan_loss_provisioning + stress_testing.id'], 'valid': True}, 'market_risk.id': {'chain': ['FinancialServicesERP.market_risk', 'value_at_risk + sensitivity_analysis + scenario_testing + hedging_strategies.id'], 'valid': True}, 'operational_risk.id': {'chain': ['FinancialServicesERP.operational_risk', 'process_risk + technology_risk + fraud_risk + business_continuity.id'], 'valid': True}, 'liquidity_risk.id': {'chain': ['FinancialServicesERP.liquidity_risk', 'cash_flow_forecasting + funding_strategies + contingency_planning + regulatory_ratios.id'], 'valid': True}}}, 'EducationERP': {'name': 'EducationERP', 'fields': {'admissions': {'type': 'application_processing + evaluation + acceptance + enrollment', 'required': True, 'relationship': {'target_table': 'application_processing + evaluation + acceptance + enrollment', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'registration': {'type': 'course_selection + schedule_building + prerequisite_checking + waitlist_management', 'required': True, 'relationship': {'target_table': 'course_selection + schedule_building + prerequisite_checking + waitlist_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'academic_records': {'type': 'grades + transcripts + degree_audits + graduation_requirements', 'required': True, 'relationship': {'target_table': 'grades + transcripts + degree_audits + graduation_requirements', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'student_services': {'type': 'advising + counseling + disability_services + career_services', 'required': True, 'relationship': {'target_table': 'advising + counseling + disability_services + career_services', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'course_catalog': {'type': 'course_descriptions + prerequisites + learning_outcomes + credit_hours', 'required': True, 'relationship': {'target_table': 'course_descriptions + prerequisites + learning_outcomes + credit_hours', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'program_management': {'type': 'degree_requirements + program_outcomes + accreditation + assessment', 'required': True, 'relationship': {'target_table': 'degree_requirements + program_outcomes + accreditation + assessment', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'schedule_management': {'type': 'room_scheduling + faculty_assignment + resource_allocation + conflict_resolution', 'required': True, 'relationship': {'target_table': 'room_scheduling + faculty_assignment + resource_allocation + conflict_resolution', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'assessment_management': {'type': 'learning_outcomes + rubrics + portfolio_assessment + program_review', 'required': True, 'relationship': {'target_table': 'learning_outcomes + rubrics + portfolio_assessment + program_review', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'human_resources': {'type': 'hiring + onboarding + performance_evaluation + professional_development', 'required': True, 'relationship': {'target_table': 'hiring + onboarding + performance_evaluation + professional_development', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'workload_management': {'type': 'teaching_loads + research_time + service_assignments + sabbatical_planning', 'required': True, 'relationship': {'target_table': 'teaching_loads + research_time + service_assignments + sabbatical_planning', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'payroll_management': {'type': 'salary_calculation + benefits_administration + tax_reporting + retirement_planning', 'required': True, 'relationship': {'target_table': 'salary_calculation + benefits_administration + tax_reporting + retirement_planning', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'research_administration': {'type': 'grant_management + compliance + intellectual_property + collaboration', 'required': True, 'relationship': {'target_table': 'grant_management + compliance + intellectual_property + collaboration', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'learning_management': {'type': 'course_content + assignments + discussions + gradebook + analytics', 'required': True, 'relationship': {'target_table': 'course_content + assignments + discussions + gradebook + analytics', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'student_portal': {'type': 'registration + grades + financial_aid + housing + dining', 'required': True, 'relationship': {'target_table': 'registration + grades + financial_aid + housing + dining', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'communication_tools': {'type': 'announcements + messaging + notifications + emergency_alerts', 'required': True, 'relationship': {'target_table': 'announcements + messaging + notifications + emergency_alerts', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'mobile_applications': {'type': 'course_access + grades + schedules + campus_services', 'required': True, 'relationship': {'target_table': 'course_access + grades + schedules + campus_services', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'student_accounts': {'type': 'tuition_billing + fee_assessment + payment_processing + financial_aid_integration', 'required': True, 'relationship': {'target_table': 'tuition_billing + fee_assessment + payment_processing + financial_aid_integration', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'financial_aid': {'type': 'fafsa_processing + aid_packaging + disbursement + compliance_reporting', 'required': True, 'relationship': {'target_table': 'fafsa_processing + aid_packaging + disbursement + compliance_reporting', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'budgeting_planning': {'type': 'departmental_budgets + enrollment_planning + revenue_forecasting + cost_analysis', 'required': True, 'relationship': {'target_table': 'departmental_budgets + enrollment_planning + revenue_forecasting + cost_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'grants_management': {'type': 'proposal_development + award_management + compliance + reporting', 'required': True, 'relationship': {'target_table': 'proposal_development + award_management + compliance + reporting', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'admissions.id': {'chain': ['EducationERP.admissions', 'application_processing + evaluation + acceptance + enrollment.id'], 'valid': True}, 'registration.id': {'chain': ['EducationERP.registration', 'course_selection + schedule_building + prerequisite_checking + waitlist_management.id'], 'valid': True}, 'academic_records.id': {'chain': ['EducationERP.academic_records', 'grades + transcripts + degree_audits + graduation_requirements.id'], 'valid': True}, 'student_services.id': {'chain': ['EducationERP.student_services', 'advising + counseling + disability_services + career_services.id'], 'valid': True}, 'course_catalog.id': {'chain': ['EducationERP.course_catalog', 'course_descriptions + prerequisites + learning_outcomes + credit_hours.id'], 'valid': True}, 'program_management.id': {'chain': ['EducationERP.program_management', 'degree_requirements + program_outcomes + accreditation + assessment.id'], 'valid': True}, 'schedule_management.id': {'chain': ['EducationERP.schedule_management', 'room_scheduling + faculty_assignment + resource_allocation + conflict_resolution.id'], 'valid': True}, 'assessment_management.id': {'chain': ['EducationERP.assessment_management', 'learning_outcomes + rubrics + portfolio_assessment + program_review.id'], 'valid': True}, 'human_resources.id': {'chain': ['EducationERP.human_resources', 'hiring + onboarding + performance_evaluation + professional_development.id'], 'valid': True}, 'workload_management.id': {'chain': ['EducationERP.workload_management', 'teaching_loads + research_time + service_assignments + sabbatical_planning.id'], 'valid': True}, 'payroll_management.id': {'chain': ['EducationERP.payroll_management', 'salary_calculation + benefits_administration + tax_reporting + retirement_planning.id'], 'valid': True}, 'research_administration.id': {'chain': ['EducationERP.research_administration', 'grant_management + compliance + intellectual_property + collaboration.id'], 'valid': True}, 'learning_management.id': {'chain': ['EducationERP.learning_management', 'course_content + assignments + discussions + gradebook + analytics.id'], 'valid': True}, 'student_portal.id': {'chain': ['EducationERP.student_portal', 'registration + grades + financial_aid + housing + dining.id'], 'valid': True}, 'communication_tools.id': {'chain': ['EducationERP.communication_tools', 'announcements + messaging + notifications + emergency_alerts.id'], 'valid': True}, 'mobile_applications.id': {'chain': ['EducationERP.mobile_applications', 'course_access + grades + schedules + campus_services.id'], 'valid': True}, 'student_accounts.id': {'chain': ['EducationERP.student_accounts', 'tuition_billing + fee_assessment + payment_processing + financial_aid_integration.id'], 'valid': True}, 'financial_aid.id': {'chain': ['EducationERP.financial_aid', 'fafsa_processing + aid_packaging + disbursement + compliance_reporting.id'], 'valid': True}, 'budgeting_planning.id': {'chain': ['EducationERP.budgeting_planning', 'departmental_budgets + enrollment_planning + revenue_forecasting + cost_analysis.id'], 'valid': True}, 'grants_management.id': {'chain': ['EducationERP.grants_management', 'proposal_development + award_management + compliance + reporting.id'], 'valid': True}}}, 'ERPInfrastructure': {'name': 'ERPInfrastructure', 'fields': {'tenant_isolation': {'type': 'data_isolation + security_isolation + performance_isolation + customization_isolation', 'required': True, 'relationship': {'target_table': 'data_isolation + security_isolation + performance_isolation + customization_isolation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'resource_sharing': {'type': 'compute_resources + storage_resources + network_resources + application_services', 'required': True, 'relationship': {'target_table': 'compute_resources + storage_resources + network_resources + application_services', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'scaling_strategies': {'type': 'horizontal_scaling + vertical_scaling + auto_scaling + elastic_scaling', 'required': True, 'relationship': {'target_table': 'horizontal_scaling + vertical_scaling + auto_scaling + elastic_scaling', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'cost_optimization': {'type': 'resource_optimization + usage_monitoring + cost_allocation + billing_transparency', 'required': True, 'relationship': {'target_table': 'resource_optimization + usage_monitoring + cost_allocation + billing_transparency', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'service_decomposition': {'type': 'domain_driven_design + bounded_contexts + service_boundaries + api_design', 'required': True, 'relationship': {'target_table': 'domain_driven_design + bounded_contexts + service_boundaries + api_design', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'container_orchestration': {'type': 'kubernetes + docker + service_mesh + load_balancing', 'required': True, 'relationship': {'target_table': 'kubernetes + docker + service_mesh + load_balancing', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'api_management': {'type': 'api_gateway + rate_limiting + authentication + documentation', 'required': True, 'relationship': {'target_table': 'api_gateway + rate_limiting + authentication + documentation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'event_driven_architecture': {'type': 'event_sourcing + message_queues + publish_subscribe + saga_patterns', 'required': True, 'relationship': {'target_table': 'event_sourcing + message_queues + publish_subscribe + saga_patterns', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'polyglot_persistence': {'type': 'relational_databases + nosql_databases + data_lakes + data_warehouses', 'required': True, 'relationship': {'target_table': 'relational_databases + nosql_databases + data_lakes + data_warehouses', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'data_streaming': {'type': 'real_time_processing + batch_processing + stream_processing + event_processing', 'required': True, 'relationship': {'target_table': 'real_time_processing + batch_processing + stream_processing + event_processing', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'data_security': {'type': 'encryption + access_control + audit_logging + privacy_protection', 'required': True, 'relationship': {'target_table': 'encryption + access_control + audit_logging + privacy_protection', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'backup_recovery': {'type': 'automated_backups + point_in_time_recovery + disaster_recovery + business_continuity', 'required': True, 'relationship': {'target_table': 'automated_backups + point_in_time_recovery + disaster_recovery + business_continuity', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'api_integration': {'type': 'rest_apis + graphql + soap_services + webhook_integration', 'required': True, 'relationship': {'target_table': 'rest_apis + graphql + soap_services + webhook_integration', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'message_integration': {'type': 'message_queues + publish_subscribe + request_reply + message_routing', 'required': True, 'relationship': {'target_table': 'message_queues + publish_subscribe + request_reply + message_routing', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'data_integration': {'type': 'etl_processes + real_time_synchronization + change_data_capture + bulk_transfers', 'required': True, 'relationship': {'target_table': 'etl_processes + real_time_synchronization + change_data_capture + bulk_transfers', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'process_integration': {'type': 'workflow_orchestration + business_process_management + robotic_process_automation', 'required': True, 'relationship': {'target_table': 'workflow_orchestration + business_process_management + robotic_process_automation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'identity_management': {'type': 'single_sign_on + multi_factor_authentication + role_based_access + privileged_access', 'required': True, 'relationship': {'target_table': 'single_sign_on + multi_factor_authentication + role_based_access + privileged_access', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'data_protection': {'type': 'gdpr_compliance + hipaa_compliance + pci_compliance + sox_compliance', 'required': True, 'relationship': {'target_table': 'gdpr_compliance + hipaa_compliance + pci_compliance + sox_compliance', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'security_monitoring': {'type': 'intrusion_detection + vulnerability_scanning + security_information_event_management', 'required': True, 'relationship': {'target_table': 'intrusion_detection + vulnerability_scanning + security_information_event_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'audit_compliance': {'type': 'audit_trails + compliance_reporting + regulatory_reporting + internal_controls', 'required': True, 'relationship': {'target_table': 'audit_trails + compliance_reporting + regulatory_reporting + internal_controls', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'tenant_isolation.id': {'chain': ['ERPInfrastructure.tenant_isolation', 'data_isolation + security_isolation + performance_isolation + customization_isolation.id'], 'valid': True}, 'resource_sharing.id': {'chain': ['ERPInfrastructure.resource_sharing', 'compute_resources + storage_resources + network_resources + application_services.id'], 'valid': True}, 'scaling_strategies.id': {'chain': ['ERPInfrastructure.scaling_strategies', 'horizontal_scaling + vertical_scaling + auto_scaling + elastic_scaling.id'], 'valid': True}, 'cost_optimization.id': {'chain': ['ERPInfrastructure.cost_optimization', 'resource_optimization + usage_monitoring + cost_allocation + billing_transparency.id'], 'valid': True}, 'service_decomposition.id': {'chain': ['ERPInfrastructure.service_decomposition', 'domain_driven_design + bounded_contexts + service_boundaries + api_design.id'], 'valid': True}, 'container_orchestration.id': {'chain': ['ERPInfrastructure.container_orchestration', 'kubernetes + docker + service_mesh + load_balancing.id'], 'valid': True}, 'api_management.id': {'chain': ['ERPInfrastructure.api_management', 'api_gateway + rate_limiting + authentication + documentation.id'], 'valid': True}, 'event_driven_architecture.id': {'chain': ['ERPInfrastructure.event_driven_architecture', 'event_sourcing + message_queues + publish_subscribe + saga_patterns.id'], 'valid': True}, 'polyglot_persistence.id': {'chain': ['ERPInfrastructure.polyglot_persistence', 'relational_databases + nosql_databases + data_lakes + data_warehouses.id'], 'valid': True}, 'data_streaming.id': {'chain': ['ERPInfrastructure.data_streaming', 'real_time_processing + batch_processing + stream_processing + event_processing.id'], 'valid': True}, 'data_security.id': {'chain': ['ERPInfrastructure.data_security', 'encryption + access_control + audit_logging + privacy_protection.id'], 'valid': True}, 'backup_recovery.id': {'chain': ['ERPInfrastructure.backup_recovery', 'automated_backups + point_in_time_recovery + disaster_recovery + business_continuity.id'], 'valid': True}, 'api_integration.id': {'chain': ['ERPInfrastructure.api_integration', 'rest_apis + graphql + soap_services + webhook_integration.id'], 'valid': True}, 'message_integration.id': {'chain': ['ERPInfrastructure.message_integration', 'message_queues + publish_subscribe + request_reply + message_routing.id'], 'valid': True}, 'data_integration.id': {'chain': ['ERPInfrastructure.data_integration', 'etl_processes + real_time_synchronization + change_data_capture + bulk_transfers.id'], 'valid': True}, 'process_integration.id': {'chain': ['ERPInfrastructure.process_integration', 'workflow_orchestration + business_process_management + robotic_process_automation.id'], 'valid': True}, 'identity_management.id': {'chain': ['ERPInfrastructure.identity_management', 'single_sign_on + multi_factor_authentication + role_based_access + privileged_access.id'], 'valid': True}, 'data_protection.id': {'chain': ['ERPInfrastructure.data_protection', 'gdpr_compliance + hipaa_compliance + pci_compliance + sox_compliance.id'], 'valid': True}, 'security_monitoring.id': {'chain': ['ERPInfrastructure.security_monitoring', 'intrusion_detection + vulnerability_scanning + security_information_event_management.id'], 'valid': True}, 'audit_compliance.id': {'chain': ['ERPInfrastructure.audit_compliance', 'audit_trails + compliance_reporting + regulatory_reporting + internal_controls.id'], 'valid': True}}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'main.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 152, 'edges': 145}, 'lookup': {'kind': 'lookup', 'nodes': 8, 'edges': 7}, 'workflow': {'kind': 'workflow', 'nodes': 8, 'edges': 7}, 'handler': {'kind': 'handler', 'nodes': 8, 'edges': 7}, 'capability': {'kind': 'capability', 'nodes': 0, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 8, 'edges': 7}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 8, 'edges': 7}, 'package': {'kind': 'package', 'nodes': 8, 'edges': 7}}, 'diagnostics': []}
