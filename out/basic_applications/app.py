"""
basic_applications - APG Python Application
===========================================
...
MODULE_NAME = 'basic_applications'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
LANDING_STYLE = 'default'
ENTITIES = [{'name': 'BlogPost', 'type': 'entity', 'properties': ['id', 'title', 'content', 'author', 'created_at', 'updated_at', 'published', 'tags', 'view_count'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'title', 'type': 'str', 'required': True}, {'name': 'content', 'type': 'str', 'required': True}, {'name': 'author', 'type': 'str', 'required': True}, {'name': 'created_at', 'type': 'datetime', 'required': True}, {'name': 'updated_at', 'type': 'datetime', 'required': True}, {'name': 'published', 'type': 'bool', 'required': True, 'default': 'false'}, {'name': 'tags', 'type': 'List', 'required': True}, {'name': 'view_count', 'type': 'int', 'required': True, 'default': '0'}], 'methods': []}, {'name': 'BlogComment', 'type': 'entity', 'properties': ['id', 'post_id', 'author_name', 'author_email', 'content', 'created_at', 'approved'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'post_id', 'type': 'str', 'required': True}, {'name': 'author_name', 'type': 'str', 'required': True}, {'name': 'author_email', 'type': 'str', 'required': True}, {'name': 'content', 'type': 'str', 'required': True}, {'name': 'created_at', 'type': 'datetime', 'required': True}, {'name': 'approved', 'type': 'bool', 'required': True, 'default': 'false'}], 'methods': []}, {'name': 'BlogUser', 'type': 'entity', 'properties': ['id', 'username', 'email', 'password_hash', 'is_admin', 'created_at', 'last_login'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'username', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'password_hash', 'type': 'str', 'required': True}, {'name': 'is_admin', 'type': 'bool', 'required': True, 'default': 'false'}, {'name': 'created_at', 'type': 'datetime', 'required': True}, {'name': 'last_login', 'type': 'datetime?', 'required': True}], 'methods': []}, {'name': 'BlogManagement', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'PostPublishing', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'BlogSystem', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}, {'name': 'Product', 'type': 'entity', 'properties': ['id', 'name', 'description', 'price', 'stock_quantity', 'category_id', 'brand', 'sku', 'images', 'weight', 'dimensions', 'max_images', 'is_active', 'created_at'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'name', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str?', 'required': True}, {'name': 'price', 'type': 'decimal', 'required': True}, {'name': 'stock_quantity', 'type': 'int', 'required': True, 'default': '0'}, {'name': 'category_id', 'type': 'str', 'required': True}, {'name': 'brand', 'type': 'str?', 'required': True}, {'name': 'sku', 'type': 'str', 'required': True}, {'name': 'images', 'type': 'List', 'required': True}, {'name': 'weight', 'type': 'float', 'required': True}, {'name': 'dimensions', 'type': 'Dict', 'required': True}, {'name': 'max_images', 'type': 'int', 'required': True, 'default': '10'}, {'name': 'is_active', 'type': 'bool', 'required': True, 'default': 'true'}, {'name': 'created_at', 'type': 'datetime', 'required': True}], 'methods': []}, {'name': 'Category', 'type': 'entity', 'properties': ['id', 'name', 'description', 'parent_id', 'is_active'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'name', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str?', 'required': True}, {'name': 'parent_id', 'type': 'str?', 'required': True}, {'name': 'is_active', 'type': 'bool', 'required': True, 'default': 'true'}], 'methods': []}, {'name': 'Order', 'type': 'entity', 'properties': ['id', 'user_id', 'status', 'total_amount', 'shipping_address', 'billing_address', 'payment_method', 'created_at', 'shipped_at', 'delivered_at'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'user_id', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"pending"'}, {'name': 'total_amount', 'type': 'decimal', 'required': True}, {'name': 'shipping_address', 'type': 'Dict', 'required': True}, {'name': 'billing_address', 'type': 'Dict', 'required': True}, {'name': 'payment_method', 'type': 'str', 'required': True}, {'name': 'created_at', 'type': 'datetime', 'required': True}, {'name': 'shipped_at', 'type': 'datetime?', 'required': True}, {'name': 'delivered_at', 'type': 'datetime?', 'required': True}], 'methods': []}, {'name': 'OrderItem', 'type': 'entity', 'properties': ['id', 'order_id', 'product_id', 'quantity', 'unit_price', 'total_price'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'order_id', 'type': 'str', 'required': True}, {'name': 'product_id', 'type': 'str', 'required': True}, {'name': 'quantity', 'type': 'int', 'required': True}, {'name': 'unit_price', 'type': 'decimal', 'required': True}, {'name': 'total_price', 'type': 'decimal', 'required': True}], 'methods': []}, {'name': 'ECommerceCore', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'OrderProcessing', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ECommerceApp', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}, {'name': 'Project', 'type': 'entity', 'properties': ['id', 'name', 'description', 'owner_id', 'status', 'start_date', 'end_date', 'created_at'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'name', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str?', 'required': True}, {'name': 'owner_id', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"active"'}, {'name': 'start_date', 'type': 'date', 'required': True}, {'name': 'end_date', 'type': 'date?', 'required': True}, {'name': 'created_at', 'type': 'datetime', 'required': True}], 'methods': []}, {'name': 'Task', 'type': 'entity', 'properties': ['id', 'title', 'description', 'project_id', 'assignee_id', 'priority', 'status', 'due_date', 'estimated_hours', 'actual_hours', 'created_at', 'completed_at'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'title', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str?', 'required': True}, {'name': 'project_id', 'type': 'str', 'required': True}, {'name': 'assignee_id', 'type': 'str?', 'required': True}, {'name': 'priority', 'type': 'str', 'required': True, 'default': '"medium"'}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"todo"'}, {'name': 'due_date', 'type': 'datetime?', 'required': True}, {'name': 'estimated_hours', 'type': 'float?', 'required': True}, {'name': 'actual_hours', 'type': 'float?', 'required': True}, {'name': 'created_at', 'type': 'datetime', 'required': True}, {'name': 'completed_at', 'type': 'datetime?', 'required': True}], 'methods': []}, {'name': 'TimeEntry', 'type': 'entity', 'properties': ['id', 'task_id', 'user_id', 'start_time', 'end_time', 'duration', 'description', 'billable'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'task_id', 'type': 'str', 'required': True}, {'name': 'user_id', 'type': 'str', 'required': True}, {'name': 'start_time', 'type': 'datetime', 'required': True}, {'name': 'end_time', 'type': 'datetime?', 'required': True}, {'name': 'duration', 'type': 'int', 'required': True}, {'name': 'description', 'type': 'str?', 'required': True}, {'name': 'billable', 'type': 'bool', 'required': True, 'default': 'true'}], 'methods': []}, {'name': 'TaskManagement', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'TaskManagerApp', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}, {'name': 'Contact', 'type': 'entity', 'properties': ['id', 'first_name', 'last_name', 'email', 'phone', 'company', 'title', 'address', 'lead_source', 'status', 'assigned_to', 'created_at', 'last_contact'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'first_name', 'type': 'str', 'required': True}, {'name': 'last_name', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str?', 'required': True}, {'name': 'company', 'type': 'str?', 'required': True}, {'name': 'title', 'type': 'str?', 'required': True}, {'name': 'address', 'type': 'Dict', 'required': True}, {'name': 'lead_source', 'type': 'str?', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'default': '"lead"'}, {'name': 'assigned_to', 'type': 'str?', 'required': True}, {'name': 'created_at', 'type': 'datetime', 'required': True}, {'name': 'last_contact', 'type': 'datetime?', 'required': True}], 'methods': []}, {'name': 'Deal', 'type': 'entity', 'properties': ['id', 'name', 'contact_id', 'value', 'probability', 'stage', 'expected_close_date', 'actual_close_date', 'notes', 'created_at'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'name', 'type': 'str', 'required': True}, {'name': 'contact_id', 'type': 'str', 'required': True}, {'name': 'value', 'type': 'decimal', 'required': True}, {'name': 'probability', 'type': 'int', 'required': True, 'default': '50'}, {'name': 'stage', 'type': 'str', 'required': True, 'default': '"prospecting"'}, {'name': 'expected_close_date', 'type': 'date', 'required': True}, {'name': 'actual_close_date', 'type': 'date?', 'required': True}, {'name': 'notes', 'type': 'str?', 'required': True}, {'name': 'created_at', 'type': 'datetime', 'required': True}], 'methods': []}, {'name': 'Activity', 'type': 'entity', 'properties': ['id', 'contact_id', 'activity_type', 'subject', 'description', 'scheduled_at', 'completed_at', 'created_by', 'created_at'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'contact_id', 'type': 'str', 'required': True}, {'name': 'activity_type', 'type': 'str', 'required': True}, {'name': 'subject', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str?', 'required': True}, {'name': 'scheduled_at', 'type': 'datetime?', 'required': True}, {'name': 'completed_at', 'type': 'datetime?', 'required': True}, {'name': 'created_by', 'type': 'str', 'required': True}, {'name': 'created_at', 'type': 'datetime', 'required': True}], 'methods': []}, {'name': 'CRMCore', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'LeadNurturing', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'CRMApp', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}, {'name': 'Warehouse', 'type': 'entity', 'properties': ['id', 'name', 'address', 'manager_id', 'is_active'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'name', 'type': 'str', 'required': True}, {'name': 'address', 'type': 'Dict', 'required': True}, {'name': 'manager_id', 'type': 'str', 'required': True}, {'name': 'is_active', 'type': 'bool', 'required': True, 'default': 'true'}], 'methods': []}, {'name': 'InventoryItem', 'type': 'entity', 'properties': ['id', 'warehouse_id', 'product_id', 'quantity', 'reserved_quantity', 'reorder_point', 'max_stock_level', 'last_counted', 'cost_per_unit', 'location'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'warehouse_id', 'type': 'str', 'required': True}, {'name': 'product_id', 'type': 'str', 'required': True}, {'name': 'quantity', 'type': 'int', 'required': True}, {'name': 'reserved_quantity', 'type': 'int', 'required': True, 'default': '0'}, {'name': 'reorder_point', 'type': 'int', 'required': True, 'default': '10'}, {'name': 'max_stock_level', 'type': 'int', 'required': True}, {'name': 'last_counted', 'type': 'datetime?', 'required': True}, {'name': 'cost_per_unit', 'type': 'decimal', 'required': True}, {'name': 'location', 'type': 'str?', 'required': True}], 'methods': []}, {'name': 'StockMovement', 'type': 'entity', 'properties': ['id', 'inventory_item_id', 'movement_type', 'quantity', 'reference_type', 'reference_id', 'notes', 'created_by', 'created_at'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'inventory_item_id', 'type': 'str', 'required': True}, {'name': 'movement_type', 'type': 'str', 'required': True}, {'name': 'quantity', 'type': 'int', 'required': True}, {'name': 'reference_type', 'type': 'str', 'required': True}, {'name': 'reference_id', 'type': 'str', 'required': True}, {'name': 'notes', 'type': 'str?', 'required': True}, {'name': 'created_by', 'type': 'str', 'required': True}, {'name': 'created_at', 'type': 'datetime', 'required': True}], 'methods': []}, {'name': 'InventoryManagement', 'type': 'capability', 'properties': [], 'fields': [], 'methods': []}, {'name': 'StockAdjustment', 'type': 'workflow', 'properties': [], 'fields': [], 'methods': []}, {'name': 'InventoryApp', 'type': 'app', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['basic_applications.apg'], 'app': {'name': 'basic_applications', 'version': '1.0.0', 'description': None, 'entity_count': 30}, 'symbols': {'module.basic_applications': {'id': 'module.basic_applications', 'kind': 'module', 'name': 'basic_applications', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.BlogPost': {'id': 'table.BlogPost', 'kind': 'table', 'name': 'BlogPost', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogPost.id': {'id': 'field.BlogPost.id', 'kind': 'field', 'name': 'BlogPost.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogPost.title': {'id': 'field.BlogPost.title', 'kind': 'field', 'name': 'BlogPost.title', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogPost.content': {'id': 'field.BlogPost.content', 'kind': 'field', 'name': 'BlogPost.content', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogPost.author': {'id': 'field.BlogPost.author', 'kind': 'field', 'name': 'BlogPost.author', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogPost.created_at': {'id': 'field.BlogPost.created_at', 'kind': 'field', 'name': 'BlogPost.created_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogPost.updated_at': {'id': 'field.BlogPost.updated_at', 'kind': 'field', 'name': 'BlogPost.updated_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogPost.published': {'id': 'field.BlogPost.published', 'kind': 'field', 'name': 'BlogPost.published', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogPost.tags': {'id': 'field.BlogPost.tags', 'kind': 'field', 'name': 'BlogPost.tags', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogPost.view_count': {'id': 'field.BlogPost.view_count', 'kind': 'field', 'name': 'BlogPost.view_count', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.BlogComment': {'id': 'table.BlogComment', 'kind': 'table', 'name': 'BlogComment', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogComment.id': {'id': 'field.BlogComment.id', 'kind': 'field', 'name': 'BlogComment.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogComment.post_id': {'id': 'field.BlogComment.post_id', 'kind': 'field', 'name': 'BlogComment.post_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogComment.author_name': {'id': 'field.BlogComment.author_name', 'kind': 'field', 'name': 'BlogComment.author_name', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogComment.author_email': {'id': 'field.BlogComment.author_email', 'kind': 'field', 'name': 'BlogComment.author_email', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogComment.content': {'id': 'field.BlogComment.content', 'kind': 'field', 'name': 'BlogComment.content', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogComment.created_at': {'id': 'field.BlogComment.created_at', 'kind': 'field', 'name': 'BlogComment.created_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogComment.approved': {'id': 'field.BlogComment.approved', 'kind': 'field', 'name': 'BlogComment.approved', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.BlogUser': {'id': 'table.BlogUser', 'kind': 'table', 'name': 'BlogUser', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogUser.id': {'id': 'field.BlogUser.id', 'kind': 'field', 'name': 'BlogUser.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogUser.username': {'id': 'field.BlogUser.username', 'kind': 'field', 'name': 'BlogUser.username', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogUser.email': {'id': 'field.BlogUser.email', 'kind': 'field', 'name': 'BlogUser.email', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogUser.password_hash': {'id': 'field.BlogUser.password_hash', 'kind': 'field', 'name': 'BlogUser.password_hash', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogUser.is_admin': {'id': 'field.BlogUser.is_admin', 'kind': 'field', 'name': 'BlogUser.is_admin', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogUser.created_at': {'id': 'field.BlogUser.created_at', 'kind': 'field', 'name': 'BlogUser.created_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.BlogUser.last_login': {'id': 'field.BlogUser.last_login', 'kind': 'field', 'name': 'BlogUser.last_login', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.BlogManagement': {'id': 'capability.BlogManagement', 'kind': 'capability', 'name': 'BlogManagement', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'workflow.PostPublishing': {'id': 'workflow.PostPublishing', 'kind': 'workflow', 'name': 'PostPublishing', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.BlogSystem': {'id': 'app.BlogSystem', 'kind': 'app', 'name': 'BlogSystem', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Product': {'id': 'table.Product', 'kind': 'table', 'name': 'Product', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.id': {'id': 'field.Product.id', 'kind': 'field', 'name': 'Product.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.name': {'id': 'field.Product.name', 'kind': 'field', 'name': 'Product.name', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.description': {'id': 'field.Product.description', 'kind': 'field', 'name': 'Product.description', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.price': {'id': 'field.Product.price', 'kind': 'field', 'name': 'Product.price', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.stock_quantity': {'id': 'field.Product.stock_quantity', 'kind': 'field', 'name': 'Product.stock_quantity', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.category_id': {'id': 'field.Product.category_id', 'kind': 'field', 'name': 'Product.category_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.brand': {'id': 'field.Product.brand', 'kind': 'field', 'name': 'Product.brand', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.sku': {'id': 'field.Product.sku', 'kind': 'field', 'name': 'Product.sku', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.images': {'id': 'field.Product.images', 'kind': 'field', 'name': 'Product.images', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.weight': {'id': 'field.Product.weight', 'kind': 'field', 'name': 'Product.weight', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.dimensions': {'id': 'field.Product.dimensions', 'kind': 'field', 'name': 'Product.dimensions', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.max_images': {'id': 'field.Product.max_images', 'kind': 'field', 'name': 'Product.max_images', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.is_active': {'id': 'field.Product.is_active', 'kind': 'field', 'name': 'Product.is_active', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Product.created_at': {'id': 'field.Product.created_at', 'kind': 'field', 'name': 'Product.created_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Category': {'id': 'table.Category', 'kind': 'table', 'name': 'Category', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Category.id': {'id': 'field.Category.id', 'kind': 'field', 'name': 'Category.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Category.name': {'id': 'field.Category.name', 'kind': 'field', 'name': 'Category.name', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Category.description': {'id': 'field.Category.description', 'kind': 'field', 'name': 'Category.description', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Category.parent_id': {'id': 'field.Category.parent_id', 'kind': 'field', 'name': 'Category.parent_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Category.is_active': {'id': 'field.Category.is_active', 'kind': 'field', 'name': 'Category.is_active', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Order': {'id': 'table.Order', 'kind': 'table', 'name': 'Order', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.id': {'id': 'field.Order.id', 'kind': 'field', 'name': 'Order.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.user_id': {'id': 'field.Order.user_id', 'kind': 'field', 'name': 'Order.user_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.status': {'id': 'field.Order.status', 'kind': 'field', 'name': 'Order.status', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.total_amount': {'id': 'field.Order.total_amount', 'kind': 'field', 'name': 'Order.total_amount', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.shipping_address': {'id': 'field.Order.shipping_address', 'kind': 'field', 'name': 'Order.shipping_address', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.billing_address': {'id': 'field.Order.billing_address', 'kind': 'field', 'name': 'Order.billing_address', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.payment_method': {'id': 'field.Order.payment_method', 'kind': 'field', 'name': 'Order.payment_method', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.created_at': {'id': 'field.Order.created_at', 'kind': 'field', 'name': 'Order.created_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.shipped_at': {'id': 'field.Order.shipped_at', 'kind': 'field', 'name': 'Order.shipped_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Order.delivered_at': {'id': 'field.Order.delivered_at', 'kind': 'field', 'name': 'Order.delivered_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.OrderItem': {'id': 'table.OrderItem', 'kind': 'table', 'name': 'OrderItem', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OrderItem.id': {'id': 'field.OrderItem.id', 'kind': 'field', 'name': 'OrderItem.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OrderItem.order_id': {'id': 'field.OrderItem.order_id', 'kind': 'field', 'name': 'OrderItem.order_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OrderItem.product_id': {'id': 'field.OrderItem.product_id', 'kind': 'field', 'name': 'OrderItem.product_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OrderItem.quantity': {'id': 'field.OrderItem.quantity', 'kind': 'field', 'name': 'OrderItem.quantity', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OrderItem.unit_price': {'id': 'field.OrderItem.unit_price', 'kind': 'field', 'name': 'OrderItem.unit_price', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OrderItem.total_price': {'id': 'field.OrderItem.total_price', 'kind': 'field', 'name': 'OrderItem.total_price', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.ECommerceCore': {'id': 'capability.ECommerceCore', 'kind': 'capability', 'name': 'ECommerceCore', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'workflow.OrderProcessing': {'id': 'workflow.OrderProcessing', 'kind': 'workflow', 'name': 'OrderProcessing', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.ECommerceApp': {'id': 'app.ECommerceApp', 'kind': 'app', 'name': 'ECommerceApp', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Project': {'id': 'table.Project', 'kind': 'table', 'name': 'Project', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Project.id': {'id': 'field.Project.id', 'kind': 'field', 'name': 'Project.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Project.name': {'id': 'field.Project.name', 'kind': 'field', 'name': 'Project.name', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Project.description': {'id': 'field.Project.description', 'kind': 'field', 'name': 'Project.description', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Project.owner_id': {'id': 'field.Project.owner_id', 'kind': 'field', 'name': 'Project.owner_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Project.status': {'id': 'field.Project.status', 'kind': 'field', 'name': 'Project.status', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Project.start_date': {'id': 'field.Project.start_date', 'kind': 'field', 'name': 'Project.start_date', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Project.end_date': {'id': 'field.Project.end_date', 'kind': 'field', 'name': 'Project.end_date', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Project.created_at': {'id': 'field.Project.created_at', 'kind': 'field', 'name': 'Project.created_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Task': {'id': 'table.Task', 'kind': 'table', 'name': 'Task', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Task.id': {'id': 'field.Task.id', 'kind': 'field', 'name': 'Task.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Task.title': {'id': 'field.Task.title', 'kind': 'field', 'name': 'Task.title', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Task.description': {'id': 'field.Task.description', 'kind': 'field', 'name': 'Task.description', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Task.project_id': {'id': 'field.Task.project_id', 'kind': 'field', 'name': 'Task.project_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Task.assignee_id': {'id': 'field.Task.assignee_id', 'kind': 'field', 'name': 'Task.assignee_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Task.priority': {'id': 'field.Task.priority', 'kind': 'field', 'name': 'Task.priority', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Task.status': {'id': 'field.Task.status', 'kind': 'field', 'name': 'Task.status', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Task.due_date': {'id': 'field.Task.due_date', 'kind': 'field', 'name': 'Task.due_date', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Task.estimated_hours': {'id': 'field.Task.estimated_hours', 'kind': 'field', 'name': 'Task.estimated_hours', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Task.actual_hours': {'id': 'field.Task.actual_hours', 'kind': 'field', 'name': 'Task.actual_hours', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Task.created_at': {'id': 'field.Task.created_at', 'kind': 'field', 'name': 'Task.created_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Task.completed_at': {'id': 'field.Task.completed_at', 'kind': 'field', 'name': 'Task.completed_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.TimeEntry': {'id': 'table.TimeEntry', 'kind': 'table', 'name': 'TimeEntry', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.TimeEntry.id': {'id': 'field.TimeEntry.id', 'kind': 'field', 'name': 'TimeEntry.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.TimeEntry.task_id': {'id': 'field.TimeEntry.task_id', 'kind': 'field', 'name': 'TimeEntry.task_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.TimeEntry.user_id': {'id': 'field.TimeEntry.user_id', 'kind': 'field', 'name': 'TimeEntry.user_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.TimeEntry.start_time': {'id': 'field.TimeEntry.start_time', 'kind': 'field', 'name': 'TimeEntry.start_time', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.TimeEntry.end_time': {'id': 'field.TimeEntry.end_time', 'kind': 'field', 'name': 'TimeEntry.end_time', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.TimeEntry.duration': {'id': 'field.TimeEntry.duration', 'kind': 'field', 'name': 'TimeEntry.duration', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.TimeEntry.description': {'id': 'field.TimeEntry.description', 'kind': 'field', 'name': 'TimeEntry.description', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.TimeEntry.billable': {'id': 'field.TimeEntry.billable', 'kind': 'field', 'name': 'TimeEntry.billable', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.TaskManagement': {'id': 'capability.TaskManagement', 'kind': 'capability', 'name': 'TaskManagement', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.TaskManagerApp': {'id': 'app.TaskManagerApp', 'kind': 'app', 'name': 'TaskManagerApp', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Contact': {'id': 'table.Contact', 'kind': 'table', 'name': 'Contact', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.id': {'id': 'field.Contact.id', 'kind': 'field', 'name': 'Contact.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.first_name': {'id': 'field.Contact.first_name', 'kind': 'field', 'name': 'Contact.first_name', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.last_name': {'id': 'field.Contact.last_name', 'kind': 'field', 'name': 'Contact.last_name', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.email': {'id': 'field.Contact.email', 'kind': 'field', 'name': 'Contact.email', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.phone': {'id': 'field.Contact.phone', 'kind': 'field', 'name': 'Contact.phone', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.company': {'id': 'field.Contact.company', 'kind': 'field', 'name': 'Contact.company', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.title': {'id': 'field.Contact.title', 'kind': 'field', 'name': 'Contact.title', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.address': {'id': 'field.Contact.address', 'kind': 'field', 'name': 'Contact.address', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.lead_source': {'id': 'field.Contact.lead_source', 'kind': 'field', 'name': 'Contact.lead_source', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.status': {'id': 'field.Contact.status', 'kind': 'field', 'name': 'Contact.status', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.assigned_to': {'id': 'field.Contact.assigned_to', 'kind': 'field', 'name': 'Contact.assigned_to', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.created_at': {'id': 'field.Contact.created_at', 'kind': 'field', 'name': 'Contact.created_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contact.last_contact': {'id': 'field.Contact.last_contact', 'kind': 'field', 'name': 'Contact.last_contact', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Deal': {'id': 'table.Deal', 'kind': 'table', 'name': 'Deal', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Deal.id': {'id': 'field.Deal.id', 'kind': 'field', 'name': 'Deal.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Deal.name': {'id': 'field.Deal.name', 'kind': 'field', 'name': 'Deal.name', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Deal.contact_id': {'id': 'field.Deal.contact_id', 'kind': 'field', 'name': 'Deal.contact_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Deal.value': {'id': 'field.Deal.value', 'kind': 'field', 'name': 'Deal.value', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Deal.probability': {'id': 'field.Deal.probability', 'kind': 'field', 'name': 'Deal.probability', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Deal.stage': {'id': 'field.Deal.stage', 'kind': 'field', 'name': 'Deal.stage', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Deal.expected_close_date': {'id': 'field.Deal.expected_close_date', 'kind': 'field', 'name': 'Deal.expected_close_date', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Deal.actual_close_date': {'id': 'field.Deal.actual_close_date', 'kind': 'field', 'name': 'Deal.actual_close_date', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Deal.notes': {'id': 'field.Deal.notes', 'kind': 'field', 'name': 'Deal.notes', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Deal.created_at': {'id': 'field.Deal.created_at', 'kind': 'field', 'name': 'Deal.created_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Activity': {'id': 'table.Activity', 'kind': 'table', 'name': 'Activity', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.id': {'id': 'field.Activity.id', 'kind': 'field', 'name': 'Activity.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.contact_id': {'id': 'field.Activity.contact_id', 'kind': 'field', 'name': 'Activity.contact_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.activity_type': {'id': 'field.Activity.activity_type', 'kind': 'field', 'name': 'Activity.activity_type', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.subject': {'id': 'field.Activity.subject', 'kind': 'field', 'name': 'Activity.subject', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.description': {'id': 'field.Activity.description', 'kind': 'field', 'name': 'Activity.description', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.scheduled_at': {'id': 'field.Activity.scheduled_at', 'kind': 'field', 'name': 'Activity.scheduled_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.completed_at': {'id': 'field.Activity.completed_at', 'kind': 'field', 'name': 'Activity.completed_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.created_by': {'id': 'field.Activity.created_by', 'kind': 'field', 'name': 'Activity.created_by', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.created_at': {'id': 'field.Activity.created_at', 'kind': 'field', 'name': 'Activity.created_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.CRMCore': {'id': 'capability.CRMCore', 'kind': 'capability', 'name': 'CRMCore', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'workflow.LeadNurturing': {'id': 'workflow.LeadNurturing', 'kind': 'workflow', 'name': 'LeadNurturing', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.CRMApp': {'id': 'app.CRMApp', 'kind': 'app', 'name': 'CRMApp', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Warehouse': {'id': 'table.Warehouse', 'kind': 'table', 'name': 'Warehouse', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Warehouse.id': {'id': 'field.Warehouse.id', 'kind': 'field', 'name': 'Warehouse.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Warehouse.name': {'id': 'field.Warehouse.name', 'kind': 'field', 'name': 'Warehouse.name', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Warehouse.address': {'id': 'field.Warehouse.address', 'kind': 'field', 'name': 'Warehouse.address', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Warehouse.manager_id': {'id': 'field.Warehouse.manager_id', 'kind': 'field', 'name': 'Warehouse.manager_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Warehouse.is_active': {'id': 'field.Warehouse.is_active', 'kind': 'field', 'name': 'Warehouse.is_active', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.InventoryItem': {'id': 'table.InventoryItem', 'kind': 'table', 'name': 'InventoryItem', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.InventoryItem.id': {'id': 'field.InventoryItem.id', 'kind': 'field', 'name': 'InventoryItem.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.InventoryItem.warehouse_id': {'id': 'field.InventoryItem.warehouse_id', 'kind': 'field', 'name': 'InventoryItem.warehouse_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.InventoryItem.product_id': {'id': 'field.InventoryItem.product_id', 'kind': 'field', 'name': 'InventoryItem.product_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.InventoryItem.quantity': {'id': 'field.InventoryItem.quantity', 'kind': 'field', 'name': 'InventoryItem.quantity', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.InventoryItem.reserved_quantity': {'id': 'field.InventoryItem.reserved_quantity', 'kind': 'field', 'name': 'InventoryItem.reserved_quantity', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.InventoryItem.reorder_point': {'id': 'field.InventoryItem.reorder_point', 'kind': 'field', 'name': 'InventoryItem.reorder_point', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.InventoryItem.max_stock_level': {'id': 'field.InventoryItem.max_stock_level', 'kind': 'field', 'name': 'InventoryItem.max_stock_level', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.InventoryItem.last_counted': {'id': 'field.InventoryItem.last_counted', 'kind': 'field', 'name': 'InventoryItem.last_counted', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.InventoryItem.cost_per_unit': {'id': 'field.InventoryItem.cost_per_unit', 'kind': 'field', 'name': 'InventoryItem.cost_per_unit', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.InventoryItem.location': {'id': 'field.InventoryItem.location', 'kind': 'field', 'name': 'InventoryItem.location', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.StockMovement': {'id': 'table.StockMovement', 'kind': 'table', 'name': 'StockMovement', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.StockMovement.id': {'id': 'field.StockMovement.id', 'kind': 'field', 'name': 'StockMovement.id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.StockMovement.inventory_item_id': {'id': 'field.StockMovement.inventory_item_id', 'kind': 'field', 'name': 'StockMovement.inventory_item_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.StockMovement.movement_type': {'id': 'field.StockMovement.movement_type', 'kind': 'field', 'name': 'StockMovement.movement_type', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.StockMovement.quantity': {'id': 'field.StockMovement.quantity', 'kind': 'field', 'name': 'StockMovement.quantity', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.StockMovement.reference_type': {'id': 'field.StockMovement.reference_type', 'kind': 'field', 'name': 'StockMovement.reference_type', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.StockMovement.reference_id': {'id': 'field.StockMovement.reference_id', 'kind': 'field', 'name': 'StockMovement.reference_id', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.StockMovement.notes': {'id': 'field.StockMovement.notes', 'kind': 'field', 'name': 'StockMovement.notes', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.StockMovement.created_by': {'id': 'field.StockMovement.created_by', 'kind': 'field', 'name': 'StockMovement.created_by', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.StockMovement.created_at': {'id': 'field.StockMovement.created_at', 'kind': 'field', 'name': 'StockMovement.created_at', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'capability.InventoryManagement': {'id': 'capability.InventoryManagement', 'kind': 'capability', 'name': 'InventoryManagement', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'workflow.StockAdjustment': {'id': 'workflow.StockAdjustment', 'kind': 'workflow', 'name': 'StockAdjustment', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.InventoryApp': {'id': 'app.InventoryApp', 'kind': 'app', 'name': 'InventoryApp', 'file': 'basic_applications.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'BlogPost': {'name': 'BlogPost', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'title': {'type': 'str', 'required': True, 'relationship': None}, 'content': {'type': 'str', 'required': True, 'relationship': None}, 'author': {'type': 'str', 'required': True, 'relationship': None}, 'created_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'updated_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'published': {'type': 'bool', 'required': True, 'relationship': None}, 'tags': {'type': 'List', 'required': True, 'relationship': {'target_table': 'List', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'view_count': {'type': 'int', 'required': True, 'relationship': None}}, 'lookup_paths': {'created_at.id': {'chain': ['BlogPost.created_at', 'datetime.id'], 'valid': True}, 'updated_at.id': {'chain': ['BlogPost.updated_at', 'datetime.id'], 'valid': True}, 'tags.id': {'chain': ['BlogPost.tags', 'List.id'], 'valid': True}}}, 'BlogComment': {'name': 'BlogComment', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'post_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Post', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'post'}}, 'author_name': {'type': 'str', 'required': True, 'relationship': None}, 'author_email': {'type': 'str', 'required': True, 'relationship': None}, 'content': {'type': 'str', 'required': True, 'relationship': None}, 'created_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'approved': {'type': 'bool', 'required': True, 'relationship': None}}, 'lookup_paths': {'created_at.id': {'chain': ['BlogComment.created_at', 'datetime.id'], 'valid': True}}}, 'BlogUser': {'name': 'BlogUser', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'username': {'type': 'str', 'required': True, 'relationship': None}, 'email': {'type': 'str', 'required': True, 'relationship': None}, 'password_hash': {'type': 'str', 'required': True, 'relationship': None}, 'is_admin': {'type': 'bool', 'required': True, 'relationship': None}, 'created_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'last_login': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'created_at.id': {'chain': ['BlogUser.created_at', 'datetime.id'], 'valid': True}, 'last_login.id': {'chain': ['BlogUser.last_login', 'datetime?.id'], 'valid': True}}}, 'Product': {'name': 'Product', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'name': {'type': 'str', 'required': True, 'relationship': None}, 'description': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'price': {'type': 'decimal', 'required': True, 'relationship': {'target_table': 'decimal', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'stock_quantity': {'type': 'int', 'required': True, 'relationship': None}, 'category_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Category', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'category'}}, 'brand': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'sku': {'type': 'str', 'required': True, 'relationship': None}, 'images': {'type': 'List', 'required': True, 'relationship': {'target_table': 'List', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'weight': {'type': 'float', 'required': True, 'relationship': None}, 'dimensions': {'type': 'Dict', 'required': True, 'relationship': {'target_table': 'Dict', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'max_images': {'type': 'int', 'required': True, 'relationship': None}, 'is_active': {'type': 'bool', 'required': True, 'relationship': None}, 'created_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'description.id': {'chain': ['Product.description', 'str?.id'], 'valid': True}, 'price.id': {'chain': ['Product.price', 'decimal.id'], 'valid': True}, 'brand.id': {'chain': ['Product.brand', 'str?.id'], 'valid': True}, 'images.id': {'chain': ['Product.images', 'List.id'], 'valid': True}, 'dimensions.id': {'chain': ['Product.dimensions', 'Dict.id'], 'valid': True}, 'created_at.id': {'chain': ['Product.created_at', 'datetime.id'], 'valid': True}}}, 'Category': {'name': 'Category', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'name': {'type': 'str', 'required': True, 'relationship': None}, 'description': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'parent_id': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'is_active': {'type': 'bool', 'required': True, 'relationship': None}}, 'lookup_paths': {'description.id': {'chain': ['Category.description', 'str?.id'], 'valid': True}, 'parent_id.id': {'chain': ['Category.parent_id', 'str?.id'], 'valid': True}}}, 'Order': {'name': 'Order', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'user_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'User', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'user'}}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'total_amount': {'type': 'decimal', 'required': True, 'relationship': {'target_table': 'decimal', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'shipping_address': {'type': 'Dict', 'required': True, 'relationship': {'target_table': 'Dict', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'billing_address': {'type': 'Dict', 'required': True, 'relationship': {'target_table': 'Dict', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'payment_method': {'type': 'str', 'required': True, 'relationship': None}, 'created_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'shipped_at': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'delivered_at': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'total_amount.id': {'chain': ['Order.total_amount', 'decimal.id'], 'valid': True}, 'shipping_address.id': {'chain': ['Order.shipping_address', 'Dict.id'], 'valid': True}, 'billing_address.id': {'chain': ['Order.billing_address', 'Dict.id'], 'valid': True}, 'created_at.id': {'chain': ['Order.created_at', 'datetime.id'], 'valid': True}, 'shipped_at.id': {'chain': ['Order.shipped_at', 'datetime?.id'], 'valid': True}, 'delivered_at.id': {'chain': ['Order.delivered_at', 'datetime?.id'], 'valid': True}}}, 'OrderItem': {'name': 'OrderItem', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'order_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Order', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'order'}}, 'product_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Product', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'product'}}, 'quantity': {'type': 'int', 'required': True, 'relationship': None}, 'unit_price': {'type': 'decimal', 'required': True, 'relationship': {'target_table': 'decimal', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'total_price': {'type': 'decimal', 'required': True, 'relationship': {'target_table': 'decimal', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'unit_price.id': {'chain': ['OrderItem.unit_price', 'decimal.id'], 'valid': True}, 'total_price.id': {'chain': ['OrderItem.total_price', 'decimal.id'], 'valid': True}}}, 'Project': {'name': 'Project', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'name': {'type': 'str', 'required': True, 'relationship': None}, 'description': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'owner_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Owner', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'owner'}}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'start_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'end_date': {'type': 'date?', 'required': True, 'relationship': {'target_table': 'date?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'created_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'description.id': {'chain': ['Project.description', 'str?.id'], 'valid': True}, 'start_date.id': {'chain': ['Project.start_date', 'date.id'], 'valid': True}, 'end_date.id': {'chain': ['Project.end_date', 'date?.id'], 'valid': True}, 'created_at.id': {'chain': ['Project.created_at', 'datetime.id'], 'valid': True}}}, 'Task': {'name': 'Task', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'title': {'type': 'str', 'required': True, 'relationship': None}, 'description': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'project_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Project', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'project'}}, 'assignee_id': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'priority': {'type': 'str', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'due_date': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'estimated_hours': {'type': 'float?', 'required': True, 'relationship': {'target_table': 'float?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'actual_hours': {'type': 'float?', 'required': True, 'relationship': {'target_table': 'float?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'created_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'completed_at': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'description.id': {'chain': ['Task.description', 'str?.id'], 'valid': True}, 'assignee_id.id': {'chain': ['Task.assignee_id', 'str?.id'], 'valid': True}, 'due_date.id': {'chain': ['Task.due_date', 'datetime?.id'], 'valid': True}, 'estimated_hours.id': {'chain': ['Task.estimated_hours', 'float?.id'], 'valid': True}, 'actual_hours.id': {'chain': ['Task.actual_hours', 'float?.id'], 'valid': True}, 'created_at.id': {'chain': ['Task.created_at', 'datetime.id'], 'valid': True}, 'completed_at.id': {'chain': ['Task.completed_at', 'datetime?.id'], 'valid': True}}}, 'TimeEntry': {'name': 'TimeEntry', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'task_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Task', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'task'}}, 'user_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'User', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'user'}}, 'start_time': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'end_time': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'duration': {'type': 'int', 'required': True, 'relationship': None}, 'description': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'billable': {'type': 'bool', 'required': True, 'relationship': None}}, 'lookup_paths': {'start_time.id': {'chain': ['TimeEntry.start_time', 'datetime.id'], 'valid': True}, 'end_time.id': {'chain': ['TimeEntry.end_time', 'datetime?.id'], 'valid': True}, 'description.id': {'chain': ['TimeEntry.description', 'str?.id'], 'valid': True}}}, 'Contact': {'name': 'Contact', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'first_name': {'type': 'str', 'required': True, 'relationship': None}, 'last_name': {'type': 'str', 'required': True, 'relationship': None}, 'email': {'type': 'str', 'required': True, 'relationship': None}, 'phone': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'company': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'title': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'address': {'type': 'Dict', 'required': True, 'relationship': {'target_table': 'Dict', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'lead_source': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'assigned_to': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'created_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'last_contact': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'phone.id': {'chain': ['Contact.phone', 'str?.id'], 'valid': True}, 'company.id': {'chain': ['Contact.company', 'str?.id'], 'valid': True}, 'title.id': {'chain': ['Contact.title', 'str?.id'], 'valid': True}, 'address.id': {'chain': ['Contact.address', 'Dict.id'], 'valid': True}, 'lead_source.id': {'chain': ['Contact.lead_source', 'str?.id'], 'valid': True}, 'assigned_to.id': {'chain': ['Contact.assigned_to', 'str?.id'], 'valid': True}, 'created_at.id': {'chain': ['Contact.created_at', 'datetime.id'], 'valid': True}, 'last_contact.id': {'chain': ['Contact.last_contact', 'datetime?.id'], 'valid': True}}}, 'Deal': {'name': 'Deal', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'name': {'type': 'str', 'required': True, 'relationship': None}, 'contact_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Contact', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'contact'}}, 'value': {'type': 'decimal', 'required': True, 'relationship': {'target_table': 'decimal', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'probability': {'type': 'int', 'required': True, 'relationship': None}, 'stage': {'type': 'str', 'required': True, 'relationship': None}, 'expected_close_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'actual_close_date': {'type': 'date?', 'required': True, 'relationship': {'target_table': 'date?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'notes': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'created_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'value.id': {'chain': ['Deal.value', 'decimal.id'], 'valid': True}, 'expected_close_date.id': {'chain': ['Deal.expected_close_date', 'date.id'], 'valid': True}, 'actual_close_date.id': {'chain': ['Deal.actual_close_date', 'date?.id'], 'valid': True}, 'notes.id': {'chain': ['Deal.notes', 'str?.id'], 'valid': True}, 'created_at.id': {'chain': ['Deal.created_at', 'datetime.id'], 'valid': True}}}, 'Activity': {'name': 'Activity', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'contact_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Contact', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'contact'}}, 'activity_type': {'type': 'str', 'required': True, 'relationship': None}, 'subject': {'type': 'str', 'required': True, 'relationship': None}, 'description': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'scheduled_at': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'completed_at': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'created_by': {'type': 'str', 'required': True, 'relationship': None}, 'created_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'description.id': {'chain': ['Activity.description', 'str?.id'], 'valid': True}, 'scheduled_at.id': {'chain': ['Activity.scheduled_at', 'datetime?.id'], 'valid': True}, 'completed_at.id': {'chain': ['Activity.completed_at', 'datetime?.id'], 'valid': True}, 'created_at.id': {'chain': ['Activity.created_at', 'datetime.id'], 'valid': True}}}, 'Warehouse': {'name': 'Warehouse', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'name': {'type': 'str', 'required': True, 'relationship': None}, 'address': {'type': 'Dict', 'required': True, 'relationship': {'target_table': 'Dict', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'manager_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Manager', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'manager'}}, 'is_active': {'type': 'bool', 'required': True, 'relationship': None}}, 'lookup_paths': {'address.id': {'chain': ['Warehouse.address', 'Dict.id'], 'valid': True}}}, 'InventoryItem': {'name': 'InventoryItem', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'warehouse_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Warehouse', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'warehouse'}}, 'product_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Product', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'product'}}, 'quantity': {'type': 'int', 'required': True, 'relationship': None}, 'reserved_quantity': {'type': 'int', 'required': True, 'relationship': None}, 'reorder_point': {'type': 'int', 'required': True, 'relationship': None}, 'max_stock_level': {'type': 'int', 'required': True, 'relationship': None}, 'last_counted': {'type': 'datetime?', 'required': True, 'relationship': {'target_table': 'datetime?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'cost_per_unit': {'type': 'decimal', 'required': True, 'relationship': {'target_table': 'decimal', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'location': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'last_counted.id': {'chain': ['InventoryItem.last_counted', 'datetime?.id'], 'valid': True}, 'cost_per_unit.id': {'chain': ['InventoryItem.cost_per_unit', 'decimal.id'], 'valid': True}, 'location.id': {'chain': ['InventoryItem.location', 'str?.id'], 'valid': True}}}, 'StockMovement': {'name': 'StockMovement', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'inventory_item_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'InventoryItem', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'inventory_item'}}, 'movement_type': {'type': 'str', 'required': True, 'relationship': None}, 'quantity': {'type': 'int', 'required': True, 'relationship': None}, 'reference_type': {'type': 'str', 'required': True, 'relationship': None}, 'reference_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Reference', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'reference'}}, 'notes': {'type': 'str?', 'required': True, 'relationship': {'target_table': 'str?', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'created_by': {'type': 'str', 'required': True, 'relationship': None}, 'created_at': {'type': 'datetime', 'required': True, 'relationship': {'target_table': 'datetime', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'notes.id': {'chain': ['StockMovement.notes', 'str?.id'], 'valid': True}, 'created_at.id': {'chain': ['StockMovement.created_at', 'datetime.id'], 'valid': True}}}}, 'views': {}, 'flows': {'PostPublishing': {'name': 'PostPublishing', 'type': 'workflow', 'properties': {}, 'methods': [], 'states': ['draft', 'review', 'published'], 'transitions': [{'source': 'draft', 'target': 'review', 'guard': 'title_length > 5 and content_length > 10'}, {'source': 'review', 'target': 'published', 'guard': 'review_approved == true";'}], 'steps': ['draft', 'review', 'published'], 'human_tasks': ['review'], 'guards': {'review': 'title_length > 5 and content_length > 10', 'published': 'review_approved == true";'}, 'assignments': {'review': 'editor'}, 'timers': {}, 'waits': {}, 'retry_policy': {}, 'compensation': {}, 'steps_raw': 'draft -> review -> published'}, 'OrderProcessing': {'name': 'OrderProcessing', 'type': 'workflow', 'properties': {}, 'methods': [], 'states': ['order_received', 'validate_inventory', 'process_payment', 'update_inventory', 'ship_order', 'deliver', 'complete'], 'transitions': [{'source': 'order_received', 'target': 'validate_inventory', 'guard': 'stock_available == true'}, {'source': 'validate_inventory', 'target': 'process_payment', 'guard': 'inventory_reserved == true'}, {'source': 'process_payment', 'target': 'update_inventory', 'guard': None}, {'source': 'update_inventory', 'target': 'ship_order', 'guard': 'payment_confirmed == true";'}, {'source': 'ship_order', 'target': 'deliver', 'guard': None}, {'source': 'deliver', 'target': 'complete', 'guard': None}], 'steps': ['order_received', 'validate_inventory', 'process_payment', 'update_inventory', 'ship_order', 'deliver', 'complete'], 'human_tasks': ['ship_order'], 'guards': {'validate_inventory': 'stock_available == true', 'process_payment': 'inventory_reserved == true', 'ship_order': 'payment_confirmed == true";'}, 'assignments': {'ship_order': 'warehouse_staff'}, 'timers': {}, 'waits': {}, 'retry_policy': {}, 'compensation': {'process_payment': 'refund_payment'}, 'steps_raw': 'order_received -> validate_inventory -> process_payment -> update_inventory -> ship_order -> deliver -> complete'}, 'LeadNurturing': {'name': 'LeadNurturing', 'type': 'workflow', 'properties': {}, 'methods': [], 'states': ['new_lead', 'score_lead', 'assign_salesperson', 'send_welcome', 'qualify_lead', 'create_opportunity'], 'transitions': [{'source': 'new_lead', 'target': 'score_lead', 'guard': None}, {'source': 'score_lead', 'target': 'assign_salesperson', 'guard': 'lead_score > 0'}, {'source': 'assign_salesperson', 'target': 'send_welcome', 'guard': None}, {'source': 'send_welcome', 'target': 'qualify_lead', 'guard': 'welcome_sent == true'}, {'source': 'qualify_lead', 'target': 'create_opportunity', 'guard': 'qualification_complete == true";'}], 'steps': ['new_lead', 'score_lead', 'assign_salesperson', 'send_welcome', 'qualify_lead', 'create_opportunity'], 'human_tasks': ['qualify_lead'], 'guards': {'assign_salesperson': 'lead_score > 0', 'qualify_lead': 'welcome_sent == true', 'create_opportunity': 'qualification_complete == true";'}, 'assignments': {'qualify_lead': 'sales_rep'}, 'timers': {}, 'waits': {}, 'retry_policy': {}, 'compensation': {}, 'steps_raw': 'new_lead -> score_lead -> assign_salesperson -> send_welcome -> qualify_lead -> create_opportunity'}, 'StockAdjustment': {'name': 'StockAdjustment', 'type': 'workflow', 'properties': {}, 'methods': [], 'states': ['initiated', 'validated', 'approved', 'applied', 'logged'], 'transitions': [{'source': 'initiated', 'target': 'validated', 'guard': 'reason not missing and quantity not zero'}, {'source': 'validated', 'target': 'approved', 'guard': 'abs_adjustment > large_adjustment_threshold'}, {'source': 'approved', 'target': 'applied', 'guard': 'approval_granted == true or abs_adjustment <= large_adjustment_threshold";'}, {'source': 'applied', 'target': 'logged', 'guard': None}], 'steps': ['initiated', 'validated', 'approved', 'applied', 'logged'], 'human_tasks': ['approved'], 'guards': {'validated': 'reason not missing and quantity not zero', 'approved': 'abs_adjustment > large_adjustment_threshold', 'applied': 'approval_granted == true or abs_adjustment <= large_adjustment_threshold";'}, 'assignments': {'approved': 'warehouse_manager'}, 'timers': {}, 'waits': {}, 'retry_policy': {}, 'compensation': {'applied': 'reverse_adjustment'}, 'steps_raw': 'initiated -> validated -> approved -> applied -> logged'}}, 'operations': {}, 'rules': {'BlogManagement.post_requires_auth': {'name': 'post_requires_auth', 'when': 'user_authenticated == false and operation == create', 'action': 'deny', 'when_ast': {'type': 'and', 'left': {'type': 'compare', 'field': 'user_authenticated', 'op': '==', 'value': False}, 'right': {'type': 'compare', 'field': 'operation', 'op': '==', 'value': 'create'}}}, 'BlogManagement.comment_rate_limit': {'name': 'comment_rate_limit', 'when': 'comments_per_minute > 3', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'comments_per_minute', 'op': '>', 'value': 3}}, 'BlogManagement.comment_spam_detected': {'name': 'comment_spam_detected', 'when': 'spam_score > 0.8', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'spam_score', 'op': '>', 'value': 0.8}}, 'BlogManagement.publish_requires_admin': {'name': 'publish_requires_admin', 'when': 'published == true and is_admin == false', 'action': 'deny', 'when_ast': {'type': 'and', 'left': {'type': 'compare', 'field': 'published', 'op': '==', 'value': True}, 'right': {'type': 'compare', 'field': 'is_admin', 'op': '==', 'value': False}}}, 'ECommerceCore.stock_check': {'name': 'stock_check', 'when': 'quantity > stock_quantity', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'quantity', 'op': '>', 'value': 'stock_quantity'}}, 'ECommerceCore.price_positive': {'name': 'price_positive', 'when': 'price <= 0', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'price', 'op': '<=', 'value': 0}}, 'ECommerceCore.order_requires_address': {'name': 'order_requires_address', 'when': 'shipping_address missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'shipping_address', 'negated': False}}, 'ECommerceCore.low_stock_alert': {'name': 'low_stock_alert', 'when': 'stock_quantity <= low_stock_threshold', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'stock_quantity', 'op': '<=', 'value': 'low_stock_threshold'}}, 'TaskManagement.task_requires_project': {'name': 'task_requires_project', 'when': 'project_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'project_id', 'negated': False}}, 'TaskManagement.overdue_alert': {'name': 'overdue_alert', 'when': 'due_date < now and status != done', 'action': 'warn', 'when_ast': {'type': 'and', 'left': {'type': 'compare', 'field': 'due_date', 'op': '<', 'value': 'now'}, 'right': {'type': 'compare', 'field': 'status', 'op': '!=', 'value': 'done'}}}, 'TaskManagement.time_entry_open': {'name': 'time_entry_open', 'when': 'end_time missing and start_time set', 'action': 'warn'}, 'TaskManagement.estimate_exceeded': {'name': 'estimate_exceeded', 'when': 'actual_hours > estimated_hours * 1.5', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'actual_hours', 'op': '>', 'value': 'estimated_hours'}}, 'CRMCore.duplicate_contact': {'name': 'duplicate_contact', 'when': 'email_exists == true', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'email_exists', 'op': '==', 'value': True}}, 'CRMCore.high_value_escalation': {'name': 'high_value_escalation', 'when': 'value > 10000', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'value', 'op': '>', 'value': 10000}}, 'CRMCore.stale_lead': {'name': 'stale_lead', 'when': 'days_since_contact > 30', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'days_since_contact', 'op': '>', 'value': 30}}, 'CRMCore.probability_range': {'name': 'probability_range', 'when': 'probability < 0 or probability > 100', 'action': 'deny', 'when_ast': {'type': 'or', 'left': {'type': 'compare', 'field': 'probability', 'op': '<', 'value': 0}, 'right': {'type': 'compare', 'field': 'probability', 'op': '>', 'value': 100}}}, 'InventoryManagement.negative_stock_denied': {'name': 'negative_stock_denied', 'when': 'quantity - adjustment_quantity < 0', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'quantity', 'op': '==', 'value': True}}, 'InventoryManagement.large_adjustment_review': {'name': 'large_adjustment_review', 'when': 'abs_adjustment > large_adjustment_threshold', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'abs_adjustment', 'op': '>', 'value': 'large_adjustment_threshold'}}, 'InventoryManagement.reorder_alert': {'name': 'reorder_alert', 'when': 'available_quantity <= reorder_point', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'available_quantity', 'op': '<=', 'value': 'reorder_point'}}, 'InventoryManagement.overstock_warning': {'name': 'overstock_warning', 'when': 'quantity > max_stock_level', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'quantity', 'op': '>', 'value': 'max_stock_level'}}}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {'BlogManagement': {'name': 'BlogManagement', 'provides': ['post_authoring', 'comment_moderation', 'user_management'], 'requires': ['auth', 'audl'], 'configuration': {'tenant_id': 'default', 'posts_per_page': 10, 'spam_filter_enabled': 'bool', 'rate_limit_comments': 3, 'captcha_threshold': 0.5}, 'rules': [{'name': 'post_requires_auth', 'when': 'user_authenticated == false and operation == create', 'action': 'deny', 'when_ast': {'type': 'and', 'left': {'type': 'compare', 'field': 'user_authenticated', 'op': '==', 'value': False}, 'right': {'type': 'compare', 'field': 'operation', 'op': '==', 'value': 'create'}}}, {'name': 'comment_rate_limit', 'when': 'comments_per_minute > 3', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'comments_per_minute', 'op': '>', 'value': 3}}, {'name': 'comment_spam_detected', 'when': 'spam_score > 0.8', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'spam_score', 'op': '>', 'value': 0.8}}, {'name': 'publish_requires_admin', 'when': 'published == true and is_admin == false', 'action': 'deny', 'when_ast': {'type': 'and', 'left': {'type': 'compare', 'field': 'published', 'op': '==', 'value': True}, 'right': {'type': 'compare', 'field': 'is_admin', 'op': '==', 'value': False}}}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Posts', 'path': '/blog', 'component': 'PostList', 'permission': 'blog:view'}, {'name': 'New Post', 'path': '/blog/new', 'component': 'PostForm', 'permission': 'blog:write'}, {'name': 'Comments', 'path': '/blog/comments', 'component': 'CommentList', 'permission': 'blog:moderate'}]}, 'theme': {'name': 'blog_theme', 'tokens': {'accent': '#2196F3'}}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {}, 'screens': {}}, 'ECommerceCore': {'name': 'ECommerceCore', 'provides': ['product_catalog', 'order_management', 'inventory_tracking', 'payment_processing'], 'requires': ['auth', 'audl', 'ntfy'], 'configuration': {'tenant_id': 'default', 'currency': 'KES', 'low_stock_threshold': 10, 'max_product_images': 10, 'max_image_size_mb': 5}, 'rules': [{'name': 'stock_check', 'when': 'quantity > stock_quantity', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'quantity', 'op': '>', 'value': 'stock_quantity'}}, {'name': 'price_positive', 'when': 'price <= 0', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'price', 'op': '<=', 'value': 0}}, {'name': 'order_requires_address', 'when': 'shipping_address missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'shipping_address', 'negated': False}}, {'name': 'low_stock_alert', 'when': 'stock_quantity <= low_stock_threshold', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'stock_quantity', 'op': '<=', 'value': 'low_stock_threshold'}}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Products', 'path': '/shop/products', 'component': 'ProductCatalog', 'permission': 'shop:view'}, {'name': 'Orders', 'path': '/shop/orders', 'component': 'OrderList', 'permission': 'shop:orders'}, {'name': 'Inventory', 'path': '/shop/inventory', 'component': 'InventoryView', 'permission': 'shop:inventory'}]}, 'theme': {'name': 'shop_theme', 'tokens': {'accent': '#FF6D00'}}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {}, 'screens': {}}, 'TaskManagement': {'name': 'TaskManagement', 'provides': ['project_tracking', 'task_assignment', 'time_logging', 'progress_reporting'], 'requires': ['auth', 'ntfy'], 'configuration': {'tenant_id': 'default', 'default_priority': 'medium', 'overdue_check_interval_hours': 24}, 'rules': [{'name': 'task_requires_project', 'when': 'project_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'project_id', 'negated': False}}, {'name': 'overdue_alert', 'when': 'due_date < now and status != done', 'action': 'warn', 'when_ast': {'type': 'and', 'left': {'type': 'compare', 'field': 'due_date', 'op': '<', 'value': 'now'}, 'right': {'type': 'compare', 'field': 'status', 'op': '!=', 'value': 'done'}}}, {'name': 'time_entry_open', 'when': 'end_time missing and start_time set', 'action': 'warn'}, {'name': 'estimate_exceeded', 'when': 'actual_hours > estimated_hours * 1.5', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'actual_hours', 'op': '>', 'value': 'estimated_hours'}}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Projects', 'path': '/tasks/projects', 'component': 'ProjectList', 'permission': 'tasks:view'}, {'name': 'My Tasks', 'path': '/tasks', 'component': 'TaskBoard', 'permission': 'tasks:view'}, {'name': 'Timesheet', 'path': '/tasks/time', 'component': 'TimesheetView', 'permission': 'tasks:time'}]}, 'theme': {'name': 'tasks_theme', 'tokens': {'accent': '#4CAF50'}}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {}, 'screens': {'TaskBoard': {'route': '/tasks', 'layout': 'grid', 'contains': ['TodoColumn', 'InProgressColumn', 'ReviewColumn', 'DoneColumn'], 'binds': ['tasks.by_status'], 'actions': ['create_task', 'move_task', 'assign_task']}}}, 'CRMCore': {'name': 'CRMCore', 'provides': ['contact_management', 'deal_pipeline', 'activity_logging', 'lead_nurturing'], 'requires': ['auth', 'ntfy', 'audl'], 'configuration': {'tenant_id': 'default', 'lead_timeout_days': 30, 'high_value_threshold': 10000, 'auto_assignment': 'bool'}, 'rules': [{'name': 'duplicate_contact', 'when': 'email_exists == true', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'email_exists', 'op': '==', 'value': True}}, {'name': 'high_value_escalation', 'when': 'value > 10000', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'value', 'op': '>', 'value': 10000}}, {'name': 'stale_lead', 'when': 'days_since_contact > 30', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'days_since_contact', 'op': '>', 'value': 30}}, {'name': 'probability_range', 'when': 'probability < 0 or probability > 100', 'action': 'deny', 'when_ast': {'type': 'or', 'left': {'type': 'compare', 'field': 'probability', 'op': '<', 'value': 0}, 'right': {'type': 'compare', 'field': 'probability', 'op': '>', 'value': 100}}}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Contacts', 'path': '/crm/contacts', 'component': 'ContactList', 'permission': 'crm:view'}, {'name': 'Pipeline', 'path': '/crm/pipeline', 'component': 'DealPipeline', 'permission': 'crm:deals'}, {'name': 'Activities', 'path': '/crm/activities', 'component': 'ActivityLog', 'permission': 'crm:activities'}]}, 'theme': {'name': 'crm_theme', 'tokens': {'accent': '#9C27B0'}}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {}, 'screens': {}}, 'InventoryManagement': {'name': 'InventoryManagement', 'provides': ['stock_tracking', 'movement_recording', 'reorder_management', 'audit_trail'], 'requires': ['auth', 'audl', 'ntfy'], 'configuration': {'tenant_id': 'default', 'default_reorder_point': 10, 'large_adjustment_threshold': 100, 'large_value_threshold': 1000, 'approval_required': 'bool'}, 'rules': [{'name': 'negative_stock_denied', 'when': 'quantity - adjustment_quantity < 0', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'quantity', 'op': '==', 'value': True}}, {'name': 'large_adjustment_review', 'when': 'abs_adjustment > large_adjustment_threshold', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'abs_adjustment', 'op': '>', 'value': 'large_adjustment_threshold'}}, {'name': 'reorder_alert', 'when': 'available_quantity <= reorder_point', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'available_quantity', 'op': '<=', 'value': 'reorder_point'}}, {'name': 'overstock_warning', 'when': 'quantity > max_stock_level', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'quantity', 'op': '>', 'value': 'max_stock_level'}}], 'rule_engine': {}, 'ui': {'shell': 'python', 'routes': [{'name': 'Inventory', 'path': '/inventory', 'component': 'InventoryList', 'permission': 'inv:view'}, {'name': 'Movements', 'path': '/inventory/movements', 'component': 'MovementLog', 'permission': 'inv:view'}, {'name': 'Adjustments', 'path': '/inventory/adjust', 'component': 'AdjustmentForm', 'permission': 'inv:adjust'}, {'name': 'Reports', 'path': '/inventory/reports', 'component': 'InventoryReport', 'permission': 'inv:report'}]}, 'theme': {'name': 'inventory_theme', 'tokens': {'accent': '#607D8B'}}, 'runtime': {}, 'erp_modules': [], 'components': {}, 'business_rules': [], 'approvals': {}, 'master_data': {}, 'i18n': {}, 'streaming': {}, 'screens': {'InventoryDashboard': {'route': '/inventory', 'layout': 'dashboard', 'contains': ['StockLevelWidget', 'ReorderAlerts', 'MovementSummary', 'ValueWidget'], 'binds': ['inventory_items.current', 'stock_movements.recent'], 'actions': ['adjust_stock', 'transfer_stock', 'export_report']}}}}, 'composition': {'applications': {'BlogSystem': {'name': 'BlogSystem', 'description': 'Blog application with post authoring and comment moderation', 'capabilities': ['BlogManagement'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/blog', '/blog/new', '/blog/comments'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}, 'ECommerceApp': {'name': 'ECommerceApp', 'description': 'E-commerce platform with product catalog and order management', 'capabilities': ['ECommerceCore'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/shop', '/shop/products', '/shop/orders', '/shop/inventory'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}, 'TaskManagerApp': {'name': 'TaskManagerApp', 'description': 'Project and task management application with time tracking', 'capabilities': ['TaskManagement'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/tasks', '/tasks/projects', '/tasks/time'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}, 'CRMApp': {'name': 'CRMApp', 'description': 'Customer relationship management with deal pipeline and activity tracking', 'capabilities': ['CRMCore'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/crm', '/crm/contacts', '/crm/pipeline', '/crm/activities'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}, 'InventoryApp': {'name': 'InventoryApp', 'description': 'Warehouse inventory management with stock movements and reorder alerts', 'capabilities': ['InventoryManagement'], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': ['/inventory', '/inventory/movements', '/inventory/adjust', '/inventory/reports'], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {'BlogManagement': ['auth', 'audl'], 'ECommerceCore': ['auth', 'audl', 'ntfy'], 'TaskManagement': ['auth', 'ntfy'], 'CRMCore': ['auth', 'ntfy', 'audl'], 'InventoryManagement': ['auth', 'audl', 'ntfy']}}, 'contracts': {'BlogManagement': {'id': 'blog_management', 'provides': ['post_authoring', 'comment_moderation', 'user_management'], 'requires': ['auth', 'audl'], 'configuration': {'tenant_id': 'default', 'posts_per_page': 10, 'spam_filter_enabled': 'bool', 'rate_limit_comments': 3, 'captcha_threshold': 0.5}, 'rules': [{'name': 'post_requires_auth', 'when': 'user_authenticated == false and operation == create', 'action': 'deny', 'when_ast': {'type': 'and', 'left': {'type': 'compare', 'field': 'user_authenticated', 'op': '==', 'value': False}, 'right': {'type': 'compare', 'field': 'operation', 'op': '==', 'value': 'create'}}}, {'name': 'comment_rate_limit', 'when': 'comments_per_minute > 3', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'comments_per_minute', 'op': '>', 'value': 3}}, {'name': 'comment_spam_detected', 'when': 'spam_score > 0.8', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'spam_score', 'op': '>', 'value': 0.8}}, {'name': 'publish_requires_admin', 'when': 'published == true and is_admin == false', 'action': 'deny', 'when_ast': {'type': 'and', 'left': {'type': 'compare', 'field': 'published', 'op': '==', 'value': True}, 'right': {'type': 'compare', 'field': 'is_admin', 'op': '==', 'value': False}}}], 'ui': {'shell': 'python', 'routes': [{'name': 'Posts', 'path': '/blog', 'component': 'PostList', 'permission': 'blog:view'}, {'name': 'New Post', 'path': '/blog/new', 'component': 'PostForm', 'permission': 'blog:write'}, {'name': 'Comments', 'path': '/blog/comments', 'component': 'CommentList', 'permission': 'blog:moderate'}]}, 'theme': {'name': 'blog_theme', 'tokens': {'accent': '#2196F3'}}}, 'ECommerceCore': {'id': 'ecommerce_core', 'provides': ['product_catalog', 'order_management', 'inventory_tracking', 'payment_processing'], 'requires': ['auth', 'audl', 'ntfy'], 'configuration': {'tenant_id': 'default', 'currency': 'KES', 'low_stock_threshold': 10, 'max_product_images': 10, 'max_image_size_mb': 5}, 'rules': [{'name': 'stock_check', 'when': 'quantity > stock_quantity', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'quantity', 'op': '>', 'value': 'stock_quantity'}}, {'name': 'price_positive', 'when': 'price <= 0', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'price', 'op': '<=', 'value': 0}}, {'name': 'order_requires_address', 'when': 'shipping_address missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'shipping_address', 'negated': False}}, {'name': 'low_stock_alert', 'when': 'stock_quantity <= low_stock_threshold', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'stock_quantity', 'op': '<=', 'value': 'low_stock_threshold'}}], 'ui': {'shell': 'python', 'routes': [{'name': 'Products', 'path': '/shop/products', 'component': 'ProductCatalog', 'permission': 'shop:view'}, {'name': 'Orders', 'path': '/shop/orders', 'component': 'OrderList', 'permission': 'shop:orders'}, {'name': 'Inventory', 'path': '/shop/inventory', 'component': 'InventoryView', 'permission': 'shop:inventory'}]}, 'theme': {'name': 'shop_theme', 'tokens': {'accent': '#FF6D00'}}}, 'TaskManagement': {'id': 'task_management', 'provides': ['project_tracking', 'task_assignment', 'time_logging', 'progress_reporting'], 'requires': ['auth', 'ntfy'], 'configuration': {'tenant_id': 'default', 'default_priority': 'medium', 'overdue_check_interval_hours': 24}, 'rules': [{'name': 'task_requires_project', 'when': 'project_id missing', 'action': 'deny', 'when_ast': {'type': 'missing', 'field': 'project_id', 'negated': False}}, {'name': 'overdue_alert', 'when': 'due_date < now and status != done', 'action': 'warn', 'when_ast': {'type': 'and', 'left': {'type': 'compare', 'field': 'due_date', 'op': '<', 'value': 'now'}, 'right': {'type': 'compare', 'field': 'status', 'op': '!=', 'value': 'done'}}}, {'name': 'time_entry_open', 'when': 'end_time missing and start_time set', 'action': 'warn'}, {'name': 'estimate_exceeded', 'when': 'actual_hours > estimated_hours * 1.5', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'actual_hours', 'op': '>', 'value': 'estimated_hours'}}], 'ui': {'shell': 'python', 'routes': [{'name': 'Projects', 'path': '/tasks/projects', 'component': 'ProjectList', 'permission': 'tasks:view'}, {'name': 'My Tasks', 'path': '/tasks', 'component': 'TaskBoard', 'permission': 'tasks:view'}, {'name': 'Timesheet', 'path': '/tasks/time', 'component': 'TimesheetView', 'permission': 'tasks:time'}]}, 'theme': {'name': 'tasks_theme', 'tokens': {'accent': '#4CAF50'}}}, 'CRMCore': {'id': 'crm_core', 'provides': ['contact_management', 'deal_pipeline', 'activity_logging', 'lead_nurturing'], 'requires': ['auth', 'ntfy', 'audl'], 'configuration': {'tenant_id': 'default', 'lead_timeout_days': 30, 'high_value_threshold': 10000, 'auto_assignment': 'bool'}, 'rules': [{'name': 'duplicate_contact', 'when': 'email_exists == true', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'email_exists', 'op': '==', 'value': True}}, {'name': 'high_value_escalation', 'when': 'value > 10000', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'value', 'op': '>', 'value': 10000}}, {'name': 'stale_lead', 'when': 'days_since_contact > 30', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'days_since_contact', 'op': '>', 'value': 30}}, {'name': 'probability_range', 'when': 'probability < 0 or probability > 100', 'action': 'deny', 'when_ast': {'type': 'or', 'left': {'type': 'compare', 'field': 'probability', 'op': '<', 'value': 0}, 'right': {'type': 'compare', 'field': 'probability', 'op': '>', 'value': 100}}}], 'ui': {'shell': 'python', 'routes': [{'name': 'Contacts', 'path': '/crm/contacts', 'component': 'ContactList', 'permission': 'crm:view'}, {'name': 'Pipeline', 'path': '/crm/pipeline', 'component': 'DealPipeline', 'permission': 'crm:deals'}, {'name': 'Activities', 'path': '/crm/activities', 'component': 'ActivityLog', 'permission': 'crm:activities'}]}, 'theme': {'name': 'crm_theme', 'tokens': {'accent': '#9C27B0'}}}, 'InventoryManagement': {'id': 'inventory_management', 'provides': ['stock_tracking', 'movement_recording', 'reorder_management', 'audit_trail'], 'requires': ['auth', 'audl', 'ntfy'], 'configuration': {'tenant_id': 'default', 'default_reorder_point': 10, 'large_adjustment_threshold': 100, 'large_value_threshold': 1000, 'approval_required': 'bool'}, 'rules': [{'name': 'negative_stock_denied', 'when': 'quantity - adjustment_quantity < 0', 'action': 'deny', 'when_ast': {'type': 'compare', 'field': 'quantity', 'op': '==', 'value': True}}, {'name': 'large_adjustment_review', 'when': 'abs_adjustment > large_adjustment_threshold', 'action': 'require_review', 'when_ast': {'type': 'compare', 'field': 'abs_adjustment', 'op': '>', 'value': 'large_adjustment_threshold'}}, {'name': 'reorder_alert', 'when': 'available_quantity <= reorder_point', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'available_quantity', 'op': '<=', 'value': 'reorder_point'}}, {'name': 'overstock_warning', 'when': 'quantity > max_stock_level', 'action': 'warn', 'when_ast': {'type': 'compare', 'field': 'quantity', 'op': '>', 'value': 'max_stock_level'}}], 'ui': {'shell': 'python', 'routes': [{'name': 'Inventory', 'path': '/inventory', 'component': 'InventoryList', 'permission': 'inv:view'}, {'name': 'Movements', 'path': '/inventory/movements', 'component': 'MovementLog', 'permission': 'inv:view'}, {'name': 'Adjustments', 'path': '/inventory/adjust', 'component': 'AdjustmentForm', 'permission': 'inv:adjust'}, {'name': 'Reports', 'path': '/inventory/reports', 'component': 'InventoryReport', 'permission': 'inv:report'}]}, 'theme': {'name': 'inventory_theme', 'tokens': {'accent': '#607D8B'}}}}, 'deployment': {'target': 'python', 'source': 'basic_applications.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 158, 'edges': 152}, 'lookup': {'kind': 'lookup', 'nodes': 31, 'edges': 30}, 'workflow': {'kind': 'workflow', 'nodes': 31, 'edges': 30}, 'handler': {'kind': 'handler', 'nodes': 31, 'edges': 30}, 'capability': {'kind': 'capability', 'nodes': 13, 'edges': 18}, 'security': {'kind': 'security', 'nodes': 31, 'edges': 30}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 31, 'edges': 30}, 'package': {'kind': 'package', 'nodes': 31, 'edges': 30}}, 'diagnostics': []}
