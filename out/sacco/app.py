"""
sacco_demo - APG Python Application
===================================
...
MODULE_NAME = 'sacco_demo'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'Member', 'type': 'entity', 'properties': ['id', 'member_number', 'full_name', 'national_id', 'phone', 'email', 'share_capital', 'monthly_contribution', 'join_date', 'status', 'employer', 'designation'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'member_number', 'type': 'str', 'required': True}, {'name': 'full_name', 'type': 'str', 'required': True}, {'name': 'national_id', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'share_capital', 'type': 'float', 'required': True}, {'name': 'monthly_contribution', 'type': 'float', 'required': True}, {'name': 'join_date', 'type': 'date', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'employer', 'type': 'str', 'required': True}, {'name': 'designation', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'SavingsAccount', 'type': 'entity', 'properties': ['id', 'member_id', 'account_number', 'balance', 'account_type', 'interest_rate', 'last_transaction_date'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'member_id', 'type': 'str', 'required': True}, {'name': 'account_number', 'type': 'str', 'required': True}, {'name': 'balance', 'type': 'float', 'required': True}, {'name': 'account_type', 'type': 'str', 'required': True}, {'name': 'interest_rate', 'type': 'float', 'required': True}, {'name': 'last_transaction_date', 'type': 'date', 'required': True}], 'methods': []}, {'name': 'Loan', 'type': 'entity', 'properties': ['id', 'member_id', 'loan_number', 'principal_amount', 'interest_rate', 'term_months', 'monthly_repayment', 'outstanding_balance', 'disbursement_date', 'status', 'loan_type', 'guarantor_1_id', 'guarantor_2_id'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'member_id', 'type': 'str', 'required': True}, {'name': 'loan_number', 'type': 'str', 'required': True}, {'name': 'principal_amount', 'type': 'float', 'required': True}, {'name': 'interest_rate', 'type': 'float', 'required': True}, {'name': 'term_months', 'type': 'int', 'required': True}, {'name': 'monthly_repayment', 'type': 'float', 'required': True}, {'name': 'outstanding_balance', 'type': 'float', 'required': True}, {'name': 'disbursement_date', 'type': 'date', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'loan_type', 'type': 'str', 'required': True}, {'name': 'guarantor_1_id', 'type': 'str', 'required': True}, {'name': 'guarantor_2_id', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Contribution', 'type': 'entity', 'properties': ['id', 'member_id', 'amount', 'contribution_date', 'payment_method', 'reference', 'contribution_type'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'member_id', 'type': 'str', 'required': True}, {'name': 'amount', 'type': 'float', 'required': True}, {'name': 'contribution_date', 'type': 'date', 'required': True}, {'name': 'payment_method', 'type': 'str', 'required': True}, {'name': 'reference', 'type': 'str', 'required': True}, {'name': 'contribution_type', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Dividend', 'type': 'entity', 'properties': ['id', 'financial_year', 'total_profit', 'dividend_rate', 'declared_date', 'payment_date', 'status'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'financial_year', 'type': 'str', 'required': True}, {'name': 'total_profit', 'type': 'float', 'required': True}, {'name': 'dividend_rate', 'type': 'float', 'required': True}, {'name': 'declared_date', 'type': 'date', 'required': True}, {'name': 'payment_date', 'type': 'date', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'SaccoApp', 'type': 'application', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['sacco_demo.apg'], 'app': {'name': 'sacco_demo', 'version': '1.0.0', 'description': None, 'entity_count': 6}, 'symbols': {'module.sacco_demo': {'id': 'module.sacco_demo', 'kind': 'module', 'name': 'sacco_demo', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Member': {'id': 'table.Member', 'kind': 'table', 'name': 'Member', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Member.id': {'id': 'field.Member.id', 'kind': 'field', 'name': 'Member.id', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Member.member_number': {'id': 'field.Member.member_number', 'kind': 'field', 'name': 'Member.member_number', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Member.full_name': {'id': 'field.Member.full_name', 'kind': 'field', 'name': 'Member.full_name', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Member.national_id': {'id': 'field.Member.national_id', 'kind': 'field', 'name': 'Member.national_id', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Member.phone': {'id': 'field.Member.phone', 'kind': 'field', 'name': 'Member.phone', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Member.email': {'id': 'field.Member.email', 'kind': 'field', 'name': 'Member.email', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Member.share_capital': {'id': 'field.Member.share_capital', 'kind': 'field', 'name': 'Member.share_capital', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Member.monthly_contribution': {'id': 'field.Member.monthly_contribution', 'kind': 'field', 'name': 'Member.monthly_contribution', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Member.join_date': {'id': 'field.Member.join_date', 'kind': 'field', 'name': 'Member.join_date', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Member.status': {'id': 'field.Member.status', 'kind': 'field', 'name': 'Member.status', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Member.employer': {'id': 'field.Member.employer', 'kind': 'field', 'name': 'Member.employer', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Member.designation': {'id': 'field.Member.designation', 'kind': 'field', 'name': 'Member.designation', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.SavingsAccount': {'id': 'table.SavingsAccount', 'kind': 'table', 'name': 'SavingsAccount', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SavingsAccount.id': {'id': 'field.SavingsAccount.id', 'kind': 'field', 'name': 'SavingsAccount.id', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SavingsAccount.member_id': {'id': 'field.SavingsAccount.member_id', 'kind': 'field', 'name': 'SavingsAccount.member_id', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SavingsAccount.account_number': {'id': 'field.SavingsAccount.account_number', 'kind': 'field', 'name': 'SavingsAccount.account_number', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SavingsAccount.balance': {'id': 'field.SavingsAccount.balance', 'kind': 'field', 'name': 'SavingsAccount.balance', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SavingsAccount.account_type': {'id': 'field.SavingsAccount.account_type', 'kind': 'field', 'name': 'SavingsAccount.account_type', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SavingsAccount.interest_rate': {'id': 'field.SavingsAccount.interest_rate', 'kind': 'field', 'name': 'SavingsAccount.interest_rate', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.SavingsAccount.last_transaction_date': {'id': 'field.SavingsAccount.last_transaction_date', 'kind': 'field', 'name': 'SavingsAccount.last_transaction_date', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Loan': {'id': 'table.Loan', 'kind': 'table', 'name': 'Loan', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.id': {'id': 'field.Loan.id', 'kind': 'field', 'name': 'Loan.id', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.member_id': {'id': 'field.Loan.member_id', 'kind': 'field', 'name': 'Loan.member_id', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.loan_number': {'id': 'field.Loan.loan_number', 'kind': 'field', 'name': 'Loan.loan_number', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.principal_amount': {'id': 'field.Loan.principal_amount', 'kind': 'field', 'name': 'Loan.principal_amount', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.interest_rate': {'id': 'field.Loan.interest_rate', 'kind': 'field', 'name': 'Loan.interest_rate', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.term_months': {'id': 'field.Loan.term_months', 'kind': 'field', 'name': 'Loan.term_months', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.monthly_repayment': {'id': 'field.Loan.monthly_repayment', 'kind': 'field', 'name': 'Loan.monthly_repayment', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.outstanding_balance': {'id': 'field.Loan.outstanding_balance', 'kind': 'field', 'name': 'Loan.outstanding_balance', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.disbursement_date': {'id': 'field.Loan.disbursement_date', 'kind': 'field', 'name': 'Loan.disbursement_date', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.status': {'id': 'field.Loan.status', 'kind': 'field', 'name': 'Loan.status', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.loan_type': {'id': 'field.Loan.loan_type', 'kind': 'field', 'name': 'Loan.loan_type', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.guarantor_1_id': {'id': 'field.Loan.guarantor_1_id', 'kind': 'field', 'name': 'Loan.guarantor_1_id', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Loan.guarantor_2_id': {'id': 'field.Loan.guarantor_2_id', 'kind': 'field', 'name': 'Loan.guarantor_2_id', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Contribution': {'id': 'table.Contribution', 'kind': 'table', 'name': 'Contribution', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contribution.id': {'id': 'field.Contribution.id', 'kind': 'field', 'name': 'Contribution.id', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contribution.member_id': {'id': 'field.Contribution.member_id', 'kind': 'field', 'name': 'Contribution.member_id', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contribution.amount': {'id': 'field.Contribution.amount', 'kind': 'field', 'name': 'Contribution.amount', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contribution.contribution_date': {'id': 'field.Contribution.contribution_date', 'kind': 'field', 'name': 'Contribution.contribution_date', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contribution.payment_method': {'id': 'field.Contribution.payment_method', 'kind': 'field', 'name': 'Contribution.payment_method', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contribution.reference': {'id': 'field.Contribution.reference', 'kind': 'field', 'name': 'Contribution.reference', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Contribution.contribution_type': {'id': 'field.Contribution.contribution_type', 'kind': 'field', 'name': 'Contribution.contribution_type', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Dividend': {'id': 'table.Dividend', 'kind': 'table', 'name': 'Dividend', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Dividend.id': {'id': 'field.Dividend.id', 'kind': 'field', 'name': 'Dividend.id', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Dividend.financial_year': {'id': 'field.Dividend.financial_year', 'kind': 'field', 'name': 'Dividend.financial_year', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Dividend.total_profit': {'id': 'field.Dividend.total_profit', 'kind': 'field', 'name': 'Dividend.total_profit', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Dividend.dividend_rate': {'id': 'field.Dividend.dividend_rate', 'kind': 'field', 'name': 'Dividend.dividend_rate', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Dividend.declared_date': {'id': 'field.Dividend.declared_date', 'kind': 'field', 'name': 'Dividend.declared_date', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Dividend.payment_date': {'id': 'field.Dividend.payment_date', 'kind': 'field', 'name': 'Dividend.payment_date', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Dividend.status': {'id': 'field.Dividend.status', 'kind': 'field', 'name': 'Dividend.status', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.SaccoApp': {'id': 'app.SaccoApp', 'kind': 'app', 'name': 'SaccoApp', 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'Member': {'name': 'Member', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'member_number': {'type': 'str', 'required': True, 'relationship': None}, 'full_name': {'type': 'str', 'required': True, 'relationship': None}, 'national_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'National', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'national'}}, 'phone': {'type': 'str', 'required': True, 'relationship': None}, 'email': {'type': 'str', 'required': True, 'relationship': None}, 'share_capital': {'type': 'float', 'required': True, 'relationship': None}, 'monthly_contribution': {'type': 'float', 'required': True, 'relationship': None}, 'join_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'employer': {'type': 'str', 'required': True, 'relationship': None}, 'designation': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'join_date.id': {'chain': ['Member.join_date', 'date.id'], 'valid': True}}}, 'SavingsAccount': {'name': 'SavingsAccount', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'member_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Member', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'member'}}, 'account_number': {'type': 'str', 'required': True, 'relationship': None}, 'balance': {'type': 'float', 'required': True, 'relationship': None}, 'account_type': {'type': 'str', 'required': True, 'relationship': None}, 'interest_rate': {'type': 'float', 'required': True, 'relationship': None}, 'last_transaction_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'last_transaction_date.id': {'chain': ['SavingsAccount.last_transaction_date', 'date.id'], 'valid': True}}}, 'Loan': {'name': 'Loan', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'member_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Member', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'member'}}, 'loan_number': {'type': 'str', 'required': True, 'relationship': None}, 'principal_amount': {'type': 'float', 'required': True, 'relationship': None}, 'interest_rate': {'type': 'float', 'required': True, 'relationship': None}, 'term_months': {'type': 'int', 'required': True, 'relationship': None}, 'monthly_repayment': {'type': 'float', 'required': True, 'relationship': None}, 'outstanding_balance': {'type': 'float', 'required': True, 'relationship': None}, 'disbursement_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'loan_type': {'type': 'str', 'required': True, 'relationship': None}, 'guarantor_1_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Guarantor1', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'guarantor_1'}}, 'guarantor_2_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Guarantor2', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'guarantor_2'}}}, 'lookup_paths': {'disbursement_date.id': {'chain': ['Loan.disbursement_date', 'date.id'], 'valid': True}}}, 'Contribution': {'name': 'Contribution', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'member_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Member', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'member'}}, 'amount': {'type': 'float', 'required': True, 'relationship': None}, 'contribution_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'payment_method': {'type': 'str', 'required': True, 'relationship': None}, 'reference': {'type': 'str', 'required': True, 'relationship': None}, 'contribution_type': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'contribution_date.id': {'chain': ['Contribution.contribution_date', 'date.id'], 'valid': True}}}, 'Dividend': {'name': 'Dividend', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'financial_year': {'type': 'str', 'required': True, 'relationship': None}, 'total_profit': {'type': 'float', 'required': True, 'relationship': None}, 'dividend_rate': {'type': 'float', 'required': True, 'relationship': None}, 'declared_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'payment_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'status': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'declared_date.id': {'chain': ['Dividend.declared_date', 'date.id'], 'valid': True}, 'payment_date.id': {'chain': ['Dividend.payment_date', 'date.id'], 'valid': True}}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {'SaccoApp': {'name': 'SaccoApp', 'description': 'Cooperative banking platform', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': [], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'sacco_demo.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 51, 'edges': 49}, 'lookup': {'kind': 'lookup', 'nodes': 7, 'edges': 6}, 'workflow': {'kind': 'workflow', 'nodes': 7, 'edges': 6}, 'handler': {'kind': 'handler', 'nodes': 7, 'edges': 6}, 'capability': {'kind': 'capability', 'nodes': 1, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 7, 'edges': 6}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 7, 'edges': 6}, 'package': {'kind': 'package', 'nodes': 7, 'edges': 6}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Application 'SaccoApp' should compose capabilities, components, or routes", 'file': 'sacco_demo.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
