"""
fintech_lending - APG Python Application
========================================
...
MODULE_NAME = 'fintech_lending'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'Applicant', 'type': 'entity', 'properties': ['id', 'applicant_code', 'full_name', 'national_id', 'phone', 'email', 'date_of_birth', 'gender', 'county', 'employer', 'monthly_income', 'employment_type', 'credit_score', 'risk_band', 'mpesa_limit', 'kyc_status'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'applicant_code', 'type': 'str', 'required': True}, {'name': 'full_name', 'type': 'str', 'required': True}, {'name': 'national_id', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'date_of_birth', 'type': 'date', 'required': True}, {'name': 'gender', 'type': 'str', 'required': True}, {'name': 'county', 'type': 'str', 'required': True}, {'name': 'employer', 'type': 'str', 'required': True}, {'name': 'monthly_income', 'type': 'float', 'required': True}, {'name': 'employment_type', 'type': 'str', 'required': True}, {'name': 'credit_score', 'type': 'int', 'required': True}, {'name': 'risk_band', 'type': 'str', 'required': True}, {'name': 'mpesa_limit', 'type': 'float', 'required': True}, {'name': 'kyc_status', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'LoanProduct', 'type': 'entity', 'properties': ['id', 'product_code', 'product_name', 'min_amount', 'max_amount', 'min_term_months', 'max_term_months', 'interest_rate', 'processing_fee_pct', 'insurance_fee_pct', 'target_segment', 'collateral_required', 'status'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'product_code', 'type': 'str', 'required': True}, {'name': 'product_name', 'type': 'str', 'required': True}, {'name': 'min_amount', 'type': 'float', 'required': True}, {'name': 'max_amount', 'type': 'float', 'required': True}, {'name': 'min_term_months', 'type': 'int', 'required': True}, {'name': 'max_term_months', 'type': 'int', 'required': True}, {'name': 'interest_rate', 'type': 'float', 'required': True}, {'name': 'processing_fee_pct', 'type': 'float', 'required': True}, {'name': 'insurance_fee_pct', 'type': 'float', 'required': True}, {'name': 'target_segment', 'type': 'str', 'required': True}, {'name': 'collateral_required', 'type': 'bool', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'LoanApplication', 'type': 'entity', 'properties': ['id', 'application_number', 'applicant_id', 'product_id', 'requested_amount', 'requested_term_months', 'purpose', 'application_date', 'status', 'credit_decision', 'approved_amount', 'approved_term_months', 'decision_date', 'decision_by', 'rejection_reason'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'application_number', 'type': 'str', 'required': True}, {'name': 'applicant_id', 'type': 'str', 'required': True}, {'name': 'product_id', 'type': 'str', 'required': True}, {'name': 'requested_amount', 'type': 'float', 'required': True}, {'name': 'requested_term_months', 'type': 'int', 'required': True}, {'name': 'purpose', 'type': 'str', 'required': True}, {'name': 'application_date', 'type': 'date', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'credit_decision', 'type': 'str', 'required': True}, {'name': 'approved_amount', 'type': 'float', 'required': True}, {'name': 'approved_term_months', 'type': 'int', 'required': True}, {'name': 'decision_date', 'type': 'date', 'required': True}, {'name': 'decision_by', 'type': 'str', 'required': True}, {'name': 'rejection_reason', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'ActiveLoan', 'type': 'entity', 'properties': ['id', 'loan_number', 'application_id', 'applicant_id', 'product_id', 'principal_amount', 'disbursed_amount', 'interest_rate', 'term_months', 'monthly_repayment', 'disbursement_date', 'maturity_date', 'outstanding_principal', 'outstanding_interest', 'days_past_due', 'loan_status', 'collection_bucket'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'loan_number', 'type': 'str', 'required': True}, {'name': 'application_id', 'type': 'str', 'required': True}, {'name': 'applicant_id', 'type': 'str', 'required': True}, {'name': 'product_id', 'type': 'str', 'required': True}, {'name': 'principal_amount', 'type': 'float', 'required': True}, {'name': 'disbursed_amount', 'type': 'float', 'required': True}, {'name': 'interest_rate', 'type': 'float', 'required': True}, {'name': 'term_months', 'type': 'int', 'required': True}, {'name': 'monthly_repayment', 'type': 'float', 'required': True}, {'name': 'disbursement_date', 'type': 'date', 'required': True}, {'name': 'maturity_date', 'type': 'date', 'required': True}, {'name': 'outstanding_principal', 'type': 'float', 'required': True}, {'name': 'outstanding_interest', 'type': 'float', 'required': True}, {'name': 'days_past_due', 'type': 'int', 'required': True}, {'name': 'loan_status', 'type': 'str', 'required': True}, {'name': 'collection_bucket', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Repayment', 'type': 'entity', 'properties': ['id', 'loan_id', 'applicant_id', 'amount', 'payment_date', 'payment_method', 'mpesa_reference', 'principal_portion', 'interest_portion', 'penalty_portion', 'running_balance', 'receipt_number'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'loan_id', 'type': 'str', 'required': True}, {'name': 'applicant_id', 'type': 'str', 'required': True}, {'name': 'amount', 'type': 'float', 'required': True}, {'name': 'payment_date', 'type': 'date', 'required': True}, {'name': 'payment_method', 'type': 'str', 'required': True}, {'name': 'mpesa_reference', 'type': 'str', 'required': True}, {'name': 'principal_portion', 'type': 'float', 'required': True}, {'name': 'interest_portion', 'type': 'float', 'required': True}, {'name': 'penalty_portion', 'type': 'float', 'required': True}, {'name': 'running_balance', 'type': 'float', 'required': True}, {'name': 'receipt_number', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'CreditScore', 'type': 'entity', 'properties': ['id', 'applicant_id', 'score', 'score_band', 'scoring_date', 'model_version', 'repayment_history_score', 'utilisation_score', 'account_age_score', 'income_stability_score', 'bureau_score', 'recommendation'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'applicant_id', 'type': 'str', 'required': True}, {'name': 'score', 'type': 'int', 'required': True}, {'name': 'score_band', 'type': 'str', 'required': True}, {'name': 'scoring_date', 'type': 'date', 'required': True}, {'name': 'model_version', 'type': 'str', 'required': True}, {'name': 'repayment_history_score', 'type': 'int', 'required': True}, {'name': 'utilisation_score', 'type': 'int', 'required': True}, {'name': 'account_age_score', 'type': 'int', 'required': True}, {'name': 'income_stability_score', 'type': 'int', 'required': True}, {'name': 'bureau_score', 'type': 'int', 'required': True}, {'name': 'recommendation', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Collection', 'type': 'entity', 'properties': ['id', 'loan_id', 'applicant_id', 'dpd', 'bucket', 'outstanding_amount', 'last_contact_date', 'last_contact_channel', 'contact_result', 'promise_to_pay_date', 'promise_to_pay_amount', 'collector_id', 'action_taken'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'loan_id', 'type': 'str', 'required': True}, {'name': 'applicant_id', 'type': 'str', 'required': True}, {'name': 'dpd', 'type': 'int', 'required': True}, {'name': 'bucket', 'type': 'str', 'required': True}, {'name': 'outstanding_amount', 'type': 'float', 'required': True}, {'name': 'last_contact_date', 'type': 'date', 'required': True}, {'name': 'last_contact_channel', 'type': 'str', 'required': True}, {'name': 'contact_result', 'type': 'str', 'required': True}, {'name': 'promise_to_pay_date', 'type': 'date', 'required': True}, {'name': 'promise_to_pay_amount', 'type': 'float', 'required': True}, {'name': 'collector_id', 'type': 'str', 'required': True}, {'name': 'action_taken', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'LendApp', 'type': 'application', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['fintech_lending.apg'], 'app': {'name': 'fintech_lending', 'version': '1.0.0', 'description': None, 'entity_count': 8}, 'symbols': {'module.fintech_lending': {'id': 'module.fintech_lending', 'kind': 'module', 'name': 'fintech_lending', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Applicant': {'id': 'table.Applicant', 'kind': 'table', 'name': 'Applicant', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.id': {'id': 'field.Applicant.id', 'kind': 'field', 'name': 'Applicant.id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.applicant_code': {'id': 'field.Applicant.applicant_code', 'kind': 'field', 'name': 'Applicant.applicant_code', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.full_name': {'id': 'field.Applicant.full_name', 'kind': 'field', 'name': 'Applicant.full_name', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.national_id': {'id': 'field.Applicant.national_id', 'kind': 'field', 'name': 'Applicant.national_id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.phone': {'id': 'field.Applicant.phone', 'kind': 'field', 'name': 'Applicant.phone', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.email': {'id': 'field.Applicant.email', 'kind': 'field', 'name': 'Applicant.email', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.date_of_birth': {'id': 'field.Applicant.date_of_birth', 'kind': 'field', 'name': 'Applicant.date_of_birth', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.gender': {'id': 'field.Applicant.gender', 'kind': 'field', 'name': 'Applicant.gender', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.county': {'id': 'field.Applicant.county', 'kind': 'field', 'name': 'Applicant.county', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.employer': {'id': 'field.Applicant.employer', 'kind': 'field', 'name': 'Applicant.employer', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.monthly_income': {'id': 'field.Applicant.monthly_income', 'kind': 'field', 'name': 'Applicant.monthly_income', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.employment_type': {'id': 'field.Applicant.employment_type', 'kind': 'field', 'name': 'Applicant.employment_type', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.credit_score': {'id': 'field.Applicant.credit_score', 'kind': 'field', 'name': 'Applicant.credit_score', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.risk_band': {'id': 'field.Applicant.risk_band', 'kind': 'field', 'name': 'Applicant.risk_band', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.mpesa_limit': {'id': 'field.Applicant.mpesa_limit', 'kind': 'field', 'name': 'Applicant.mpesa_limit', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Applicant.kyc_status': {'id': 'field.Applicant.kyc_status', 'kind': 'field', 'name': 'Applicant.kyc_status', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.LoanProduct': {'id': 'table.LoanProduct', 'kind': 'table', 'name': 'LoanProduct', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.id': {'id': 'field.LoanProduct.id', 'kind': 'field', 'name': 'LoanProduct.id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.product_code': {'id': 'field.LoanProduct.product_code', 'kind': 'field', 'name': 'LoanProduct.product_code', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.product_name': {'id': 'field.LoanProduct.product_name', 'kind': 'field', 'name': 'LoanProduct.product_name', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.min_amount': {'id': 'field.LoanProduct.min_amount', 'kind': 'field', 'name': 'LoanProduct.min_amount', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.max_amount': {'id': 'field.LoanProduct.max_amount', 'kind': 'field', 'name': 'LoanProduct.max_amount', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.min_term_months': {'id': 'field.LoanProduct.min_term_months', 'kind': 'field', 'name': 'LoanProduct.min_term_months', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.max_term_months': {'id': 'field.LoanProduct.max_term_months', 'kind': 'field', 'name': 'LoanProduct.max_term_months', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.interest_rate': {'id': 'field.LoanProduct.interest_rate', 'kind': 'field', 'name': 'LoanProduct.interest_rate', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.processing_fee_pct': {'id': 'field.LoanProduct.processing_fee_pct', 'kind': 'field', 'name': 'LoanProduct.processing_fee_pct', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.insurance_fee_pct': {'id': 'field.LoanProduct.insurance_fee_pct', 'kind': 'field', 'name': 'LoanProduct.insurance_fee_pct', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.target_segment': {'id': 'field.LoanProduct.target_segment', 'kind': 'field', 'name': 'LoanProduct.target_segment', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.collateral_required': {'id': 'field.LoanProduct.collateral_required', 'kind': 'field', 'name': 'LoanProduct.collateral_required', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanProduct.status': {'id': 'field.LoanProduct.status', 'kind': 'field', 'name': 'LoanProduct.status', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.LoanApplication': {'id': 'table.LoanApplication', 'kind': 'table', 'name': 'LoanApplication', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.id': {'id': 'field.LoanApplication.id', 'kind': 'field', 'name': 'LoanApplication.id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.application_number': {'id': 'field.LoanApplication.application_number', 'kind': 'field', 'name': 'LoanApplication.application_number', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.applicant_id': {'id': 'field.LoanApplication.applicant_id', 'kind': 'field', 'name': 'LoanApplication.applicant_id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.product_id': {'id': 'field.LoanApplication.product_id', 'kind': 'field', 'name': 'LoanApplication.product_id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.requested_amount': {'id': 'field.LoanApplication.requested_amount', 'kind': 'field', 'name': 'LoanApplication.requested_amount', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.requested_term_months': {'id': 'field.LoanApplication.requested_term_months', 'kind': 'field', 'name': 'LoanApplication.requested_term_months', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.purpose': {'id': 'field.LoanApplication.purpose', 'kind': 'field', 'name': 'LoanApplication.purpose', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.application_date': {'id': 'field.LoanApplication.application_date', 'kind': 'field', 'name': 'LoanApplication.application_date', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.status': {'id': 'field.LoanApplication.status', 'kind': 'field', 'name': 'LoanApplication.status', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.credit_decision': {'id': 'field.LoanApplication.credit_decision', 'kind': 'field', 'name': 'LoanApplication.credit_decision', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.approved_amount': {'id': 'field.LoanApplication.approved_amount', 'kind': 'field', 'name': 'LoanApplication.approved_amount', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.approved_term_months': {'id': 'field.LoanApplication.approved_term_months', 'kind': 'field', 'name': 'LoanApplication.approved_term_months', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.decision_date': {'id': 'field.LoanApplication.decision_date', 'kind': 'field', 'name': 'LoanApplication.decision_date', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.decision_by': {'id': 'field.LoanApplication.decision_by', 'kind': 'field', 'name': 'LoanApplication.decision_by', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.LoanApplication.rejection_reason': {'id': 'field.LoanApplication.rejection_reason', 'kind': 'field', 'name': 'LoanApplication.rejection_reason', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.ActiveLoan': {'id': 'table.ActiveLoan', 'kind': 'table', 'name': 'ActiveLoan', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.id': {'id': 'field.ActiveLoan.id', 'kind': 'field', 'name': 'ActiveLoan.id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.loan_number': {'id': 'field.ActiveLoan.loan_number', 'kind': 'field', 'name': 'ActiveLoan.loan_number', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.application_id': {'id': 'field.ActiveLoan.application_id', 'kind': 'field', 'name': 'ActiveLoan.application_id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.applicant_id': {'id': 'field.ActiveLoan.applicant_id', 'kind': 'field', 'name': 'ActiveLoan.applicant_id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.product_id': {'id': 'field.ActiveLoan.product_id', 'kind': 'field', 'name': 'ActiveLoan.product_id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.principal_amount': {'id': 'field.ActiveLoan.principal_amount', 'kind': 'field', 'name': 'ActiveLoan.principal_amount', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.disbursed_amount': {'id': 'field.ActiveLoan.disbursed_amount', 'kind': 'field', 'name': 'ActiveLoan.disbursed_amount', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.interest_rate': {'id': 'field.ActiveLoan.interest_rate', 'kind': 'field', 'name': 'ActiveLoan.interest_rate', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.term_months': {'id': 'field.ActiveLoan.term_months', 'kind': 'field', 'name': 'ActiveLoan.term_months', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.monthly_repayment': {'id': 'field.ActiveLoan.monthly_repayment', 'kind': 'field', 'name': 'ActiveLoan.monthly_repayment', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.disbursement_date': {'id': 'field.ActiveLoan.disbursement_date', 'kind': 'field', 'name': 'ActiveLoan.disbursement_date', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.maturity_date': {'id': 'field.ActiveLoan.maturity_date', 'kind': 'field', 'name': 'ActiveLoan.maturity_date', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.outstanding_principal': {'id': 'field.ActiveLoan.outstanding_principal', 'kind': 'field', 'name': 'ActiveLoan.outstanding_principal', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.outstanding_interest': {'id': 'field.ActiveLoan.outstanding_interest', 'kind': 'field', 'name': 'ActiveLoan.outstanding_interest', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.days_past_due': {'id': 'field.ActiveLoan.days_past_due', 'kind': 'field', 'name': 'ActiveLoan.days_past_due', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.loan_status': {'id': 'field.ActiveLoan.loan_status', 'kind': 'field', 'name': 'ActiveLoan.loan_status', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ActiveLoan.collection_bucket': {'id': 'field.ActiveLoan.collection_bucket', 'kind': 'field', 'name': 'ActiveLoan.collection_bucket', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Repayment': {'id': 'table.Repayment', 'kind': 'table', 'name': 'Repayment', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Repayment.id': {'id': 'field.Repayment.id', 'kind': 'field', 'name': 'Repayment.id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Repayment.loan_id': {'id': 'field.Repayment.loan_id', 'kind': 'field', 'name': 'Repayment.loan_id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Repayment.applicant_id': {'id': 'field.Repayment.applicant_id', 'kind': 'field', 'name': 'Repayment.applicant_id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Repayment.amount': {'id': 'field.Repayment.amount', 'kind': 'field', 'name': 'Repayment.amount', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Repayment.payment_date': {'id': 'field.Repayment.payment_date', 'kind': 'field', 'name': 'Repayment.payment_date', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Repayment.payment_method': {'id': 'field.Repayment.payment_method', 'kind': 'field', 'name': 'Repayment.payment_method', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Repayment.mpesa_reference': {'id': 'field.Repayment.mpesa_reference', 'kind': 'field', 'name': 'Repayment.mpesa_reference', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Repayment.principal_portion': {'id': 'field.Repayment.principal_portion', 'kind': 'field', 'name': 'Repayment.principal_portion', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Repayment.interest_portion': {'id': 'field.Repayment.interest_portion', 'kind': 'field', 'name': 'Repayment.interest_portion', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Repayment.penalty_portion': {'id': 'field.Repayment.penalty_portion', 'kind': 'field', 'name': 'Repayment.penalty_portion', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Repayment.running_balance': {'id': 'field.Repayment.running_balance', 'kind': 'field', 'name': 'Repayment.running_balance', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Repayment.receipt_number': {'id': 'field.Repayment.receipt_number', 'kind': 'field', 'name': 'Repayment.receipt_number', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.CreditScore': {'id': 'table.CreditScore', 'kind': 'table', 'name': 'CreditScore', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CreditScore.id': {'id': 'field.CreditScore.id', 'kind': 'field', 'name': 'CreditScore.id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CreditScore.applicant_id': {'id': 'field.CreditScore.applicant_id', 'kind': 'field', 'name': 'CreditScore.applicant_id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CreditScore.score': {'id': 'field.CreditScore.score', 'kind': 'field', 'name': 'CreditScore.score', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CreditScore.score_band': {'id': 'field.CreditScore.score_band', 'kind': 'field', 'name': 'CreditScore.score_band', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CreditScore.scoring_date': {'id': 'field.CreditScore.scoring_date', 'kind': 'field', 'name': 'CreditScore.scoring_date', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CreditScore.model_version': {'id': 'field.CreditScore.model_version', 'kind': 'field', 'name': 'CreditScore.model_version', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CreditScore.repayment_history_score': {'id': 'field.CreditScore.repayment_history_score', 'kind': 'field', 'name': 'CreditScore.repayment_history_score', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CreditScore.utilisation_score': {'id': 'field.CreditScore.utilisation_score', 'kind': 'field', 'name': 'CreditScore.utilisation_score', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CreditScore.account_age_score': {'id': 'field.CreditScore.account_age_score', 'kind': 'field', 'name': 'CreditScore.account_age_score', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CreditScore.income_stability_score': {'id': 'field.CreditScore.income_stability_score', 'kind': 'field', 'name': 'CreditScore.income_stability_score', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CreditScore.bureau_score': {'id': 'field.CreditScore.bureau_score', 'kind': 'field', 'name': 'CreditScore.bureau_score', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CreditScore.recommendation': {'id': 'field.CreditScore.recommendation', 'kind': 'field', 'name': 'CreditScore.recommendation', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Collection': {'id': 'table.Collection', 'kind': 'table', 'name': 'Collection', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.id': {'id': 'field.Collection.id', 'kind': 'field', 'name': 'Collection.id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.loan_id': {'id': 'field.Collection.loan_id', 'kind': 'field', 'name': 'Collection.loan_id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.applicant_id': {'id': 'field.Collection.applicant_id', 'kind': 'field', 'name': 'Collection.applicant_id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.dpd': {'id': 'field.Collection.dpd', 'kind': 'field', 'name': 'Collection.dpd', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.bucket': {'id': 'field.Collection.bucket', 'kind': 'field', 'name': 'Collection.bucket', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.outstanding_amount': {'id': 'field.Collection.outstanding_amount', 'kind': 'field', 'name': 'Collection.outstanding_amount', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.last_contact_date': {'id': 'field.Collection.last_contact_date', 'kind': 'field', 'name': 'Collection.last_contact_date', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.last_contact_channel': {'id': 'field.Collection.last_contact_channel', 'kind': 'field', 'name': 'Collection.last_contact_channel', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.contact_result': {'id': 'field.Collection.contact_result', 'kind': 'field', 'name': 'Collection.contact_result', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.promise_to_pay_date': {'id': 'field.Collection.promise_to_pay_date', 'kind': 'field', 'name': 'Collection.promise_to_pay_date', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.promise_to_pay_amount': {'id': 'field.Collection.promise_to_pay_amount', 'kind': 'field', 'name': 'Collection.promise_to_pay_amount', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.collector_id': {'id': 'field.Collection.collector_id', 'kind': 'field', 'name': 'Collection.collector_id', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Collection.action_taken': {'id': 'field.Collection.action_taken', 'kind': 'field', 'name': 'Collection.action_taken', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.LendApp': {'id': 'app.LendApp', 'kind': 'app', 'name': 'LendApp', 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'Applicant': {'name': 'Applicant', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'applicant_code': {'type': 'str', 'required': True, 'relationship': None}, 'full_name': {'type': 'str', 'required': True, 'relationship': None}, 'national_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'National', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'national'}}, 'phone': {'type': 'str', 'required': True, 'relationship': None}, 'email': {'type': 'str', 'required': True, 'relationship': None}, 'date_of_birth': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'gender': {'type': 'str', 'required': True, 'relationship': None}, 'county': {'type': 'str', 'required': True, 'relationship': None}, 'employer': {'type': 'str', 'required': True, 'relationship': None}, 'monthly_income': {'type': 'float', 'required': True, 'relationship': None}, 'employment_type': {'type': 'str', 'required': True, 'relationship': None}, 'credit_score': {'type': 'int', 'required': True, 'relationship': None}, 'risk_band': {'type': 'str', 'required': True, 'relationship': None}, 'mpesa_limit': {'type': 'float', 'required': True, 'relationship': None}, 'kyc_status': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'date_of_birth.id': {'chain': ['Applicant.date_of_birth', 'date.id'], 'valid': True}}}, 'LoanProduct': {'name': 'LoanProduct', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'product_code': {'type': 'str', 'required': True, 'relationship': None}, 'product_name': {'type': 'str', 'required': True, 'relationship': None}, 'min_amount': {'type': 'float', 'required': True, 'relationship': None}, 'max_amount': {'type': 'float', 'required': True, 'relationship': None}, 'min_term_months': {'type': 'int', 'required': True, 'relationship': None}, 'max_term_months': {'type': 'int', 'required': True, 'relationship': None}, 'interest_rate': {'type': 'float', 'required': True, 'relationship': None}, 'processing_fee_pct': {'type': 'float', 'required': True, 'relationship': None}, 'insurance_fee_pct': {'type': 'float', 'required': True, 'relationship': None}, 'target_segment': {'type': 'str', 'required': True, 'relationship': None}, 'collateral_required': {'type': 'bool', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {}}, 'LoanApplication': {'name': 'LoanApplication', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'application_number': {'type': 'str', 'required': True, 'relationship': None}, 'applicant_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Applicant', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'applicant'}}, 'product_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Product', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'product'}}, 'requested_amount': {'type': 'float', 'required': True, 'relationship': None}, 'requested_term_months': {'type': 'int', 'required': True, 'relationship': None}, 'purpose': {'type': 'str', 'required': True, 'relationship': None}, 'application_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'credit_decision': {'type': 'str', 'required': True, 'relationship': None}, 'approved_amount': {'type': 'float', 'required': True, 'relationship': None}, 'approved_term_months': {'type': 'int', 'required': True, 'relationship': None}, 'decision_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'decision_by': {'type': 'str', 'required': True, 'relationship': None}, 'rejection_reason': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'application_date.id': {'chain': ['LoanApplication.application_date', 'date.id'], 'valid': True}, 'decision_date.id': {'chain': ['LoanApplication.decision_date', 'date.id'], 'valid': True}}}, 'ActiveLoan': {'name': 'ActiveLoan', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'loan_number': {'type': 'str', 'required': True, 'relationship': None}, 'application_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Application', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'application'}}, 'applicant_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Applicant', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'applicant'}}, 'product_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Product', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'product'}}, 'principal_amount': {'type': 'float', 'required': True, 'relationship': None}, 'disbursed_amount': {'type': 'float', 'required': True, 'relationship': None}, 'interest_rate': {'type': 'float', 'required': True, 'relationship': None}, 'term_months': {'type': 'int', 'required': True, 'relationship': None}, 'monthly_repayment': {'type': 'float', 'required': True, 'relationship': None}, 'disbursement_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'maturity_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'outstanding_principal': {'type': 'float', 'required': True, 'relationship': None}, 'outstanding_interest': {'type': 'float', 'required': True, 'relationship': None}, 'days_past_due': {'type': 'int', 'required': True, 'relationship': None}, 'loan_status': {'type': 'str', 'required': True, 'relationship': None}, 'collection_bucket': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'disbursement_date.id': {'chain': ['ActiveLoan.disbursement_date', 'date.id'], 'valid': True}, 'maturity_date.id': {'chain': ['ActiveLoan.maturity_date', 'date.id'], 'valid': True}}}, 'Repayment': {'name': 'Repayment', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'loan_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Loan', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'loan'}}, 'applicant_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Applicant', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'applicant'}}, 'amount': {'type': 'float', 'required': True, 'relationship': None}, 'payment_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'payment_method': {'type': 'str', 'required': True, 'relationship': None}, 'mpesa_reference': {'type': 'str', 'required': True, 'relationship': None}, 'principal_portion': {'type': 'float', 'required': True, 'relationship': None}, 'interest_portion': {'type': 'float', 'required': True, 'relationship': None}, 'penalty_portion': {'type': 'float', 'required': True, 'relationship': None}, 'running_balance': {'type': 'float', 'required': True, 'relationship': None}, 'receipt_number': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'payment_date.id': {'chain': ['Repayment.payment_date', 'date.id'], 'valid': True}}}, 'CreditScore': {'name': 'CreditScore', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'applicant_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Applicant', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'applicant'}}, 'score': {'type': 'int', 'required': True, 'relationship': None}, 'score_band': {'type': 'str', 'required': True, 'relationship': None}, 'scoring_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'model_version': {'type': 'str', 'required': True, 'relationship': None}, 'repayment_history_score': {'type': 'int', 'required': True, 'relationship': None}, 'utilisation_score': {'type': 'int', 'required': True, 'relationship': None}, 'account_age_score': {'type': 'int', 'required': True, 'relationship': None}, 'income_stability_score': {'type': 'int', 'required': True, 'relationship': None}, 'bureau_score': {'type': 'int', 'required': True, 'relationship': None}, 'recommendation': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'scoring_date.id': {'chain': ['CreditScore.scoring_date', 'date.id'], 'valid': True}}}, 'Collection': {'name': 'Collection', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'loan_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Loan', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'loan'}}, 'applicant_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Applicant', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'applicant'}}, 'dpd': {'type': 'int', 'required': True, 'relationship': None}, 'bucket': {'type': 'str', 'required': True, 'relationship': None}, 'outstanding_amount': {'type': 'float', 'required': True, 'relationship': None}, 'last_contact_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'last_contact_channel': {'type': 'str', 'required': True, 'relationship': None}, 'contact_result': {'type': 'str', 'required': True, 'relationship': None}, 'promise_to_pay_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'promise_to_pay_amount': {'type': 'float', 'required': True, 'relationship': None}, 'collector_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Collector', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'collector'}}, 'action_taken': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'last_contact_date.id': {'chain': ['Collection.last_contact_date', 'date.id'], 'valid': True}, 'promise_to_pay_date.id': {'chain': ['Collection.promise_to_pay_date', 'date.id'], 'valid': True}}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {'LendApp': {'name': 'LendApp', 'description': 'AI-powered digital lending platform', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': [], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'fintech_lending.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 105, 'edges': 103}, 'lookup': {'kind': 'lookup', 'nodes': 9, 'edges': 8}, 'workflow': {'kind': 'workflow', 'nodes': 9, 'edges': 8}, 'handler': {'kind': 'handler', 'nodes': 9, 'edges': 8}, 'capability': {'kind': 'capability', 'nodes': 1, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 9, 'edges': 8}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 9, 'edges': 8}, 'package': {'kind': 'package', 'nodes': 9, 'edges': 8}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Application 'LendApp' should compose capabilities, components, or routes", 'file': 'fintech_lending.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
APG_UI_TEMPLATES: Dict[str, str] = {'entity_list.html.j2': '<!--- entity_list.html.j2 — APG entity list page template --->\n{# Variables: entity_name, entity_type, fields, records, total, count, notice,\n              safe_entity, query, records_json #}\n<nav class="flex items-center gap-2 text-sm mb-6 pb-3 border-b border-gray-200 dark:border-gray-700">\n  <a href="/ui" class="text-apg-primary hover:underline">Application</a>\n  <span class="text-gray-400">/</span>\n  <span class="font-medium text-gray-900 dark:text-gray-100">{{ entity_name }}</span>\n  <span class="ml-auto">\n    <a href="/entities/{{ safe_entity }}/records"\n       class="text-xs text-gray-400 hover:text-apg-primary">JSON ↗</a>\n  </span>\n</nav>\n\n{% if notice %}\n<div role="alert"\n     class="mb-4 px-4 py-3 bg-yellow-50 border border-yellow-200 rounded text-sm text-yellow-800 dark:bg-yellow-900/20 dark:border-yellow-700 dark:text-yellow-300">\n  {{ notice }}\n</div>\n{% endif %}\n\n<div class="flex items-start gap-6 flex-col xl:flex-row">\n  {# Create record form #}\n  <div class="w-full xl:w-80 shrink-0">\n    <div class="apg-card">\n      <div class="apg-card-header">\n        <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">New {{ entity_name }}</h2>\n        <span class="apg-badge apg-badge-neutral">{{ entity_type }}</span>\n      </div>\n      <form method="post" action="/ui/entities/{{ safe_entity }}/records" class="space-y-3" novalidate>\n        {% for field in fields %}\n        <div class="apg-field">\n          <label for="field-{{ field.name }}"\n                 class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">\n            {{ field.name }}\n            {% if field.required %}<span class="text-red-500 ml-0.5" aria-hidden="true">*</span>{% endif %}\n          </label>\n          {% if field.type in (\'text\', \'string\', \'varchar\') %}\n          <textarea id="field-{{ field.name }}" name="{{ field.name }}" rows="2"\n                    class="block w-full px-2.5 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-apg-primary resize-none"\n                    {% if field.required %}required{% endif %}></textarea>\n          {% elif field.type in (\'int\', \'integer\', \'float\', \'number\', \'decimal\', \'money\') %}\n          <input type="number" id="field-{{ field.name }}" name="{{ field.name }}"\n                 class="block w-full px-2.5 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-apg-primary"\n                 {% if field.required %}required{% endif %}>\n          {% elif field.type in (\'bool\', \'boolean\') %}\n          <select id="field-{{ field.name }}" name="{{ field.name }}"\n                  class="block w-full px-2.5 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-apg-primary">\n            <option value="">—</option>\n            <option value="true">True</option>\n            <option value="false">False</option>\n          </select>\n          {% else %}\n          <input type="text" id="field-{{ field.name }}" name="{{ field.name }}"\n                 class="block w-full px-2.5 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-apg-primary"\n                 {% if field.required %}required{% endif %}>\n          {% endif %}\n        </div>\n        {% endfor %}\n        <button type="submit"\n                class="w-full px-3 py-2 bg-apg-primary text-white text-sm font-medium rounded hover:opacity-90 transition-opacity focus:outline-none focus:ring-2 focus:ring-apg-primary focus:ring-offset-2">\n          Create {{ entity_name }}\n        </button>\n      </form>\n    </div>\n  </div>\n\n  {# Records list #}\n  <div class="flex-1 min-w-0">\n    <div class="flex items-center justify-between mb-3">\n      <h1 class="text-lg font-semibold text-gray-900 dark:text-gray-100">\n        {{ entity_name }}\n        <span class="ml-2 text-xs font-normal text-gray-400">({{ total }} total)</span>\n      </h1>\n      <p class="text-xs text-gray-500">Showing {{ count }} of {{ total }}</p>\n    </div>\n\n    {{ records_table | safe }}\n\n    <details class="mt-4">\n      <summary class="text-xs text-gray-400 cursor-pointer hover:text-gray-600 dark:hover:text-gray-300 select-none py-1">\n        Raw JSON\n      </summary>\n      <pre class="mt-2 text-xs">{{ records_json }}</pre>\n    </details>\n  </div>\n</div>\n', 'app_index.html.j2': '<!--- app_index.html.j2 — APG application home page --->\n{# Variables: module_name, module_description, entities, capabilities, databases,\n              application_routes, ui_routes, agents, agent_teams #}\n<div class="mb-6">\n  <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ module_name }}</h1>\n  <p class="text-gray-500 mt-1">{{ module_description or \'Generated APG application\' }}</p>\n</div>\n\n{# Quick nav #}\n<nav class="flex flex-wrap gap-2 mb-8 text-sm" aria-label="API navigation">\n  {% for link in api_links %}\n  <a href="{{ link.url }}"\n     class="inline-flex items-center px-3 py-1.5 rounded border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-apg-primary transition-colors">\n    {{ link.label }}\n  </a>\n  {% endfor %}\n</nav>\n\n{# Stats row #}\n<div class="apg-grid-4 mb-8">\n  <div class="apg-card">\n    <div class="apg-stat">\n      <span class="apg-stat-value">{{ entities | length }}</span>\n      <span class="apg-stat-label">Entities</span>\n    </div>\n  </div>\n  <div class="apg-card">\n    <div class="apg-stat">\n      <span class="apg-stat-value">{{ capabilities | length }}</span>\n      <span class="apg-stat-label">Capabilities</span>\n    </div>\n  </div>\n  <div class="apg-card">\n    <div class="apg-stat">\n      <span class="apg-stat-value">{{ agents | length }}</span>\n      <span class="apg-stat-label">AI Agents</span>\n    </div>\n  </div>\n  <div class="apg-card">\n    <div class="apg-stat">\n      <span class="apg-stat-value">{{ ui_routes | length }}</span>\n      <span class="apg-stat-label">Screens</span>\n    </div>\n  </div>\n</div>\n\n<div class="apg-grid-2 gap-6">\n  {% if entities %}\n  <div class="apg-card">\n    <div class="apg-card-header">\n      <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Entities</h2>\n    </div>\n    <ul class="divide-y divide-gray-100 dark:divide-gray-700">\n      {% for entity in entities %}\n      <li class="py-2 flex items-center justify-between">\n        <a href="/ui/entities/{{ entity.name | urlencode }}"\n           class="text-sm text-apg-primary hover:underline font-medium">\n          {{ entity.name }}\n        </a>\n        <span class="apg-badge apg-badge-neutral">{{ entity.type }}</span>\n      </li>\n      {% endfor %}\n    </ul>\n  </div>\n  {% endif %}\n\n  {% if capabilities %}\n  <div class="apg-card">\n    <div class="apg-card-header">\n      <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Capabilities</h2>\n    </div>\n    <ul class="divide-y divide-gray-100 dark:divide-gray-700">\n      {% for cap in capabilities %}\n      <li class="py-2">\n        <a href="/ui/capabilities/{{ cap | urlencode }}"\n           class="text-sm text-apg-primary hover:underline font-medium">\n          {{ cap }}\n        </a>\n      </li>\n      {% endfor %}\n    </ul>\n  </div>\n  {% endif %}\n\n  {% if ui_routes %}\n  <div class="apg-card">\n    <div class="apg-card-header">\n      <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Application Screens</h2>\n    </div>\n    <ul class="divide-y divide-gray-100 dark:divide-gray-700">\n      {% for route, screen in ui_routes.items() %}\n      <li class="py-2 flex items-center justify-between">\n        <a href="{{ route }}" class="text-sm text-apg-primary hover:underline">{{ route }}</a>\n        <span class="text-xs text-gray-400">{{ screen.get(\'application\', \'\') }}</span>\n      </li>\n      {% endfor %}\n    </ul>\n  </div>\n  {% endif %}\n\n  {% if agents %}\n  <div class="apg-card">\n    <div class="apg-card-header">\n      <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">AI Agents</h2>\n    </div>\n    <ul class="divide-y divide-gray-100 dark:divide-gray-700">\n      {% for agent_name in agents %}\n      <li class="py-2">\n        <a href="/ui/agents/{{ agent_name | urlencode }}"\n           class="text-sm text-apg-primary hover:underline font-medium">\n          {{ agent_name }}\n        </a>\n      </li>\n      {% endfor %}\n    </ul>\n  </div>\n  {% endif %}\n</div>\n'}
