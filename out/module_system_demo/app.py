"""
InventoryManagement - APG Python Application
============================================
...
MODULE_NAME = 'InventoryManagement'
MODULE_VERSION = '2.1.0'
MODULE_DESCRIPTION = None
LANDING_STYLE = 'default'
ENTITIES = [{'name': 'InventoryDB', 'type': 'database', 'properties': ['products', 'categories', 'suppliers'], 'fields': [{'name': 'products', 'type': 'str', 'required': True, 'default': 'table {\n\t\tid: int [pk, increment];\n\t\tsku: str [unique, required, max_length=50, pattern=/^[A-Z0-9-]+$/];\n\t\tname: str [required, max_length=200, searchable];\n\t\tdescription: text [max_length=1000];\n\t\tcategory_id: int [fk="categories.id", required];\n\t\tsupplier_id: int [fk="suppliers.id"];\n\t\t\n\t\t\n\t\tcost_price: decimal [precision=10, scale=2, min_value=0];\n\t\tselling_price: decimal [precision=10, scale=2, min_value=0];\n\t\tmargin: decimal [computed] = (selling_price - cost_price) / cost_price * 100;\n\t\t\n\t\t\n\t\tstock_quantity: int [min_value=0, default=0];\n\t\treserved_quantity: int [min_value=0, default=0];\n\t\tavailable_quantity: int [computed] = stock_quantity - reserved_quantity;\n\t\treorder_point: int [min_value=0, default=10];\n\t\treorder_quantity: int [min_value=1, default=50];\n\t\t\n\t\t\n\t\tweight: decimal [precision=8, scale=3, unit="kg"];\n\t\tdimensions: json {\n\t\t\tlength: decimal [unit="cm"];\n\t\t\twidth: decimal [unit="cm"];\n\t\t\theight: decimal [unit="cm"];\n\t\t};\n\t\t\n\t\t\n\t\tstatus: enum ["active", "discontinued", "pending", "out_of_stock"];\n\t\tis_serialized: bool [default=false];\n\t\tis_perishable: bool [default=false];\n\t\texpiry_date: datetime?;\n\t\t\n\t\t\n\t\tcreated_at: datetime [default=now(), immutable];\n\t\tupdated_at: datetime [auto_update];\n\t\tcreated_by: int [fk="users.id"];\n\t\tupdated_by: int [fk="users.id"];\n\t\t\n\t\t\n\t\t@indexes: [\n\t\t\t{fields: ["sku"], type: "unique"},\n\t\t\t{fields: ["category_id", "status"], type: "composite"},\n\t\t\t{fields: ["supplier_id"], type: "standard"},\n\t\t\t{fields: ["name"], type: "fulltext"}\n\t\t];\n\t}'}, {'name': 'categories', 'type': 'str', 'required': True, 'default': 'table {\n\t\tid: int [pk, increment];\n\t\tname: str [required, max_length=100];\n\t\tparent_id: int? [fk="categories.id"];  \n\t\tdescription: text;\n\t\tis_active: bool [default=true];\n\t\tsort_order: int [default=0];\n\t\t\n\t\t\n\t\tpath: str [max_length=500, computed];  \n\t\tlevel: int [computed];  \n\t\t\n\t\tcreated_at: datetime [default=now()];\n\t\tupdated_at: datetime [auto_update];\n\t\t\n\t\t@indexes: [\n\t\t\t{fields: ["parent_id"], type: "standard"},\n\t\t\t{fields: ["path"], type: "standard"},\n\t\t\t{fields: ["is_active", "sort_order"], type: "composite"}\n\t\t];\n\t}'}, {'name': 'suppliers', 'type': 'str', 'required': True, 'default': 'table {\n\t\tid: int [pk, increment];\n\t\tcompany_name: str [required, max_length=200];\n\t\tcontact_person: str [max_length=100];\n\t\temail: str [email, max_length=255];\n\t\tphone: str [phone, max_length=20];\n\t\taddress: json {\n\t\t\tstreet: str;\n\t\t\tcity: str;\n\t\t\tstate: str;\n\t\t\tzip_code: str;\n\t\t\tcountry: str [default="US"];\n\t\t};\n\t\tpayment_terms: enum ["net_30", "net_60", "cash_on_delivery", "prepaid"];\n\t\tis_active: bool [default=true];\n\t\trating: decimal [precision=3, scale=2, range=1.0..5.0];\n\t\t\n\t\tcreated_at: datetime [default=now()];\n\t\tupdated_at: datetime [auto_update];\n\t\t\n\t\t@indexes: [\n\t\t\t{fields: ["company_name"], type: "standard"},\n\t\t\t{fields: ["is_active"], type: "standard"}\n\t\t];\n\t}'}], 'methods': [], 'connection_config': {'products': 'table {\n\t\tid: int [pk, increment];\n\t\tsku: str [unique, required, max_length=50, pattern=/^[A-Z0-9-]+$/];\n\t\tname: str [required, max_length=200, searchable];\n\t\tdescription: text [max_length=1000];\n\t\tcategory_id: int [fk="categories.id", required];\n\t\tsupplier_id: int [fk="suppliers.id"];\n\t\t\n\t\t\n\t\tcost_price: decimal [precision=10, scale=2, min_value=0];\n\t\tselling_price: decimal [precision=10, scale=2, min_value=0];\n\t\tmargin: decimal [computed] = (selling_price - cost_price) / cost_price * 100;\n\t\t\n\t\t\n\t\tstock_quantity: int [min_value=0, default=0];\n\t\treserved_quantity: int [min_value=0, default=0];\n\t\tavailable_quantity: int [computed] = stock_quantity - reserved_quantity;\n\t\treorder_point: int [min_value=0, default=10];\n\t\treorder_quantity: int [min_value=1, default=50];\n\t\t\n\t\t\n\t\tweight: decimal [precision=8, scale=3, unit="kg"];\n\t\tdimensions: json {\n\t\t\tlength: decimal [unit="cm"];\n\t\t\twidth: decimal [unit="cm"];\n\t\t\theight: decimal [unit="cm"];\n\t\t};\n\t\t\n\t\t\n\t\tstatus: enum ["active", "discontinued", "pending", "out_of_stock"];\n\t\tis_serialized: bool [default=false];\n\t\tis_perishable: bool [default=false];\n\t\texpiry_date: datetime?;\n\t\t\n\t\t\n\t\tcreated_at: datetime [default=now(), immutable];\n\t\tupdated_at: datetime [auto_update];\n\t\tcreated_by: int [fk="users.id"];\n\t\tupdated_by: int [fk="users.id"];\n\t\t\n\t\t\n\t\t@indexes: [\n\t\t\t{fields: ["sku"], type: "unique"},\n\t\t\t{fields: ["category_id", "status"], type: "composite"},\n\t\t\t{fields: ["supplier_id"], type: "standard"},\n\t\t\t{fields: ["name"], type: "fulltext"}\n\t\t];\n\t}', 'categories': 'table {\n\t\tid: int [pk, increment];\n\t\tname: str [required, max_length=100];\n\t\tparent_id: int? [fk="categories.id"];  \n\t\tdescription: text;\n\t\tis_active: bool [default=true];\n\t\tsort_order: int [default=0];\n\t\t\n\t\t\n\t\tpath: str [max_length=500, computed];  \n\t\tlevel: int [computed];  \n\t\t\n\t\tcreated_at: datetime [default=now()];\n\t\tupdated_at: datetime [auto_update];\n\t\t\n\t\t@indexes: [\n\t\t\t{fields: ["parent_id"], type: "standard"},\n\t\t\t{fields: ["path"], type: "standard"},\n\t\t\t{fields: ["is_active", "sort_order"], type: "composite"}\n\t\t];\n\t}', 'suppliers': 'table {\n\t\tid: int [pk, increment];\n\t\tcompany_name: str [required, max_length=200];\n\t\tcontact_person: str [max_length=100];\n\t\temail: str [email, max_length=255];\n\t\tphone: str [phone, max_length=20];\n\t\taddress: json {\n\t\t\tstreet: str;\n\t\t\tcity: str;\n\t\t\tstate: str;\n\t\t\tzip_code: str;\n\t\t\tcountry: str [default="US"];\n\t\t};\n\t\tpayment_terms: enum ["net_30", "net_60", "cash_on_delivery", "prepaid"];\n\t\tis_active: bool [default=true];\n\t\trating: decimal [precision=3, scale=2, range=1.0..5.0];\n\t\t\n\t\tcreated_at: datetime [default=now()];\n\t\tupdated_at: datetime [auto_update];\n\t\t\n\t\t@indexes: [\n\t\t\t{fields: ["company_name"], type: "standard"},\n\t\t\t{fields: ["is_active"], type: "standard"}\n\t\t];\n\t}'}, 'schemas': []}, {'name': 'InventoryTracking', 'type': 'entity', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ProductForm', 'type': 'form', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ProductManagementTests', 'type': 'entity', 'properties': [], 'fields': [], 'methods': []}, {'name': 'low_stock', 'type': 'entity', 'properties': ['condition', 'severity', 'email', 'slack', 'max_per_product', 'max_total', 'if_not_acknowledged_within', 'escalate_to', 'escalation_channel'], 'fields': [{'name': 'condition', 'type': 'int <', 'required': True, 'default': 'string'}, {'name': 'severity', 'type': 'int', 'required': True, 'default': '= 0 ? "critical" : "warning"'}, {'name': 'email', 'type': '["inventory@company.com"]', 'required': True}, {'name': 'slack', 'type': '["#inventory-alerts"]', 'required': True}, {'name': 'max_per_product', 'type': '1 per hour', 'required': True}, {'name': 'max_total', 'type': '50 per hour', 'required': True}, {'name': 'if_not_acknowledged_within', 'type': '2 hours', 'required': True}, {'name': 'escalate_to', 'type': '["operations@company.com"]', 'required': True}, {'name': 'escalation_channel', 'type': '["phone", "sms"]', 'required': True}], 'methods': []}, {'name': 'expiring_products', 'type': 'entity', 'properties': ['condition', 'severity', 'schedule', 'email', 'body_template'], 'fields': [{'name': 'condition', 'type': 'int && product.expiry_date <', 'required': True, 'default': 'now() + interval("7 days")'}, {'name': 'severity', 'type': '"warning"', 'required': True}, {'name': 'schedule', 'type': 'daily at "09:00"', 'required': True}, {'name': 'email', 'type': '["quality@company.com", "warehouse@company.com"]', 'required': True}, {'name': 'body_template', 'type': '"email/expiring_products.html"', 'required': True}], 'methods': []}, {'name': 'system_health', 'type': 'entity', 'properties': ['email', 'slack', 'pager', 'group_similar_alerts', 'time_window', 'max_group_size'], 'fields': [{'name': 'email', 'type': '["devops@company.com"]', 'required': True}, {'name': 'slack', 'type': '["#alerts"]', 'required': True}, {'name': 'pager', 'type': '["on-call-engineer"]', 'required': True}, {'name': 'group_similar_alerts', 'type': 'bool', 'required': True}, {'name': 'time_window', 'type': '5 minutes', 'required': True}, {'name': 'max_group_size', 'type': 'int', 'required': True}], 'methods': []}, {'name': 'InventoryLogger', 'type': 'entity', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': False, 'source_files': ['InventoryManagement.apg'], 'app': {'name': 'InventoryManagement', 'version': '2.1.0', 'description': None, 'entity_count': 8}, 'symbols': {'module.InventoryManagement': {'id': 'module.InventoryManagement', 'kind': 'module', 'name': 'InventoryManagement', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'database.InventoryDB': {'id': 'database.InventoryDB', 'kind': 'database', 'name': 'InventoryDB', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'entity.InventoryTracking': {'id': 'entity.InventoryTracking', 'kind': 'entity', 'name': 'InventoryTracking', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'form.ProductForm': {'id': 'form.ProductForm', 'kind': 'form', 'name': 'ProductForm', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'entity.ProductManagementTests': {'id': 'entity.ProductManagementTests', 'kind': 'entity', 'name': 'ProductManagementTests', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.low_stock': {'id': 'table.low_stock', 'kind': 'table', 'name': 'low_stock', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.low_stock.condition': {'id': 'field.low_stock.condition', 'kind': 'field', 'name': 'low_stock.condition', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.low_stock.severity': {'id': 'field.low_stock.severity', 'kind': 'field', 'name': 'low_stock.severity', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.low_stock.email': {'id': 'field.low_stock.email', 'kind': 'field', 'name': 'low_stock.email', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.low_stock.slack': {'id': 'field.low_stock.slack', 'kind': 'field', 'name': 'low_stock.slack', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.low_stock.max_per_product': {'id': 'field.low_stock.max_per_product', 'kind': 'field', 'name': 'low_stock.max_per_product', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.low_stock.max_total': {'id': 'field.low_stock.max_total', 'kind': 'field', 'name': 'low_stock.max_total', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.low_stock.if_not_acknowledged_within': {'id': 'field.low_stock.if_not_acknowledged_within', 'kind': 'field', 'name': 'low_stock.if_not_acknowledged_within', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.low_stock.escalate_to': {'id': 'field.low_stock.escalate_to', 'kind': 'field', 'name': 'low_stock.escalate_to', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.low_stock.escalation_channel': {'id': 'field.low_stock.escalation_channel', 'kind': 'field', 'name': 'low_stock.escalation_channel', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.expiring_products': {'id': 'table.expiring_products', 'kind': 'table', 'name': 'expiring_products', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.expiring_products.condition': {'id': 'field.expiring_products.condition', 'kind': 'field', 'name': 'expiring_products.condition', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.expiring_products.severity': {'id': 'field.expiring_products.severity', 'kind': 'field', 'name': 'expiring_products.severity', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.expiring_products.schedule': {'id': 'field.expiring_products.schedule', 'kind': 'field', 'name': 'expiring_products.schedule', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.expiring_products.email': {'id': 'field.expiring_products.email', 'kind': 'field', 'name': 'expiring_products.email', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.expiring_products.body_template': {'id': 'field.expiring_products.body_template', 'kind': 'field', 'name': 'expiring_products.body_template', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.system_health': {'id': 'table.system_health', 'kind': 'table', 'name': 'system_health', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.system_health.email': {'id': 'field.system_health.email', 'kind': 'field', 'name': 'system_health.email', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.system_health.slack': {'id': 'field.system_health.slack', 'kind': 'field', 'name': 'system_health.slack', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.system_health.pager': {'id': 'field.system_health.pager', 'kind': 'field', 'name': 'system_health.pager', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.system_health.group_similar_alerts': {'id': 'field.system_health.group_similar_alerts', 'kind': 'field', 'name': 'system_health.group_similar_alerts', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.system_health.time_window': {'id': 'field.system_health.time_window', 'kind': 'field', 'name': 'system_health.time_window', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.system_health.max_group_size': {'id': 'field.system_health.max_group_size', 'kind': 'field', 'name': 'system_health.max_group_size', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'entity.InventoryLogger': {'id': 'entity.InventoryLogger', 'kind': 'entity', 'name': 'InventoryLogger', 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'low_stock': {'name': 'low_stock', 'fields': {'condition': {'type': 'int <', 'required': True, 'relationship': {'target_table': 'int <', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'severity': {'type': 'int', 'required': True, 'relationship': None}, 'email': {'type': '["inventory@company.com"]', 'required': True, 'relationship': {'target_table': '["inventory@company.com"]', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'slack': {'type': '["#inventory-alerts"]', 'required': True, 'relationship': {'target_table': '["#inventory-alerts"]', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'max_per_product': {'type': '1 per hour', 'required': True, 'relationship': {'target_table': '1 per hour', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'max_total': {'type': '50 per hour', 'required': True, 'relationship': {'target_table': '50 per hour', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'if_not_acknowledged_within': {'type': '2 hours', 'required': True, 'relationship': {'target_table': '2 hours', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'escalate_to': {'type': '["operations@company.com"]', 'required': True, 'relationship': {'target_table': '["operations@company.com"]', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'escalation_channel': {'type': '["phone", "sms"]', 'required': True, 'relationship': {'target_table': '["phone", "sms"]', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'condition.id': {'chain': ['low_stock.condition', 'int <.id'], 'valid': True}, 'email.id': {'chain': ['low_stock.email', '["inventory@company.com"].id'], 'valid': True}, 'slack.id': {'chain': ['low_stock.slack', '["#inventory-alerts"].id'], 'valid': True}, 'max_per_product.id': {'chain': ['low_stock.max_per_product', '1 per hour.id'], 'valid': True}, 'max_total.id': {'chain': ['low_stock.max_total', '50 per hour.id'], 'valid': True}, 'if_not_acknowledged_within.id': {'chain': ['low_stock.if_not_acknowledged_within', '2 hours.id'], 'valid': True}, 'escalate_to.id': {'chain': ['low_stock.escalate_to', '["operations@company.com"].id'], 'valid': True}, 'escalation_channel.id': {'chain': ['low_stock.escalation_channel', '["phone", "sms"].id'], 'valid': True}}}, 'expiring_products': {'name': 'expiring_products', 'fields': {'condition': {'type': 'int && product.expiry_date <', 'required': True, 'relationship': {'target_table': 'int && product.expiry_date <', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'severity': {'type': '"warning"', 'required': True, 'relationship': {'target_table': '"warning"', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'schedule': {'type': 'daily at "09:00"', 'required': True, 'relationship': {'target_table': 'daily at "09:00"', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'email': {'type': '["quality@company.com", "warehouse@company.com"]', 'required': True, 'relationship': {'target_table': '["quality@company.com", "warehouse@company.com"]', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'body_template': {'type': '"email/expiring_products.html"', 'required': True, 'relationship': {'target_table': '"email/expiring_products.html"', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'condition.id': {'chain': ['expiring_products.condition', 'int && product.expiry_date <.id'], 'valid': True}, 'severity.id': {'chain': ['expiring_products.severity', '"warning".id'], 'valid': True}, 'schedule.id': {'chain': ['expiring_products.schedule', 'daily at "09:00".id'], 'valid': True}, 'email.id': {'chain': ['expiring_products.email', '["quality@company.com", "warehouse@company.com"].id'], 'valid': True}, 'body_template.id': {'chain': ['expiring_products.body_template', '"email/expiring_products.html".id'], 'valid': True}}}, 'system_health': {'name': 'system_health', 'fields': {'email': {'type': '["devops@company.com"]', 'required': True, 'relationship': {'target_table': '["devops@company.com"]', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'slack': {'type': '["#alerts"]', 'required': True, 'relationship': {'target_table': '["#alerts"]', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'pager': {'type': '["on-call-engineer"]', 'required': True, 'relationship': {'target_table': '["on-call-engineer"]', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'group_similar_alerts': {'type': 'bool', 'required': True, 'relationship': None}, 'time_window': {'type': '5 minutes', 'required': True, 'relationship': {'target_table': '5 minutes', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'max_group_size': {'type': 'int', 'required': True, 'relationship': None}}, 'lookup_paths': {'email.id': {'chain': ['system_health.email', '["devops@company.com"].id'], 'valid': True}, 'slack.id': {'chain': ['system_health.slack', '["#alerts"].id'], 'valid': True}, 'pager.id': {'chain': ['system_health.pager', '["on-call-engineer"].id'], 'valid': True}, 'time_window.id': {'chain': ['system_health.time_window', '5 minutes.id'], 'valid': True}}}}, 'views': {'ProductForm': {'name': 'ProductForm', 'type': 'form', 'properties': {}, 'methods': [], 'bindings': []}}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'InventoryManagement.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 30, 'edges': 23}, 'lookup': {'kind': 'lookup', 'nodes': 9, 'edges': 8}, 'workflow': {'kind': 'workflow', 'nodes': 9, 'edges': 8}, 'handler': {'kind': 'handler', 'nodes': 9, 'edges': 8}, 'capability': {'kind': 'capability', 'nodes': 0, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 9, 'edges': 8}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 9, 'edges': 8}, 'package': {'kind': 'package', 'nodes': 9, 'edges': 8}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Database 'InventoryDB' should have connection configuration", 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0401', 'title': 'Unknown view subject table', 'severity': 'error', 'message': "Form 'ProductForm' is backed by unknown table 'Product'.", 'file': 'InventoryManagement.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
