...
ENTITIES = [{'name': 'ThreatIntelligencePlatform', 'type': 'entity', 'properties': ['scrapy_framework', 'selenium_automation', 'tor_integration', 'rate_limiting', 'social_platforms', 'threat_feeds', 'search_engines', 'security_services', 'rss_feeds', 'email_monitoring', 'file_monitoring', 'network_monitoring', 'format_standardization', 'encoding_handling', 'language_detection', 'timestamp_normalization', 'entity_extraction', 'sentiment_analysis', 'topic_modeling', 'language_identification', 'malware_analysis', 'network_analysis', 'code_analysis', 'metadata_analysis', 'temporal_correlation', 'spatial_correlation', 'entity_correlation', 'behavioral_correlation', 'risk_scoring', 'attack_attribution', 'campaign_tracking', 'indicator_enrichment', 'threat_forecasting', 'attack_prediction', 'campaign_evolution', 'geopolitical_analysis', 'social_network_mapping', 'infrastructure_mapping', 'supply_chain_analysis', 'attack_surface_mapping', 'interactive_maps', 'network_graphs', 'timeline_analysis', 'threat_landscapes', 'real_time_monitoring'], 'fields': [{'name': 'scrapy_framework', 'type': 'distributed_crawling + proxy_rotation + user_agent_rotation', 'required': True}, {'name': 'selenium_automation', 'type': 'javascript_rendering + dynamic_content + captcha_solving', 'required': True}, {'name': 'tor_integration', 'type': 'anonymized_access + circuit_management + exit_node_selection', 'required': True}, {'name': 'rate_limiting', 'type': 'respectful_crawling + backoff_strategies + concurrent_limits', 'required': True}, {'name': 'social_platforms', 'type': 'twitter_api + facebook_graph + linkedin_api + instagram_basic', 'required': True}, {'name': 'threat_feeds', 'type': 'misp + taxii + stix + opencti + commercial_feeds', 'required': True}, {'name': 'search_engines', 'type': 'google_api + bing_api + yandex_api + baidu_api + duckduckgo', 'required': True}, {'name': 'security_services', 'type': 'virustotal_api + shodan_api + censys_api + urlvoid_api', 'required': True}, {'name': 'rss_feeds', 'type': 'automated_monitoring + content_extraction + deduplication', 'required': True}, {'name': 'email_monitoring', 'type': 'honeypot_emails + phishing_detection + malware_attachments', 'required': True}, {'name': 'file_monitoring', 'type': 'document_analysis + metadata_extraction + content_indexing', 'required': True}, {'name': 'network_monitoring', 'type': 'packet_capture + flow_analysis + dns_monitoring', 'required': True}, {'name': 'format_standardization', 'type': 'json + xml + csv + database_formats', 'required': True}, {'name': 'encoding_handling', 'type': 'utf8 + ascii + unicode + character_set_detection', 'required': True}, {'name': 'language_detection', 'type': 'automatic_language_identification + translation_services', 'required': True}, {'name': 'timestamp_normalization', 'type': 'timezone_conversion + format_standardization', 'required': True}, {'name': 'entity_extraction', 'type': 'named_entities + geolocation + organizations + persons', 'required': True}, {'name': 'sentiment_analysis', 'type': 'opinion_mining + emotion_detection + bias_analysis', 'required': True}, {'name': 'topic_modeling', 'type': 'lda + bert_embeddings + clustering + categorization', 'required': True}, {'name': 'language_identification', 'type': 'multilingual_support + dialect_detection', 'required': True}, {'name': 'malware_analysis', 'type': 'static_analysis + dynamic_analysis + behavioral_analysis', 'required': True}, {'name': 'network_analysis', 'type': 'packet_inspection + protocol_analysis + traffic_patterns', 'required': True}, {'name': 'code_analysis', 'type': 'vulnerability_detection + backdoor_identification + obfuscation_detection', 'required': True}, {'name': 'metadata_analysis', 'type': 'exif_data + document_properties + hidden_information', 'required': True}, {'name': 'temporal_correlation', 'type': 'time_series_analysis + event_sequencing + pattern_detection', 'required': True}, {'name': 'spatial_correlation', 'type': 'geospatial_analysis + location_clustering + movement_patterns', 'required': True}, {'name': 'entity_correlation', 'type': 'relationship_mapping + network_analysis + influence_scoring', 'required': True}, {'name': 'behavioral_correlation', 'type': 'activity_patterns + communication_analysis + habit_identification', 'required': True}, {'name': 'risk_scoring', 'type': 'cvss_scoring + custom_metrics + business_impact_assessment', 'required': True}, {'name': 'attack_attribution', 'type': 'ttps_mapping + infrastructure_analysis + behavioral_profiling', 'required': True}, {'name': 'campaign_tracking', 'type': 'multi_stage_attacks + persistent_threats + evolution_analysis', 'required': True}, {'name': 'indicator_enrichment', 'type': 'context_addition + reputation_scoring + confidence_assessment', 'required': True}, {'name': 'threat_forecasting', 'type': 'trend_analysis + seasonal_patterns + emerging_threats', 'required': True}, {'name': 'attack_prediction', 'type': 'vulnerability_exploitation_likelihood + target_probability', 'required': True}, {'name': 'campaign_evolution', 'type': 'attack_progression + technique_adaptation + countermeasure_evasion', 'required': True}, {'name': 'geopolitical_analysis', 'type': 'conflict_prediction + stability_assessment + influence_operations', 'required': True}, {'name': 'social_network_mapping', 'type': 'relationship_identification + influence_networks + communication_patterns', 'required': True}, {'name': 'infrastructure_mapping', 'type': 'c2_servers + hosting_providers + domain_clustering', 'required': True}, {'name': 'supply_chain_analysis', 'type': 'dependency_mapping + third_party_risks + vendor_assessment', 'required': True}, {'name': 'attack_surface_mapping', 'type': 'exposed_assets + vulnerability_chains + entry_points', 'required': True}, {'name': 'interactive_maps', 'type': 'geographic_threat_distribution + attack_origins + target_locations', 'required': True}, {'name': 'network_graphs', 'type': 'relationship_visualizations + influence_networks + communication_flows', 'required': True}, {'name': 'timeline_analysis', 'type': 'attack_chronology + campaign_evolution + incident_correlation', 'required': True}, {'name': 'threat_landscapes', 'type': 'sector_analysis + attack_vectors + vulnerability_distributions', 'required': True}, {'name': 'real_time_monitoring', 'type': 'live_threat_feeds + alert_dashboards + situational_awareness', 'required': True}], 'methods': []}, {'name': 'OSINTInvestigator', 'type': 'entity', 'properties': ['social_media_profiling', 'public_records', 'professional_networks', 'image_recognition', 'corporate_filings', 'financial_analysis', 'regulatory_compliance', 'competitive_intelligence', 'satellite_imagery', 'street_view_analysis', 'flight_tracking', 'maritime_tracking', 'multi_source_correlation', 'confidence_scoring', 'gap_analysis', 'timeline_reconstruction', 'source_validation', 'technical_verification', 'cross_validation', 'expert_validation'], 'fields': [{'name': 'social_media_profiling', 'type': 'cross_platform_correlation + behavioral_analysis + connection_mapping', 'required': True}, {'name': 'public_records', 'type': 'court_records + property_records + business_registrations + voter_rolls', 'required': True}, {'name': 'professional_networks', 'type': 'linkedin + industry_databases + academic_publications + patents', 'required': True}, {'name': 'image_recognition', 'type': 'reverse_image_search + facial_recognition + photo_metadata_analysis', 'required': True}, {'name': 'corporate_filings', 'type': 'sec_filings + annual_reports + regulatory_submissions + patent_applications', 'required': True}, {'name': 'financial_analysis', 'type': 'revenue_analysis + ownership_structure + subsidiary_mapping + credit_ratings', 'required': True}, {'name': 'regulatory_compliance', 'type': 'sanctions_lists + compliance_violations + regulatory_actions', 'required': True}, {'name': 'competitive_intelligence', 'type': 'market_position + strategic_partnerships + merger_activity', 'required': True}, {'name': 'satellite_imagery', 'type': 'historical_imagery + change_detection + facility_identification', 'required': True}, {'name': 'street_view_analysis', 'type': 'facility_assessment + security_evaluation + activity_monitoring', 'required': True}, {'name': 'flight_tracking', 'type': 'aircraft_registration + flight_patterns + ownership_analysis', 'required': True}, {'name': 'maritime_tracking', 'type': 'vessel_identification + shipping_routes + port_activities', 'required': True}, {'name': 'multi_source_correlation', 'type': 'cross_reference_validation + consistency_checking + conflict_resolution', 'required': True}, {'name': 'confidence_scoring', 'type': 'source_reliability + information_quality + verification_status', 'required': True}, {'name': 'gap_analysis', 'type': 'information_completeness + missing_data_identification + collection_priorities', 'required': True}, {'name': 'timeline_reconstruction', 'type': 'chronological_ordering + event_correlation + causality_analysis', 'required': True}, {'name': 'source_validation', 'type': 'credibility_assessment + bias_detection + fact_checking', 'required': True}, {'name': 'technical_verification', 'type': 'metadata_analysis + digital_signatures + blockchain_verification', 'required': True}, {'name': 'cross_validation', 'type': 'multiple_source_confirmation + triangulation + consistency_analysis', 'required': True}, {'name': 'expert_validation', 'type': 'subject_matter_expert_review + peer_verification + quality_assurance', 'required': True}], 'methods': []}, {'name': 'CyberThreatHunter', 'type': 'entity', 'properties': ['user_behavior', 'system_behavior', 'application_behavior', 'temporal_analysis', 'atomic_indicators', 'composite_indicators', 'contextual_indicators', 'predictive_indicators', 'kill_chain_mapping', 'lateral_movement', 'data_exfiltration', 'impact_assessment', 'automated_hunting', 'alert_triage', 'response_orchestration', 'threat_intelligence'], 'fields': [{'name': 'user_behavior', 'type': 'login_patterns + access_anomalies + privilege_usage + data_access', 'required': True}, {'name': 'system_behavior', 'type': 'process_patterns + network_communications + resource_utilization', 'required': True}, {'name': 'application_behavior', 'type': 'usage_patterns + error_rates + performance_metrics', 'required': True}, {'name': 'temporal_analysis', 'type': 'time_based_patterns + seasonal_variations + activity_clustering', 'required': True}, {'name': 'atomic_indicators', 'type': 'ip_addresses + domain_names + file_hashes + registry_keys', 'required': True}, {'name': 'composite_indicators', 'type': 'attack_patterns + behavioral_signatures + campaign_markers', 'required': True}, {'name': 'contextual_indicators', 'type': 'environmental_context + temporal_context + relational_context', 'required': True}, {'name': 'predictive_indicators', 'type': 'precursor_events + early_warning_signs + trend_analysis', 'required': True}, {'name': 'kill_chain_mapping', 'type': 'reconnaissance + weaponization + delivery + exploitation + installation + c2 + actions', 'required': True}, {'name': 'lateral_movement', 'type': 'network_traversal + privilege_escalation + persistence_establishment', 'required': True}, {'name': 'data_exfiltration', 'type': 'data_identification + collection + staging + transmission', 'required': True}, {'name': 'impact_assessment', 'type': 'system_compromise + data_loss + operational_disruption', 'required': True}, {'name': 'automated_hunting', 'type': 'playbook_execution + rule_based_hunting + scheduled_searches', 'required': True}, {'name': 'alert_triage', 'type': 'automated_classification + priority_scoring + false_positive_reduction', 'required': True}, {'name': 'response_orchestration', 'type': 'automated_containment + evidence_collection + stakeholder_notification', 'required': True}, {'name': 'threat_intelligence', 'type': 'automated_ioc_extraction + feed_integration + indicator_sharing', 'required': True}], 'methods': []}, {'name': 'FinancialIntelligence', 'type': 'entity', 'properties': ['entity_relationship_mapping', 'centrality_analysis', 'community_detection', 'temporal_network_analysis', 'structuring_detection', 'typology_matching', 'behavioral_anomalies', 'geographic_anomalies', 'customer_risk_scoring', 'transaction_risk_scoring', 'portfolio_risk_assessment', 'predictive_modeling', 'suspicious_activity_reports', 'currency_transaction_reports', 'regulatory_reporting', 'internal_reporting'], 'fields': [{'name': 'entity_relationship_mapping', 'type': 'ownership_networks + transaction_networks + communication_networks', 'required': True}, {'name': 'centrality_analysis', 'type': 'key_player_identification + influence_measurement + risk_propagation', 'required': True}, {'name': 'community_detection', 'type': 'cluster_identification + group_behavior + collective_risk', 'required': True}, {'name': 'temporal_network_analysis', 'type': 'relationship_evolution + transaction_timing + coordination_detection', 'required': True}, {'name': 'structuring_detection', 'type': 'smurfing + layering + integration + structuring_avoidance', 'required': True}, {'name': 'typology_matching', 'type': 'known_ml_typologies + emerging_patterns + sector_specific_risks', 'required': True}, {'name': 'behavioral_anomalies', 'type': 'deviation_from_normal + unusual_transactions + suspicious_timing', 'required': True}, {'name': 'geographic_anomalies', 'type': 'unusual_jurisdictions + sanctions_evasion + trade_mispricing', 'required': True}, {'name': 'customer_risk_scoring', 'type': 'static_factors + dynamic_behavior + external_intelligence', 'required': True}, {'name': 'transaction_risk_scoring', 'type': 'amount + frequency + counterparties + geographic + timing', 'required': True}, {'name': 'portfolio_risk_assessment', 'type': 'concentration_risk + correlated_exposures + systemic_risk', 'required': True}, {'name': 'predictive_modeling', 'type': 'early_warning_indicators + risk_forecasting + scenario_analysis', 'required': True}, {'name': 'suspicious_activity_reports', 'type': 'automated_sar_generation + narrative_creation + regulatory_submission', 'required': True}, {'name': 'currency_transaction_reports', 'type': 'threshold_monitoring + aggregation_rules + exemption_management', 'required': True}, {'name': 'regulatory_reporting', 'type': 'periodic_reports + ad_hoc_reporting + audit_trails + documentation', 'required': True}, {'name': 'internal_reporting', 'type': 'management_dashboards + risk_metrics + performance_indicators + trend_analysis', 'required': True}], 'methods': []}, {'name': 'DisinformationDetector', 'type': 'entity', 'properties': ['fact_checking', 'linguistic_analysis', 'semantic_analysis', 'narrative_analysis', 'image_forensics', 'video_forensics', 'audio_forensics', 'multimedia_correlation', 'user_behavior', 'network_behavior', 'platform_behavior', 'temporal_behavior', 'supervised_learning', 'unsupervised_learning', 'deep_learning', 'ensemble_methods', 'propagation_analysis', 'community_detection', 'centrality_analysis', 'temporal_graph_analysis', 'source_credibility', 'evidence_quality', 'logical_consistency', 'expert_validation'], 'fields': [{'name': 'fact_checking', 'type': 'claim_verification + source_validation + evidence_assessment', 'required': True}, {'name': 'linguistic_analysis', 'type': 'writing_style + vocabulary_analysis + sentiment_patterns', 'required': True}, {'name': 'semantic_analysis', 'type': 'meaning_extraction + context_understanding + logical_consistency', 'required': True}, {'name': 'narrative_analysis', 'type': 'story_structure + plot_coherence + character_consistency', 'required': True}, {'name': 'image_forensics', 'type': 'pixel_analysis + compression_artifacts + metadata_analysis + reverse_image_search', 'required': True}, {'name': 'video_forensics', 'type': 'temporal_consistency + lighting_analysis + facial_analysis + deepfake_detection', 'required': True}, {'name': 'audio_forensics', 'type': 'spectral_analysis + voice_comparison + synthesis_detection + background_noise', 'required': True}, {'name': 'multimedia_correlation', 'type': 'cross_media_consistency + synchronization_analysis + contextual_matching', 'required': True}, {'name': 'user_behavior', 'type': 'posting_patterns + engagement_metrics + network_interactions + account_history', 'required': True}, {'name': 'network_behavior', 'type': 'coordinated_activity + amplification_patterns + cascade_analysis + timing_analysis', 'required': True}, {'name': 'platform_behavior', 'type': 'cross_platform_coordination + migration_patterns + platform_specific_adaptations', 'required': True}, {'name': 'temporal_behavior', 'type': 'activity_timing + lifecycle_analysis + campaign_duration + decay_patterns', 'required': True}, {'name': 'supervised_learning', 'type': 'labeled_training_data + classification_models + performance_evaluation', 'required': True}, {'name': 'unsupervised_learning', 'type': 'anomaly_detection + clustering + pattern_discovery + outlier_identification', 'required': True}, {'name': 'deep_learning', 'type': 'neural_networks + transformer_models + attention_mechanisms + transfer_learning', 'required': True}, {'name': 'ensemble_methods', 'type': 'model_combination + voting_systems + confidence_aggregation + robustness_improvement', 'required': True}, {'name': 'propagation_analysis', 'type': 'information_diffusion + viral_spreading + influence_measurement + cascade_prediction', 'required': True}, {'name': 'community_detection', 'type': 'echo_chambers + filter_bubbles + polarization_analysis + group_dynamics', 'required': True}, {'name': 'centrality_analysis', 'type': 'key_influencers + bridge_nodes + bottlenecks + information_brokers', 'required': True}, {'name': 'temporal_graph_analysis', 'type': 'network_evolution + relationship_dynamics + activity_patterns + trend_analysis', 'required': True}, {'name': 'source_credibility', 'type': 'reputation_scoring + track_record + expertise_assessment + bias_evaluation', 'required': True}, {'name': 'evidence_quality', 'type': 'primary_sources + corroboration + documentation + chain_of_custody', 'required': True}, {'name': 'logical_consistency', 'type': 'internal_consistency + external_consistency + contradiction_detection + coherence_analysis', 'required': True}, {'name': 'expert_validation', 'type': 'fact_checker_networks + domain_experts + peer_review + consensus_building', 'required': True}], 'methods': []}, {'name': 'GeopoliticalAnalysis', 'type': 'entity', 'properties': ['traditional_media', 'digital_media', 'social_media', 'specialized_sources', 'government_communications', 'diplomatic_channels', 'regulatory_filings', 'international_organizations', 'academic_research', 'think_tanks', 'ngo_reports', 'commercial_intelligence', 'temporal_patterns', 'comparative_analysis', 'causal_analysis', 'scenario_planning', 'political_forecasting', 'economic_forecasting', 'conflict_prediction', 'social_forecasting'], 'fields': [{'name': 'traditional_media', 'type': 'newspapers + television + radio + magazines + wire_services', 'required': True}, {'name': 'digital_media', 'type': 'online_news + blogs + podcasts + video_platforms + streaming_services', 'required': True}, {'name': 'social_media', 'type': 'twitter + facebook + instagram + tiktok + linkedin + regional_platforms', 'required': True}, {'name': 'specialized_sources', 'type': 'trade_publications + academic_journals + think_tank_reports + government_publications', 'required': True}, {'name': 'government_communications', 'type': 'press_releases + speeches + policy_documents + legislative_proceedings', 'required': True}, {'name': 'diplomatic_channels', 'type': 'embassy_reports + consular_communications + international_agreements', 'required': True}, {'name': 'regulatory_filings', 'type': 'corporate_disclosures + trade_data + financial_reports + compliance_documents', 'required': True}, {'name': 'international_organizations', 'type': 'un_reports + world_bank + imf + regional_organizations', 'required': True}, {'name': 'academic_research', 'type': 'university_studies + research_institutions + policy_analysis + expert_opinions', 'required': True}, {'name': 'think_tanks', 'type': 'policy_recommendations + strategic_analysis + scenario_planning + expert_networks', 'required': True}, {'name': 'ngo_reports', 'type': 'human_rights + environmental + development + advocacy_organizations', 'required': True}, {'name': 'commercial_intelligence', 'type': 'market_research + industry_analysis + competitive_intelligence + economic_forecasting', 'required': True}, {'name': 'temporal_patterns', 'type': 'historical_trends + cyclical_patterns + seasonal_variations + long_term_trajectories', 'required': True}, {'name': 'comparative_analysis', 'type': 'cross_country_comparisons + regional_analysis + peer_benchmarking + best_practices', 'required': True}, {'name': 'causal_analysis', 'type': 'root_cause_identification + impact_assessment + unintended_consequences + feedback_loops', 'required': True}, {'name': 'scenario_planning', 'type': 'alternative_futures + contingency_planning + risk_assessment + opportunity_identification', 'required': True}, {'name': 'political_forecasting', 'type': 'election_prediction + policy_outcomes + stability_assessment + leadership_changes', 'required': True}, {'name': 'economic_forecasting', 'type': 'growth_projections + market_predictions + trade_flows + resource_prices', 'required': True}, {'name': 'conflict_prediction', 'type': 'early_warning_systems + escalation_dynamics + peace_processes + intervention_effectiveness', 'required': True}, {'name': 'social_forecasting', 'type': 'demographic_projections + migration_patterns + urbanization + social_change', 'required': True}], 'methods': []}, {'name': 'IntelligenceInfrastructure', 'type': 'entity', 'properties': ['perimeter_defense', 'network_segmentation', 'encrypted_communications', 'anonymization', 'encryption_at_rest', 'encryption_in_transit', 'access_control', 'data_loss_prevention', 'secure_development', 'infrastructure_security', 'incident_response', 'business_continuity', 'data_protection', 'security_standards', 'intelligence_standards', 'industry_standards'], 'fields': [{'name': 'perimeter_defense', 'type': 'firewalls + intrusion_detection + ddos_protection + traffic_analysis', 'required': True}, {'name': 'network_segmentation', 'type': 'vlan_isolation + micro_segmentation + zero_trust + access_control', 'required': True}, {'name': 'encrypted_communications', 'type': 'vpn_tunnels + tls_encryption + end_to_end_encryption + secure_messaging', 'required': True}, {'name': 'anonymization', 'type': 'tor_networks + proxy_chains + traffic_obfuscation + identity_protection', 'required': True}, {'name': 'encryption_at_rest', 'type': 'full_disk_encryption + database_encryption + file_encryption + key_management', 'required': True}, {'name': 'encryption_in_transit', 'type': 'network_encryption + api_encryption + message_encryption + certificate_management', 'required': True}, {'name': 'access_control', 'type': 'multi_factor_authentication + role_based_access + attribute_based_access + privileged_access_management', 'required': True}, {'name': 'data_loss_prevention', 'type': 'content_inspection + policy_enforcement + monitoring + incident_response', 'required': True}, {'name': 'secure_development', 'type': 'secure_coding + vulnerability_testing + code_review + dependency_management', 'required': True}, {'name': 'infrastructure_security', 'type': 'container_security + orchestration_security + cloud_security + compliance_monitoring', 'required': True}, {'name': 'incident_response', 'type': 'threat_detection + incident_classification + response_procedures + forensic_analysis', 'required': True}, {'name': 'business_continuity', 'type': 'backup_systems + disaster_recovery + failover_procedures + continuity_planning', 'required': True}, {'name': 'data_protection', 'type': 'gdpr + ccpa + hipaa + sox + pci_dss', 'required': True}, {'name': 'security_standards', 'type': 'iso27001 + nist_cybersecurity + cis_controls + owasp', 'required': True}, {'name': 'intelligence_standards', 'type': 'odni_ics + nato_standards + five_eyes + national_requirements', 'required': True}, {'name': 'industry_standards', 'type': 'financial_regulations + healthcare_compliance + government_standards + international_law', 'required': True}], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['main.apg'], 'app': {'name': 'main', 'version': '1.0.0', 'description': None, 'entity_count': 7}, 'symbols': {'module.main': {'id': 'module.main', 'kind': 'module', 'name': 'main', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.ThreatIntelligencePlatform': {'id': 'table.ThreatIntelligencePlatform', 'kind': 'table', 'name': 'ThreatIntelligencePlatform', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.scrapy_framework': {'id': 'field.ThreatIntelligencePlatform.scrapy_framework', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.scrapy_framework', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.selenium_automation': {'id': 'field.ThreatIntelligencePlatform.selenium_automation', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.selenium_automation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.tor_integration': {'id': 'field.ThreatIntelligencePlatform.tor_integration', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.tor_integration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.rate_limiting': {'id': 'field.ThreatIntelligencePlatform.rate_limiting', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.rate_limiting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.social_platforms': {'id': 'field.ThreatIntelligencePlatform.social_platforms', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.social_platforms', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.threat_feeds': {'id': 'field.ThreatIntelligencePlatform.threat_feeds', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.threat_feeds', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.search_engines': {'id': 'field.ThreatIntelligencePlatform.search_engines', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.search_engines', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.security_services': {'id': 'field.ThreatIntelligencePlatform.security_services', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.security_services', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.rss_feeds': {'id': 'field.ThreatIntelligencePlatform.rss_feeds', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.rss_feeds', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.email_monitoring': {'id': 'field.ThreatIntelligencePlatform.email_monitoring', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.email_monitoring', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.file_monitoring': {'id': 'field.ThreatIntelligencePlatform.file_monitoring', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.file_monitoring', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.network_monitoring': {'id': 'field.ThreatIntelligencePlatform.network_monitoring', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.network_monitoring', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.format_standardization': {'id': 'field.ThreatIntelligencePlatform.format_standardization', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.format_standardization', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.encoding_handling': {'id': 'field.ThreatIntelligencePlatform.encoding_handling', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.encoding_handling', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.language_detection': {'id': 'field.ThreatIntelligencePlatform.language_detection', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.language_detection', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.timestamp_normalization': {'id': 'field.ThreatIntelligencePlatform.timestamp_normalization', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.timestamp_normalization', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.entity_extraction': {'id': 'field.ThreatIntelligencePlatform.entity_extraction', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.entity_extraction', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.sentiment_analysis': {'id': 'field.ThreatIntelligencePlatform.sentiment_analysis', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.sentiment_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.topic_modeling': {'id': 'field.ThreatIntelligencePlatform.topic_modeling', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.topic_modeling', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.language_identification': {'id': 'field.ThreatIntelligencePlatform.language_identification', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.language_identification', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.malware_analysis': {'id': 'field.ThreatIntelligencePlatform.malware_analysis', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.malware_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.network_analysis': {'id': 'field.ThreatIntelligencePlatform.network_analysis', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.network_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.code_analysis': {'id': 'field.ThreatIntelligencePlatform.code_analysis', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.code_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.metadata_analysis': {'id': 'field.ThreatIntelligencePlatform.metadata_analysis', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.metadata_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.temporal_correlation': {'id': 'field.ThreatIntelligencePlatform.temporal_correlation', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.temporal_correlation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.spatial_correlation': {'id': 'field.ThreatIntelligencePlatform.spatial_correlation', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.spatial_correlation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.entity_correlation': {'id': 'field.ThreatIntelligencePlatform.entity_correlation', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.entity_correlation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.behavioral_correlation': {'id': 'field.ThreatIntelligencePlatform.behavioral_correlation', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.behavioral_correlation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.risk_scoring': {'id': 'field.ThreatIntelligencePlatform.risk_scoring', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.risk_scoring', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.attack_attribution': {'id': 'field.ThreatIntelligencePlatform.attack_attribution', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.attack_attribution', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.campaign_tracking': {'id': 'field.ThreatIntelligencePlatform.campaign_tracking', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.campaign_tracking', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.indicator_enrichment': {'id': 'field.ThreatIntelligencePlatform.indicator_enrichment', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.indicator_enrichment', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.threat_forecasting': {'id': 'field.ThreatIntelligencePlatform.threat_forecasting', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.threat_forecasting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.attack_prediction': {'id': 'field.ThreatIntelligencePlatform.attack_prediction', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.attack_prediction', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.campaign_evolution': {'id': 'field.ThreatIntelligencePlatform.campaign_evolution', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.campaign_evolution', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.geopolitical_analysis': {'id': 'field.ThreatIntelligencePlatform.geopolitical_analysis', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.geopolitical_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.social_network_mapping': {'id': 'field.ThreatIntelligencePlatform.social_network_mapping', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.social_network_mapping', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.infrastructure_mapping': {'id': 'field.ThreatIntelligencePlatform.infrastructure_mapping', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.infrastructure_mapping', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.supply_chain_analysis': {'id': 'field.ThreatIntelligencePlatform.supply_chain_analysis', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.supply_chain_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.attack_surface_mapping': {'id': 'field.ThreatIntelligencePlatform.attack_surface_mapping', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.attack_surface_mapping', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.interactive_maps': {'id': 'field.ThreatIntelligencePlatform.interactive_maps', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.interactive_maps', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.network_graphs': {'id': 'field.ThreatIntelligencePlatform.network_graphs', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.network_graphs', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.timeline_analysis': {'id': 'field.ThreatIntelligencePlatform.timeline_analysis', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.timeline_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.threat_landscapes': {'id': 'field.ThreatIntelligencePlatform.threat_landscapes', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.threat_landscapes', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ThreatIntelligencePlatform.real_time_monitoring': {'id': 'field.ThreatIntelligencePlatform.real_time_monitoring', 'kind': 'field', 'name': 'ThreatIntelligencePlatform.real_time_monitoring', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.OSINTInvestigator': {'id': 'table.OSINTInvestigator', 'kind': 'table', 'name': 'OSINTInvestigator', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.social_media_profiling': {'id': 'field.OSINTInvestigator.social_media_profiling', 'kind': 'field', 'name': 'OSINTInvestigator.social_media_profiling', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.public_records': {'id': 'field.OSINTInvestigator.public_records', 'kind': 'field', 'name': 'OSINTInvestigator.public_records', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.professional_networks': {'id': 'field.OSINTInvestigator.professional_networks', 'kind': 'field', 'name': 'OSINTInvestigator.professional_networks', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.image_recognition': {'id': 'field.OSINTInvestigator.image_recognition', 'kind': 'field', 'name': 'OSINTInvestigator.image_recognition', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.corporate_filings': {'id': 'field.OSINTInvestigator.corporate_filings', 'kind': 'field', 'name': 'OSINTInvestigator.corporate_filings', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.financial_analysis': {'id': 'field.OSINTInvestigator.financial_analysis', 'kind': 'field', 'name': 'OSINTInvestigator.financial_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.regulatory_compliance': {'id': 'field.OSINTInvestigator.regulatory_compliance', 'kind': 'field', 'name': 'OSINTInvestigator.regulatory_compliance', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.competitive_intelligence': {'id': 'field.OSINTInvestigator.competitive_intelligence', 'kind': 'field', 'name': 'OSINTInvestigator.competitive_intelligence', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.satellite_imagery': {'id': 'field.OSINTInvestigator.satellite_imagery', 'kind': 'field', 'name': 'OSINTInvestigator.satellite_imagery', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.street_view_analysis': {'id': 'field.OSINTInvestigator.street_view_analysis', 'kind': 'field', 'name': 'OSINTInvestigator.street_view_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.flight_tracking': {'id': 'field.OSINTInvestigator.flight_tracking', 'kind': 'field', 'name': 'OSINTInvestigator.flight_tracking', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.maritime_tracking': {'id': 'field.OSINTInvestigator.maritime_tracking', 'kind': 'field', 'name': 'OSINTInvestigator.maritime_tracking', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.multi_source_correlation': {'id': 'field.OSINTInvestigator.multi_source_correlation', 'kind': 'field', 'name': 'OSINTInvestigator.multi_source_correlation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.confidence_scoring': {'id': 'field.OSINTInvestigator.confidence_scoring', 'kind': 'field', 'name': 'OSINTInvestigator.confidence_scoring', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.gap_analysis': {'id': 'field.OSINTInvestigator.gap_analysis', 'kind': 'field', 'name': 'OSINTInvestigator.gap_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.timeline_reconstruction': {'id': 'field.OSINTInvestigator.timeline_reconstruction', 'kind': 'field', 'name': 'OSINTInvestigator.timeline_reconstruction', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.source_validation': {'id': 'field.OSINTInvestigator.source_validation', 'kind': 'field', 'name': 'OSINTInvestigator.source_validation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.technical_verification': {'id': 'field.OSINTInvestigator.technical_verification', 'kind': 'field', 'name': 'OSINTInvestigator.technical_verification', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.cross_validation': {'id': 'field.OSINTInvestigator.cross_validation', 'kind': 'field', 'name': 'OSINTInvestigator.cross_validation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.OSINTInvestigator.expert_validation': {'id': 'field.OSINTInvestigator.expert_validation', 'kind': 'field', 'name': 'OSINTInvestigator.expert_validation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.CyberThreatHunter': {'id': 'table.CyberThreatHunter', 'kind': 'table', 'name': 'CyberThreatHunter', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.user_behavior': {'id': 'field.CyberThreatHunter.user_behavior', 'kind': 'field', 'name': 'CyberThreatHunter.user_behavior', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.system_behavior': {'id': 'field.CyberThreatHunter.system_behavior', 'kind': 'field', 'name': 'CyberThreatHunter.system_behavior', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.application_behavior': {'id': 'field.CyberThreatHunter.application_behavior', 'kind': 'field', 'name': 'CyberThreatHunter.application_behavior', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.temporal_analysis': {'id': 'field.CyberThreatHunter.temporal_analysis', 'kind': 'field', 'name': 'CyberThreatHunter.temporal_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.atomic_indicators': {'id': 'field.CyberThreatHunter.atomic_indicators', 'kind': 'field', 'name': 'CyberThreatHunter.atomic_indicators', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.composite_indicators': {'id': 'field.CyberThreatHunter.composite_indicators', 'kind': 'field', 'name': 'CyberThreatHunter.composite_indicators', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.contextual_indicators': {'id': 'field.CyberThreatHunter.contextual_indicators', 'kind': 'field', 'name': 'CyberThreatHunter.contextual_indicators', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.predictive_indicators': {'id': 'field.CyberThreatHunter.predictive_indicators', 'kind': 'field', 'name': 'CyberThreatHunter.predictive_indicators', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.kill_chain_mapping': {'id': 'field.CyberThreatHunter.kill_chain_mapping', 'kind': 'field', 'name': 'CyberThreatHunter.kill_chain_mapping', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.lateral_movement': {'id': 'field.CyberThreatHunter.lateral_movement', 'kind': 'field', 'name': 'CyberThreatHunter.lateral_movement', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.data_exfiltration': {'id': 'field.CyberThreatHunter.data_exfiltration', 'kind': 'field', 'name': 'CyberThreatHunter.data_exfiltration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.impact_assessment': {'id': 'field.CyberThreatHunter.impact_assessment', 'kind': 'field', 'name': 'CyberThreatHunter.impact_assessment', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.automated_hunting': {'id': 'field.CyberThreatHunter.automated_hunting', 'kind': 'field', 'name': 'CyberThreatHunter.automated_hunting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.alert_triage': {'id': 'field.CyberThreatHunter.alert_triage', 'kind': 'field', 'name': 'CyberThreatHunter.alert_triage', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.response_orchestration': {'id': 'field.CyberThreatHunter.response_orchestration', 'kind': 'field', 'name': 'CyberThreatHunter.response_orchestration', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.CyberThreatHunter.threat_intelligence': {'id': 'field.CyberThreatHunter.threat_intelligence', 'kind': 'field', 'name': 'CyberThreatHunter.threat_intelligence', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.FinancialIntelligence': {'id': 'table.FinancialIntelligence', 'kind': 'table', 'name': 'FinancialIntelligence', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.entity_relationship_mapping': {'id': 'field.FinancialIntelligence.entity_relationship_mapping', 'kind': 'field', 'name': 'FinancialIntelligence.entity_relationship_mapping', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.centrality_analysis': {'id': 'field.FinancialIntelligence.centrality_analysis', 'kind': 'field', 'name': 'FinancialIntelligence.centrality_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.community_detection': {'id': 'field.FinancialIntelligence.community_detection', 'kind': 'field', 'name': 'FinancialIntelligence.community_detection', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.temporal_network_analysis': {'id': 'field.FinancialIntelligence.temporal_network_analysis', 'kind': 'field', 'name': 'FinancialIntelligence.temporal_network_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.structuring_detection': {'id': 'field.FinancialIntelligence.structuring_detection', 'kind': 'field', 'name': 'FinancialIntelligence.structuring_detection', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.typology_matching': {'id': 'field.FinancialIntelligence.typology_matching', 'kind': 'field', 'name': 'FinancialIntelligence.typology_matching', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.behavioral_anomalies': {'id': 'field.FinancialIntelligence.behavioral_anomalies', 'kind': 'field', 'name': 'FinancialIntelligence.behavioral_anomalies', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.geographic_anomalies': {'id': 'field.FinancialIntelligence.geographic_anomalies', 'kind': 'field', 'name': 'FinancialIntelligence.geographic_anomalies', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.customer_risk_scoring': {'id': 'field.FinancialIntelligence.customer_risk_scoring', 'kind': 'field', 'name': 'FinancialIntelligence.customer_risk_scoring', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.transaction_risk_scoring': {'id': 'field.FinancialIntelligence.transaction_risk_scoring', 'kind': 'field', 'name': 'FinancialIntelligence.transaction_risk_scoring', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.portfolio_risk_assessment': {'id': 'field.FinancialIntelligence.portfolio_risk_assessment', 'kind': 'field', 'name': 'FinancialIntelligence.portfolio_risk_assessment', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.predictive_modeling': {'id': 'field.FinancialIntelligence.predictive_modeling', 'kind': 'field', 'name': 'FinancialIntelligence.predictive_modeling', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.suspicious_activity_reports': {'id': 'field.FinancialIntelligence.suspicious_activity_reports', 'kind': 'field', 'name': 'FinancialIntelligence.suspicious_activity_reports', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.currency_transaction_reports': {'id': 'field.FinancialIntelligence.currency_transaction_reports', 'kind': 'field', 'name': 'FinancialIntelligence.currency_transaction_reports', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.regulatory_reporting': {'id': 'field.FinancialIntelligence.regulatory_reporting', 'kind': 'field', 'name': 'FinancialIntelligence.regulatory_reporting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.FinancialIntelligence.internal_reporting': {'id': 'field.FinancialIntelligence.internal_reporting', 'kind': 'field', 'name': 'FinancialIntelligence.internal_reporting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.DisinformationDetector': {'id': 'table.DisinformationDetector', 'kind': 'table', 'name': 'DisinformationDetector', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.fact_checking': {'id': 'field.DisinformationDetector.fact_checking', 'kind': 'field', 'name': 'DisinformationDetector.fact_checking', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.linguistic_analysis': {'id': 'field.DisinformationDetector.linguistic_analysis', 'kind': 'field', 'name': 'DisinformationDetector.linguistic_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.semantic_analysis': {'id': 'field.DisinformationDetector.semantic_analysis', 'kind': 'field', 'name': 'DisinformationDetector.semantic_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.narrative_analysis': {'id': 'field.DisinformationDetector.narrative_analysis', 'kind': 'field', 'name': 'DisinformationDetector.narrative_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.image_forensics': {'id': 'field.DisinformationDetector.image_forensics', 'kind': 'field', 'name': 'DisinformationDetector.image_forensics', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.video_forensics': {'id': 'field.DisinformationDetector.video_forensics', 'kind': 'field', 'name': 'DisinformationDetector.video_forensics', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.audio_forensics': {'id': 'field.DisinformationDetector.audio_forensics', 'kind': 'field', 'name': 'DisinformationDetector.audio_forensics', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.multimedia_correlation': {'id': 'field.DisinformationDetector.multimedia_correlation', 'kind': 'field', 'name': 'DisinformationDetector.multimedia_correlation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.user_behavior': {'id': 'field.DisinformationDetector.user_behavior', 'kind': 'field', 'name': 'DisinformationDetector.user_behavior', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.network_behavior': {'id': 'field.DisinformationDetector.network_behavior', 'kind': 'field', 'name': 'DisinformationDetector.network_behavior', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.platform_behavior': {'id': 'field.DisinformationDetector.platform_behavior', 'kind': 'field', 'name': 'DisinformationDetector.platform_behavior', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.temporal_behavior': {'id': 'field.DisinformationDetector.temporal_behavior', 'kind': 'field', 'name': 'DisinformationDetector.temporal_behavior', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.supervised_learning': {'id': 'field.DisinformationDetector.supervised_learning', 'kind': 'field', 'name': 'DisinformationDetector.supervised_learning', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.unsupervised_learning': {'id': 'field.DisinformationDetector.unsupervised_learning', 'kind': 'field', 'name': 'DisinformationDetector.unsupervised_learning', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.deep_learning': {'id': 'field.DisinformationDetector.deep_learning', 'kind': 'field', 'name': 'DisinformationDetector.deep_learning', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.ensemble_methods': {'id': 'field.DisinformationDetector.ensemble_methods', 'kind': 'field', 'name': 'DisinformationDetector.ensemble_methods', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.propagation_analysis': {'id': 'field.DisinformationDetector.propagation_analysis', 'kind': 'field', 'name': 'DisinformationDetector.propagation_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.community_detection': {'id': 'field.DisinformationDetector.community_detection', 'kind': 'field', 'name': 'DisinformationDetector.community_detection', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.centrality_analysis': {'id': 'field.DisinformationDetector.centrality_analysis', 'kind': 'field', 'name': 'DisinformationDetector.centrality_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.temporal_graph_analysis': {'id': 'field.DisinformationDetector.temporal_graph_analysis', 'kind': 'field', 'name': 'DisinformationDetector.temporal_graph_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.source_credibility': {'id': 'field.DisinformationDetector.source_credibility', 'kind': 'field', 'name': 'DisinformationDetector.source_credibility', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.evidence_quality': {'id': 'field.DisinformationDetector.evidence_quality', 'kind': 'field', 'name': 'DisinformationDetector.evidence_quality', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.logical_consistency': {'id': 'field.DisinformationDetector.logical_consistency', 'kind': 'field', 'name': 'DisinformationDetector.logical_consistency', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.DisinformationDetector.expert_validation': {'id': 'field.DisinformationDetector.expert_validation', 'kind': 'field', 'name': 'DisinformationDetector.expert_validation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.GeopoliticalAnalysis': {'id': 'table.GeopoliticalAnalysis', 'kind': 'table', 'name': 'GeopoliticalAnalysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.traditional_media': {'id': 'field.GeopoliticalAnalysis.traditional_media', 'kind': 'field', 'name': 'GeopoliticalAnalysis.traditional_media', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.digital_media': {'id': 'field.GeopoliticalAnalysis.digital_media', 'kind': 'field', 'name': 'GeopoliticalAnalysis.digital_media', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.social_media': {'id': 'field.GeopoliticalAnalysis.social_media', 'kind': 'field', 'name': 'GeopoliticalAnalysis.social_media', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.specialized_sources': {'id': 'field.GeopoliticalAnalysis.specialized_sources', 'kind': 'field', 'name': 'GeopoliticalAnalysis.specialized_sources', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.government_communications': {'id': 'field.GeopoliticalAnalysis.government_communications', 'kind': 'field', 'name': 'GeopoliticalAnalysis.government_communications', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.diplomatic_channels': {'id': 'field.GeopoliticalAnalysis.diplomatic_channels', 'kind': 'field', 'name': 'GeopoliticalAnalysis.diplomatic_channels', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.regulatory_filings': {'id': 'field.GeopoliticalAnalysis.regulatory_filings', 'kind': 'field', 'name': 'GeopoliticalAnalysis.regulatory_filings', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.international_organizations': {'id': 'field.GeopoliticalAnalysis.international_organizations', 'kind': 'field', 'name': 'GeopoliticalAnalysis.international_organizations', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.academic_research': {'id': 'field.GeopoliticalAnalysis.academic_research', 'kind': 'field', 'name': 'GeopoliticalAnalysis.academic_research', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.think_tanks': {'id': 'field.GeopoliticalAnalysis.think_tanks', 'kind': 'field', 'name': 'GeopoliticalAnalysis.think_tanks', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.ngo_reports': {'id': 'field.GeopoliticalAnalysis.ngo_reports', 'kind': 'field', 'name': 'GeopoliticalAnalysis.ngo_reports', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.commercial_intelligence': {'id': 'field.GeopoliticalAnalysis.commercial_intelligence', 'kind': 'field', 'name': 'GeopoliticalAnalysis.commercial_intelligence', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.temporal_patterns': {'id': 'field.GeopoliticalAnalysis.temporal_patterns', 'kind': 'field', 'name': 'GeopoliticalAnalysis.temporal_patterns', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.comparative_analysis': {'id': 'field.GeopoliticalAnalysis.comparative_analysis', 'kind': 'field', 'name': 'GeopoliticalAnalysis.comparative_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.causal_analysis': {'id': 'field.GeopoliticalAnalysis.causal_analysis', 'kind': 'field', 'name': 'GeopoliticalAnalysis.causal_analysis', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.scenario_planning': {'id': 'field.GeopoliticalAnalysis.scenario_planning', 'kind': 'field', 'name': 'GeopoliticalAnalysis.scenario_planning', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.political_forecasting': {'id': 'field.GeopoliticalAnalysis.political_forecasting', 'kind': 'field', 'name': 'GeopoliticalAnalysis.political_forecasting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.economic_forecasting': {'id': 'field.GeopoliticalAnalysis.economic_forecasting', 'kind': 'field', 'name': 'GeopoliticalAnalysis.economic_forecasting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.conflict_prediction': {'id': 'field.GeopoliticalAnalysis.conflict_prediction', 'kind': 'field', 'name': 'GeopoliticalAnalysis.conflict_prediction', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.GeopoliticalAnalysis.social_forecasting': {'id': 'field.GeopoliticalAnalysis.social_forecasting', 'kind': 'field', 'name': 'GeopoliticalAnalysis.social_forecasting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.IntelligenceInfrastructure': {'id': 'table.IntelligenceInfrastructure', 'kind': 'table', 'name': 'IntelligenceInfrastructure', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.perimeter_defense': {'id': 'field.IntelligenceInfrastructure.perimeter_defense', 'kind': 'field', 'name': 'IntelligenceInfrastructure.perimeter_defense', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.network_segmentation': {'id': 'field.IntelligenceInfrastructure.network_segmentation', 'kind': 'field', 'name': 'IntelligenceInfrastructure.network_segmentation', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.encrypted_communications': {'id': 'field.IntelligenceInfrastructure.encrypted_communications', 'kind': 'field', 'name': 'IntelligenceInfrastructure.encrypted_communications', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.anonymization': {'id': 'field.IntelligenceInfrastructure.anonymization', 'kind': 'field', 'name': 'IntelligenceInfrastructure.anonymization', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.encryption_at_rest': {'id': 'field.IntelligenceInfrastructure.encryption_at_rest', 'kind': 'field', 'name': 'IntelligenceInfrastructure.encryption_at_rest', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.encryption_in_transit': {'id': 'field.IntelligenceInfrastructure.encryption_in_transit', 'kind': 'field', 'name': 'IntelligenceInfrastructure.encryption_in_transit', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.access_control': {'id': 'field.IntelligenceInfrastructure.access_control', 'kind': 'field', 'name': 'IntelligenceInfrastructure.access_control', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.data_loss_prevention': {'id': 'field.IntelligenceInfrastructure.data_loss_prevention', 'kind': 'field', 'name': 'IntelligenceInfrastructure.data_loss_prevention', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.secure_development': {'id': 'field.IntelligenceInfrastructure.secure_development', 'kind': 'field', 'name': 'IntelligenceInfrastructure.secure_development', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.infrastructure_security': {'id': 'field.IntelligenceInfrastructure.infrastructure_security', 'kind': 'field', 'name': 'IntelligenceInfrastructure.infrastructure_security', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.incident_response': {'id': 'field.IntelligenceInfrastructure.incident_response', 'kind': 'field', 'name': 'IntelligenceInfrastructure.incident_response', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.business_continuity': {'id': 'field.IntelligenceInfrastructure.business_continuity', 'kind': 'field', 'name': 'IntelligenceInfrastructure.business_continuity', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.data_protection': {'id': 'field.IntelligenceInfrastructure.data_protection', 'kind': 'field', 'name': 'IntelligenceInfrastructure.data_protection', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.security_standards': {'id': 'field.IntelligenceInfrastructure.security_standards', 'kind': 'field', 'name': 'IntelligenceInfrastructure.security_standards', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.intelligence_standards': {'id': 'field.IntelligenceInfrastructure.intelligence_standards', 'kind': 'field', 'name': 'IntelligenceInfrastructure.intelligence_standards', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.IntelligenceInfrastructure.industry_standards': {'id': 'field.IntelligenceInfrastructure.industry_standards', 'kind': 'field', 'name': 'IntelligenceInfrastructure.industry_standards', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'ThreatIntelligencePlatform': {'name': 'ThreatIntelligencePlatform', 'fields': {'scrapy_framework': {'type': 'distributed_crawling + proxy_rotation + user_agent_rotation', 'required': True, 'relationship': {'target_table': 'distributed_crawling + proxy_rotation + user_agent_rotation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'selenium_automation': {'type': 'javascript_rendering + dynamic_content + captcha_solving', 'required': True, 'relationship': {'target_table': 'javascript_rendering + dynamic_content + captcha_solving', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'tor_integration': {'type': 'anonymized_access + circuit_management + exit_node_selection', 'required': True, 'relationship': {'target_table': 'anonymized_access + circuit_management + exit_node_selection', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'rate_limiting': {'type': 'respectful_crawling + backoff_strategies + concurrent_limits', 'required': True, 'relationship': {'target_table': 'respectful_crawling + backoff_strategies + concurrent_limits', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'social_platforms': {'type': 'twitter_api + facebook_graph + linkedin_api + instagram_basic', 'required': True, 'relationship': {'target_table': 'twitter_api + facebook_graph + linkedin_api + instagram_basic', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'threat_feeds': {'type': 'misp + taxii + stix + opencti + commercial_feeds', 'required': True, 'relationship': {'target_table': 'misp + taxii + stix + opencti + commercial_feeds', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'search_engines': {'type': 'google_api + bing_api + yandex_api + baidu_api + duckduckgo', 'required': True, 'relationship': {'target_table': 'google_api + bing_api + yandex_api + baidu_api + duckduckgo', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'security_services': {'type': 'virustotal_api + shodan_api + censys_api + urlvoid_api', 'required': True, 'relationship': {'target_table': 'virustotal_api + shodan_api + censys_api + urlvoid_api', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'rss_feeds': {'type': 'automated_monitoring + content_extraction + deduplication', 'required': True, 'relationship': {'target_table': 'automated_monitoring + content_extraction + deduplication', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'email_monitoring': {'type': 'honeypot_emails + phishing_detection + malware_attachments', 'required': True, 'relationship': {'target_table': 'honeypot_emails + phishing_detection + malware_attachments', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'file_monitoring': {'type': 'document_analysis + metadata_extraction + content_indexing', 'required': True, 'relationship': {'target_table': 'document_analysis + metadata_extraction + content_indexing', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'network_monitoring': {'type': 'packet_capture + flow_analysis + dns_monitoring', 'required': True, 'relationship': {'target_table': 'packet_capture + flow_analysis + dns_monitoring', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'format_standardization': {'type': 'json + xml + csv + database_formats', 'required': True, 'relationship': {'target_table': 'json + xml + csv + database_formats', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'encoding_handling': {'type': 'utf8 + ascii + unicode + character_set_detection', 'required': True, 'relationship': {'target_table': 'utf8 + ascii + unicode + character_set_detection', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'language_detection': {'type': 'automatic_language_identification + translation_services', 'required': True, 'relationship': {'target_table': 'automatic_language_identification + translation_services', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'timestamp_normalization': {'type': 'timezone_conversion + format_standardization', 'required': True, 'relationship': {'target_table': 'timezone_conversion + format_standardization', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'entity_extraction': {'type': 'named_entities + geolocation + organizations + persons', 'required': True, 'relationship': {'target_table': 'named_entities + geolocation + organizations + persons', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'sentiment_analysis': {'type': 'opinion_mining + emotion_detection + bias_analysis', 'required': True, 'relationship': {'target_table': 'opinion_mining + emotion_detection + bias_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'topic_modeling': {'type': 'lda + bert_embeddings + clustering + categorization', 'required': True, 'relationship': {'target_table': 'lda + bert_embeddings + clustering + categorization', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'language_identification': {'type': 'multilingual_support + dialect_detection', 'required': True, 'relationship': {'target_table': 'multilingual_support + dialect_detection', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'malware_analysis': {'type': 'static_analysis + dynamic_analysis + behavioral_analysis', 'required': True, 'relationship': {'target_table': 'static_analysis + dynamic_analysis + behavioral_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'network_analysis': {'type': 'packet_inspection + protocol_analysis + traffic_patterns', 'required': True, 'relationship': {'target_table': 'packet_inspection + protocol_analysis + traffic_patterns', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'code_analysis': {'type': 'vulnerability_detection + backdoor_identification + obfuscation_detection', 'required': True, 'relationship': {'target_table': 'vulnerability_detection + backdoor_identification + obfuscation_detection', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'metadata_analysis': {'type': 'exif_data + document_properties + hidden_information', 'required': True, 'relationship': {'target_table': 'exif_data + document_properties + hidden_information', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'temporal_correlation': {'type': 'time_series_analysis + event_sequencing + pattern_detection', 'required': True, 'relationship': {'target_table': 'time_series_analysis + event_sequencing + pattern_detection', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'spatial_correlation': {'type': 'geospatial_analysis + location_clustering + movement_patterns', 'required': True, 'relationship': {'target_table': 'geospatial_analysis + location_clustering + movement_patterns', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'entity_correlation': {'type': 'relationship_mapping + network_analysis + influence_scoring', 'required': True, 'relationship': {'target_table': 'relationship_mapping + network_analysis + influence_scoring', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'behavioral_correlation': {'type': 'activity_patterns + communication_analysis + habit_identification', 'required': True, 'relationship': {'target_table': 'activity_patterns + communication_analysis + habit_identification', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'risk_scoring': {'type': 'cvss_scoring + custom_metrics + business_impact_assessment', 'required': True, 'relationship': {'target_table': 'cvss_scoring + custom_metrics + business_impact_assessment', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'attack_attribution': {'type': 'ttps_mapping + infrastructure_analysis + behavioral_profiling', 'required': True, 'relationship': {'target_table': 'ttps_mapping + infrastructure_analysis + behavioral_profiling', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'campaign_tracking': {'type': 'multi_stage_attacks + persistent_threats + evolution_analysis', 'required': True, 'relationship': {'target_table': 'multi_stage_attacks + persistent_threats + evolution_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'indicator_enrichment': {'type': 'context_addition + reputation_scoring + confidence_assessment', 'required': True, 'relationship': {'target_table': 'context_addition + reputation_scoring + confidence_assessment', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'threat_forecasting': {'type': 'trend_analysis + seasonal_patterns + emerging_threats', 'required': True, 'relationship': {'target_table': 'trend_analysis + seasonal_patterns + emerging_threats', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'attack_prediction': {'type': 'vulnerability_exploitation_likelihood + target_probability', 'required': True, 'relationship': {'target_table': 'vulnerability_exploitation_likelihood + target_probability', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'campaign_evolution': {'type': 'attack_progression + technique_adaptation + countermeasure_evasion', 'required': True, 'relationship': {'target_table': 'attack_progression + technique_adaptation + countermeasure_evasion', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'geopolitical_analysis': {'type': 'conflict_prediction + stability_assessment + influence_operations', 'required': True, 'relationship': {'target_table': 'conflict_prediction + stability_assessment + influence_operations', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'social_network_mapping': {'type': 'relationship_identification + influence_networks + communication_patterns', 'required': True, 'relationship': {'target_table': 'relationship_identification + influence_networks + communication_patterns', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'infrastructure_mapping': {'type': 'c2_servers + hosting_providers + domain_clustering', 'required': True, 'relationship': {'target_table': 'c2_servers + hosting_providers + domain_clustering', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'supply_chain_analysis': {'type': 'dependency_mapping + third_party_risks + vendor_assessment', 'required': True, 'relationship': {'target_table': 'dependency_mapping + third_party_risks + vendor_assessment', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'attack_surface_mapping': {'type': 'exposed_assets + vulnerability_chains + entry_points', 'required': True, 'relationship': {'target_table': 'exposed_assets + vulnerability_chains + entry_points', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'interactive_maps': {'type': 'geographic_threat_distribution + attack_origins + target_locations', 'required': True, 'relationship': {'target_table': 'geographic_threat_distribution + attack_origins + target_locations', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'network_graphs': {'type': 'relationship_visualizations + influence_networks + communication_flows', 'required': True, 'relationship': {'target_table': 'relationship_visualizations + influence_networks + communication_flows', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'timeline_analysis': {'type': 'attack_chronology + campaign_evolution + incident_correlation', 'required': True, 'relationship': {'target_table': 'attack_chronology + campaign_evolution + incident_correlation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'threat_landscapes': {'type': 'sector_analysis + attack_vectors + vulnerability_distributions', 'required': True, 'relationship': {'target_table': 'sector_analysis + attack_vectors + vulnerability_distributions', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'real_time_monitoring': {'type': 'live_threat_feeds + alert_dashboards + situational_awareness', 'required': True, 'relationship': {'target_table': 'live_threat_feeds + alert_dashboards + situational_awareness', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'scrapy_framework.id': {'chain': ['ThreatIntelligencePlatform.scrapy_framework', 'distributed_crawling + proxy_rotation + user_agent_rotation.id'], 'valid': True}, 'selenium_automation.id': {'chain': ['ThreatIntelligencePlatform.selenium_automation', 'javascript_rendering + dynamic_content + captcha_solving.id'], 'valid': True}, 'tor_integration.id': {'chain': ['ThreatIntelligencePlatform.tor_integration', 'anonymized_access + circuit_management + exit_node_selection.id'], 'valid': True}, 'rate_limiting.id': {'chain': ['ThreatIntelligencePlatform.rate_limiting', 'respectful_crawling + backoff_strategies + concurrent_limits.id'], 'valid': True}, 'social_platforms.id': {'chain': ['ThreatIntelligencePlatform.social_platforms', 'twitter_api + facebook_graph + linkedin_api + instagram_basic.id'], 'valid': True}, 'threat_feeds.id': {'chain': ['ThreatIntelligencePlatform.threat_feeds', 'misp + taxii + stix + opencti + commercial_feeds.id'], 'valid': True}, 'search_engines.id': {'chain': ['ThreatIntelligencePlatform.search_engines', 'google_api + bing_api + yandex_api + baidu_api + duckduckgo.id'], 'valid': True}, 'security_services.id': {'chain': ['ThreatIntelligencePlatform.security_services', 'virustotal_api + shodan_api + censys_api + urlvoid_api.id'], 'valid': True}, 'rss_feeds.id': {'chain': ['ThreatIntelligencePlatform.rss_feeds', 'automated_monitoring + content_extraction + deduplication.id'], 'valid': True}, 'email_monitoring.id': {'chain': ['ThreatIntelligencePlatform.email_monitoring', 'honeypot_emails + phishing_detection + malware_attachments.id'], 'valid': True}, 'file_monitoring.id': {'chain': ['ThreatIntelligencePlatform.file_monitoring', 'document_analysis + metadata_extraction + content_indexing.id'], 'valid': True}, 'network_monitoring.id': {'chain': ['ThreatIntelligencePlatform.network_monitoring', 'packet_capture + flow_analysis + dns_monitoring.id'], 'valid': True}, 'format_standardization.id': {'chain': ['ThreatIntelligencePlatform.format_standardization', 'json + xml + csv + database_formats.id'], 'valid': True}, 'encoding_handling.id': {'chain': ['ThreatIntelligencePlatform.encoding_handling', 'utf8 + ascii + unicode + character_set_detection.id'], 'valid': True}, 'language_detection.id': {'chain': ['ThreatIntelligencePlatform.language_detection', 'automatic_language_identification + translation_services.id'], 'valid': True}, 'timestamp_normalization.id': {'chain': ['ThreatIntelligencePlatform.timestamp_normalization', 'timezone_conversion + format_standardization.id'], 'valid': True}, 'entity_extraction.id': {'chain': ['ThreatIntelligencePlatform.entity_extraction', 'named_entities + geolocation + organizations + persons.id'], 'valid': True}, 'sentiment_analysis.id': {'chain': ['ThreatIntelligencePlatform.sentiment_analysis', 'opinion_mining + emotion_detection + bias_analysis.id'], 'valid': True}, 'topic_modeling.id': {'chain': ['ThreatIntelligencePlatform.topic_modeling', 'lda + bert_embeddings + clustering + categorization.id'], 'valid': True}, 'language_identification.id': {'chain': ['ThreatIntelligencePlatform.language_identification', 'multilingual_support + dialect_detection.id'], 'valid': True}, 'malware_analysis.id': {'chain': ['ThreatIntelligencePlatform.malware_analysis', 'static_analysis + dynamic_analysis + behavioral_analysis.id'], 'valid': True}, 'network_analysis.id': {'chain': ['ThreatIntelligencePlatform.network_analysis', 'packet_inspection + protocol_analysis + traffic_patterns.id'], 'valid': True}, 'code_analysis.id': {'chain': ['ThreatIntelligencePlatform.code_analysis', 'vulnerability_detection + backdoor_identification + obfuscation_detection.id'], 'valid': True}, 'metadata_analysis.id': {'chain': ['ThreatIntelligencePlatform.metadata_analysis', 'exif_data + document_properties + hidden_information.id'], 'valid': True}, 'temporal_correlation.id': {'chain': ['ThreatIntelligencePlatform.temporal_correlation', 'time_series_analysis + event_sequencing + pattern_detection.id'], 'valid': True}, 'spatial_correlation.id': {'chain': ['ThreatIntelligencePlatform.spatial_correlation', 'geospatial_analysis + location_clustering + movement_patterns.id'], 'valid': True}, 'entity_correlation.id': {'chain': ['ThreatIntelligencePlatform.entity_correlation', 'relationship_mapping + network_analysis + influence_scoring.id'], 'valid': True}, 'behavioral_correlation.id': {'chain': ['ThreatIntelligencePlatform.behavioral_correlation', 'activity_patterns + communication_analysis + habit_identification.id'], 'valid': True}, 'risk_scoring.id': {'chain': ['ThreatIntelligencePlatform.risk_scoring', 'cvss_scoring + custom_metrics + business_impact_assessment.id'], 'valid': True}, 'attack_attribution.id': {'chain': ['ThreatIntelligencePlatform.attack_attribution', 'ttps_mapping + infrastructure_analysis + behavioral_profiling.id'], 'valid': True}, 'campaign_tracking.id': {'chain': ['ThreatIntelligencePlatform.campaign_tracking', 'multi_stage_attacks + persistent_threats + evolution_analysis.id'], 'valid': True}, 'indicator_enrichment.id': {'chain': ['ThreatIntelligencePlatform.indicator_enrichment', 'context_addition + reputation_scoring + confidence_assessment.id'], 'valid': True}, 'threat_forecasting.id': {'chain': ['ThreatIntelligencePlatform.threat_forecasting', 'trend_analysis + seasonal_patterns + emerging_threats.id'], 'valid': True}, 'attack_prediction.id': {'chain': ['ThreatIntelligencePlatform.attack_prediction', 'vulnerability_exploitation_likelihood + target_probability.id'], 'valid': True}, 'campaign_evolution.id': {'chain': ['ThreatIntelligencePlatform.campaign_evolution', 'attack_progression + technique_adaptation + countermeasure_evasion.id'], 'valid': True}, 'geopolitical_analysis.id': {'chain': ['ThreatIntelligencePlatform.geopolitical_analysis', 'conflict_prediction + stability_assessment + influence_operations.id'], 'valid': True}, 'social_network_mapping.id': {'chain': ['ThreatIntelligencePlatform.social_network_mapping', 'relationship_identification + influence_networks + communication_patterns.id'], 'valid': True}, 'infrastructure_mapping.id': {'chain': ['ThreatIntelligencePlatform.infrastructure_mapping', 'c2_servers + hosting_providers + domain_clustering.id'], 'valid': True}, 'supply_chain_analysis.id': {'chain': ['ThreatIntelligencePlatform.supply_chain_analysis', 'dependency_mapping + third_party_risks + vendor_assessment.id'], 'valid': True}, 'attack_surface_mapping.id': {'chain': ['ThreatIntelligencePlatform.attack_surface_mapping', 'exposed_assets + vulnerability_chains + entry_points.id'], 'valid': True}, 'interactive_maps.id': {'chain': ['ThreatIntelligencePlatform.interactive_maps', 'geographic_threat_distribution + attack_origins + target_locations.id'], 'valid': True}, 'network_graphs.id': {'chain': ['ThreatIntelligencePlatform.network_graphs', 'relationship_visualizations + influence_networks + communication_flows.id'], 'valid': True}, 'timeline_analysis.id': {'chain': ['ThreatIntelligencePlatform.timeline_analysis', 'attack_chronology + campaign_evolution + incident_correlation.id'], 'valid': True}, 'threat_landscapes.id': {'chain': ['ThreatIntelligencePlatform.threat_landscapes', 'sector_analysis + attack_vectors + vulnerability_distributions.id'], 'valid': True}, 'real_time_monitoring.id': {'chain': ['ThreatIntelligencePlatform.real_time_monitoring', 'live_threat_feeds + alert_dashboards + situational_awareness.id'], 'valid': True}}}, 'OSINTInvestigator': {'name': 'OSINTInvestigator', 'fields': {'social_media_profiling': {'type': 'cross_platform_correlation + behavioral_analysis + connection_mapping', 'required': True, 'relationship': {'target_table': 'cross_platform_correlation + behavioral_analysis + connection_mapping', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'public_records': {'type': 'court_records + property_records + business_registrations + voter_rolls', 'required': True, 'relationship': {'target_table': 'court_records + property_records + business_registrations + voter_rolls', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'professional_networks': {'type': 'linkedin + industry_databases + academic_publications + patents', 'required': True, 'relationship': {'target_table': 'linkedin + industry_databases + academic_publications + patents', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'image_recognition': {'type': 'reverse_image_search + facial_recognition + photo_metadata_analysis', 'required': True, 'relationship': {'target_table': 'reverse_image_search + facial_recognition + photo_metadata_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'corporate_filings': {'type': 'sec_filings + annual_reports + regulatory_submissions + patent_applications', 'required': True, 'relationship': {'target_table': 'sec_filings + annual_reports + regulatory_submissions + patent_applications', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'financial_analysis': {'type': 'revenue_analysis + ownership_structure + subsidiary_mapping + credit_ratings', 'required': True, 'relationship': {'target_table': 'revenue_analysis + ownership_structure + subsidiary_mapping + credit_ratings', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'regulatory_compliance': {'type': 'sanctions_lists + compliance_violations + regulatory_actions', 'required': True, 'relationship': {'target_table': 'sanctions_lists + compliance_violations + regulatory_actions', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'competitive_intelligence': {'type': 'market_position + strategic_partnerships + merger_activity', 'required': True, 'relationship': {'target_table': 'market_position + strategic_partnerships + merger_activity', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'satellite_imagery': {'type': 'historical_imagery + change_detection + facility_identification', 'required': True, 'relationship': {'target_table': 'historical_imagery + change_detection + facility_identification', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'street_view_analysis': {'type': 'facility_assessment + security_evaluation + activity_monitoring', 'required': True, 'relationship': {'target_table': 'facility_assessment + security_evaluation + activity_monitoring', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'flight_tracking': {'type': 'aircraft_registration + flight_patterns + ownership_analysis', 'required': True, 'relationship': {'target_table': 'aircraft_registration + flight_patterns + ownership_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'maritime_tracking': {'type': 'vessel_identification + shipping_routes + port_activities', 'required': True, 'relationship': {'target_table': 'vessel_identification + shipping_routes + port_activities', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'multi_source_correlation': {'type': 'cross_reference_validation + consistency_checking + conflict_resolution', 'required': True, 'relationship': {'target_table': 'cross_reference_validation + consistency_checking + conflict_resolution', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'confidence_scoring': {'type': 'source_reliability + information_quality + verification_status', 'required': True, 'relationship': {'target_table': 'source_reliability + information_quality + verification_status', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'gap_analysis': {'type': 'information_completeness + missing_data_identification + collection_priorities', 'required': True, 'relationship': {'target_table': 'information_completeness + missing_data_identification + collection_priorities', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'timeline_reconstruction': {'type': 'chronological_ordering + event_correlation + causality_analysis', 'required': True, 'relationship': {'target_table': 'chronological_ordering + event_correlation + causality_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'source_validation': {'type': 'credibility_assessment + bias_detection + fact_checking', 'required': True, 'relationship': {'target_table': 'credibility_assessment + bias_detection + fact_checking', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'technical_verification': {'type': 'metadata_analysis + digital_signatures + blockchain_verification', 'required': True, 'relationship': {'target_table': 'metadata_analysis + digital_signatures + blockchain_verification', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'cross_validation': {'type': 'multiple_source_confirmation + triangulation + consistency_analysis', 'required': True, 'relationship': {'target_table': 'multiple_source_confirmation + triangulation + consistency_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'expert_validation': {'type': 'subject_matter_expert_review + peer_verification + quality_assurance', 'required': True, 'relationship': {'target_table': 'subject_matter_expert_review + peer_verification + quality_assurance', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'social_media_profiling.id': {'chain': ['OSINTInvestigator.social_media_profiling', 'cross_platform_correlation + behavioral_analysis + connection_mapping.id'], 'valid': True}, 'public_records.id': {'chain': ['OSINTInvestigator.public_records', 'court_records + property_records + business_registrations + voter_rolls.id'], 'valid': True}, 'professional_networks.id': {'chain': ['OSINTInvestigator.professional_networks', 'linkedin + industry_databases + academic_publications + patents.id'], 'valid': True}, 'image_recognition.id': {'chain': ['OSINTInvestigator.image_recognition', 'reverse_image_search + facial_recognition + photo_metadata_analysis.id'], 'valid': True}, 'corporate_filings.id': {'chain': ['OSINTInvestigator.corporate_filings', 'sec_filings + annual_reports + regulatory_submissions + patent_applications.id'], 'valid': True}, 'financial_analysis.id': {'chain': ['OSINTInvestigator.financial_analysis', 'revenue_analysis + ownership_structure + subsidiary_mapping + credit_ratings.id'], 'valid': True}, 'regulatory_compliance.id': {'chain': ['OSINTInvestigator.regulatory_compliance', 'sanctions_lists + compliance_violations + regulatory_actions.id'], 'valid': True}, 'competitive_intelligence.id': {'chain': ['OSINTInvestigator.competitive_intelligence', 'market_position + strategic_partnerships + merger_activity.id'], 'valid': True}, 'satellite_imagery.id': {'chain': ['OSINTInvestigator.satellite_imagery', 'historical_imagery + change_detection + facility_identification.id'], 'valid': True}, 'street_view_analysis.id': {'chain': ['OSINTInvestigator.street_view_analysis', 'facility_assessment + security_evaluation + activity_monitoring.id'], 'valid': True}, 'flight_tracking.id': {'chain': ['OSINTInvestigator.flight_tracking', 'aircraft_registration + flight_patterns + ownership_analysis.id'], 'valid': True}, 'maritime_tracking.id': {'chain': ['OSINTInvestigator.maritime_tracking', 'vessel_identification + shipping_routes + port_activities.id'], 'valid': True}, 'multi_source_correlation.id': {'chain': ['OSINTInvestigator.multi_source_correlation', 'cross_reference_validation + consistency_checking + conflict_resolution.id'], 'valid': True}, 'confidence_scoring.id': {'chain': ['OSINTInvestigator.confidence_scoring', 'source_reliability + information_quality + verification_status.id'], 'valid': True}, 'gap_analysis.id': {'chain': ['OSINTInvestigator.gap_analysis', 'information_completeness + missing_data_identification + collection_priorities.id'], 'valid': True}, 'timeline_reconstruction.id': {'chain': ['OSINTInvestigator.timeline_reconstruction', 'chronological_ordering + event_correlation + causality_analysis.id'], 'valid': True}, 'source_validation.id': {'chain': ['OSINTInvestigator.source_validation', 'credibility_assessment + bias_detection + fact_checking.id'], 'valid': True}, 'technical_verification.id': {'chain': ['OSINTInvestigator.technical_verification', 'metadata_analysis + digital_signatures + blockchain_verification.id'], 'valid': True}, 'cross_validation.id': {'chain': ['OSINTInvestigator.cross_validation', 'multiple_source_confirmation + triangulation + consistency_analysis.id'], 'valid': True}, 'expert_validation.id': {'chain': ['OSINTInvestigator.expert_validation', 'subject_matter_expert_review + peer_verification + quality_assurance.id'], 'valid': True}}}, 'CyberThreatHunter': {'name': 'CyberThreatHunter', 'fields': {'user_behavior': {'type': 'login_patterns + access_anomalies + privilege_usage + data_access', 'required': True, 'relationship': {'target_table': 'login_patterns + access_anomalies + privilege_usage + data_access', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'system_behavior': {'type': 'process_patterns + network_communications + resource_utilization', 'required': True, 'relationship': {'target_table': 'process_patterns + network_communications + resource_utilization', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'application_behavior': {'type': 'usage_patterns + error_rates + performance_metrics', 'required': True, 'relationship': {'target_table': 'usage_patterns + error_rates + performance_metrics', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'temporal_analysis': {'type': 'time_based_patterns + seasonal_variations + activity_clustering', 'required': True, 'relationship': {'target_table': 'time_based_patterns + seasonal_variations + activity_clustering', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'atomic_indicators': {'type': 'ip_addresses + domain_names + file_hashes + registry_keys', 'required': True, 'relationship': {'target_table': 'ip_addresses + domain_names + file_hashes + registry_keys', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'composite_indicators': {'type': 'attack_patterns + behavioral_signatures + campaign_markers', 'required': True, 'relationship': {'target_table': 'attack_patterns + behavioral_signatures + campaign_markers', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'contextual_indicators': {'type': 'environmental_context + temporal_context + relational_context', 'required': True, 'relationship': {'target_table': 'environmental_context + temporal_context + relational_context', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'predictive_indicators': {'type': 'precursor_events + early_warning_signs + trend_analysis', 'required': True, 'relationship': {'target_table': 'precursor_events + early_warning_signs + trend_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'kill_chain_mapping': {'type': 'reconnaissance + weaponization + delivery + exploitation + installation + c2 + actions', 'required': True, 'relationship': {'target_table': 'reconnaissance + weaponization + delivery + exploitation + installation + c2 + actions', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'lateral_movement': {'type': 'network_traversal + privilege_escalation + persistence_establishment', 'required': True, 'relationship': {'target_table': 'network_traversal + privilege_escalation + persistence_establishment', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'data_exfiltration': {'type': 'data_identification + collection + staging + transmission', 'required': True, 'relationship': {'target_table': 'data_identification + collection + staging + transmission', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'impact_assessment': {'type': 'system_compromise + data_loss + operational_disruption', 'required': True, 'relationship': {'target_table': 'system_compromise + data_loss + operational_disruption', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'automated_hunting': {'type': 'playbook_execution + rule_based_hunting + scheduled_searches', 'required': True, 'relationship': {'target_table': 'playbook_execution + rule_based_hunting + scheduled_searches', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'alert_triage': {'type': 'automated_classification + priority_scoring + false_positive_reduction', 'required': True, 'relationship': {'target_table': 'automated_classification + priority_scoring + false_positive_reduction', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'response_orchestration': {'type': 'automated_containment + evidence_collection + stakeholder_notification', 'required': True, 'relationship': {'target_table': 'automated_containment + evidence_collection + stakeholder_notification', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'threat_intelligence': {'type': 'automated_ioc_extraction + feed_integration + indicator_sharing', 'required': True, 'relationship': {'target_table': 'automated_ioc_extraction + feed_integration + indicator_sharing', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'user_behavior.id': {'chain': ['CyberThreatHunter.user_behavior', 'login_patterns + access_anomalies + privilege_usage + data_access.id'], 'valid': True}, 'system_behavior.id': {'chain': ['CyberThreatHunter.system_behavior', 'process_patterns + network_communications + resource_utilization.id'], 'valid': True}, 'application_behavior.id': {'chain': ['CyberThreatHunter.application_behavior', 'usage_patterns + error_rates + performance_metrics.id'], 'valid': True}, 'temporal_analysis.id': {'chain': ['CyberThreatHunter.temporal_analysis', 'time_based_patterns + seasonal_variations + activity_clustering.id'], 'valid': True}, 'atomic_indicators.id': {'chain': ['CyberThreatHunter.atomic_indicators', 'ip_addresses + domain_names + file_hashes + registry_keys.id'], 'valid': True}, 'composite_indicators.id': {'chain': ['CyberThreatHunter.composite_indicators', 'attack_patterns + behavioral_signatures + campaign_markers.id'], 'valid': True}, 'contextual_indicators.id': {'chain': ['CyberThreatHunter.contextual_indicators', 'environmental_context + temporal_context + relational_context.id'], 'valid': True}, 'predictive_indicators.id': {'chain': ['CyberThreatHunter.predictive_indicators', 'precursor_events + early_warning_signs + trend_analysis.id'], 'valid': True}, 'kill_chain_mapping.id': {'chain': ['CyberThreatHunter.kill_chain_mapping', 'reconnaissance + weaponization + delivery + exploitation + installation + c2 + actions.id'], 'valid': True}, 'lateral_movement.id': {'chain': ['CyberThreatHunter.lateral_movement', 'network_traversal + privilege_escalation + persistence_establishment.id'], 'valid': True}, 'data_exfiltration.id': {'chain': ['CyberThreatHunter.data_exfiltration', 'data_identification + collection + staging + transmission.id'], 'valid': True}, 'impact_assessment.id': {'chain': ['CyberThreatHunter.impact_assessment', 'system_compromise + data_loss + operational_disruption.id'], 'valid': True}, 'automated_hunting.id': {'chain': ['CyberThreatHunter.automated_hunting', 'playbook_execution + rule_based_hunting + scheduled_searches.id'], 'valid': True}, 'alert_triage.id': {'chain': ['CyberThreatHunter.alert_triage', 'automated_classification + priority_scoring + false_positive_reduction.id'], 'valid': True}, 'response_orchestration.id': {'chain': ['CyberThreatHunter.response_orchestration', 'automated_containment + evidence_collection + stakeholder_notification.id'], 'valid': True}, 'threat_intelligence.id': {'chain': ['CyberThreatHunter.threat_intelligence', 'automated_ioc_extraction + feed_integration + indicator_sharing.id'], 'valid': True}}}, 'FinancialIntelligence': {'name': 'FinancialIntelligence', 'fields': {'entity_relationship_mapping': {'type': 'ownership_networks + transaction_networks + communication_networks', 'required': True, 'relationship': {'target_table': 'ownership_networks + transaction_networks + communication_networks', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'centrality_analysis': {'type': 'key_player_identification + influence_measurement + risk_propagation', 'required': True, 'relationship': {'target_table': 'key_player_identification + influence_measurement + risk_propagation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'community_detection': {'type': 'cluster_identification + group_behavior + collective_risk', 'required': True, 'relationship': {'target_table': 'cluster_identification + group_behavior + collective_risk', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'temporal_network_analysis': {'type': 'relationship_evolution + transaction_timing + coordination_detection', 'required': True, 'relationship': {'target_table': 'relationship_evolution + transaction_timing + coordination_detection', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'structuring_detection': {'type': 'smurfing + layering + integration + structuring_avoidance', 'required': True, 'relationship': {'target_table': 'smurfing + layering + integration + structuring_avoidance', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'typology_matching': {'type': 'known_ml_typologies + emerging_patterns + sector_specific_risks', 'required': True, 'relationship': {'target_table': 'known_ml_typologies + emerging_patterns + sector_specific_risks', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'behavioral_anomalies': {'type': 'deviation_from_normal + unusual_transactions + suspicious_timing', 'required': True, 'relationship': {'target_table': 'deviation_from_normal + unusual_transactions + suspicious_timing', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'geographic_anomalies': {'type': 'unusual_jurisdictions + sanctions_evasion + trade_mispricing', 'required': True, 'relationship': {'target_table': 'unusual_jurisdictions + sanctions_evasion + trade_mispricing', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'customer_risk_scoring': {'type': 'static_factors + dynamic_behavior + external_intelligence', 'required': True, 'relationship': {'target_table': 'static_factors + dynamic_behavior + external_intelligence', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'transaction_risk_scoring': {'type': 'amount + frequency + counterparties + geographic + timing', 'required': True, 'relationship': {'target_table': 'amount + frequency + counterparties + geographic + timing', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'portfolio_risk_assessment': {'type': 'concentration_risk + correlated_exposures + systemic_risk', 'required': True, 'relationship': {'target_table': 'concentration_risk + correlated_exposures + systemic_risk', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'predictive_modeling': {'type': 'early_warning_indicators + risk_forecasting + scenario_analysis', 'required': True, 'relationship': {'target_table': 'early_warning_indicators + risk_forecasting + scenario_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'suspicious_activity_reports': {'type': 'automated_sar_generation + narrative_creation + regulatory_submission', 'required': True, 'relationship': {'target_table': 'automated_sar_generation + narrative_creation + regulatory_submission', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'currency_transaction_reports': {'type': 'threshold_monitoring + aggregation_rules + exemption_management', 'required': True, 'relationship': {'target_table': 'threshold_monitoring + aggregation_rules + exemption_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'regulatory_reporting': {'type': 'periodic_reports + ad_hoc_reporting + audit_trails + documentation', 'required': True, 'relationship': {'target_table': 'periodic_reports + ad_hoc_reporting + audit_trails + documentation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'internal_reporting': {'type': 'management_dashboards + risk_metrics + performance_indicators + trend_analysis', 'required': True, 'relationship': {'target_table': 'management_dashboards + risk_metrics + performance_indicators + trend_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'entity_relationship_mapping.id': {'chain': ['FinancialIntelligence.entity_relationship_mapping', 'ownership_networks + transaction_networks + communication_networks.id'], 'valid': True}, 'centrality_analysis.id': {'chain': ['FinancialIntelligence.centrality_analysis', 'key_player_identification + influence_measurement + risk_propagation.id'], 'valid': True}, 'community_detection.id': {'chain': ['FinancialIntelligence.community_detection', 'cluster_identification + group_behavior + collective_risk.id'], 'valid': True}, 'temporal_network_analysis.id': {'chain': ['FinancialIntelligence.temporal_network_analysis', 'relationship_evolution + transaction_timing + coordination_detection.id'], 'valid': True}, 'structuring_detection.id': {'chain': ['FinancialIntelligence.structuring_detection', 'smurfing + layering + integration + structuring_avoidance.id'], 'valid': True}, 'typology_matching.id': {'chain': ['FinancialIntelligence.typology_matching', 'known_ml_typologies + emerging_patterns + sector_specific_risks.id'], 'valid': True}, 'behavioral_anomalies.id': {'chain': ['FinancialIntelligence.behavioral_anomalies', 'deviation_from_normal + unusual_transactions + suspicious_timing.id'], 'valid': True}, 'geographic_anomalies.id': {'chain': ['FinancialIntelligence.geographic_anomalies', 'unusual_jurisdictions + sanctions_evasion + trade_mispricing.id'], 'valid': True}, 'customer_risk_scoring.id': {'chain': ['FinancialIntelligence.customer_risk_scoring', 'static_factors + dynamic_behavior + external_intelligence.id'], 'valid': True}, 'transaction_risk_scoring.id': {'chain': ['FinancialIntelligence.transaction_risk_scoring', 'amount + frequency + counterparties + geographic + timing.id'], 'valid': True}, 'portfolio_risk_assessment.id': {'chain': ['FinancialIntelligence.portfolio_risk_assessment', 'concentration_risk + correlated_exposures + systemic_risk.id'], 'valid': True}, 'predictive_modeling.id': {'chain': ['FinancialIntelligence.predictive_modeling', 'early_warning_indicators + risk_forecasting + scenario_analysis.id'], 'valid': True}, 'suspicious_activity_reports.id': {'chain': ['FinancialIntelligence.suspicious_activity_reports', 'automated_sar_generation + narrative_creation + regulatory_submission.id'], 'valid': True}, 'currency_transaction_reports.id': {'chain': ['FinancialIntelligence.currency_transaction_reports', 'threshold_monitoring + aggregation_rules + exemption_management.id'], 'valid': True}, 'regulatory_reporting.id': {'chain': ['FinancialIntelligence.regulatory_reporting', 'periodic_reports + ad_hoc_reporting + audit_trails + documentation.id'], 'valid': True}, 'internal_reporting.id': {'chain': ['FinancialIntelligence.internal_reporting', 'management_dashboards + risk_metrics + performance_indicators + trend_analysis.id'], 'valid': True}}}, 'DisinformationDetector': {'name': 'DisinformationDetector', 'fields': {'fact_checking': {'type': 'claim_verification + source_validation + evidence_assessment', 'required': True, 'relationship': {'target_table': 'claim_verification + source_validation + evidence_assessment', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'linguistic_analysis': {'type': 'writing_style + vocabulary_analysis + sentiment_patterns', 'required': True, 'relationship': {'target_table': 'writing_style + vocabulary_analysis + sentiment_patterns', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'semantic_analysis': {'type': 'meaning_extraction + context_understanding + logical_consistency', 'required': True, 'relationship': {'target_table': 'meaning_extraction + context_understanding + logical_consistency', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'narrative_analysis': {'type': 'story_structure + plot_coherence + character_consistency', 'required': True, 'relationship': {'target_table': 'story_structure + plot_coherence + character_consistency', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'image_forensics': {'type': 'pixel_analysis + compression_artifacts + metadata_analysis + reverse_image_search', 'required': True, 'relationship': {'target_table': 'pixel_analysis + compression_artifacts + metadata_analysis + reverse_image_search', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'video_forensics': {'type': 'temporal_consistency + lighting_analysis + facial_analysis + deepfake_detection', 'required': True, 'relationship': {'target_table': 'temporal_consistency + lighting_analysis + facial_analysis + deepfake_detection', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'audio_forensics': {'type': 'spectral_analysis + voice_comparison + synthesis_detection + background_noise', 'required': True, 'relationship': {'target_table': 'spectral_analysis + voice_comparison + synthesis_detection + background_noise', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'multimedia_correlation': {'type': 'cross_media_consistency + synchronization_analysis + contextual_matching', 'required': True, 'relationship': {'target_table': 'cross_media_consistency + synchronization_analysis + contextual_matching', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'user_behavior': {'type': 'posting_patterns + engagement_metrics + network_interactions + account_history', 'required': True, 'relationship': {'target_table': 'posting_patterns + engagement_metrics + network_interactions + account_history', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'network_behavior': {'type': 'coordinated_activity + amplification_patterns + cascade_analysis + timing_analysis', 'required': True, 'relationship': {'target_table': 'coordinated_activity + amplification_patterns + cascade_analysis + timing_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'platform_behavior': {'type': 'cross_platform_coordination + migration_patterns + platform_specific_adaptations', 'required': True, 'relationship': {'target_table': 'cross_platform_coordination + migration_patterns + platform_specific_adaptations', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'temporal_behavior': {'type': 'activity_timing + lifecycle_analysis + campaign_duration + decay_patterns', 'required': True, 'relationship': {'target_table': 'activity_timing + lifecycle_analysis + campaign_duration + decay_patterns', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'supervised_learning': {'type': 'labeled_training_data + classification_models + performance_evaluation', 'required': True, 'relationship': {'target_table': 'labeled_training_data + classification_models + performance_evaluation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'unsupervised_learning': {'type': 'anomaly_detection + clustering + pattern_discovery + outlier_identification', 'required': True, 'relationship': {'target_table': 'anomaly_detection + clustering + pattern_discovery + outlier_identification', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'deep_learning': {'type': 'neural_networks + transformer_models + attention_mechanisms + transfer_learning', 'required': True, 'relationship': {'target_table': 'neural_networks + transformer_models + attention_mechanisms + transfer_learning', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'ensemble_methods': {'type': 'model_combination + voting_systems + confidence_aggregation + robustness_improvement', 'required': True, 'relationship': {'target_table': 'model_combination + voting_systems + confidence_aggregation + robustness_improvement', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'propagation_analysis': {'type': 'information_diffusion + viral_spreading + influence_measurement + cascade_prediction', 'required': True, 'relationship': {'target_table': 'information_diffusion + viral_spreading + influence_measurement + cascade_prediction', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'community_detection': {'type': 'echo_chambers + filter_bubbles + polarization_analysis + group_dynamics', 'required': True, 'relationship': {'target_table': 'echo_chambers + filter_bubbles + polarization_analysis + group_dynamics', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'centrality_analysis': {'type': 'key_influencers + bridge_nodes + bottlenecks + information_brokers', 'required': True, 'relationship': {'target_table': 'key_influencers + bridge_nodes + bottlenecks + information_brokers', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'temporal_graph_analysis': {'type': 'network_evolution + relationship_dynamics + activity_patterns + trend_analysis', 'required': True, 'relationship': {'target_table': 'network_evolution + relationship_dynamics + activity_patterns + trend_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'source_credibility': {'type': 'reputation_scoring + track_record + expertise_assessment + bias_evaluation', 'required': True, 'relationship': {'target_table': 'reputation_scoring + track_record + expertise_assessment + bias_evaluation', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'evidence_quality': {'type': 'primary_sources + corroboration + documentation + chain_of_custody', 'required': True, 'relationship': {'target_table': 'primary_sources + corroboration + documentation + chain_of_custody', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'logical_consistency': {'type': 'internal_consistency + external_consistency + contradiction_detection + coherence_analysis', 'required': True, 'relationship': {'target_table': 'internal_consistency + external_consistency + contradiction_detection + coherence_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'expert_validation': {'type': 'fact_checker_networks + domain_experts + peer_review + consensus_building', 'required': True, 'relationship': {'target_table': 'fact_checker_networks + domain_experts + peer_review + consensus_building', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'fact_checking.id': {'chain': ['DisinformationDetector.fact_checking', 'claim_verification + source_validation + evidence_assessment.id'], 'valid': True}, 'linguistic_analysis.id': {'chain': ['DisinformationDetector.linguistic_analysis', 'writing_style + vocabulary_analysis + sentiment_patterns.id'], 'valid': True}, 'semantic_analysis.id': {'chain': ['DisinformationDetector.semantic_analysis', 'meaning_extraction + context_understanding + logical_consistency.id'], 'valid': True}, 'narrative_analysis.id': {'chain': ['DisinformationDetector.narrative_analysis', 'story_structure + plot_coherence + character_consistency.id'], 'valid': True}, 'image_forensics.id': {'chain': ['DisinformationDetector.image_forensics', 'pixel_analysis + compression_artifacts + metadata_analysis + reverse_image_search.id'], 'valid': True}, 'video_forensics.id': {'chain': ['DisinformationDetector.video_forensics', 'temporal_consistency + lighting_analysis + facial_analysis + deepfake_detection.id'], 'valid': True}, 'audio_forensics.id': {'chain': ['DisinformationDetector.audio_forensics', 'spectral_analysis + voice_comparison + synthesis_detection + background_noise.id'], 'valid': True}, 'multimedia_correlation.id': {'chain': ['DisinformationDetector.multimedia_correlation', 'cross_media_consistency + synchronization_analysis + contextual_matching.id'], 'valid': True}, 'user_behavior.id': {'chain': ['DisinformationDetector.user_behavior', 'posting_patterns + engagement_metrics + network_interactions + account_history.id'], 'valid': True}, 'network_behavior.id': {'chain': ['DisinformationDetector.network_behavior', 'coordinated_activity + amplification_patterns + cascade_analysis + timing_analysis.id'], 'valid': True}, 'platform_behavior.id': {'chain': ['DisinformationDetector.platform_behavior', 'cross_platform_coordination + migration_patterns + platform_specific_adaptations.id'], 'valid': True}, 'temporal_behavior.id': {'chain': ['DisinformationDetector.temporal_behavior', 'activity_timing + lifecycle_analysis + campaign_duration + decay_patterns.id'], 'valid': True}, 'supervised_learning.id': {'chain': ['DisinformationDetector.supervised_learning', 'labeled_training_data + classification_models + performance_evaluation.id'], 'valid': True}, 'unsupervised_learning.id': {'chain': ['DisinformationDetector.unsupervised_learning', 'anomaly_detection + clustering + pattern_discovery + outlier_identification.id'], 'valid': True}, 'deep_learning.id': {'chain': ['DisinformationDetector.deep_learning', 'neural_networks + transformer_models + attention_mechanisms + transfer_learning.id'], 'valid': True}, 'ensemble_methods.id': {'chain': ['DisinformationDetector.ensemble_methods', 'model_combination + voting_systems + confidence_aggregation + robustness_improvement.id'], 'valid': True}, 'propagation_analysis.id': {'chain': ['DisinformationDetector.propagation_analysis', 'information_diffusion + viral_spreading + influence_measurement + cascade_prediction.id'], 'valid': True}, 'community_detection.id': {'chain': ['DisinformationDetector.community_detection', 'echo_chambers + filter_bubbles + polarization_analysis + group_dynamics.id'], 'valid': True}, 'centrality_analysis.id': {'chain': ['DisinformationDetector.centrality_analysis', 'key_influencers + bridge_nodes + bottlenecks + information_brokers.id'], 'valid': True}, 'temporal_graph_analysis.id': {'chain': ['DisinformationDetector.temporal_graph_analysis', 'network_evolution + relationship_dynamics + activity_patterns + trend_analysis.id'], 'valid': True}, 'source_credibility.id': {'chain': ['DisinformationDetector.source_credibility', 'reputation_scoring + track_record + expertise_assessment + bias_evaluation.id'], 'valid': True}, 'evidence_quality.id': {'chain': ['DisinformationDetector.evidence_quality', 'primary_sources + corroboration + documentation + chain_of_custody.id'], 'valid': True}, 'logical_consistency.id': {'chain': ['DisinformationDetector.logical_consistency', 'internal_consistency + external_consistency + contradiction_detection + coherence_analysis.id'], 'valid': True}, 'expert_validation.id': {'chain': ['DisinformationDetector.expert_validation', 'fact_checker_networks + domain_experts + peer_review + consensus_building.id'], 'valid': True}}}, 'GeopoliticalAnalysis': {'name': 'GeopoliticalAnalysis', 'fields': {'traditional_media': {'type': 'newspapers + television + radio + magazines + wire_services', 'required': True, 'relationship': {'target_table': 'newspapers + television + radio + magazines + wire_services', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'digital_media': {'type': 'online_news + blogs + podcasts + video_platforms + streaming_services', 'required': True, 'relationship': {'target_table': 'online_news + blogs + podcasts + video_platforms + streaming_services', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'social_media': {'type': 'twitter + facebook + instagram + tiktok + linkedin + regional_platforms', 'required': True, 'relationship': {'target_table': 'twitter + facebook + instagram + tiktok + linkedin + regional_platforms', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'specialized_sources': {'type': 'trade_publications + academic_journals + think_tank_reports + government_publications', 'required': True, 'relationship': {'target_table': 'trade_publications + academic_journals + think_tank_reports + government_publications', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'government_communications': {'type': 'press_releases + speeches + policy_documents + legislative_proceedings', 'required': True, 'relationship': {'target_table': 'press_releases + speeches + policy_documents + legislative_proceedings', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'diplomatic_channels': {'type': 'embassy_reports + consular_communications + international_agreements', 'required': True, 'relationship': {'target_table': 'embassy_reports + consular_communications + international_agreements', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'regulatory_filings': {'type': 'corporate_disclosures + trade_data + financial_reports + compliance_documents', 'required': True, 'relationship': {'target_table': 'corporate_disclosures + trade_data + financial_reports + compliance_documents', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'international_organizations': {'type': 'un_reports + world_bank + imf + regional_organizations', 'required': True, 'relationship': {'target_table': 'un_reports + world_bank + imf + regional_organizations', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'academic_research': {'type': 'university_studies + research_institutions + policy_analysis + expert_opinions', 'required': True, 'relationship': {'target_table': 'university_studies + research_institutions + policy_analysis + expert_opinions', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'think_tanks': {'type': 'policy_recommendations + strategic_analysis + scenario_planning + expert_networks', 'required': True, 'relationship': {'target_table': 'policy_recommendations + strategic_analysis + scenario_planning + expert_networks', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'ngo_reports': {'type': 'human_rights + environmental + development + advocacy_organizations', 'required': True, 'relationship': {'target_table': 'human_rights + environmental + development + advocacy_organizations', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'commercial_intelligence': {'type': 'market_research + industry_analysis + competitive_intelligence + economic_forecasting', 'required': True, 'relationship': {'target_table': 'market_research + industry_analysis + competitive_intelligence + economic_forecasting', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'temporal_patterns': {'type': 'historical_trends + cyclical_patterns + seasonal_variations + long_term_trajectories', 'required': True, 'relationship': {'target_table': 'historical_trends + cyclical_patterns + seasonal_variations + long_term_trajectories', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'comparative_analysis': {'type': 'cross_country_comparisons + regional_analysis + peer_benchmarking + best_practices', 'required': True, 'relationship': {'target_table': 'cross_country_comparisons + regional_analysis + peer_benchmarking + best_practices', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'causal_analysis': {'type': 'root_cause_identification + impact_assessment + unintended_consequences + feedback_loops', 'required': True, 'relationship': {'target_table': 'root_cause_identification + impact_assessment + unintended_consequences + feedback_loops', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'scenario_planning': {'type': 'alternative_futures + contingency_planning + risk_assessment + opportunity_identification', 'required': True, 'relationship': {'target_table': 'alternative_futures + contingency_planning + risk_assessment + opportunity_identification', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'political_forecasting': {'type': 'election_prediction + policy_outcomes + stability_assessment + leadership_changes', 'required': True, 'relationship': {'target_table': 'election_prediction + policy_outcomes + stability_assessment + leadership_changes', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'economic_forecasting': {'type': 'growth_projections + market_predictions + trade_flows + resource_prices', 'required': True, 'relationship': {'target_table': 'growth_projections + market_predictions + trade_flows + resource_prices', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'conflict_prediction': {'type': 'early_warning_systems + escalation_dynamics + peace_processes + intervention_effectiveness', 'required': True, 'relationship': {'target_table': 'early_warning_systems + escalation_dynamics + peace_processes + intervention_effectiveness', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'social_forecasting': {'type': 'demographic_projections + migration_patterns + urbanization + social_change', 'required': True, 'relationship': {'target_table': 'demographic_projections + migration_patterns + urbanization + social_change', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'traditional_media.id': {'chain': ['GeopoliticalAnalysis.traditional_media', 'newspapers + television + radio + magazines + wire_services.id'], 'valid': True}, 'digital_media.id': {'chain': ['GeopoliticalAnalysis.digital_media', 'online_news + blogs + podcasts + video_platforms + streaming_services.id'], 'valid': True}, 'social_media.id': {'chain': ['GeopoliticalAnalysis.social_media', 'twitter + facebook + instagram + tiktok + linkedin + regional_platforms.id'], 'valid': True}, 'specialized_sources.id': {'chain': ['GeopoliticalAnalysis.specialized_sources', 'trade_publications + academic_journals + think_tank_reports + government_publications.id'], 'valid': True}, 'government_communications.id': {'chain': ['GeopoliticalAnalysis.government_communications', 'press_releases + speeches + policy_documents + legislative_proceedings.id'], 'valid': True}, 'diplomatic_channels.id': {'chain': ['GeopoliticalAnalysis.diplomatic_channels', 'embassy_reports + consular_communications + international_agreements.id'], 'valid': True}, 'regulatory_filings.id': {'chain': ['GeopoliticalAnalysis.regulatory_filings', 'corporate_disclosures + trade_data + financial_reports + compliance_documents.id'], 'valid': True}, 'international_organizations.id': {'chain': ['GeopoliticalAnalysis.international_organizations', 'un_reports + world_bank + imf + regional_organizations.id'], 'valid': True}, 'academic_research.id': {'chain': ['GeopoliticalAnalysis.academic_research', 'university_studies + research_institutions + policy_analysis + expert_opinions.id'], 'valid': True}, 'think_tanks.id': {'chain': ['GeopoliticalAnalysis.think_tanks', 'policy_recommendations + strategic_analysis + scenario_planning + expert_networks.id'], 'valid': True}, 'ngo_reports.id': {'chain': ['GeopoliticalAnalysis.ngo_reports', 'human_rights + environmental + development + advocacy_organizations.id'], 'valid': True}, 'commercial_intelligence.id': {'chain': ['GeopoliticalAnalysis.commercial_intelligence', 'market_research + industry_analysis + competitive_intelligence + economic_forecasting.id'], 'valid': True}, 'temporal_patterns.id': {'chain': ['GeopoliticalAnalysis.temporal_patterns', 'historical_trends + cyclical_patterns + seasonal_variations + long_term_trajectories.id'], 'valid': True}, 'comparative_analysis.id': {'chain': ['GeopoliticalAnalysis.comparative_analysis', 'cross_country_comparisons + regional_analysis + peer_benchmarking + best_practices.id'], 'valid': True}, 'causal_analysis.id': {'chain': ['GeopoliticalAnalysis.causal_analysis', 'root_cause_identification + impact_assessment + unintended_consequences + feedback_loops.id'], 'valid': True}, 'scenario_planning.id': {'chain': ['GeopoliticalAnalysis.scenario_planning', 'alternative_futures + contingency_planning + risk_assessment + opportunity_identification.id'], 'valid': True}, 'political_forecasting.id': {'chain': ['GeopoliticalAnalysis.political_forecasting', 'election_prediction + policy_outcomes + stability_assessment + leadership_changes.id'], 'valid': True}, 'economic_forecasting.id': {'chain': ['GeopoliticalAnalysis.economic_forecasting', 'growth_projections + market_predictions + trade_flows + resource_prices.id'], 'valid': True}, 'conflict_prediction.id': {'chain': ['GeopoliticalAnalysis.conflict_prediction', 'early_warning_systems + escalation_dynamics + peace_processes + intervention_effectiveness.id'], 'valid': True}, 'social_forecasting.id': {'chain': ['GeopoliticalAnalysis.social_forecasting', 'demographic_projections + migration_patterns + urbanization + social_change.id'], 'valid': True}}}, 'IntelligenceInfrastructure': {'name': 'IntelligenceInfrastructure', 'fields': {'perimeter_defense': {'type': 'firewalls + intrusion_detection + ddos_protection + traffic_analysis', 'required': True, 'relationship': {'target_table': 'firewalls + intrusion_detection + ddos_protection + traffic_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'network_segmentation': {'type': 'vlan_isolation + micro_segmentation + zero_trust + access_control', 'required': True, 'relationship': {'target_table': 'vlan_isolation + micro_segmentation + zero_trust + access_control', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'encrypted_communications': {'type': 'vpn_tunnels + tls_encryption + end_to_end_encryption + secure_messaging', 'required': True, 'relationship': {'target_table': 'vpn_tunnels + tls_encryption + end_to_end_encryption + secure_messaging', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'anonymization': {'type': 'tor_networks + proxy_chains + traffic_obfuscation + identity_protection', 'required': True, 'relationship': {'target_table': 'tor_networks + proxy_chains + traffic_obfuscation + identity_protection', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'encryption_at_rest': {'type': 'full_disk_encryption + database_encryption + file_encryption + key_management', 'required': True, 'relationship': {'target_table': 'full_disk_encryption + database_encryption + file_encryption + key_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'encryption_in_transit': {'type': 'network_encryption + api_encryption + message_encryption + certificate_management', 'required': True, 'relationship': {'target_table': 'network_encryption + api_encryption + message_encryption + certificate_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'access_control': {'type': 'multi_factor_authentication + role_based_access + attribute_based_access + privileged_access_management', 'required': True, 'relationship': {'target_table': 'multi_factor_authentication + role_based_access + attribute_based_access + privileged_access_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'data_loss_prevention': {'type': 'content_inspection + policy_enforcement + monitoring + incident_response', 'required': True, 'relationship': {'target_table': 'content_inspection + policy_enforcement + monitoring + incident_response', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'secure_development': {'type': 'secure_coding + vulnerability_testing + code_review + dependency_management', 'required': True, 'relationship': {'target_table': 'secure_coding + vulnerability_testing + code_review + dependency_management', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'infrastructure_security': {'type': 'container_security + orchestration_security + cloud_security + compliance_monitoring', 'required': True, 'relationship': {'target_table': 'container_security + orchestration_security + cloud_security + compliance_monitoring', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'incident_response': {'type': 'threat_detection + incident_classification + response_procedures + forensic_analysis', 'required': True, 'relationship': {'target_table': 'threat_detection + incident_classification + response_procedures + forensic_analysis', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'business_continuity': {'type': 'backup_systems + disaster_recovery + failover_procedures + continuity_planning', 'required': True, 'relationship': {'target_table': 'backup_systems + disaster_recovery + failover_procedures + continuity_planning', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'data_protection': {'type': 'gdpr + ccpa + hipaa + sox + pci_dss', 'required': True, 'relationship': {'target_table': 'gdpr + ccpa + hipaa + sox + pci_dss', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'security_standards': {'type': 'iso27001 + nist_cybersecurity + cis_controls + owasp', 'required': True, 'relationship': {'target_table': 'iso27001 + nist_cybersecurity + cis_controls + owasp', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'intelligence_standards': {'type': 'odni_ics + nato_standards + five_eyes + national_requirements', 'required': True, 'relationship': {'target_table': 'odni_ics + nato_standards + five_eyes + national_requirements', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'industry_standards': {'type': 'financial_regulations + healthcare_compliance + government_standards + international_law', 'required': True, 'relationship': {'target_table': 'financial_regulations + healthcare_compliance + government_standards + international_law', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'perimeter_defense.id': {'chain': ['IntelligenceInfrastructure.perimeter_defense', 'firewalls + intrusion_detection + ddos_protection + traffic_analysis.id'], 'valid': True}, 'network_segmentation.id': {'chain': ['IntelligenceInfrastructure.network_segmentation', 'vlan_isolation + micro_segmentation + zero_trust + access_control.id'], 'valid': True}, 'encrypted_communications.id': {'chain': ['IntelligenceInfrastructure.encrypted_communications', 'vpn_tunnels + tls_encryption + end_to_end_encryption + secure_messaging.id'], 'valid': True}, 'anonymization.id': {'chain': ['IntelligenceInfrastructure.anonymization', 'tor_networks + proxy_chains + traffic_obfuscation + identity_protection.id'], 'valid': True}, 'encryption_at_rest.id': {'chain': ['IntelligenceInfrastructure.encryption_at_rest', 'full_disk_encryption + database_encryption + file_encryption + key_management.id'], 'valid': True}, 'encryption_in_transit.id': {'chain': ['IntelligenceInfrastructure.encryption_in_transit', 'network_encryption + api_encryption + message_encryption + certificate_management.id'], 'valid': True}, 'access_control.id': {'chain': ['IntelligenceInfrastructure.access_control', 'multi_factor_authentication + role_based_access + attribute_based_access + privileged_access_management.id'], 'valid': True}, 'data_loss_prevention.id': {'chain': ['IntelligenceInfrastructure.data_loss_prevention', 'content_inspection + policy_enforcement + monitoring + incident_response.id'], 'valid': True}, 'secure_development.id': {'chain': ['IntelligenceInfrastructure.secure_development', 'secure_coding + vulnerability_testing + code_review + dependency_management.id'], 'valid': True}, 'infrastructure_security.id': {'chain': ['IntelligenceInfrastructure.infrastructure_security', 'container_security + orchestration_security + cloud_security + compliance_monitoring.id'], 'valid': True}, 'incident_response.id': {'chain': ['IntelligenceInfrastructure.incident_response', 'threat_detection + incident_classification + response_procedures + forensic_analysis.id'], 'valid': True}, 'business_continuity.id': {'chain': ['IntelligenceInfrastructure.business_continuity', 'backup_systems + disaster_recovery + failover_procedures + continuity_planning.id'], 'valid': True}, 'data_protection.id': {'chain': ['IntelligenceInfrastructure.data_protection', 'gdpr + ccpa + hipaa + sox + pci_dss.id'], 'valid': True}, 'security_standards.id': {'chain': ['IntelligenceInfrastructure.security_standards', 'iso27001 + nist_cybersecurity + cis_controls + owasp.id'], 'valid': True}, 'intelligence_standards.id': {'chain': ['IntelligenceInfrastructure.intelligence_standards', 'odni_ics + nato_standards + five_eyes + national_requirements.id'], 'valid': True}, 'industry_standards.id': {'chain': ['IntelligenceInfrastructure.industry_standards', 'financial_regulations + healthcare_compliance + government_standards + international_law.id'], 'valid': True}}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'main.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 164, 'edges': 157}, 'lookup': {'kind': 'lookup', 'nodes': 8, 'edges': 7}, 'workflow': {'kind': 'workflow', 'nodes': 8, 'edges': 7}, 'handler': {'kind': 'handler', 'nodes': 8, 'edges': 7}, 'capability': {'kind': 'capability', 'nodes': 0, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 8, 'edges': 7}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 8, 'edges': 7}, 'package': {'kind': 'package', 'nodes': 8, 'edges': 7}}, 'diagnostics': []}
