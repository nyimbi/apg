"""
ngo_grants - APG Python Application
===================================
...
MODULE_NAME = 'ngo_grants'
MODULE_VERSION = '1.0.0'
MODULE_DESCRIPTION = None
ENTITIES = [{'name': 'Grant', 'type': 'entity', 'properties': ['id', 'grant_code', 'title', 'donor_id', 'amount', 'currency', 'start_date', 'end_date', 'status', 'grant_type', 'reporting_frequency', 'project_manager', 'country', 'sector', 'thematic_area'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'grant_code', 'type': 'str', 'required': True}, {'name': 'title', 'type': 'str', 'required': True}, {'name': 'donor_id', 'type': 'str', 'required': True}, {'name': 'amount', 'type': 'float', 'required': True}, {'name': 'currency', 'type': 'str', 'required': True}, {'name': 'start_date', 'type': 'date', 'required': True}, {'name': 'end_date', 'type': 'date', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'grant_type', 'type': 'str', 'required': True}, {'name': 'reporting_frequency', 'type': 'str', 'required': True}, {'name': 'project_manager', 'type': 'str', 'required': True}, {'name': 'country', 'type': 'str', 'required': True}, {'name': 'sector', 'type': 'str', 'required': True}, {'name': 'thematic_area', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Donor', 'type': 'entity', 'properties': ['id', 'donor_code', 'organisation_name', 'donor_type', 'contact_person', 'email', 'phone', 'country', 'total_committed', 'total_disbursed', 'relationship_manager', 'preferred_reporting'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'donor_code', 'type': 'str', 'required': True}, {'name': 'organisation_name', 'type': 'str', 'required': True}, {'name': 'donor_type', 'type': 'str', 'required': True}, {'name': 'contact_person', 'type': 'str', 'required': True}, {'name': 'email', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str', 'required': True}, {'name': 'country', 'type': 'str', 'required': True}, {'name': 'total_committed', 'type': 'float', 'required': True}, {'name': 'total_disbursed', 'type': 'float', 'required': True}, {'name': 'relationship_manager', 'type': 'str', 'required': True}, {'name': 'preferred_reporting', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Disbursement', 'type': 'entity', 'properties': ['id', 'grant_id', 'donor_id', 'tranche_number', 'amount', 'currency', 'disbursement_date', 'bank_reference', 'purpose', 'status', 'conditions_met'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'grant_id', 'type': 'str', 'required': True}, {'name': 'donor_id', 'type': 'str', 'required': True}, {'name': 'tranche_number', 'type': 'int', 'required': True}, {'name': 'amount', 'type': 'float', 'required': True}, {'name': 'currency', 'type': 'str', 'required': True}, {'name': 'disbursement_date', 'type': 'date', 'required': True}, {'name': 'bank_reference', 'type': 'str', 'required': True}, {'name': 'purpose', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'conditions_met', 'type': 'bool', 'required': True}], 'methods': []}, {'name': 'Beneficiary', 'type': 'entity', 'properties': ['id', 'beneficiary_code', 'full_name', 'gender', 'age', 'county', 'sub_county', 'vulnerability_category', 'programme_id', 'enrolment_date', 'status', 'household_size', 'phone'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'beneficiary_code', 'type': 'str', 'required': True}, {'name': 'full_name', 'type': 'str', 'required': True}, {'name': 'gender', 'type': 'str', 'required': True}, {'name': 'age', 'type': 'int', 'required': True}, {'name': 'county', 'type': 'str', 'required': True}, {'name': 'sub_county', 'type': 'str', 'required': True}, {'name': 'vulnerability_category', 'type': 'str', 'required': True}, {'name': 'programme_id', 'type': 'str', 'required': True}, {'name': 'enrolment_date', 'type': 'date', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'household_size', 'type': 'int', 'required': True}, {'name': 'phone', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Indicator', 'type': 'entity', 'properties': ['id', 'grant_id', 'indicator_code', 'indicator_name', 'indicator_type', 'baseline_value', 'target_value', 'current_value', 'unit_of_measurement', 'data_source', 'collection_frequency', 'disaggregation'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'grant_id', 'type': 'str', 'required': True}, {'name': 'indicator_code', 'type': 'str', 'required': True}, {'name': 'indicator_name', 'type': 'str', 'required': True}, {'name': 'indicator_type', 'type': 'str', 'required': True}, {'name': 'baseline_value', 'type': 'float', 'required': True}, {'name': 'target_value', 'type': 'float', 'required': True}, {'name': 'current_value', 'type': 'float', 'required': True}, {'name': 'unit_of_measurement', 'type': 'str', 'required': True}, {'name': 'data_source', 'type': 'str', 'required': True}, {'name': 'collection_frequency', 'type': 'str', 'required': True}, {'name': 'disaggregation', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'ProgressReport', 'type': 'entity', 'properties': ['id', 'grant_id', 'report_period', 'submission_date', 'narrative_summary', 'financial_expenditure', 'achievements', 'challenges', 'next_steps', 'status', 'reviewed_by'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'grant_id', 'type': 'str', 'required': True}, {'name': 'report_period', 'type': 'str', 'required': True}, {'name': 'submission_date', 'type': 'date', 'required': True}, {'name': 'narrative_summary', 'type': 'str', 'required': True}, {'name': 'financial_expenditure', 'type': 'float', 'required': True}, {'name': 'achievements', 'type': 'str', 'required': True}, {'name': 'challenges', 'type': 'str', 'required': True}, {'name': 'next_steps', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'reviewed_by', 'type': 'str', 'required': True}], 'methods': []}, {'name': 'Activity', 'type': 'entity', 'properties': ['id', 'grant_id', 'activity_code', 'activity_name', 'description', 'start_date', 'end_date', 'budget', 'actual_expenditure', 'status', 'lead_person', 'beneficiaries_reached'], 'fields': [{'name': 'id', 'type': 'str', 'required': True}, {'name': 'grant_id', 'type': 'str', 'required': True}, {'name': 'activity_code', 'type': 'str', 'required': True}, {'name': 'activity_name', 'type': 'str', 'required': True}, {'name': 'description', 'type': 'str', 'required': True}, {'name': 'start_date', 'type': 'date', 'required': True}, {'name': 'end_date', 'type': 'date', 'required': True}, {'name': 'budget', 'type': 'float', 'required': True}, {'name': 'actual_expenditure', 'type': 'float', 'required': True}, {'name': 'status', 'type': 'str', 'required': True}, {'name': 'lead_person', 'type': 'str', 'required': True}, {'name': 'beneficiaries_reached', 'type': 'int', 'required': True}], 'methods': []}, {'name': 'NGOApp', 'type': 'application', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['ngo_grants.apg'], 'app': {'name': 'ngo_grants', 'version': '1.0.0', 'description': None, 'entity_count': 8}, 'symbols': {'module.ngo_grants': {'id': 'module.ngo_grants', 'kind': 'module', 'name': 'ngo_grants', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Grant': {'id': 'table.Grant', 'kind': 'table', 'name': 'Grant', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.id': {'id': 'field.Grant.id', 'kind': 'field', 'name': 'Grant.id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.grant_code': {'id': 'field.Grant.grant_code', 'kind': 'field', 'name': 'Grant.grant_code', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.title': {'id': 'field.Grant.title', 'kind': 'field', 'name': 'Grant.title', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.donor_id': {'id': 'field.Grant.donor_id', 'kind': 'field', 'name': 'Grant.donor_id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.amount': {'id': 'field.Grant.amount', 'kind': 'field', 'name': 'Grant.amount', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.currency': {'id': 'field.Grant.currency', 'kind': 'field', 'name': 'Grant.currency', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.start_date': {'id': 'field.Grant.start_date', 'kind': 'field', 'name': 'Grant.start_date', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.end_date': {'id': 'field.Grant.end_date', 'kind': 'field', 'name': 'Grant.end_date', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.status': {'id': 'field.Grant.status', 'kind': 'field', 'name': 'Grant.status', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.grant_type': {'id': 'field.Grant.grant_type', 'kind': 'field', 'name': 'Grant.grant_type', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.reporting_frequency': {'id': 'field.Grant.reporting_frequency', 'kind': 'field', 'name': 'Grant.reporting_frequency', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.project_manager': {'id': 'field.Grant.project_manager', 'kind': 'field', 'name': 'Grant.project_manager', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.country': {'id': 'field.Grant.country', 'kind': 'field', 'name': 'Grant.country', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.sector': {'id': 'field.Grant.sector', 'kind': 'field', 'name': 'Grant.sector', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Grant.thematic_area': {'id': 'field.Grant.thematic_area', 'kind': 'field', 'name': 'Grant.thematic_area', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Donor': {'id': 'table.Donor', 'kind': 'table', 'name': 'Donor', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Donor.id': {'id': 'field.Donor.id', 'kind': 'field', 'name': 'Donor.id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Donor.donor_code': {'id': 'field.Donor.donor_code', 'kind': 'field', 'name': 'Donor.donor_code', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Donor.organisation_name': {'id': 'field.Donor.organisation_name', 'kind': 'field', 'name': 'Donor.organisation_name', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Donor.donor_type': {'id': 'field.Donor.donor_type', 'kind': 'field', 'name': 'Donor.donor_type', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Donor.contact_person': {'id': 'field.Donor.contact_person', 'kind': 'field', 'name': 'Donor.contact_person', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Donor.email': {'id': 'field.Donor.email', 'kind': 'field', 'name': 'Donor.email', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Donor.phone': {'id': 'field.Donor.phone', 'kind': 'field', 'name': 'Donor.phone', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Donor.country': {'id': 'field.Donor.country', 'kind': 'field', 'name': 'Donor.country', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Donor.total_committed': {'id': 'field.Donor.total_committed', 'kind': 'field', 'name': 'Donor.total_committed', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Donor.total_disbursed': {'id': 'field.Donor.total_disbursed', 'kind': 'field', 'name': 'Donor.total_disbursed', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Donor.relationship_manager': {'id': 'field.Donor.relationship_manager', 'kind': 'field', 'name': 'Donor.relationship_manager', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Donor.preferred_reporting': {'id': 'field.Donor.preferred_reporting', 'kind': 'field', 'name': 'Donor.preferred_reporting', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Disbursement': {'id': 'table.Disbursement', 'kind': 'table', 'name': 'Disbursement', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Disbursement.id': {'id': 'field.Disbursement.id', 'kind': 'field', 'name': 'Disbursement.id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Disbursement.grant_id': {'id': 'field.Disbursement.grant_id', 'kind': 'field', 'name': 'Disbursement.grant_id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Disbursement.donor_id': {'id': 'field.Disbursement.donor_id', 'kind': 'field', 'name': 'Disbursement.donor_id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Disbursement.tranche_number': {'id': 'field.Disbursement.tranche_number', 'kind': 'field', 'name': 'Disbursement.tranche_number', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Disbursement.amount': {'id': 'field.Disbursement.amount', 'kind': 'field', 'name': 'Disbursement.amount', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Disbursement.currency': {'id': 'field.Disbursement.currency', 'kind': 'field', 'name': 'Disbursement.currency', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Disbursement.disbursement_date': {'id': 'field.Disbursement.disbursement_date', 'kind': 'field', 'name': 'Disbursement.disbursement_date', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Disbursement.bank_reference': {'id': 'field.Disbursement.bank_reference', 'kind': 'field', 'name': 'Disbursement.bank_reference', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Disbursement.purpose': {'id': 'field.Disbursement.purpose', 'kind': 'field', 'name': 'Disbursement.purpose', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Disbursement.status': {'id': 'field.Disbursement.status', 'kind': 'field', 'name': 'Disbursement.status', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Disbursement.conditions_met': {'id': 'field.Disbursement.conditions_met', 'kind': 'field', 'name': 'Disbursement.conditions_met', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Beneficiary': {'id': 'table.Beneficiary', 'kind': 'table', 'name': 'Beneficiary', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.id': {'id': 'field.Beneficiary.id', 'kind': 'field', 'name': 'Beneficiary.id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.beneficiary_code': {'id': 'field.Beneficiary.beneficiary_code', 'kind': 'field', 'name': 'Beneficiary.beneficiary_code', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.full_name': {'id': 'field.Beneficiary.full_name', 'kind': 'field', 'name': 'Beneficiary.full_name', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.gender': {'id': 'field.Beneficiary.gender', 'kind': 'field', 'name': 'Beneficiary.gender', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.age': {'id': 'field.Beneficiary.age', 'kind': 'field', 'name': 'Beneficiary.age', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.county': {'id': 'field.Beneficiary.county', 'kind': 'field', 'name': 'Beneficiary.county', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.sub_county': {'id': 'field.Beneficiary.sub_county', 'kind': 'field', 'name': 'Beneficiary.sub_county', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.vulnerability_category': {'id': 'field.Beneficiary.vulnerability_category', 'kind': 'field', 'name': 'Beneficiary.vulnerability_category', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.programme_id': {'id': 'field.Beneficiary.programme_id', 'kind': 'field', 'name': 'Beneficiary.programme_id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.enrolment_date': {'id': 'field.Beneficiary.enrolment_date', 'kind': 'field', 'name': 'Beneficiary.enrolment_date', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.status': {'id': 'field.Beneficiary.status', 'kind': 'field', 'name': 'Beneficiary.status', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.household_size': {'id': 'field.Beneficiary.household_size', 'kind': 'field', 'name': 'Beneficiary.household_size', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Beneficiary.phone': {'id': 'field.Beneficiary.phone', 'kind': 'field', 'name': 'Beneficiary.phone', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Indicator': {'id': 'table.Indicator', 'kind': 'table', 'name': 'Indicator', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Indicator.id': {'id': 'field.Indicator.id', 'kind': 'field', 'name': 'Indicator.id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Indicator.grant_id': {'id': 'field.Indicator.grant_id', 'kind': 'field', 'name': 'Indicator.grant_id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Indicator.indicator_code': {'id': 'field.Indicator.indicator_code', 'kind': 'field', 'name': 'Indicator.indicator_code', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Indicator.indicator_name': {'id': 'field.Indicator.indicator_name', 'kind': 'field', 'name': 'Indicator.indicator_name', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Indicator.indicator_type': {'id': 'field.Indicator.indicator_type', 'kind': 'field', 'name': 'Indicator.indicator_type', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Indicator.baseline_value': {'id': 'field.Indicator.baseline_value', 'kind': 'field', 'name': 'Indicator.baseline_value', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Indicator.target_value': {'id': 'field.Indicator.target_value', 'kind': 'field', 'name': 'Indicator.target_value', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Indicator.current_value': {'id': 'field.Indicator.current_value', 'kind': 'field', 'name': 'Indicator.current_value', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Indicator.unit_of_measurement': {'id': 'field.Indicator.unit_of_measurement', 'kind': 'field', 'name': 'Indicator.unit_of_measurement', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Indicator.data_source': {'id': 'field.Indicator.data_source', 'kind': 'field', 'name': 'Indicator.data_source', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Indicator.collection_frequency': {'id': 'field.Indicator.collection_frequency', 'kind': 'field', 'name': 'Indicator.collection_frequency', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Indicator.disaggregation': {'id': 'field.Indicator.disaggregation', 'kind': 'field', 'name': 'Indicator.disaggregation', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.ProgressReport': {'id': 'table.ProgressReport', 'kind': 'table', 'name': 'ProgressReport', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProgressReport.id': {'id': 'field.ProgressReport.id', 'kind': 'field', 'name': 'ProgressReport.id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProgressReport.grant_id': {'id': 'field.ProgressReport.grant_id', 'kind': 'field', 'name': 'ProgressReport.grant_id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProgressReport.report_period': {'id': 'field.ProgressReport.report_period', 'kind': 'field', 'name': 'ProgressReport.report_period', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProgressReport.submission_date': {'id': 'field.ProgressReport.submission_date', 'kind': 'field', 'name': 'ProgressReport.submission_date', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProgressReport.narrative_summary': {'id': 'field.ProgressReport.narrative_summary', 'kind': 'field', 'name': 'ProgressReport.narrative_summary', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProgressReport.financial_expenditure': {'id': 'field.ProgressReport.financial_expenditure', 'kind': 'field', 'name': 'ProgressReport.financial_expenditure', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProgressReport.achievements': {'id': 'field.ProgressReport.achievements', 'kind': 'field', 'name': 'ProgressReport.achievements', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProgressReport.challenges': {'id': 'field.ProgressReport.challenges', 'kind': 'field', 'name': 'ProgressReport.challenges', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProgressReport.next_steps': {'id': 'field.ProgressReport.next_steps', 'kind': 'field', 'name': 'ProgressReport.next_steps', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProgressReport.status': {'id': 'field.ProgressReport.status', 'kind': 'field', 'name': 'ProgressReport.status', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProgressReport.reviewed_by': {'id': 'field.ProgressReport.reviewed_by', 'kind': 'field', 'name': 'ProgressReport.reviewed_by', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.Activity': {'id': 'table.Activity', 'kind': 'table', 'name': 'Activity', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.id': {'id': 'field.Activity.id', 'kind': 'field', 'name': 'Activity.id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.grant_id': {'id': 'field.Activity.grant_id', 'kind': 'field', 'name': 'Activity.grant_id', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.activity_code': {'id': 'field.Activity.activity_code', 'kind': 'field', 'name': 'Activity.activity_code', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.activity_name': {'id': 'field.Activity.activity_name', 'kind': 'field', 'name': 'Activity.activity_name', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.description': {'id': 'field.Activity.description', 'kind': 'field', 'name': 'Activity.description', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.start_date': {'id': 'field.Activity.start_date', 'kind': 'field', 'name': 'Activity.start_date', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.end_date': {'id': 'field.Activity.end_date', 'kind': 'field', 'name': 'Activity.end_date', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.budget': {'id': 'field.Activity.budget', 'kind': 'field', 'name': 'Activity.budget', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.actual_expenditure': {'id': 'field.Activity.actual_expenditure', 'kind': 'field', 'name': 'Activity.actual_expenditure', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.status': {'id': 'field.Activity.status', 'kind': 'field', 'name': 'Activity.status', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.lead_person': {'id': 'field.Activity.lead_person', 'kind': 'field', 'name': 'Activity.lead_person', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.Activity.beneficiaries_reached': {'id': 'field.Activity.beneficiaries_reached', 'kind': 'field', 'name': 'Activity.beneficiaries_reached', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'app.NGOApp': {'id': 'app.NGOApp', 'kind': 'app', 'name': 'NGOApp', 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'Grant': {'name': 'Grant', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'grant_code': {'type': 'str', 'required': True, 'relationship': None}, 'title': {'type': 'str', 'required': True, 'relationship': None}, 'donor_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Donor', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'donor'}}, 'amount': {'type': 'float', 'required': True, 'relationship': None}, 'currency': {'type': 'str', 'required': True, 'relationship': None}, 'start_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'end_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'grant_type': {'type': 'str', 'required': True, 'relationship': None}, 'reporting_frequency': {'type': 'str', 'required': True, 'relationship': None}, 'project_manager': {'type': 'str', 'required': True, 'relationship': None}, 'country': {'type': 'str', 'required': True, 'relationship': None}, 'sector': {'type': 'str', 'required': True, 'relationship': None}, 'thematic_area': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'start_date.id': {'chain': ['Grant.start_date', 'date.id'], 'valid': True}, 'end_date.id': {'chain': ['Grant.end_date', 'date.id'], 'valid': True}}}, 'Donor': {'name': 'Donor', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'donor_code': {'type': 'str', 'required': True, 'relationship': None}, 'organisation_name': {'type': 'str', 'required': True, 'relationship': None}, 'donor_type': {'type': 'str', 'required': True, 'relationship': None}, 'contact_person': {'type': 'str', 'required': True, 'relationship': None}, 'email': {'type': 'str', 'required': True, 'relationship': None}, 'phone': {'type': 'str', 'required': True, 'relationship': None}, 'country': {'type': 'str', 'required': True, 'relationship': None}, 'total_committed': {'type': 'float', 'required': True, 'relationship': None}, 'total_disbursed': {'type': 'float', 'required': True, 'relationship': None}, 'relationship_manager': {'type': 'str', 'required': True, 'relationship': None}, 'preferred_reporting': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {}}, 'Disbursement': {'name': 'Disbursement', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'grant_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Grant', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'grant'}}, 'donor_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Donor', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'donor'}}, 'tranche_number': {'type': 'int', 'required': True, 'relationship': None}, 'amount': {'type': 'float', 'required': True, 'relationship': None}, 'currency': {'type': 'str', 'required': True, 'relationship': None}, 'disbursement_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'bank_reference': {'type': 'str', 'required': True, 'relationship': None}, 'purpose': {'type': 'str', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'conditions_met': {'type': 'bool', 'required': True, 'relationship': None}}, 'lookup_paths': {'disbursement_date.id': {'chain': ['Disbursement.disbursement_date', 'date.id'], 'valid': True}}}, 'Beneficiary': {'name': 'Beneficiary', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'beneficiary_code': {'type': 'str', 'required': True, 'relationship': None}, 'full_name': {'type': 'str', 'required': True, 'relationship': None}, 'gender': {'type': 'str', 'required': True, 'relationship': None}, 'age': {'type': 'int', 'required': True, 'relationship': None}, 'county': {'type': 'str', 'required': True, 'relationship': None}, 'sub_county': {'type': 'str', 'required': True, 'relationship': None}, 'vulnerability_category': {'type': 'str', 'required': True, 'relationship': None}, 'programme_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Programme', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'programme'}}, 'enrolment_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'household_size': {'type': 'int', 'required': True, 'relationship': None}, 'phone': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'enrolment_date.id': {'chain': ['Beneficiary.enrolment_date', 'date.id'], 'valid': True}}}, 'Indicator': {'name': 'Indicator', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'grant_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Grant', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'grant'}}, 'indicator_code': {'type': 'str', 'required': True, 'relationship': None}, 'indicator_name': {'type': 'str', 'required': True, 'relationship': None}, 'indicator_type': {'type': 'str', 'required': True, 'relationship': None}, 'baseline_value': {'type': 'float', 'required': True, 'relationship': None}, 'target_value': {'type': 'float', 'required': True, 'relationship': None}, 'current_value': {'type': 'float', 'required': True, 'relationship': None}, 'unit_of_measurement': {'type': 'str', 'required': True, 'relationship': None}, 'data_source': {'type': 'str', 'required': True, 'relationship': None}, 'collection_frequency': {'type': 'str', 'required': True, 'relationship': None}, 'disaggregation': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {}}, 'ProgressReport': {'name': 'ProgressReport', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'grant_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Grant', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'grant'}}, 'report_period': {'type': 'str', 'required': True, 'relationship': None}, 'submission_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'narrative_summary': {'type': 'str', 'required': True, 'relationship': None}, 'financial_expenditure': {'type': 'float', 'required': True, 'relationship': None}, 'achievements': {'type': 'str', 'required': True, 'relationship': None}, 'challenges': {'type': 'str', 'required': True, 'relationship': None}, 'next_steps': {'type': 'str', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'reviewed_by': {'type': 'str', 'required': True, 'relationship': None}}, 'lookup_paths': {'submission_date.id': {'chain': ['ProgressReport.submission_date', 'date.id'], 'valid': True}}}, 'Activity': {'name': 'Activity', 'fields': {'id': {'type': 'str', 'required': True, 'relationship': None}, 'grant_id': {'type': 'str', 'required': True, 'relationship': {'target_table': 'Grant', 'target_field': 'id', 'cardinality': 'many-to-one', 'alias': 'grant'}}, 'activity_code': {'type': 'str', 'required': True, 'relationship': None}, 'activity_name': {'type': 'str', 'required': True, 'relationship': None}, 'description': {'type': 'str', 'required': True, 'relationship': None}, 'start_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'end_date': {'type': 'date', 'required': True, 'relationship': {'target_table': 'date', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'budget': {'type': 'float', 'required': True, 'relationship': None}, 'actual_expenditure': {'type': 'float', 'required': True, 'relationship': None}, 'status': {'type': 'str', 'required': True, 'relationship': None}, 'lead_person': {'type': 'str', 'required': True, 'relationship': None}, 'beneficiaries_reached': {'type': 'int', 'required': True, 'relationship': None}}, 'lookup_paths': {'start_date.id': {'chain': ['Activity.start_date', 'date.id'], 'valid': True}, 'end_date.id': {'chain': ['Activity.end_date', 'date.id'], 'valid': True}}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {'NGOApp': {'name': 'NGOApp', 'description': 'Grant management and impact measurement', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': [], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'ngo_grants.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 93, 'edges': 92}, 'lookup': {'kind': 'lookup', 'nodes': 9, 'edges': 8}, 'workflow': {'kind': 'workflow', 'nodes': 9, 'edges': 8}, 'handler': {'kind': 'handler', 'nodes': 9, 'edges': 8}, 'capability': {'kind': 'capability', 'nodes': 1, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 9, 'edges': 8}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 9, 'edges': 8}, 'package': {'kind': 'package', 'nodes': 9, 'edges': 8}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Application 'NGOApp' should compose capabilities, components, or routes", 'file': 'ngo_grants.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
