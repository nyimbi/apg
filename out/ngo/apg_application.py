...
APPLICATION_DATA: Dict[str, Dict[str, Any]] = {'NGOApp': {'description': 'Grant management and impact measurement', 'capabilities': [], 'agents': [], 'agent_teams': [], 'components': {}, 'screens': {}, 'routes': [], 'workflows': [], 'policies': {}, 'configuration': {}, 'theme': {}, 'runtime': {}, 'integrations': {}, 'deployments': {}}}
