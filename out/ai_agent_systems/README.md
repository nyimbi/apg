...
- `ResearchAgent` - runtime `local`, invoke with `POST /agents/ResearchAgent/invoke`
- `ConversationalAssistant` - runtime `local`, invoke with `POST /agents/ConversationalAssistant/invoke`
- `SoftwareDeveloper` - runtime `local`, invoke with `POST /agents/SoftwareDeveloper/invoke`
- `SystemMonitor` - runtime `local`, invoke with `POST /agents/SystemMonitor/invoke`
...
- `CollaborativeAgentSystem` - invoke with `POST /agent-teams/CollaborativeAgentSystem/invoke`
