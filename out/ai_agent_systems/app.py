...
ENTITIES = [{'name': 'ResearchAgent', 'type': 'ai_agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'ConversationalAssistant', 'type': 'ai_agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'CollaborativeAgentSystem', 'type': 'agent_team', 'properties': [], 'fields': [], 'methods': []}, {'name': 'SoftwareDeveloper', 'type': 'ai_agent', 'properties': [], 'fields': [], 'methods': []}, {'name': 'SystemMonitor', 'type': 'ai_agent', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['main.apg'], 'app': {'name': 'main', 'version': '1.0.0', 'description': None, 'entity_count': 5}, 'symbols': {'module.main': {'id': 'module.main', 'kind': 'module', 'name': 'main', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'agent.ResearchAgent': {'id': 'agent.ResearchAgent', 'kind': 'agent', 'name': 'ResearchAgent', 'file': 'main.apg', 'range': {'start': {'line': 21, 'character': 0}, 'end': {'line': 21, 'character': 1}}, 'references': []}, 'llm.local': {'id': 'llm.local', 'kind': 'llm', 'name': 'local', 'file': 'main.apg', 'range': {'start': {'line': 253, 'character': 0}, 'end': {'line': 253, 'character': 1}}, 'references': []}, 'agent.ConversationalAssistant': {'id': 'agent.ConversationalAssistant', 'kind': 'agent', 'name': 'ConversationalAssistant', 'file': 'main.apg', 'range': {'start': {'line': 86, 'character': 0}, 'end': {'line': 86, 'character': 1}}, 'references': []}, 'composition.CollaborativeAgentSystem': {'id': 'composition.CollaborativeAgentSystem', 'kind': 'composition', 'name': 'CollaborativeAgentSystem', 'file': 'main.apg', 'range': {'start': {'line': 133, 'character': 0}, 'end': {'line': 133, 'character': 1}}, 'references': []}, 'agent.SoftwareDeveloper': {'id': 'agent.SoftwareDeveloper', 'kind': 'agent', 'name': 'SoftwareDeveloper', 'file': 'main.apg', 'range': {'start': {'line': 190, 'character': 0}, 'end': {'line': 190, 'character': 1}}, 'references': []}, 'agent.SystemMonitor': {'id': 'agent.SystemMonitor', 'kind': 'agent', 'name': 'SystemMonitor', 'file': 'main.apg', 'range': {'start': {'line': 253, 'character': 0}, 'end': {'line': 253, 'character': 1}}, 'references': []}}, 'tables': {}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {'ResearchAgent': {'name': 'ResearchAgent', 'role': None, 'model': 'local', 'runtime': None, 'system': None, 'capabilities': [], 'tools': [], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {}, 'rules': [], 'ui': {}, 'theme': {}}, 'ConversationalAssistant': {'name': 'ConversationalAssistant', 'role': None, 'model': 'local', 'runtime': None, 'system': None, 'capabilities': [], 'tools': [], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {}, 'rules': [], 'ui': {}, 'theme': {}}, 'SoftwareDeveloper': {'name': 'SoftwareDeveloper', 'role': None, 'model': 'local', 'runtime': None, 'system': None, 'capabilities': [], 'tools': [], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {}, 'rules': [], 'ui': {}, 'theme': {}}, 'SystemMonitor': {'name': 'SystemMonitor', 'role': None, 'model': 'local', 'runtime': None, 'system': None, 'capabilities': [], 'tools': [], 'memory': None, 'inputs': [], 'outputs': [], 'handoffs': [], 'configuration': {}, 'rules': [], 'ui': {}, 'theme': {}}}, 'llms': {'ResearchAgent': {'model': 'local', 'runtime': None}, 'ConversationalAssistant': {'model': 'local', 'runtime': None}, 'SoftwareDeveloper': {'model': 'local', 'runtime': None}, 'SystemMonitor': {'model': 'local', 'runtime': None}}, 'capabilities': {}, 'composition': {'applications': {}, 'agent_teams': {'CollaborativeAgentSystem': {'agents': ['ResearchAgent', 'SoftwareDeveloper'], 'flow': [], 'capabilities': [], 'configuration': {}, 'rules': [], 'ui': {}, 'theme': {}}}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'main.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 0, 'edges': 0}, 'lookup': {'kind': 'lookup', 'nodes': 6, 'edges': 5}, 'workflow': {'kind': 'workflow', 'nodes': 6, 'edges': 5}, 'handler': {'kind': 'handler', 'nodes': 6, 'edges': 5}, 'capability': {'kind': 'capability', 'nodes': 0, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 6, 'edges': 5}, 'agent': {'kind': 'agent', 'nodes': 5, 'edges': 2}, 'deployment': {'kind': 'deployment', 'nodes': 6, 'edges': 5}, 'package': {'kind': 'package', 'nodes': 6, 'edges': 5}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "AI agent 'ResearchAgent' should declare a role or system prompt", 'file': 'main.apg', 'range': {'start': {'line': 20, 'character': 0}, 'end': {'line': 20, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "AI agent 'ConversationalAssistant' should declare a role or system prompt", 'file': 'main.apg', 'range': {'start': {'line': 85, 'character': 0}, 'end': {'line': 85, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "AI agent 'SoftwareDeveloper' should declare a role or system prompt", 'file': 'main.apg', 'range': {'start': {'line': 189, 'character': 0}, 'end': {'line': 189, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "AI agent 'SystemMonitor' should declare a role or system prompt", 'file': 'main.apg', 'range': {'start': {'line': 252, 'character': 0}, 'end': {'line': 252, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
