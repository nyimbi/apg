...
ENTITIES = [{'name': 'ManufacturingLine', 'type': 'digital_twin', 'properties': ['physical_model', 'asset_id', 'location', 'cad_file', 'materials', 'tolerances', 'solver', 'mesh_resolution', 'boundary_conditions', 'loading', 'max_rpm', 'max_feed_rate', 'cutting_forces', 'temperature_range', 'coolant_degradation', 'frequency', 'protocol', 'endpoint', 'security', 'models', 'training_data', 'retraining_frequency', 'confidence_threshold'], 'fields': [{'name': 'physical_model', 'type': '"CNC_Machining_Center_X200"', 'required': True}, {'name': 'asset_id', 'type': '"LINE_01_CNC_001"', 'required': True}, {'name': 'location', 'type': '"Factory_Floor_A_Station_12"', 'required': True}, {'name': 'cad_file', 'type': '"/models/cnc_x200.step"', 'required': True}, {'name': 'materials', 'type': '["steel_316", "aluminum_6061", "carbon_fiber"]', 'required': True}, {'name': 'tolerances', 'type': 'geometric_tolerance(±0.001)', 'required': True}, {'name': 'solver', 'type': '"ansys_mechanical"', 'required': True}, {'name': 'mesh_resolution', 'type': 'float', 'required': True}, {'name': 'boundary_conditions', 'type': '[fixed_base, rotating_spindle]', 'required': True}, {'name': 'loading', 'type': 'dynamic_forces', 'required': True}, {'name': 'max_rpm', 'type': '12000', 'required': True}, {'name': 'max_feed_rate', 'type': '15000', 'required': True}, {'name': 'cutting_forces', 'type': '±5000N', 'required': True}, {'name': 'temperature_range', 'type': '[20, 80]', 'required': True}, {'name': 'coolant_degradation', 'type': 'normal(μ', 'required': True, 'default': '720, σ=48)'}, {'name': 'frequency', 'type': '1000Hz', 'required': True}, {'name': 'protocol', 'type': 'opc_ua', 'required': True}, {'name': 'endpoint', 'type': '"opc.tcp://192.168.1.100:4840"', 'required': True}, {'name': 'security', 'type': 'sign_and_encrypt', 'required': True}, {'name': 'models', 'type': 'isolation_forest->autoencoder->lstm_autoencoder', 'required': True}, {'name': 'training_data', 'type': 'historical_sensor_data(365_days)', 'required': True}, {'name': 'retraining_frequency', 'type': 'weekly', 'required': True}, {'name': 'confidence_threshold', 'type': '0.95', 'required': True}], 'methods': []}, {'name': 'QualityInspectionSystem', 'type': 'entity', 'properties': ['dimensional_accuracy', 'surface_roughness', 'color_tolerance', 'defect_classification_accuracy', 'false_positive_rate'], 'fields': [{'name': 'dimensional_accuracy', 'type': 'float', 'required': True}, {'name': 'surface_roughness', 'type': 'float', 'required': True}, {'name': 'color_tolerance', 'type': 'float', 'required': True}, {'name': 'defect_classification_accuracy', 'type': 'float', 'required': True}, {'name': 'false_positive_rate', 'type': 'float', 'required': True}], 'methods': []}, {'name': 'ProductionAnomalyDetector', 'type': 'entity', 'properties': ['autoencoder', 'voting_strategy', 'confidence_weighting', 'window_size', 'slide_interval', 'buffer_size', 'processing_latency', 'critical', 'high', 'medium'], 'fields': [{'name': 'autoencoder', 'type': 'float', 'required': True}, {'name': 'voting_strategy', 'type': 'string', 'required': True}, {'name': 'confidence_weighting', 'type': '[0.2, 0.3, 0.25, 0.25]', 'required': True}, {'name': 'window_size', 'type': 'float', 'required': True}, {'name': 'slide_interval', 'type': 'float', 'required': True}, {'name': 'buffer_size', 'type': 'int', 'required': True}, {'name': 'processing_latency', 'type': 'float', 'required': True}, {'name': 'critical', 'type': 'string', 'required': True}, {'name': 'high', 'type': 'string', 'required': True}, {'name': 'medium', 'type': 'string', 'required': True}], 'methods': []}, {'name': 'MaintenancePredictor', 'type': 'entity', 'properties': ['current_clamps', 'model', 'uncertainty_quantification', 'confidence_intervals', 'prediction_horizon', 'strategy', 'cost_function'], 'fields': [{'name': 'current_clamps', 'type': 'string', 'required': True}, {'name': 'model', 'type': 'particle_filter + kalman_filter', 'required': True}, {'name': 'uncertainty_quantification', 'type': 'float', 'required': True}, {'name': 'confidence_intervals', 'type': '[80%, 95%]', 'required': True}, {'name': 'prediction_horizon', 'type': '[7_days, 30_days, 90_days]', 'required': True}, {'name': 'strategy', 'type': 'condition_based + predictive', 'required': True}, {'name': 'cost_function', 'type': 'minimize(maintenance_cost + downtime_cost + failure_risk)', 'required': True}], 'methods': []}, {'name': 'SmartFactoryDigitalTwin', 'type': 'digital_twin', 'properties': ['overall_equipment_effectiveness', 'throughput', 'yield', 'energy_efficiency', 'maintenance_cost_ratio', 'production_scheduling', 'resource_allocation', 'inventory_management', 'quality_control', 'energy_management'], 'fields': [{'name': 'overall_equipment_effectiveness', 'type': 'float * performance * quality', 'required': True}, {'name': 'throughput', 'type': 'units_per_hour', 'required': True}, {'name': 'yield', 'type': 'good_parts / total_parts', 'required': True}, {'name': 'energy_efficiency', 'type': 'kwh_per_unit_produced', 'required': True}, {'name': 'maintenance_cost_ratio', 'type': 'maintenance_cost / production_value', 'required': True}, {'name': 'production_scheduling', 'type': 'mixed_integer_programming', 'required': True}, {'name': 'resource_allocation', 'type': 'linear_programming', 'required': True}, {'name': 'inventory_management', 'type': 'dynamic_programming', 'required': True}, {'name': 'quality_control', 'type': 'statistical_process_control', 'required': True}, {'name': 'energy_management', 'type': 'model_predictive_control', 'required': True}], 'methods': []}, {'name': 'DigitalTwinInfrastructure', 'type': 'entity', 'properties': [], 'fields': [], 'methods': []}]
...
SEMANTIC_MODEL: Dict[str, Any] = {'format': 'apg.semantic-model.v1', 'ok': True, 'source_files': ['main.apg'], 'app': {'name': 'main', 'version': '1.0.0', 'description': None, 'entity_count': 6}, 'symbols': {'module.main': {'id': 'module.main', 'kind': 'module', 'name': 'main', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'digital_twin.ManufacturingLine': {'id': 'digital_twin.ManufacturingLine', 'kind': 'digital_twin', 'name': 'ManufacturingLine', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.QualityInspectionSystem': {'id': 'table.QualityInspectionSystem', 'kind': 'table', 'name': 'QualityInspectionSystem', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspectionSystem.dimensional_accuracy': {'id': 'field.QualityInspectionSystem.dimensional_accuracy', 'kind': 'field', 'name': 'QualityInspectionSystem.dimensional_accuracy', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspectionSystem.surface_roughness': {'id': 'field.QualityInspectionSystem.surface_roughness', 'kind': 'field', 'name': 'QualityInspectionSystem.surface_roughness', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspectionSystem.color_tolerance': {'id': 'field.QualityInspectionSystem.color_tolerance', 'kind': 'field', 'name': 'QualityInspectionSystem.color_tolerance', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspectionSystem.defect_classification_accuracy': {'id': 'field.QualityInspectionSystem.defect_classification_accuracy', 'kind': 'field', 'name': 'QualityInspectionSystem.defect_classification_accuracy', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.QualityInspectionSystem.false_positive_rate': {'id': 'field.QualityInspectionSystem.false_positive_rate', 'kind': 'field', 'name': 'QualityInspectionSystem.false_positive_rate', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.ProductionAnomalyDetector': {'id': 'table.ProductionAnomalyDetector', 'kind': 'table', 'name': 'ProductionAnomalyDetector', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProductionAnomalyDetector.autoencoder': {'id': 'field.ProductionAnomalyDetector.autoencoder', 'kind': 'field', 'name': 'ProductionAnomalyDetector.autoencoder', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProductionAnomalyDetector.voting_strategy': {'id': 'field.ProductionAnomalyDetector.voting_strategy', 'kind': 'field', 'name': 'ProductionAnomalyDetector.voting_strategy', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProductionAnomalyDetector.confidence_weighting': {'id': 'field.ProductionAnomalyDetector.confidence_weighting', 'kind': 'field', 'name': 'ProductionAnomalyDetector.confidence_weighting', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProductionAnomalyDetector.window_size': {'id': 'field.ProductionAnomalyDetector.window_size', 'kind': 'field', 'name': 'ProductionAnomalyDetector.window_size', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProductionAnomalyDetector.slide_interval': {'id': 'field.ProductionAnomalyDetector.slide_interval', 'kind': 'field', 'name': 'ProductionAnomalyDetector.slide_interval', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProductionAnomalyDetector.buffer_size': {'id': 'field.ProductionAnomalyDetector.buffer_size', 'kind': 'field', 'name': 'ProductionAnomalyDetector.buffer_size', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProductionAnomalyDetector.processing_latency': {'id': 'field.ProductionAnomalyDetector.processing_latency', 'kind': 'field', 'name': 'ProductionAnomalyDetector.processing_latency', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProductionAnomalyDetector.critical': {'id': 'field.ProductionAnomalyDetector.critical', 'kind': 'field', 'name': 'ProductionAnomalyDetector.critical', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProductionAnomalyDetector.high': {'id': 'field.ProductionAnomalyDetector.high', 'kind': 'field', 'name': 'ProductionAnomalyDetector.high', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.ProductionAnomalyDetector.medium': {'id': 'field.ProductionAnomalyDetector.medium', 'kind': 'field', 'name': 'ProductionAnomalyDetector.medium', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'table.MaintenancePredictor': {'id': 'table.MaintenancePredictor', 'kind': 'table', 'name': 'MaintenancePredictor', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.MaintenancePredictor.current_clamps': {'id': 'field.MaintenancePredictor.current_clamps', 'kind': 'field', 'name': 'MaintenancePredictor.current_clamps', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.MaintenancePredictor.model': {'id': 'field.MaintenancePredictor.model', 'kind': 'field', 'name': 'MaintenancePredictor.model', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.MaintenancePredictor.uncertainty_quantification': {'id': 'field.MaintenancePredictor.uncertainty_quantification', 'kind': 'field', 'name': 'MaintenancePredictor.uncertainty_quantification', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.MaintenancePredictor.confidence_intervals': {'id': 'field.MaintenancePredictor.confidence_intervals', 'kind': 'field', 'name': 'MaintenancePredictor.confidence_intervals', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.MaintenancePredictor.prediction_horizon': {'id': 'field.MaintenancePredictor.prediction_horizon', 'kind': 'field', 'name': 'MaintenancePredictor.prediction_horizon', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.MaintenancePredictor.strategy': {'id': 'field.MaintenancePredictor.strategy', 'kind': 'field', 'name': 'MaintenancePredictor.strategy', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'field.MaintenancePredictor.cost_function': {'id': 'field.MaintenancePredictor.cost_function', 'kind': 'field', 'name': 'MaintenancePredictor.cost_function', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'digital_twin.SmartFactoryDigitalTwin': {'id': 'digital_twin.SmartFactoryDigitalTwin', 'kind': 'digital_twin', 'name': 'SmartFactoryDigitalTwin', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}, 'entity.DigitalTwinInfrastructure': {'id': 'entity.DigitalTwinInfrastructure', 'kind': 'entity', 'name': 'DigitalTwinInfrastructure', 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'references': []}}, 'tables': {'QualityInspectionSystem': {'name': 'QualityInspectionSystem', 'fields': {'dimensional_accuracy': {'type': 'float', 'required': True, 'relationship': None}, 'surface_roughness': {'type': 'float', 'required': True, 'relationship': None}, 'color_tolerance': {'type': 'float', 'required': True, 'relationship': None}, 'defect_classification_accuracy': {'type': 'float', 'required': True, 'relationship': None}, 'false_positive_rate': {'type': 'float', 'required': True, 'relationship': None}}, 'lookup_paths': {}}, 'ProductionAnomalyDetector': {'name': 'ProductionAnomalyDetector', 'fields': {'autoencoder': {'type': 'float', 'required': True, 'relationship': None}, 'voting_strategy': {'type': 'string', 'required': True, 'relationship': {'target_table': 'string', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'confidence_weighting': {'type': '[0.2, 0.3, 0.25, 0.25]', 'required': True, 'relationship': {'target_table': '[0.2, 0.3, 0.25, 0.25]', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'window_size': {'type': 'float', 'required': True, 'relationship': None}, 'slide_interval': {'type': 'float', 'required': True, 'relationship': None}, 'buffer_size': {'type': 'int', 'required': True, 'relationship': None}, 'processing_latency': {'type': 'float', 'required': True, 'relationship': None}, 'critical': {'type': 'string', 'required': True, 'relationship': {'target_table': 'string', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'high': {'type': 'string', 'required': True, 'relationship': {'target_table': 'string', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'medium': {'type': 'string', 'required': True, 'relationship': {'target_table': 'string', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'voting_strategy.id': {'chain': ['ProductionAnomalyDetector.voting_strategy', 'string.id'], 'valid': True}, 'confidence_weighting.id': {'chain': ['ProductionAnomalyDetector.confidence_weighting', '[0.2, 0.3, 0.25, 0.25].id'], 'valid': True}, 'critical.id': {'chain': ['ProductionAnomalyDetector.critical', 'string.id'], 'valid': True}, 'high.id': {'chain': ['ProductionAnomalyDetector.high', 'string.id'], 'valid': True}, 'medium.id': {'chain': ['ProductionAnomalyDetector.medium', 'string.id'], 'valid': True}}}, 'MaintenancePredictor': {'name': 'MaintenancePredictor', 'fields': {'current_clamps': {'type': 'string', 'required': True, 'relationship': {'target_table': 'string', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'model': {'type': 'particle_filter + kalman_filter', 'required': True, 'relationship': {'target_table': 'particle_filter + kalman_filter', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'uncertainty_quantification': {'type': 'float', 'required': True, 'relationship': None}, 'confidence_intervals': {'type': '[80%, 95%]', 'required': True, 'relationship': {'target_table': '[80%, 95%]', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'prediction_horizon': {'type': '[7_days, 30_days, 90_days]', 'required': True, 'relationship': {'target_table': '[7_days, 30_days, 90_days]', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'strategy': {'type': 'condition_based + predictive', 'required': True, 'relationship': {'target_table': 'condition_based + predictive', 'target_field': 'id', 'cardinality': 'many-to-one'}}, 'cost_function': {'type': 'minimize(maintenance_cost + downtime_cost + failure_risk)', 'required': True, 'relationship': {'target_table': 'minimize(maintenance_cost + downtime_cost + failure_risk)', 'target_field': 'id', 'cardinality': 'many-to-one'}}}, 'lookup_paths': {'current_clamps.id': {'chain': ['MaintenancePredictor.current_clamps', 'string.id'], 'valid': True}, 'model.id': {'chain': ['MaintenancePredictor.model', 'particle_filter + kalman_filter.id'], 'valid': True}, 'confidence_intervals.id': {'chain': ['MaintenancePredictor.confidence_intervals', '[80%, 95%].id'], 'valid': True}, 'prediction_horizon.id': {'chain': ['MaintenancePredictor.prediction_horizon', '[7_days, 30_days, 90_days].id'], 'valid': True}, 'strategy.id': {'chain': ['MaintenancePredictor.strategy', 'condition_based + predictive.id'], 'valid': True}, 'cost_function.id': {'chain': ['MaintenancePredictor.cost_function', 'minimize(maintenance_cost + downtime_cost + failure_risk).id'], 'valid': True}}}}, 'views': {}, 'flows': {}, 'operations': {}, 'rules': {}, 'roles': {}, 'security': {}, 'agents': {}, 'llms': {}, 'capabilities': {}, 'composition': {'applications': {}, 'agent_teams': {}, 'capability_dependencies': {}}, 'contracts': {}, 'deployment': {'target': 'python', 'source': 'main.apg'}, 'packages': {}, 'graphs': {'er': {'kind': 'er', 'nodes': 26, 'edges': 22}, 'lookup': {'kind': 'lookup', 'nodes': 7, 'edges': 6}, 'workflow': {'kind': 'workflow', 'nodes': 7, 'edges': 6}, 'handler': {'kind': 'handler', 'nodes': 7, 'edges': 6}, 'capability': {'kind': 'capability', 'nodes': 0, 'edges': 0}, 'security': {'kind': 'security', 'nodes': 7, 'edges': 6}, 'agent': {'kind': 'agent', 'nodes': 0, 'edges': 0}, 'deployment': {'kind': 'deployment', 'nodes': 7, 'edges': 6}, 'package': {'kind': 'package', 'nodes': 7, 'edges': 6}}, 'diagnostics': [{'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Digital twin 'ManufacturingLine' should have state-related properties", 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}, {'code': 'APG0100', 'title': 'Semantic warning', 'severity': 'warning', 'message': "Digital twin 'SmartFactoryDigitalTwin' should have state-related properties", 'file': 'main.apg', 'range': {'start': {'line': 0, 'character': 0}, 'end': {'line': 0, 'character': 1}}, 'related_locations': [], 'fixes': [], 'docs_url': 'docs/tooling.md#semantic-model-contract'}]}
