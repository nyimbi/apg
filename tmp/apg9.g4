...
apg
    : appConfig? (table | enumDefinition | relationship | index | role | trigger | script | workflow | form | masterDetailForm | wizard | formStorage | chart | aiConfig | customFunction | report | notification | scheduledTask | backgroundJob)* EOF
    ;
