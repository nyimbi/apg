...
```python
from capabilities.communication.websocket_communication.integration import WebSocketCommunicationCapability

capability = WebSocketCommunicationCapability()
