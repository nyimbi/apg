"""Context resolution regressions for common collaboration surfaces."""
...
API_PATH = REPO_ROOT / "capabilities" / "common" / "colb" / "api.py"
VIEWS_PATH = REPO_ROOT / "capabilities" / "common" / "colb" / "views.py"
WEBSOCKET_PATH = REPO_ROOT / "capabilities" / "common" / "colb" / "websocket_manager.py"
...
def test_common_colb_surfaces_no_longer_use_fixed_collaboration_identity():
...
def test_common_colb_api_auth_resolves_state_headers_and_env(monkeypatch):
...
def test_common_colb_views_resolve_flask_context_before_headers():
...
def test_common_colb_websocket_context_resolves_path_headers_and_query(monkeypatch):
